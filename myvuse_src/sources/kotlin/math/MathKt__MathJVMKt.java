...
public class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    private static final double m5618ln(double d) {
        return Math.log(d);
    }
    ...
    /* JADX INFO: renamed from: ln */
    private static final float m5619ln(float f) {
