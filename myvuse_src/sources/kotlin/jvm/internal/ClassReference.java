...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
    ...
    static {
        ...
        for (Object obj : listListOf) {
            ...
            arrayList.add(TuplesKt.m5605to((Class) obj, Integer.valueOf(i)));
            i = i2;
        }
        ...
        for (String str : collectionValues) {
            ...
            Pair pairM5605to = TuplesKt.m5605to(sb.append(StringsKt.substringAfterLast$default(str, '.', (String) null, 2, (Object) null)).append("CompanionObject").toString(), str + ".Companion");
            map3.put(pairM5605to.getFirst(), pairM5605to.getSecond());
        }
