...
/* JADX INFO: compiled from: FastImageBorderRadiusAnimator.kt */
/* JADX INFO: loaded from: classes6.dex */
@Metadata(m5597d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0015\u0012\u0006\u0010\u0003\u001a\u00020\u0004\u0012\u0006\u0010\u0005\u001a\u00020\u0004¢\u0006\u0002\u0010\u0006J\u0010\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nH\u0017J\u0018\u0010\u000b\u001a\u00020\f2\u0006\u0010\u0005\u001a\u00020\u00022\u0006\u0010\r\u001a\u00020\u000eH\u0003J\u0018\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u00022\u0006\u0010\u0012\u001a\u00020\u0002H\u0014¨\u0006\u0013"}, m5598d2 = {"Lcom/reactnativenavigation/views/element/animators/FastImageBorderRadiusAnimator;", "Lcom/reactnativenavigation/views/element/animators/PropertyAnimatorCreator;", "Landroid/widget/ImageView;", "from", "Landroid/view/View;", TypedValues.TransitionType.S_TO, "(Landroid/view/View;Landroid/view/View;)V", "create", "Landroid/animation/Animator;", "options", "Lcom/reactnativenavigation/options/SharedElementTransitionOptions;", "setInitialOutline", "", "provider", "Lcom/reactnativenavigation/utils/BorderRadiusOutlineProvider;", "shouldAnimateProperty", "", "fromChild", "toChild", "react-native-navigation_reactNative71Release"}, m5599k = 1, m5600mv = {1, 9, 0}, m5602xi = 48)
public final class FastImageBorderRadiusAnimator extends PropertyAnimatorCreator<ImageView> {
    ...
    public boolean shouldAnimateProperty(ImageView fromChild, ImageView toChild) {
        ...
        return ((fromChild instanceof ReactImageView) || (toChild instanceof ReactImageView) || (FastImageBorderRadiusAnimator_utilitiesKt.getInheritedBorderRadius(this, getFrom()) == 0.0f && FastImageBorderRadiusAnimator_utilitiesKt.getInheritedBorderRadius(this, getTo()) == 0.0f)) ? false : true;
    }
    ...
    public Animator create(SharedElementTransitionOptions options) {
        ...
        ValueAnimator valueAnimatorOfObject = ObjectAnimator.ofObject(new CornerRadiusEvaluator(new Function1<Float, Unit>() { // from class: com.reactnativenavigation.views.element.animators.FastImageBorderRadiusAnimator.create.1
            {
                super(1);
            }
        ...
        valueAnimator.addListener(new Animator.AnimatorListener() { // from class: com.reactnativenavigation.views.element.animators.FastImageBorderRadiusAnimator$create$lambda$1$$inlined$doOnEnd$1
            ...
            public void onAnimationEnd(Animator animator) {
                Intrinsics.checkNotNullParameter(animator, "animator");
                ((ImageView) this.this$0.getTo()).setOutlineProvider(null);
            }
        });
    ...
    private final void setInitialOutline(ImageView to, BorderRadiusOutlineProvider provider) {
