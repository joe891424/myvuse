...
public final class ReactViewRotationAnimator extends PropertyAnimatorCreator<ReactViewGroup> {
    ...
    public ReactViewRotationAnimator(View from, View to) {
        super(from, to);
    ...
    public boolean shouldAnimateProperty(ReactViewGroup fromChild, ReactViewGroup toChild) {
        ...
        return this.fromRotation != this.toRotation && fromChild.getChildCount() == 0 && toChild.getChildCount() == 0;
    }
