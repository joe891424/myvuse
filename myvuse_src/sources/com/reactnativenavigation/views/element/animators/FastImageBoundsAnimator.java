...
public final class FastImageBoundsAnimator extends PropertyAnimatorCreator<ImageView> {
    ...
    public boolean shouldAnimateProperty(ImageView fromChild, ImageView toChild) {
        ...
        return (ViewUtils.areDimensionsEqual(getFrom(), getTo()) || (fromChild instanceof ReactImageView) || (toChild instanceof ReactImageView)) ? false : true;
    }
    ...
    public Animator create(SharedElementTransitionOptions options) {
        ...
        ValueAnimator valueAnimatorOfObject = ObjectAnimator.ofObject(new BoundsEvaluator(new Function1<Rect, Unit>() { // from class: com.reactnativenavigation.views.element.animators.FastImageBoundsAnimator.create.1
            {
                super(1);
            }
            ...
            public final void invoke2(Rect it2) {
                ...
                FastImageBoundsAnimator.this.getTo().setClipBounds(it2);
                FastImageBoundsAnimator.this.getTo().invalidate();
            }
        }), rect, rect2);
