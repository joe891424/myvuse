...
public final class Aquila {
    ...
    public Aquila() {
        BatCharacteristic batCharacteristic = new BatCharacteristic("Device Info", BatVocabulary.Aquila.Characteristics.deviceInfoCharacteristic, false, CharacteristicType.DeviceInfo.INSTANCE, 4, null);
        this.deviceInfoCharacteristic = batCharacteristic;
        BatCharacteristic batCharacteristic2 = new BatCharacteristic("Time", BatVocabulary.Aquila.Characteristics.timeCharacteristic, false, CharacteristicType.Time.INSTANCE, 4, null);
        this.timeCharacteristic = batCharacteristic2;
        BatCharacteristic batCharacteristic3 = new BatCharacteristic("Battery", BatVocabulary.Aquila.Characteristics.batteryCharacteristic, false, CharacteristicType.Battery.INSTANCE, 4, null);
        this.batteryCharacteristic = batCharacteristic3;
        BatCharacteristic batCharacteristic4 = new BatCharacteristic("Lock", BatVocabulary.Aquila.Characteristics.lockCharacteristic, true, CharacteristicType.Lock.INSTANCE);
        this.lockCharacteristic = batCharacteristic4;
        BatCharacteristic batCharacteristic5 = new BatCharacteristic("Find", BatVocabulary.Aquila.Characteristics.findCharacteristic, true, CharacteristicType.FindVape.INSTANCE);
        this.findCharacteristic = batCharacteristic5;
        BatCharacteristic batCharacteristic6 = new BatCharacteristic("Led", BatVocabulary.Aquila.Characteristics.ledCharacteristic, true, CharacteristicType.Led.INSTANCE);
        this.ledCharacteristic = batCharacteristic6;
        BatCharacteristic batCharacteristic7 = new BatCharacteristic("Reset", BatVocabulary.Aquila.Characteristics.resetCharacteristic, true, CharacteristicType.Reset.INSTANCE);
        this.resetCharacteristic = batCharacteristic7;
        BatCharacteristic batCharacteristic8 = new BatCharacteristic("Haptic", BatVocabulary.Aquila.Characteristics.hapticCharacteristic, true, CharacteristicType.Haptic.INSTANCE);
        this.hapticCharacteristic = batCharacteristic8;
        BatCharacteristic batCharacteristic9 = new BatCharacteristic("Ble Timeout", BatVocabulary.Aquila.Characteristics.bleTimeoutCharacteristic, true, CharacteristicType.BleTimeout.INSTANCE);
        this.bleTimeoutCharacteristic = batCharacteristic9;
        this.vapingService = new BatService("Vaping", BatVocabulary.Aquila.Services.vapingService, ServiceType.Vaping.INSTANCE, CollectionsKt.listOf((Object[]) new BatCharacteristic[]{batCharacteristic, batCharacteristic2, batCharacteristic4, batCharacteristic3, batCharacteristic5, batCharacteristic6, batCharacteristic7, batCharacteristic8, batCharacteristic9}));
        BatCharacteristic batCharacteristic10 = new BatCharacteristic("Last Error", BatVocabulary.Aquila.Characteristics.errorCharacteristic, true, CharacteristicType.LastError.INSTANCE);
        this.lastErrorCharacteristic = batCharacteristic10;
        BatCharacteristic batCharacteristic11 = new BatCharacteristic("Logs", BatVocabulary.Aquila.Characteristics.logCharacteristic, true, CharacteristicType.Logs.INSTANCE);
        this.logCharacteristic = batCharacteristic11;
        this.logService = new BatService("Log", BatVocabulary.Aquila.Services.logService, ServiceType.Log.INSTANCE, CollectionsKt.listOf((Object[]) new BatCharacteristic[]{batCharacteristic10, batCharacteristic11}));
        BatCharacteristic batCharacteristic12 = new BatCharacteristic("Age Challenge", BatVocabulary.Aquila.Characteristics.ageChallengeCharacteristic, true, null, 8, null);
        this.ageChallengeCharacteristic = batCharacteristic12;
        BatCharacteristic batCharacteristic13 = new BatCharacteristic("Age Signature", BatVocabulary.Aquila.Characteristics.ageSignatureCharacteristic, true, null, 8, null);
        this.ageSignatureCharacteristic = batCharacteristic13;
        this.ageVerificationService = new BatService("Age Verification", BatVocabulary.Aquila.Services.ageVerificationService, ServiceType.AgeVerification.INSTANCE, CollectionsKt.listOf((Object[]) new BatCharacteristic[]{batCharacteristic12, batCharacteristic13}));
    }
    ...
    public final List<BatService> setup(List<? extends BluetoothGattService> gattServices) {
        ...
        Logger.INSTANCE.log("Aquila: setting up " + gattServices.size() + " services");
        ...
        if (!this.vapingService.setup(gattServices)) {
            Logger.INSTANCE.log("Aquila: setup failed - vaping service is missing");
        ...
        Logger.INSTANCE.log("Aquila: services are setup");
