...
public final class EPod {
    ...
    private final BatCharacteristic errorCharacteristic;
    ...
    public EPod() {
        BatCharacteristic batCharacteristic = new BatCharacteristic("Device Info", BatVocabulary.EPod.Characteristics.deviceInfoCharacteristic, false, CharacteristicType.DeviceInfo.INSTANCE, 4, null);
        this.deviceInfoCharacteristic = batCharacteristic;
        BatCharacteristic batCharacteristic2 = new BatCharacteristic("Time", BatVocabulary.EPod.Characteristics.timeCharacteristic, false, CharacteristicType.Time.INSTANCE, 4, null);
        this.timeCharacteristic = batCharacteristic2;
        BatCharacteristic batCharacteristic3 = new BatCharacteristic("Lock", BatVocabulary.EPod.Characteristics.lockCharacteristic, false, CharacteristicType.Lock.INSTANCE, 4, null);
        this.lockCharacteristic = batCharacteristic3;
        BatCharacteristic batCharacteristic4 = new BatCharacteristic("Battery", BatVocabulary.EPod.Characteristics.batteryCharacteristic, false, CharacteristicType.Battery.INSTANCE, 4, null);
        this.batteryCharacteristic = batCharacteristic4;
        BatCharacteristic batCharacteristic5 = new BatCharacteristic("Puffs", BatVocabulary.EPod.Characteristics.puffsCharacteristic, true, CharacteristicType.Puffs.INSTANCE);
        this.puffsCharacteristic = batCharacteristic5;
        BatCharacteristic batCharacteristic6 = new BatCharacteristic("Cloud", BatVocabulary.EPod.Characteristics.cloudCharacteristic, false, CharacteristicType.Cloud.INSTANCE, 4, null);
        this.cloudCharacteristic = batCharacteristic6;
        BatCharacteristic batCharacteristic7 = new BatCharacteristic("Find", BatVocabulary.EPod.Characteristics.findCharacteristic, false, CharacteristicType.FindVape.INSTANCE, 4, null);
        this.findCharacteristic = batCharacteristic7;
        BatCharacteristic batCharacteristic8 = new BatCharacteristic("Led", BatVocabulary.EPod.Characteristics.ledCharacteristic, true, CharacteristicType.Led.INSTANCE);
        this.ledCharacteristic = batCharacteristic8;
        BatCharacteristic batCharacteristic9 = new BatCharacteristic("Reset", BatVocabulary.EPod.Characteristics.resetCharacteristic, false, CharacteristicType.Reset.INSTANCE, 4, null);
        this.resetCharacteristic = batCharacteristic9;
        this.vapingService = new BatService("Vaping", BatVocabulary.EPod.Services.vapingService, ServiceType.Vaping.INSTANCE, CollectionsKt.listOf((Object[]) new BatCharacteristic[]{batCharacteristic, batCharacteristic2, batCharacteristic3, batCharacteristic4, batCharacteristic5, batCharacteristic6, batCharacteristic7, batCharacteristic8, batCharacteristic9}));
        BatCharacteristic batCharacteristic10 = new BatCharacteristic("Last Error", BatVocabulary.EPod.Characteristics.errorCharacteristic, false, CharacteristicType.LastError.INSTANCE, 4, null);
        this.errorCharacteristic = batCharacteristic10;
        BatCharacteristic batCharacteristic11 = new BatCharacteristic("Logs", BatVocabulary.EPod.Characteristics.logCharacteristic, false, CharacteristicType.Logs.INSTANCE, 4, null);
        this.logCharacteristic = batCharacteristic11;
        this.logService = new BatService("Log", BatVocabulary.EPod.Services.logService, ServiceType.Log.INSTANCE, CollectionsKt.listOf((Object[]) new BatCharacteristic[]{batCharacteristic10, batCharacteristic11}));
    }
    ...
    public final List<BatService> setup(List<? extends BluetoothGattService> gattServices) {
        ...
        logger.log(name, "EPod: - setting up " + gattServices.size() + " services");
