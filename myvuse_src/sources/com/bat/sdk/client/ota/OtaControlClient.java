...
public final class OtaControlClient extends CharacteristicClient<FotaControl, FotaControl> {
    ...
    public OtaControlClient(GattManager gattManager) {
        ...
        this.characteristicUuids = CollectionsKt.listOf(BatVocabulary.VPro.Characteristics.otaControlCharacteristic);
    }

    @Override // com.bat.sdk.client.CharacteristicClient
    public byte[] encode(FotaControl request, DeviceType deviceType) {
    ...
    @Override // com.bat.sdk.client.CharacteristicClient
    public FotaControl decode(byte[] bytes, DeviceType deviceType) {
        Intrinsics.checkNotNullParameter(bytes, "bytes");
        Intrinsics.checkNotNullParameter(deviceType, "deviceType");
        byte b = bytes[0];
        return b == FotaControl.Start.INSTANCE.getCode() ? FotaControl.Start.INSTANCE : b == FotaControl.Continue.INSTANCE.getCode() ? FotaControl.Continue.INSTANCE : b == FotaControl.Complete.INSTANCE.getCode() ? FotaControl.Complete.INSTANCE : b == FotaControl.Done.INSTANCE.getCode() ? FotaControl.Done.INSTANCE : FotaControl.Error.INSTANCE;
    }
