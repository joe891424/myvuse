...
public class ApplicationSoSource extends SoSource {
    ...
    public ApplicationSoSource(Context context, int i) {
        ...
        if (applicationContext == null) {
            LogInstrumentation.m2734w("SoLoader", "context.getApplicationContext returned null, holding reference to original context.ApplicationSoSource fallbacks to: " + context.getApplicationInfo().nativeLibraryDir);
    ...
    public boolean checkAndMaybeUpdate() throws IOException {
        ...
        LogInstrumentation.m2726d("SoLoader", "Native library directory updated from " + file + " to " + nativeLibDirFromContext);
        this.flags |= 1;
