...
public final class SysUtil {
    ...
    public static void deleteOrThrow(File file) throws IOException {
        ...
        if (parentFile != null && !parentFile.canWrite() && !parentFile.setWritable(true)) {
            LogInstrumentation.m2728e(TAG, "Enable write permission failed: " + parentFile);
        }
    ...
    private static final class LollipopSysdeps {
        ...
        public static String[] getSupportedAbis() {
            ...
            try {
                ...
                LogInstrumentation.m2728e(SysUtil.TAG, String.format("Could not read /proc/self/exe. Falling back to default ABI list: %s. errno: %d Err msg: %s", Arrays.toString(strArr), Integer.valueOf(e.errno), e.getMessage()));
        ...
        try {
            ...
            try {
                ...
                if (!file.setWritable(false)) {
                    LogInstrumentation.m2734w(TAG, "error removing " + file.getCanonicalPath() + " write permission");
                }
                return fileLocker;
            } catch (Throwable th) {
                th = th;
