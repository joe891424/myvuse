...
import com.facebook.drawee.C1706R;
    ...
    private void init(Context context, @Nullable AttributeSet attributeSet) {
        ...
        try {
            ...
            if (attributeSet != null) {
                TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C1706R.styleable.SimpleDraweeView);
                try {
                    if (typedArrayObtainStyledAttributes.hasValue(C1706R.styleable.SimpleDraweeView_actualImageUri)) {
                        setImageURI(Uri.parse(typedArrayObtainStyledAttributes.getString(C1706R.styleable.SimpleDraweeView_actualImageUri)), (Object) null);
                    } else if (typedArrayObtainStyledAttributes.hasValue(C1706R.styleable.SimpleDraweeView_actualImageResource) && (resourceId = typedArrayObtainStyledAttributes.getResourceId(C1706R.styleable.SimpleDraweeView_actualImageResource, -1)) != -1) {
                        if (isInEditMode()) {
