...
public class ProgressBarDrawable extends Drawable implements CloneableDrawable {
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mIsVertical) {
            drawVerticalBar(canvas, AndroidLocationEnablerModule.DEFAULT_INTERVAL_DURATION, this.mBackgroundColor);
            drawVerticalBar(canvas, this.mLevel, this.mColor);
        } else {
            drawHorizontalBar(canvas, AndroidLocationEnablerModule.DEFAULT_INTERVAL_DURATION, this.mBackgroundColor);
    ...
    private void drawHorizontalBar(Canvas canvas, int i, int i2) {
        ...
        int iWidth = ((bounds.width() - (this.mPadding * 2)) * i) / AndroidLocationEnablerModule.DEFAULT_INTERVAL_DURATION;
    ...
    private void drawVerticalBar(Canvas canvas, int i, int i2) {
        Rect bounds = getBounds();
        int iHeight = ((bounds.height() - (this.mPadding * 2)) * i) / AndroidLocationEnablerModule.DEFAULT_INTERVAL_DURATION;
