...
public class LocalExifThumbnailProducer implements ThumbnailProducer<EncodedImage> {
    ...
    public void produceResults(Consumer<EncodedImage> consumer, ProducerContext producerContext) {
        ...
        final StatefulProducerRunnable<EncodedImage> statefulProducerRunnable = new StatefulProducerRunnable<EncodedImage>(consumer, producerListener, producerContext, PRODUCER_NAME) { // from class: com.facebook.imagepipeline.producers.LocalExifThumbnailProducer.1
            ...
            public Map<String, String> getExtraMapOnSuccess(@Nullable EncodedImage encodedImage) {
                return ImmutableMap.m1249of(LocalExifThumbnailProducer.CREATED_THUMBNAIL, Boolean.toString(encodedImage != null));
            }
        };
    ...
    ExifInterface getExifInterface(Uri uri) throws Throwable {
        ...
        try {
            ...
            FLog.m1273e((Class<?>) LocalExifThumbnailProducer.class, "StackOverflowError in ExifInterface constructor");
        }
    ...
    public EncodedImage buildEncodedImage(PooledByteBuffer pooledByteBuffer, ExifInterface exifInterface) {
        ...
        CloseableReference closeableReferenceM1331of = CloseableReference.m1331of(pooledByteBuffer);
        try {
            EncodedImage encodedImage = new EncodedImage((CloseableReference<PooledByteBuffer>) closeableReferenceM1331of);
