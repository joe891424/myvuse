...
public abstract class LocalFetchProducer implements Producer<EncodedImage> {
    ...
    protected EncodedImage getByteBufferBackedEncodedImage(InputStream inputStream, int i) throws IOException {
        CloseableReference closeableReferenceM1331of;
        CloseableReference closeableReference = null;
        try {
            if (i <= 0) {
                closeableReferenceM1331of = CloseableReference.m1331of(this.mPooledByteBufferFactory.newByteBuffer(inputStream));
            } else {
                closeableReferenceM1331of = CloseableReference.m1331of(this.mPooledByteBufferFactory.newByteBuffer(inputStream, i));
            }
            closeableReference = closeableReferenceM1331of;
