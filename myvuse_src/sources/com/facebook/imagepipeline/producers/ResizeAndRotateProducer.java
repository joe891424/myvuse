    ...
    private class TransformingConsumer extends DelegatingConsumer<EncodedImage, EncodedImage> {
        ...
        public void doTransform(EncodedImage encodedImage, int i, ImageTranscoder imageTranscoder) throws Throwable {
            ...
            try {
                ...
                CloseableReference closeableReferenceM1331of = CloseableReference.m1331of(pooledByteBufferOutputStreamNewOutputStream.toByteBuffer());
                try {
                    EncodedImage encodedImage2 = new EncodedImage((CloseableReference<PooledByteBuffer>) closeableReferenceM1331of);
        ...
        private Map<String, String> getExtraMap(EncodedImage encodedImage, @Nullable ResizeOptions resizeOptions, @Nullable ImageTranscodeResult imageTranscodeResult, @Nullable String str) {
            ...
            String str3 = encodedImage.getWidth() + EllipticCurveJsonWebKey.X_MEMBER_NAME + encodedImage.getHeight();
            if (resizeOptions != null) {
                str2 = resizeOptions.width + EllipticCurveJsonWebKey.X_MEMBER_NAME + resizeOptions.height;
            } else {
                str2 = "Unspecified";
            }
