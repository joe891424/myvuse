    ...
    private class PostprocessorConsumer extends DelegatingConsumer<CloseableReference<CloseableImage>, CloseableReference<CloseableImage>> {
        ...
        private Map<String, String> getExtraMap(ProducerListener2 producerListener2, ProducerContext producerContext, Postprocessor postprocessor) {
            if (producerListener2.requiresExtraMap(producerContext, PostprocessorProducer.NAME)) {
                return ImmutableMap.m1249of(PostprocessorProducer.POSTPROCESSOR, postprocessor.getName());
            }
            return null;
        }
        ...
        private CloseableReference<CloseableImage> postprocessInternal(CloseableImage closeableImage) {
            ...
            try {
                CloseableStaticBitmap closeableStaticBitmapM1344of = CloseableStaticBitmap.m1344of(closeableReferenceProcess, closeableImage.getQualityInfo(), closeableStaticBitmap.getRotationAngle(), closeableStaticBitmap.getExifOrientation());
                closeableStaticBitmapM1344of.putExtras(closeableStaticBitmap.getExtras());
                return CloseableReference.m1331of(closeableStaticBitmapM1344of);
            } finally {
