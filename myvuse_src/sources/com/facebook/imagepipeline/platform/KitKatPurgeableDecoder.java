...
public class KitKatPurgeableDecoder extends DalvikPurgeableDecoder {
    ...
    protected Bitmap decodeByteArrayAsPurgeable(CloseableReference<PooledByteBuffer> closeableReference, BitmapFactory.Options options) {
        ...
        try {
            ...
            return (Bitmap) Preconditions.checkNotNull(BitmapFactoryInstrumentation.decodeByteArray(bArr, 0, size, options), "BitmapFactory returned null");
        } finally {
    ...
    protected Bitmap decodeJPEGByteArrayAsPurgeable(CloseableReference<PooledByteBuffer> closeableReference, int i, BitmapFactory.Options options) {
        ...
        try {
            ...
            return (Bitmap) Preconditions.checkNotNull(BitmapFactoryInstrumentation.decodeByteArray(bArr2, 0, i, options), "BitmapFactory returned null");
        } finally {
            CloseableReference.closeSafely((CloseableReference<?>) closeableReference2);
        }
    }
