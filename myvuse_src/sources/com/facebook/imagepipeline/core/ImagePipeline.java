...
public class ImagePipeline {
    ...
    public boolean isInDiskCacheSync(ImageRequest imageRequest) {
        CacheKey encodedCacheKey = this.mCacheKeyFactory.getEncodedCacheKey(imageRequest, null);
        int i = C17689.f2107x9ce557aa[imageRequest.getCacheChoice().ordinal()];
        if (i == 1) {
    ...
    /* JADX INFO: renamed from: com.facebook.imagepipeline.core.ImagePipeline$9 */
    static /* synthetic */ class C17689 {

        /* JADX INFO: renamed from: $SwitchMap$com$facebook$imagepipeline$request$ImageRequest$CacheChoice */
        static final /* synthetic */ int[] f2107x9ce557aa;
        ...
        static {
            ...
            try {
                f2107x9ce557aa[ImageRequest.CacheChoice.SMALL.ordinal()] = 2;
