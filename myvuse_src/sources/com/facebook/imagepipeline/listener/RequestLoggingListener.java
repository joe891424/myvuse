...
public final class RequestLoggingListener implements RequestListener {
    ...
    public synchronized void onRequestStart(ImageRequest request, Object callerContextObject, String requestId, boolean isPrefetch) {
        ...
        if (FLog.isLoggable(2)) {
            ...
            FLog.m1309v(TAG, "time %d: onRequestSubmit: {requestId: %s, callerContext: %s, isPrefetch: %b}", Long.valueOf(companion.getTime()), requestId, callerContextObject, Boolean.valueOf(isPrefetch));
    ...
    public synchronized void onProducerStart(String requestId, String producerName) {
        ...
        if (FLog.isLoggable(2)) {
            ...
            FLog.m1308v(TAG, "time %d: onProducerStart: {requestId: %s, producer: %s}", Long.valueOf(time), requestId, producerName);
        }
    }
    ...
    public synchronized void onProducerFinishWithSuccess(String requestId, String producerName, Map<String, String> extraMap) {
        ...
        if (FLog.isLoggable(2)) {
            ...
            FLog.m1311v(TAG, "time %d: onProducerFinishWithSuccess: {requestId: %s, producer: %s, elapsedTime: %d ms, extraMap: %s}", Long.valueOf(time), requestId, producerName, Long.valueOf(companion.getElapsedTime(lRemove, time)), extraMap);
        }
    }
    ...
    public synchronized void onProducerFinishWithFailure(String requestId, String producerName, Throwable throwable, Map<String, String> extraMap) {
        ...
        if (FLog.isLoggable(5)) {
            ...
            Companion companion = INSTANCE;
            long time = companion.getTime();
            FLog.m1320w(TAG, throwable, "time %d: onProducerFinishWithFailure: {requestId: %s, stage: %s, elapsedTime: %d ms, extraMap: %s, throwable: %s}", Long.valueOf(time), requestId, producerName, Long.valueOf(companion.getElapsedTime(lRemove, time)), extraMap, throwable.toString());
        }
    }
    ...
    public synchronized void onProducerFinishWithCancellation(String requestId, String producerName, Map<String, String> extraMap) {
        ...
        if (FLog.isLoggable(2)) {
            ...
            Companion companion = INSTANCE;
            long time = companion.getTime();
            FLog.m1311v(TAG, "time %d: onProducerFinishWithCancellation: {requestId: %s, stage: %s, elapsedTime: %d ms, extraMap: %s}", Long.valueOf(time), requestId, producerName, Long.valueOf(companion.getElapsedTime(lRemove, time)), extraMap);
        }
    }
    ...
    public synchronized void onProducerEvent(String requestId, String producerName, String producerEventName) {
        ...
        if (FLog.isLoggable(2)) {
            ...
            Companion companion = INSTANCE;
            FLog.m1311v(TAG, "time %d: onProducerEvent: {requestId: %s, stage: %s, eventName: %s; elapsedTime: %d ms}", Long.valueOf(companion.getTime()), requestId, producerName, producerEventName, Long.valueOf(companion.getElapsedTime(l, companion.getTime())));
        }
    }
    ...
    public synchronized void onUltimateProducerReached(String requestId, String producerName, boolean successful) {
        ...
        if (FLog.isLoggable(2)) {
            ...
            Companion companion = INSTANCE;
            long time = companion.getTime();
            FLog.m1311v(TAG, "time %d: onUltimateProducerReached: {requestId: %s, producer: %s, elapsedTime: %d ms, success: %b}", Long.valueOf(time), requestId, producerName, Long.valueOf(companion.getElapsedTime(lRemove, time)), Boolean.valueOf(successful));
        }
    }
    ...
    public synchronized void onRequestSuccess(ImageRequest request, String requestId, boolean isPrefetch) {
        ...
        if (FLog.isLoggable(2)) {
            ...
            Companion companion = INSTANCE;
            long time = companion.getTime();
            FLog.m1308v(TAG, "time %d: onRequestSuccess: {requestId: %s, elapsedTime: %d ms}", Long.valueOf(time), requestId, Long.valueOf(companion.getElapsedTime(lRemove, time)));
        }
    }
    ...
    public synchronized void onRequestFailure(ImageRequest request, String requestId, Throwable throwable, boolean isPrefetch) {
        ...
        if (FLog.isLoggable(5)) {
            ...
            Companion companion = INSTANCE;
            long time = companion.getTime();
            FLog.m1319w(TAG, "time %d: onRequestFailure: {requestId: %s, elapsedTime: %d ms, throwable: %s}", Long.valueOf(time), requestId, Long.valueOf(companion.getElapsedTime(lRemove, time)), throwable.toString());
        }
    }
    ...
    public synchronized void onRequestCancellation(String requestId) {
        ...
        if (FLog.isLoggable(2)) {
            ...
            Companion companion = INSTANCE;
            long time = companion.getTime();
            FLog.m1308v(TAG, "time %d: onRequestCancellation: {requestId: %s, elapsedTime: %d ms}", Long.valueOf(time), requestId, Long.valueOf(companion.getElapsedTime(lRemove, time)));
        }
    }
    ...
    /* JADX INFO: compiled from: RequestLoggingListener.kt */
    @Metadata(m5597d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\t\n\u0002\b\u0007\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u001f\u0010\t\u001a\u00020\u00062\b\u0010\n\u001a\u0004\u0018\u00010\u00062\u0006\u0010\u000b\u001a\u00020\u0006H\u0002¢\u0006\u0002\u0010\fR\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u0014\u0010\u0005\u001a\u00020\u00068BX\u0082\u0004¢\u0006\u0006\u001a\u0004\b\u0007\u0010\b¨\u0006\r"}, m5598d2 = {"Lcom/facebook/imagepipeline/listener/RequestLoggingListener$Companion;", "", "()V", "TAG", "", "time", "", "getTime", "()J", "getElapsedTime", "startTime", "endTime", "(Ljava/lang/Long;J)J", "imagepipeline_release"}, m5599k = 1, m5600mv = {1, 8, 0}, m5602xi = 48)
