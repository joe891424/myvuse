...
public abstract class PlatformBitmapFactory {
    ...
    private static Bitmap.Config getSuitableBitmapConfig(Bitmap bitmap) {
        ...
        int i = C17491.$SwitchMap$android$graphics$Bitmap$Config[config2.ordinal()];
        if (i == 1) {
    ...
    /* JADX INFO: renamed from: com.facebook.imagepipeline.bitmaps.PlatformBitmapFactory$1 */
