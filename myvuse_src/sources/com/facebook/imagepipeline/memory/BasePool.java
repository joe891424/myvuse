...
public abstract class BasePool<V> implements Pool<V> {
        ...
        synchronized (this) {
            ...
            if (bucket != null && (value = getValue(bucket)) != null) {
                ...
                if (FLog.isLoggable(2)) {
                    FLog.m1299v(this.TAG, "get (reuse) (object, size) = (%x, %s)", Integer.valueOf(System.identityHashCode(value)), Integer.valueOf(bucketedSizeForValue));
                }
                return value;
            }
            ...
            synchronized (this) {
                ...
                logStats();
                if (FLog.isLoggable(2)) {
                    FLog.m1299v(this.TAG, "get (alloc) (object, size) = (%x, %s)", Integer.valueOf(System.identityHashCode(vAlloc)), Integer.valueOf(bucketedSize));
                }
            }
            return vAlloc;
        }
    ...
    public void release(V v) {
        ...
        synchronized (this) {
            ...
            if (!this.mInUseValues.remove(v)) {
                FLog.m1275e(this.TAG, "release (free, value unrecognized) (object, size) = (%x, %s)", Integer.valueOf(System.identityHashCode(v)), Integer.valueOf(bucketedSizeForValue));
                free(v);
                ...
                if (FLog.isLoggable(2)) {
                    FLog.m1299v(this.TAG, "release (free) (object, size) = (%x, %s)", Integer.valueOf(System.identityHashCode(v)), Integer.valueOf(bucketedSizeForValue));
                }
                free(v);
                ...
                if (FLog.isLoggable(2)) {
                    FLog.m1299v(this.TAG, "release (reuse) (object, size) = (%x, %s)", Integer.valueOf(System.identityHashCode(v)), Integer.valueOf(bucketedSizeForValue));
                }
            }
            logStats();
        }
    ...
    synchronized void trimToSize(int i) {
        ...
        if (FLog.isLoggable(2)) {
            FLog.m1300v(this.TAG, "trimToSize: TargetSize = %d; Initial Size = %d; Bytes to free = %d", Integer.valueOf(i), Integer.valueOf(this.mUsed.mNumBytes + this.mFree.mNumBytes), Integer.valueOf(iMin));
        }
        logStats();
        ...
        logStats();
        if (FLog.isLoggable(2)) {
            FLog.m1299v(this.TAG, "trimToSize: TargetSize = %d; Final Size = %d", Integer.valueOf(i), Integer.valueOf(this.mUsed.mNumBytes + this.mFree.mNumBytes));
        }
    }
    ...
    synchronized Bucket<V> getBucket(int i) {
        ...
        if (bucket == null && this.mAllowNewBuckets) {
            if (FLog.isLoggable(2)) {
                FLog.m1298v(this.TAG, "creating new bucket %s", Integer.valueOf(i));
            }
    ...
    private void logStats() {
        if (FLog.isLoggable(2)) {
            FLog.m1301v(this.TAG, "Used = (%d, %d); Free = (%d, %d)", Integer.valueOf(this.mUsed.mCount), Integer.valueOf(this.mUsed.mNumBytes), Integer.valueOf(this.mFree.mCount), Integer.valueOf(this.mFree.mNumBytes));
        }
    }
