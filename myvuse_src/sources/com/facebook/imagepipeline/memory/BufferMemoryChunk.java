...
public class BufferMemoryChunk implements MemoryChunk, Closeable {
    ...
    public void copy(int i, MemoryChunk memoryChunk, int i2, int i3) {
        ...
        if (memoryChunk.getUniqueId() == getUniqueId()) {
            LogInstrumentation.m2734w(TAG, "Copying from BufferMemoryChunk " + Long.toHexString(getUniqueId()) + " to BufferMemoryChunk " + Long.toHexString(memoryChunk.getUniqueId()) + " which are the same ");
