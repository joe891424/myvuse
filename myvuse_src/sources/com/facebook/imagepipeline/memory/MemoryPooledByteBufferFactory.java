...
public final class MemoryPooledByteBufferFactory implements PooledByteBufferFactory {
    ...
    public MemoryPooledByteBuffer newByteBuffer(int size) {
        ...
        CloseableReference closeableReferenceM1333of = CloseableReference.m1333of(this.pool.get(size), this.pool);
        Intrinsics.checkNotNullExpressionValue(closeableReferenceM1333of, "of(pool[size], pool)");
        try {
            return new MemoryPooledByteBuffer(closeableReferenceM1333of, size);
        } finally {
            closeableReferenceM1333of.close();
        }
    }
