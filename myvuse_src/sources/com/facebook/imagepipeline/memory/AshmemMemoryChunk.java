    ...
    */
    ...
    public void copy(int i, MemoryChunk memoryChunk, int i2, int i3) {
        ...
        if (memoryChunk.getUniqueId() == getUniqueId()) {
            LogInstrumentation.m2734w(TAG, "Copying from AshmemMemoryChunk " + Long.toHexString(getUniqueId()) + " to AshmemMemoryChunk " + Long.toHexString(memoryChunk.getUniqueId()) + " which are the same ");
