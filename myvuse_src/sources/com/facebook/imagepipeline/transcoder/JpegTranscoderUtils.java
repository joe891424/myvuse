...
public final class JpegTranscoderUtils {
    ...
    static {
        ImmutableList<Integer> immutableListM1247of = ImmutableList.m1247of((Object[]) new Integer[]{2, 7, 4, 5});
        Intrinsics.checkNotNullExpressionValue(immutableListM1247of, "of(\n          ExifInterf…ce.ORIENTATION_TRANSPOSE)");
        INVERTED_EXIF_ORIENTATIONS = immutableListM1247of;
    }
