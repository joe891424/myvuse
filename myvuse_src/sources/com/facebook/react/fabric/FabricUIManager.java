...
public class FabricUIManager implements UIManager, LifecycleEventListener {
    ...
    private int mCurrentSynchronousCommitNumber = AndroidLocationEnablerModule.DEFAULT_INTERVAL_DURATION;
    ...
    public <T extends View> int addRootView(T t, WritableMap writableMap, String str) {
        ...
        if (ENABLE_FABRIC_LOGS) {
            FLog.m1267d(str2, "Starting surface for module: %s and reactTag: %d", jSModuleName, Integer.valueOf(rootViewTag));
        }
    ...
    public <T extends View> int startSurface(T t, String str, WritableMap writableMap, int i, int i2) {
        ...
        if (ENABLE_FABRIC_LOGS) {
            FLog.m1267d(TAG, "Starting surface for module: %s and reactTag: %d", str, Integer.valueOf(rootViewTag));
        }
    ...
    public void onCatalystInstanceDestroy() {
        String str = TAG;
        FLog.m1289i(str, "FabricUIManager.onCatalystInstanceDestroy");
    ...
    public boolean getThemeData(int i, float[] fArr) {
        ...
        if (context == null) {
            FLog.m1317w(TAG, "\"themedReactContext\" is null when call \"getThemeData\"");
            return false;
        }
    ...
    public void synchronouslyUpdateViewOnUIThread(final int i, final ReadableMap readableMap) {
        ...
        if (ENABLE_FABRIC_LOGS) {
            FLog.m1267d(TAG, "SynchronouslyUpdateViewOnUIThread for tag %d: %s", Integer.valueOf(i), "<hidden>");
        }
    ...
    public void updateRootLayoutSpecs(int i, int i2, int i3, int i4, int i5) {
        ...
        if (ENABLE_FABRIC_LOGS) {
            FLog.m1266d(TAG, "Updating Root Layout Specs for [%d]", Integer.valueOf(i));
        }
    ...
    public void receiveEvent(int i, int i2, String str, boolean z, WritableMap writableMap, int i3) {
        if (this.mDestroyed) {
            FLog.m1277e(TAG, "Attempted to receiveEvent after destruction");
            return;
        }
        ...
        if (ReactFeatureFlags.enableFabricPendingEventQueue && this.mMountingManager.getViewExists(i2)) {
            ...
            FLog.m1265d(TAG, "Unable to invoke event: " + str + " for reactTag: " + i2);
        }
    }
        ...
        this.mMountItemDispatcher.addMountItem(new MountItem() { // from class: com.facebook.react.fabric.FabricUIManager.4
            ...
            public void execute(MountingManager mountingManager) {
                ...
                if (surfaceManager != null) {
                    ...
                    FLog.m1277e(FabricUIManager.TAG, "setJSResponder skipped, surface no longer available [" + i + "]");
                }
            }
    ...
    private class DispatchUIFrameCallback extends GuardedFrameCallback {
        ...
        public void doFrameGuarded(long j) {
            if (!this.mIsMountingEnabled || FabricUIManager.this.mDestroyed) {
                FLog.m1317w(FabricUIManager.TAG, "Not flushing pending UI operations because of previously thrown Exception");
                return;
            }
            ...
            try {
                try {
                    ...
                    FLog.m1278e(FabricUIManager.TAG, "Exception thrown when executing UIFrameGuarded", e);
                    stop();
                    throw e;
                }
            } finally {
