...
class ObjectAnimatedNode extends AnimatedNode {
    ...
    private JavaOnlyArray collectViewUpdatesHelper(ReadableArray readableArray) {
        ...
        for (int i = 0; i < readableArray.size(); i++) {
            switch (C18851.$SwitchMap$com$facebook$react$bridge$ReadableType[readableArray.getType(i).ordinal()]) {
                case 1:
    ...
    /* JADX INFO: renamed from: com.facebook.react.animated.ObjectAnimatedNode$1 */
    ...
    private JavaOnlyMap collectViewUpdatesHelper(ReadableMap readableMap) {
        ...
        while (readableMapKeySetIteratorKeySetIterator.hasNextKey()) {
            ...
            switch (C18851.$SwitchMap$com$facebook$react$bridge$ReadableType[readableMap.getType(strNextKey).ordinal()]) {
                case 1:
