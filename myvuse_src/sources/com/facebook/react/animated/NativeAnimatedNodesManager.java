    ...
    private void updateNodes(List<AnimatedNode> list) {
        ...
        while (!arrayDeque.isEmpty()) {
            ...
            try {
                ...
                FLog.m1278e(TAG, "Native animation workaround, frame lost as result of race condition", e);
            }
        ...
        if (i3 != i11) {
            ...
            FLog.m1277e(TAG, "Detected animation cycle or disconnected graph. ");
            Iterator<AnimatedNode> it2 = list.iterator();
            while (it2.hasNext()) {
                FLog.m1277e(TAG, it2.next().prettyPrintWithChildren());
            }
