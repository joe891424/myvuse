...
public class Task<TResult> implements TaskInterface<TResult> {
    ...
    public static <TResult> Task<Task<TResult>> whenAnyResult(Collection<? extends Task<TResult>> collection) {
        ...
        while (it2.hasNext()) {
            it2.next().continueWith(new Continuation<TResult, Void>() { // from class: com.facebook.react.runtime.internal.bolts.Task.5
                @Override // com.facebook.react.runtime.internal.bolts.Continuation
    ...
    public static Task<Task<?>> whenAny(Collection<? extends Task<?>> collection) {
        ...
        while (it2.hasNext()) {
            it2.next().continueWith(new Continuation<Object, Void>() { // from class: com.facebook.react.runtime.internal.bolts.Task.6
                @Override // com.facebook.react.runtime.internal.bolts.Continuation
    ...
    public static Task<Void> whenAll(Collection<? extends Task<?>> collection) {
        ...
        Iterator<? extends Task<?>> it2 = collection.iterator();
        while (it2.hasNext()) {
            it2.next().continueWith(new Continuation<Object, Void>() { // from class: com.facebook.react.runtime.internal.bolts.Task.8
                @Override // com.facebook.react.runtime.internal.bolts.Continuation
                public Void then(Task<Object> task) {
                    if (task.isFaulted()) {
                        synchronized (obj) {
