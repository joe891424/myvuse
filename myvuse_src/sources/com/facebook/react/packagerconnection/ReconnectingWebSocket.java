...
public final class ReconnectingWebSocket extends WebSocketListener {
    ...
    public void connect() {
        ...
        this.mOkHttpClient.newWebSocket(!(builderUrl instanceof Request.Builder) ? builderUrl.build() : OkHttp3Instrumentation.build(builderUrl), this);
    }
    ...
    private void reconnect() {
        ...
        if (!this.mSuppressConnectionErrors) {
            FLog.m1317w(TAG, "Couldn't connect to \"" + this.mUrl + "\", will silently retry");
    ...
    private void abort(String str, Throwable th) {
        FLog.m1278e(TAG, "Error occurred, shutting down websocket connection: " + str, th);
        closeWebSocketQuietly();
    }
