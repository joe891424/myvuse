...
public class MessageQueueThreadImpl implements MessageQueueThread {
    ...
    public boolean runOnQueue(Runnable runnable) {
        if (this.mIsFinished) {
            FLog.m1317w(ReactConstants.TAG, "Tried to enqueue runnable on already finished thread: '" + getName() + "... dropping Runnable.");
            return false;
        }
    ...
    /* JADX INFO: renamed from: com.facebook.react.bridge.queue.MessageQueueThreadImpl$5 */
    static /* synthetic */ class C19235 {

        /* JADX INFO: renamed from: $SwitchMap$com$facebook$react$bridge$queue$MessageQueueThreadSpec$ThreadType */
        static final /* synthetic */ int[] f2114x16463f8b;
        ...
        static {
            ...
            try {
                f2114x16463f8b[MessageQueueThreadSpec.ThreadType.NEW_BACKGROUND.ordinal()] = 2;
    ...
    public static MessageQueueThreadImpl create(MessageQueueThreadSpec messageQueueThreadSpec, QueueThreadExceptionHandler queueThreadExceptionHandler) {
        int i = C19235.f2114x16463f8b[messageQueueThreadSpec.getThreadType().ordinal()];
        if (i == 1) {
