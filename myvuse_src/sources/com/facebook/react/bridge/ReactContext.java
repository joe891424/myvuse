...
public class ReactContext extends ContextWrapper {
    ...
    public synchronized void initializeMessageQueueThreads(ReactQueueConfiguration reactQueueConfiguration) {
        FLog.m1265d(TAG, "initializeMessageQueueThreads() is called.");
    ...
    public void addLifecycleEventListener(final LifecycleEventListener lifecycleEventListener) {
        ...
        if ((!hasActiveReactInstance() && !isBridgeless()) || (i = C19142.$SwitchMap$com$facebook$react$common$LifecycleState[this.mLifecycleState.ordinal()]) == 1 || i == 2) {
            return;
        }
        if (i == 3) {
    ...
    public void handleException(Exception exc) {
        ...
        if (z2 && z3) {
            ...
            FLog.m1278e(ReactConstants.TAG, "Unable to handle Exception - catalystInstanceVariableExists: " + z + " - isCatalystInstanceAlive: " + z2 + " - hasExceptionHandler: " + z3, exc);
