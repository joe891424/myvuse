...
public class ReadableNativeMap extends NativeMap implements ReadableMap {
    ...
    public Iterator<Map.Entry<String, Object>> getEntryIterator() {
        ...
        synchronized (this) {
            ...
            mJniCallCounter++;
            it2 = new Iterator<Map.Entry<String, Object>>() { // from class: com.facebook.react.bridge.ReadableNativeMap.1
                int currentIndex = 0;
    ...
    public HashMap<String, Object> toHashMap() {
        ...
        for (String str : map.keySet()) {
            switch (C19183.$SwitchMap$com$facebook$react$bridge$ReadableType[getType(str).ordinal()]) {
                case 1:
                case 2:
                case 3:
                case 4:
    ...
    /* JADX INFO: renamed from: com.facebook.react.bridge.ReadableNativeMap$3 */
    static /* synthetic */ class C19183 {
