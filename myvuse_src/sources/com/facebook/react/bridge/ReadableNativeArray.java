...
public class ReadableNativeArray extends NativeArray implements ReadableArray {
    ...
    public ArrayList<Object> toArrayList() {
        ...
        for (int i = 0; i < size(); i++) {
            switch (C19151.$SwitchMap$com$facebook$react$bridge$ReadableType[getType(i).ordinal()]) {
                case 1:
                    arrayList.add(null);
                    break;
                case 2:
    ...
    /* JADX INFO: renamed from: com.facebook.react.bridge.ReadableNativeArray$1 */
