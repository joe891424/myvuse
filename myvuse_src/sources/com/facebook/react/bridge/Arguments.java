...
public class Arguments {
    ...
    public static ArrayList toList(ReadableArray readableArray) {
        ...
        for (int i = 0; i < readableArray.size(); i++) {
            switch (C18872.$SwitchMap$com$facebook$react$bridge$ReadableType[readableArray.getType(i).ordinal()]) {
                case 1:
                    arrayList.add(null);
                    break;
                case 2:
    ...
    /* JADX INFO: renamed from: com.facebook.react.bridge.Arguments$2 */
    static /* synthetic */ class C18872 {
    ...
    public static Bundle toBundle(ReadableMap readableMap) {
        ...
        while (readableMapKeySetIteratorKeySetIterator.hasNextKey()) {
            ...
            switch (C18872.$SwitchMap$com$facebook$react$bridge$ReadableType[readableMap.getType(strNextKey).ordinal()]) {
                case 1:
