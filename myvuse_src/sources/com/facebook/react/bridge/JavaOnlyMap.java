...
public class JavaOnlyMap implements ReadableMap, WritableMap {
    ...
    public static JavaOnlyMap m1347of(Object... objArr) {
    ...
    public static JavaOnlyMap deepClone(ReadableMap readableMap) {
        ...
        while (readableMapKeySetIteratorKeySetIterator.hasNextKey()) {
            ...
            switch (C19112.$SwitchMap$com$facebook$react$bridge$ReadableType[readableMap.getType(strNextKey).ordinal()]) {
                case 1:
