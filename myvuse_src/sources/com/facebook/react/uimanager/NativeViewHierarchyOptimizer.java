...
public class NativeViewHierarchyOptimizer {
    ...
    private void transitionLayoutOnlyViewToNativeView(ReactShadowNode reactShadowNode, ReactStylesDiffMap reactStylesDiffMap) {
        ...
        FLog.m1289i(TAG, "Transitioning LayoutOnlyView - tag: " + reactShadowNode.getReactTag() + " - rootTag: " + reactShadowNode.getRootTag() + " - hasProps: " + (reactStylesDiffMap != null) + " - tagsWithLayout.size: " + this.mTagsWithLayoutVisited.size());
