...
public class UIImplementation {
    ...
    public void updateRootView(int i, int i2, int i3) {
        ...
        if (node == null) {
            FLog.m1317w(ReactConstants.TAG, "Tried to update non-existent root tag: " + i);
        } else {
    ...
    public void updateNodeSize(int i, int i2, int i3) {
        ReactShadowNode node = this.mShadowNodeRegistry.getNode(i);
        if (node == null) {
            FLog.m1317w(ReactConstants.TAG, "Tried to update size of non-existent tag: " + i);
            return;
        }
    ...
    public void setViewLocalData(int i, Object obj) {
        ReactShadowNode node = this.mShadowNodeRegistry.getNode(i);
        if (node == null) {
            FLog.m1317w(ReactConstants.TAG, "Attempt to set local data for view with unknown tag: " + i);
        } else {
    ...
    */
    ...
    private boolean checkOrAssertViewExists(int i, String str) {
        ...
        FLog.m1317w(ReactConstants.TAG, "Unable to execute operation " + str + " on view with tag: " + i + ", since the view does not exist");
        return false;
    }
    ...
    public int resolveRootTagFromReactTag(int i) {
        ...
        FLog.m1317w(ReactConstants.TAG, "Warning : attempted to resolve a non-existent react shadow node. reactTag=" + i);
        return 0;
    }
