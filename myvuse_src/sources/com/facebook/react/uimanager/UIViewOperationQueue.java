...
public class UIViewOperationQueue {
    ...
    private final class UpdateLayoutOperation extends ViewOperation {
        ...
        private final int f2121mX;

        /* JADX INFO: renamed from: mY */
        private final int f2122mY;
        ...
        public void execute() {
            ...
            UIViewOperationQueue.this.mNativeViewHierarchyManager.updateLayout(this.mParentTag, this.mTag, this.f2121mX, this.f2122mY, this.mWidth, this.mHeight);
        }
    }
                    ...
                    try {
                        try {
                            ...
                            if (UIViewOperationQueue.this.mIsProfilingNextBatch && UIViewOperationQueue.this.mProfiledBatchCommitStartTime == 0) {
                                ...
                                Systrace.beginAsyncSection(0L, "delayBeforeDispatchViewUpdates", 0, UIViewOperationQueue.this.mProfiledBatchCommitStartTime * Constants.Network.MAX_PAYLOAD_SIZE);
                                Systrace.endAsyncSection(0L, "delayBeforeDispatchViewUpdates", 0, UIViewOperationQueue.this.mProfiledBatchDispatchViewUpdatesTime * Constants.Network.MAX_PAYLOAD_SIZE);
                                Systrace.beginAsyncSection(0L, "delayBeforeBatchRunStart", 0, UIViewOperationQueue.this.mProfiledBatchDispatchViewUpdatesTime * Constants.Network.MAX_PAYLOAD_SIZE);
                                Systrace.endAsyncSection(0L, "delayBeforeBatchRunStart", 0, UIViewOperationQueue.this.mProfiledBatchRunStartTime * Constants.Network.MAX_PAYLOAD_SIZE);
                            }
    ...
    public void flushPendingBatches() {
        if (this.mIsInIllegalUIState) {
            FLog.m1317w(ReactConstants.TAG, "Not flushing pending UI operations because of previously thrown Exception");
            return;
        }
        synchronized (this.mDispatchRunnablesLock) {
            ...
            if (this.mIsProfilingNextBatch) {
                ...
                Systrace.beginAsyncSection(0L, "batchedExecutionTime", 0, jUptimeMillis * Constants.Network.MAX_PAYLOAD_SIZE);
    ...
    private class DispatchUIFrameCallback extends GuardedFrameCallback {
        ...
        private void dispatchPendingNonBatchedOperations(long j) throws Exception {
            ...
            while (16 - ((System.nanoTime() - j) / Constants.Network.MAX_PAYLOAD_SIZE) >= this.mMinTimeLeftInFrameForNonBatchedOperationMs) {
