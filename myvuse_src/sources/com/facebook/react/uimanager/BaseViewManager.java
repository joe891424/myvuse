...
public abstract class BaseViewManager<T extends View, C extends LayoutShadowNode> extends ViewManager<T, C> implements BaseViewManagerInterface<T>, View.OnLayoutChangeListener {
    ...
    protected T prepareToRecycleView(ThemedReactContext themedReactContext, T t) {
        t.setTag(null);
        t.setTag(C1848R.id.pointer_events, null);
        t.setTag(C1848R.id.react_test_id, null);
        t.setTag(C1848R.id.view_tag_native_id, null);
        t.setTag(C1848R.id.labelled_by, null);
        t.setTag(C1848R.id.accessibility_label, null);
        t.setTag(C1848R.id.accessibility_hint, null);
        t.setTag(C1848R.id.accessibility_role, null);
        t.setTag(C1848R.id.accessibility_state, null);
        t.setTag(C1848R.id.accessibility_actions, null);
        t.setTag(C1848R.id.accessibility_value, null);
        t.setTag(C1848R.id.accessibility_state_expanded, null);
        ...
        t.setTag(C1848R.id.transform, null);
        t.setTag(C1848R.id.transform_origin, null);
        t.setTag(C1848R.id.invalidate_transform, null);
    ...
    public void onLayoutChange(View view, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8) {
        ...
        ReadableArray readableArray = (ReadableArray) view.getTag(C1848R.id.transform_origin);
        ReadableArray readableArray2 = (ReadableArray) view.getTag(C1848R.id.transform);
    ...
    public void setTransform(T t, ReadableArray readableArray) {
        t.setTag(C1848R.id.transform, readableArray);
        t.setTag(C1848R.id.invalidate_transform, true);
    }

    @Override // com.facebook.react.uimanager.BaseViewManagerInterface
    @ReactProp(name = ViewProps.TRANSFORM_ORIGIN)
    public void setTransformOrigin(T t, ReadableArray readableArray) {
        t.setTag(C1848R.id.transform_origin, readableArray);
        t.setTag(C1848R.id.invalidate_transform, true);
    ...
    public void setTestId(T t, String str) {
        t.setTag(C1848R.id.react_test_id, str);
        t.setTag(str);
    }
    ...
    public void setNativeId(T t, String str) {
        t.setTag(C1848R.id.view_tag_native_id, str);
    ...
    public void setAccessibilityLabelledBy(T t, Dynamic dynamic) {
        ...
        if (dynamic.getType() == ReadableType.String) {
            t.setTag(C1848R.id.labelled_by, dynamic.asString());
        } else if (dynamic.getType() == ReadableType.Array) {
            t.setTag(C1848R.id.labelled_by, dynamic.asArray().getString(0));
        }
    }
    ...
    public void setAccessibilityLabel(T t, String str) {
        t.setTag(C1848R.id.accessibility_label, str);
    ...
    public void setAccessibilityHint(T t, String str) {
        t.setTag(C1848R.id.accessibility_hint, str);
        updateViewContentDescription(t);
    }
    ...
    public void setAccessibilityRole(T t, String str) {
        if (str == null) {
            ...
            t.setTag(C1848R.id.accessibility_role, ReactAccessibilityDelegate.AccessibilityRole.fromValue(str));
        }
    }
    ...
    public void setAccessibilityCollection(T t, ReadableMap readableMap) {
        t.setTag(C1848R.id.accessibility_collection, readableMap);
    }
    ...
    public void setAccessibilityCollectionItem(T t, ReadableMap readableMap) {
        t.setTag(C1848R.id.accessibility_collection_item, readableMap);
    }
    ...
    public void setViewState(T t, ReadableMap readableMap) {
        ...
        if (readableMap.hasKey(STATE_EXPANDED)) {
            t.setTag(C1848R.id.accessibility_state_expanded, Boolean.valueOf(readableMap.getBoolean(STATE_EXPANDED)));
        }
        if (readableMap.hasKey("selected")) {
            ...
            if (t.isAccessibilityFocused() && zIsSelected && !z) {
                t.announceForAccessibility(t.getContext().getString(C1848R.string.state_unselected_description));
            }
        } else {
            t.setSelected(false);
        }
        t.setTag(C1848R.id.accessibility_state, readableMap);
    ...
    private void updateViewContentDescription(T t) {
        Dynamic dynamic;
        String str = (String) t.getTag(C1848R.id.accessibility_label);
        ReadableMap readableMap = (ReadableMap) t.getTag(C1848R.id.accessibility_state);
        ArrayList arrayList = new ArrayList();
        ReadableMap readableMap2 = (ReadableMap) t.getTag(C1848R.id.accessibility_value);
        if (str != null) {
            arrayList.add(str);
        }
        if (readableMap != null) {
            ...
            while (readableMapKeySetIteratorKeySetIterator.hasNextKey()) {
                ...
                if (strNextKey.equals(STATE_CHECKED) && dynamic2.getType() == ReadableType.String && dynamic2.asString().equals(STATE_MIXED)) {
                    arrayList.add(t.getContext().getString(C1848R.string.state_mixed_description));
                } else if (strNextKey.equals(STATE_BUSY) && dynamic2.getType() == ReadableType.Boolean && dynamic2.asBoolean()) {
                    arrayList.add(t.getContext().getString(C1848R.string.state_busy_description));
                }
            }
        }
    ...
    public void setAccessibilityActions(T t, ReadableArray readableArray) {
        ...
        t.setTag(C1848R.id.accessibility_actions, readableArray);
    }
    ...
    public void setAccessibilityValue(T t, ReadableMap readableMap) {
        if (readableMap == null) {
            ...
            t.setTag(C1848R.id.accessibility_value, readableMap);
    ...
    public void setRole(T t, String str) {
        if (str == null) {
            t.setTag(C1848R.id.role, null);
        } else {
            t.setTag(C1848R.id.role, ReactAccessibilityDelegate.Role.fromValue(str));
        }
    }
    ...
    protected void onAfterUpdateTransaction(T t) {
        ...
        Boolean bool = (Boolean) t.getTag(C1848R.id.invalidate_transform);
        if (bool == null || !bool.booleanValue()) {
            return;
        }
        setTransformProperty(t, (ReadableArray) t.getTag(C1848R.id.transform), (ReadableArray) t.getTag(C1848R.id.transform_origin));
        t.setTag(C1848R.id.invalidate_transform, false);
    }
    ...
    public Map<String, Object> getExportedCustomBubblingEventTypeConstants() {
        ...
        exportedCustomDirectEventTypeConstants.putAll(MapBuilder.builder().put(PointerEventHelper.POINTER_CANCEL, MapBuilder.m1349of("phasedRegistrationNames", MapBuilder.m1350of("bubbled", "onPointerCancel", "captured", "onPointerCancelCapture"))).put(PointerEventHelper.POINTER_DOWN, MapBuilder.m1349of("phasedRegistrationNames", MapBuilder.m1350of("bubbled", "onPointerDown", "captured", "onPointerDownCapture"))).put(PointerEventHelper.POINTER_ENTER, MapBuilder.m1349of("phasedRegistrationNames", MapBuilder.m1351of("bubbled", "onPointerEnter", "captured", "onPointerEnterCapture", "skipBubbling", true))).put(PointerEventHelper.POINTER_LEAVE, MapBuilder.m1349of("phasedRegistrationNames", MapBuilder.m1351of("bubbled", "onPointerLeave", "captured", "onPointerLeaveCapture", "skipBubbling", true))).put(PointerEventHelper.POINTER_MOVE, MapBuilder.m1349of("phasedRegistrationNames", MapBuilder.m1350of("bubbled", "onPointerMove", "captured", "onPointerMoveCapture"))).put(PointerEventHelper.POINTER_UP, MapBuilder.m1349of("phasedRegistrationNames", MapBuilder.m1350of("bubbled", "onPointerUp", "captured", "onPointerUpCapture"))).put(PointerEventHelper.POINTER_OUT, MapBuilder.m1349of("phasedRegistrationNames", MapBuilder.m1350of("bubbled", "onPointerOut", "captured", "onPointerOutCapture"))).put(PointerEventHelper.POINTER_OVER, MapBuilder.m1349of("phasedRegistrationNames", MapBuilder.m1350of("bubbled", "onPointerOver", "captured", "onPointerOverCapture"))).put(PointerEventHelper.CLICK, MapBuilder.m1349of("phasedRegistrationNames", MapBuilder.m1350of("bubbled", "onClick", "captured", "onClickCapture"))).build());
    ...
    public Map<String, Object> getExportedCustomDirectEventTypeConstants() {
        ...
        exportedCustomDirectEventTypeConstants.putAll(MapBuilder.builder().put(ReactAccessibilityDelegate.TOP_ACCESSIBILITY_ACTION_EVENT, MapBuilder.m1349of("registrationName", "onAccessibilityAction")).build());
        return exportedCustomDirectEventTypeConstants;
    }
    ...
    private void logUnsupportedPropertyWarning(String str) {
        FLog.m1319w(ReactConstants.TAG, "%s doesn't support property '%s'", getName(), str);
    }

    private static void setPointerEventsFlag(View view, PointerEventHelper.EVENT event, boolean z) {
        Integer num = (Integer) view.getTag(C1848R.id.pointer_events);
        int iIntValue = num != null ? num.intValue() : 0;
        int iOrdinal = 1 << event.ordinal();
        view.setTag(C1848R.id.pointer_events, Integer.valueOf(z ? iOrdinal | iIntValue : (~iOrdinal) & iIntValue));
    }
