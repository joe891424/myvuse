...
public class TransformHelper {
                ...
                if ("matrix".equals(strNextKey)) {
                    ...
                    if ("rotate".equals(strNextKey) || "rotateZ".equals(strNextKey)) {
                        ...
                        if (ViewProps.TRANSLATE_X.equals(strNextKey)) {
                            ...
                            FLog.m1317w(ReactConstants.TAG, "Unsupported transform type: " + strNextKey);
                        }
                    }
                    MatrixMathHelper.multiplyInto(dArr, dArr, dArr2);
                    i3 = i + 1;
    ...
    private static float[] getTranslateForTransformOrigin(float f, float f2, ReadableArray readableArray) {
        ...
        while (i < readableArray.size() && i < 3) {
            int i2 = C20582.$SwitchMap$com$facebook$react$bridge$ReadableType[readableArray.getType(i).ordinal()];
            if (i2 == 1) {
    ...
    /* JADX INFO: renamed from: com.facebook.react.uimanager.TransformHelper$2 */
    static /* synthetic */ class C20582 {
