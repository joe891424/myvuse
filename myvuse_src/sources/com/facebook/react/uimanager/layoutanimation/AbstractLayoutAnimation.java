...
abstract class AbstractLayoutAnimation {
    ...
    public void initializeFromConfig(ReadableMap readableMap, int i) {
        ...
        this.mDurationMs = i;
        this.mDelayMs = readableMap.hasKey(BackgroundFetchConfig.FIELD_DELAY) ? readableMap.getInt(BackgroundFetchConfig.FIELD_DELAY) : 0;
