...
public class PointerEvent extends Event<PointerEvent> {
    ...
    private WritableMap createW3CPointerEvent(int i) {
        ...
        writableMapCreateMap.putDouble(EllipticCurveJsonWebKey.X_MEMBER_NAME, dIPFromPixel);
        writableMapCreateMap.putDouble(EllipticCurveJsonWebKey.Y_MEMBER_NAME, dIPFromPixel2);
        ...
        writableMapCreateMap.putInt(OTUXParamsKeys.OT_UX_BUTTONS, PointerEventHelper.getButtons(this.mEventName, w3CPointerType, buttonState));
        writableMapCreateMap.putDouble("pressure", isClickEvent() ? 0.0d : PointerEventHelper.getPressure(writableMapCreateMap.getInt(OTUXParamsKeys.OT_UX_BUTTONS), this.mEventName));
