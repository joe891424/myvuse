...
public class TouchEvent extends Event<TouchEvent> {
    ...
    /* JADX INFO: renamed from: com.facebook.react.uimanager.events.TouchEvent$1 */
    ...
    public boolean canCoalesce() {
        int i = C20771.$SwitchMap$com$facebook$react$uimanager$events$TouchEventType[((TouchEventType) Assertions.assertNotNull(this.mTouchEventType)).ordinal()];
        if (i == 1 || i == 2 || i == 3) {
            return false;
        }
        if (i == 4) {
    ...
    protected int getEventCategory() {
        ...
        int i = C20771.$SwitchMap$com$facebook$react$uimanager$events$TouchEventType[touchEventType.ordinal()];
        if (i == 1) {
            return 0;
        }
        if (i == 2 || i == 3) {
