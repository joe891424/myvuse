...
public class ReactViewManager extends ReactClippingViewManager<ReactViewGroup> {
    ...
    public void setHitSlop(ReactViewGroup reactViewGroup, Dynamic dynamic) {
        int i = C21102.$SwitchMap$com$facebook$react$bridge$ReadableType[dynamic.getType().ordinal()];
        if (i == 1) {
            ...
            if (i != 3) {
                FLog.m1317w(ReactConstants.TAG, "Invalid type for 'hitSlop' value " + dynamic.getType());
            }
    ...
    public Map<String, Integer> getCommandsMap() {
        return MapBuilder.m1350of(HOTSPOT_UPDATE_KEY, 1, "setPressed", 2);
    }
