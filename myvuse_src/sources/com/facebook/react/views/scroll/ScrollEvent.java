...
public class ScrollEvent extends Event<ScrollEvent> {
    ...
    protected WritableMap getEventData() {
        ...
        writableMapCreateMap2.putDouble(EllipticCurveJsonWebKey.X_MEMBER_NAME, PixelUtil.toDIPFromPixel(this.mScrollX));
        writableMapCreateMap2.putDouble(EllipticCurveJsonWebKey.Y_MEMBER_NAME, PixelUtil.toDIPFromPixel(this.mScrollY));
        ...
        writableMapCreateMap5.putDouble(EllipticCurveJsonWebKey.X_MEMBER_NAME, this.mXVelocity);
        writableMapCreateMap5.putDouble(EllipticCurveJsonWebKey.Y_MEMBER_NAME, this.mYVelocity);
