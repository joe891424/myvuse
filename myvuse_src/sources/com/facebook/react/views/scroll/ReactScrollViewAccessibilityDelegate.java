...
public class ReactScrollViewAccessibilityDelegate extends AccessibilityDelegateCompat {
    ...
    private void onInitializeAccessibilityEventInternal(View view, AccessibilityEvent accessibilityEvent) {
        ...
        ReadableMap readableMap2 = (ReadableMap) view.getTag(C1848R.id.accessibility_collection);
        ...
        while (true) {
            ...
            ReadableMap readableMap3 = (ReadableMap) childAt3.getTag(C1848R.id.accessibility_collection_item);
            if (!(childAt3 instanceof ViewGroup)) {
                return;
            }
            ViewGroup viewGroup2 = (ViewGroup) childAt3;
            if (viewGroup2.getChildCount() > 0 && readableMap3 == null && (childAt = viewGroup2.getChildAt(0)) != null && (readableMap = (ReadableMap) childAt.getTag(C1848R.id.accessibility_collection_item)) != null) {
    ...
    private void onInitializeAccessibilityNodeInfoInternal(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
        ...
        ReadableMap readableMap = (ReadableMap) view.getTag(C1848R.id.accessibility_collection);
        if (readableMap != null) {
