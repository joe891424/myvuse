...
public class ReactImageManager extends SimpleViewManager<ReactImageView> {
    ...
    public void setResizeMethod(ReactImageView reactImageView, String str) {
        ...
        if ("resize".equals(str)) {
            ...
            reactImageView.setResizeMethod(ImageResizeMethod.AUTO);
            FLog.m1317w(ReactConstants.TAG, "Invalid resize method: '" + str + "'");
        }
    }
    ...
    public Map getExportedCustomDirectEventTypeConstants() {
        ...
        exportedCustomDirectEventTypeConstants.putAll(MapBuilder.m1353of(ImageLoadEvent.eventNameForType(4), MapBuilder.m1349of("registrationName", "onLoadStart"), ImageLoadEvent.eventNameForType(5), MapBuilder.m1349of("registrationName", "onProgress"), ImageLoadEvent.eventNameForType(2), MapBuilder.m1349of("registrationName", "onLoad"), ImageLoadEvent.eventNameForType(1), MapBuilder.m1349of("registrationName", "onError"), ImageLoadEvent.eventNameForType(3), MapBuilder.m1349of("registrationName", "onLoadEnd")));
