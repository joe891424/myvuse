...
public class TextAttributeProps {
    ...
    public static int getTextAlignment(ReactStylesDiffMap reactStylesDiffMap, boolean z, int i) {
        ...
        if (string != null && !"auto".equals(string)) {
            ...
            if (RadialGradientManager.PROP_CENTER.equals(string)) {
                return 1;
            }
            FLog.m1317w(ReactConstants.TAG, "Invalid textAlign: " + string);
        }
        return 0;
    }
    ...
    public static int getLayoutDirection(String str) {
        ...
        FLog.m1317w(ReactConstants.TAG, "Invalid layoutDirection: " + str);
        return -1;
    }
    ...
    private void setTextTransform(String str) {
        ...
        if ("lowercase".equals(str)) {
            ...
            FLog.m1317w(ReactConstants.TAG, "Invalid textTransform: " + str);
            this.mTextTransform = TextTransform.NONE;
        }
    }
