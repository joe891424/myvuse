...
public class TextLayoutManagerMapBuffer {
    ...
    private static final LruCache<ReadableMapBuffer, Spannable> sSpannableCache = new LruCache<>(AndroidLocationEnablerModule.DEFAULT_INTERVAL_DURATION);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:21:0x0090, code lost:
        ...
        r21.add(new com.facebook.react.views.text.SetSpanOperation(r6, r8, new com.facebook.react.views.text.ReactClickableSpan(r10)));
     */
