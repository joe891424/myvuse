...
public class ReactTextViewManager extends ReactTextAnchorViewManager<ReactTextView, ReactTextShadowNode> implements IViewManagerWithChildren {
    ...
    public void updateExtraData(ReactTextView reactTextView, Object obj) {
        ...
        if (reactClickableSpanArr.length > 0) {
            reactTextView.setTag(C1848R.id.accessibility_links, new ReactAccessibilityDelegate.AccessibilityLinks(reactClickableSpanArr, text));
    ...
    public Map getExportedCustomDirectEventTypeConstants() {
        ...
        exportedCustomDirectEventTypeConstants.putAll(MapBuilder.m1350of("topTextLayout", MapBuilder.m1349of("registrationName", "onTextLayout"), "topInlineViewLayout", MapBuilder.m1349of("registrationName", "onInlineViewLayout")));
