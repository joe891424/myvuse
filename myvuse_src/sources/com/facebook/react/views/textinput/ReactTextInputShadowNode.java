...
public class ReactTextInputShadowNode extends ReactBaseTextShadowNode implements YogaMeasureFunction {
    ...
    public void setTextBreakStrategy(String str) {
        ...
        if ("highQuality".equals(str)) {
            ...
            FLog.m1317w(ReactConstants.TAG, "Invalid textBreakStrategy: " + str);
            this.mTextBreakStrategy = 0;
        }
    }
    ...
    protected EditText createInternalEditText() {
        return new EditText(new ContextThemeWrapper(getThemedContext(), C1848R.style.Theme_ReactNative_TextInput_DefaultBackground));
    }
}
