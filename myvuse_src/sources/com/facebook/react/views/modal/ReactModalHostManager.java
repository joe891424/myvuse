...
public class ReactModalHostManager extends ViewGroupManager<ReactModalHostView> implements ModalHostViewManagerInterface<ReactModalHostView> {
    ...
    public Map<String, Object> getExportedCustomDirectEventTypeConstants() {
        ...
        exportedCustomDirectEventTypeConstants.putAll(MapBuilder.builder().put("topRequestClose", MapBuilder.m1349of("registrationName", "onRequestClose")).put("topShow", MapBuilder.m1349of("registrationName", "onShow")).put("topDismiss", MapBuilder.m1349of("registrationName", "onDismiss")).put("topOrientationChange", MapBuilder.m1349of("registrationName", "onOrientationChange")).build());
