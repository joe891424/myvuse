...
public class ReactDrawerLayoutManager extends ViewGroupManager<ReactDrawerLayout> implements AndroidDrawerLayoutManagerInterface<ReactDrawerLayout> {
    ...
    public void setDrawerPosition(ReactDrawerLayout reactDrawerLayout, Dynamic dynamic) {
        ...
        if (dynamic.getType() == ReadableType.Number) {
            ...
            if (8388611 == iAsInt || 8388613 == iAsInt) {
                ...
                FLog.m1317w(ReactConstants.TAG, "Unknown drawerPosition " + iAsInt);
                reactDrawerLayout.setDrawerPosition(GravityCompat.START);
                return;
            }
        }
        if (dynamic.getType() == ReadableType.String) {
            ...
            FLog.m1317w(ReactConstants.TAG, "drawerPosition must be a string or int");
            reactDrawerLayout.setDrawerPosition(GravityCompat.START);
        }
    }
    ...
    private void setDrawerPositionInternal(ReactDrawerLayout reactDrawerLayout, String str) {
        if (str.equals(ViewProps.LEFT)) {
            ...
            FLog.m1317w(ReactConstants.TAG, "drawerPosition must be 'left' or 'right', received" + str);
            reactDrawerLayout.setDrawerPosition(GravityCompat.START);
        }
    }
    ...
    public void setDrawerLockMode(ReactDrawerLayout reactDrawerLayout, String str) {
        ...
        if ("locked-closed".equals(str)) {
            ...
            FLog.m1317w(ReactConstants.TAG, "Unknown drawerLockMode " + str);
            reactDrawerLayout.setDrawerLockMode(0);
        }
    }
    ...
    public Map<String, Integer> getCommandsMap() {
        return MapBuilder.m1350of("openDrawer", 1, "closeDrawer", 2);
    }
    ...
    public Map<String, Object> getExportedViewConstants() {
        return MapBuilder.m1349of("DrawerPosition", MapBuilder.m1350of("Left", Integer.valueOf(GravityCompat.START), "Right", Integer.valueOf(GravityCompat.END)));
    }
    ...
    public Map<String, Object> getExportedCustomDirectEventTypeConstants() {
        ...
        exportedCustomDirectEventTypeConstants.putAll(MapBuilder.m1352of(DrawerSlideEvent.EVENT_NAME, MapBuilder.m1349of("registrationName", "onDrawerSlide"), DrawerOpenedEvent.EVENT_NAME, MapBuilder.m1349of("registrationName", "onDrawerOpen"), DrawerClosedEvent.EVENT_NAME, MapBuilder.m1349of("registrationName", "onDrawerClose"), DrawerStateChangedEvent.EVENT_NAME, MapBuilder.m1349of("registrationName", "onDrawerStateChanged")));
