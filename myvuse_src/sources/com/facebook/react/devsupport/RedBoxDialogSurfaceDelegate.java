...
public class RedBoxDialogSurfaceDelegate implements SurfaceDelegate {
    ...
    public void createContentView(String str) {
        ...
        if (currentActivity == null || currentActivity.isFinishing()) {
            ...
            FLog.m1277e(ReactConstants.TAG, sb.append(lastErrorTitle).toString());
            return;
        }
    ...
    public void show() {
        ...
        if (this.mDialog == null) {
            Dialog dialog = new Dialog(currentActivity, C1848R.style.Theme_Catalyst_RedBox) { // from class: com.facebook.react.devsupport.RedBoxDialogSurfaceDelegate.1
