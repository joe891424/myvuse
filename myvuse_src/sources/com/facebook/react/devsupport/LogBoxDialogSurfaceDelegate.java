...
public class LogBoxDialogSurfaceDelegate implements SurfaceDelegate {
    ...
    public void createContentView(String str) {
        ...
        if (viewCreateRootView == null) {
            RNLog.m1358e("Unable to launch logbox because react was unable to create the root view");
        }
    }
    ...
    public void show() {
        ...
        if (currentActivity == null || currentActivity.isFinishing()) {
            RNLog.m1358e("Unable to launch logbox because react activity is not available, here is the error that logbox would've displayed: ");
            return;
        }
