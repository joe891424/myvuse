...
public abstract class DevSupportManagerBase implements DevSupportManager {
    ...
    public DevSupportManagerBase(Context context, ReactInstanceDevHelper reactInstanceDevHelper, String str, boolean z, RedBoxHandler redBoxHandler, DevBundleDownloadListener devBundleDownloadListener, int i, Map<String, RequestHandler> map, SurfaceDelegateFactory surfaceDelegateFactory, DevLoadingViewManager devLoadingViewManager) {
        ...
        this.mDevServerHelper = new DevServerHelper(devInternalSettings, context.getPackageName(), new InspectorPackagerConnection.BundleStatusProvider() { // from class: com.facebook.react.devsupport.DevSupportManagerBase$$ExternalSyntheticLambda18
    ...
    private void logJSException(Exception exc) {
        ...
        if (exc instanceof JSException) {
            FLog.m1278e(ReactConstants.TAG, "Exception in native call from JS", exc);
    ...
    public void showNewJavaError(String str, Throwable th) {
        FLog.m1278e(ReactConstants.TAG, "Exception in native call", th);
    ...
    public void showDevOptionsDialog() {
        ...
        if (this.mDevOptionsDialog == null && this.mIsDevSupportEnabled && !ActivityManager.isUserAMonkey()) {
            ...
            linkedHashMap.put(this.mApplicationContext.getString(C1848R.string.catalyst_reload), new DevOptionHandler() { // from class: com.facebook.react.devsupport.DevSupportManagerBase.2
                ...
                public void onOptionSelected() {
                    if (!DevSupportManagerBase.this.mDevSettings.isJSDevModeEnabled() && DevSupportManagerBase.this.mDevSettings.isHotModuleReplacementEnabled()) {
                        Toast.makeText(DevSupportManagerBase.this.mApplicationContext, DevSupportManagerBase.this.mApplicationContext.getString(C1848R.string.catalyst_hot_reloading_auto_disable), 1).show();
            ...
            if (this.mDevSettings.isDeviceDebugEnabled() && !this.mDevSettings.isRemoteJSDebugEnabled()) {
                linkedHashMap.put(this.mApplicationContext.getString(C1848R.string.catalyst_debug_open), new DevOptionHandler() { // from class: com.facebook.react.devsupport.DevSupportManagerBase$$ExternalSyntheticLambda2
                    @Override // com.facebook.react.devsupport.interfaces.DevOptionHandler
            ...
            linkedHashMap.put(this.mApplicationContext.getString(C1848R.string.catalyst_change_bundle_location), new DevOptionHandler() { // from class: com.facebook.react.devsupport.DevSupportManagerBase$$ExternalSyntheticLambda3
                @Override // com.facebook.react.devsupport.interfaces.DevOptionHandler
                public final void onOptionSelected() {
            ...
            if (this.mDevSettings.isElementInspectorEnabled()) {
                string = this.mApplicationContext.getString(C1848R.string.catalyst_inspector_stop);
            } else {
                string = this.mApplicationContext.getString(C1848R.string.catalyst_inspector);
            }
            ...
            if (this.mDevSettings.isHotModuleReplacementEnabled()) {
                string2 = this.mApplicationContext.getString(C1848R.string.catalyst_hot_reloading_stop);
            } else {
                string2 = this.mApplicationContext.getString(C1848R.string.catalyst_hot_reloading);
            }
            linkedHashMap.put(string2, new DevOptionHandler() { // from class: com.facebook.react.devsupport.DevSupportManagerBase$$ExternalSyntheticLambda4
                @Override // com.facebook.react.devsupport.interfaces.DevOptionHandler
                public final void onOptionSelected() {
            ...
            if (this.mDevSettings.isFpsDebugEnabled()) {
                string3 = this.mApplicationContext.getString(C1848R.string.catalyst_perf_monitor_stop);
            } else {
                string3 = this.mApplicationContext.getString(C1848R.string.catalyst_perf_monitor);
            }
            ...
            linkedHashMap.put(this.mApplicationContext.getString(C1848R.string.catalyst_settings), new DevOptionHandler() { // from class: com.facebook.react.devsupport.DevSupportManagerBase$$ExternalSyntheticLambda6
                @Override // com.facebook.react.devsupport.interfaces.DevOptionHandler
                public final void onOptionSelected() {
            ...
            if (currentActivity == null || currentActivity.isFinishing()) {
                FLog.m1277e(ReactConstants.TAG, "Unable to launch dev options menu because react activity isn't available");
                return;
            }
            LinearLayout linearLayout = new LinearLayout(currentActivity);
            linearLayout.setOrientation(1);
            TextView textView = new TextView(currentActivity);
            textView.setText(currentActivity.getString(C1848R.string.catalyst_dev_menu_header, new Object[]{getUniqueTag()}));
            ...
            if (jSExecutorDescription != null) {
                ...
                textView2.setText(currentActivity.getString(C1848R.string.catalyst_dev_menu_sub_header, new Object[]{jSExecutorDescription}));
                textView2.setPadding(0, 20, 0, 0);
                textView2.setGravity(17);
                textView2.setTextSize(14.0f);
                linearLayout.addView(textView2);
            }
            AlertDialog alertDialogCreate = new AlertDialog.Builder(currentActivity).setCustomTitle(linearLayout).setItems((CharSequence[]) linkedHashMap.keySet().toArray(new String[0]), new DialogInterface.OnClickListener() { // from class: com.facebook.react.devsupport.DevSupportManagerBase$$ExternalSyntheticLambda7
                @Override // android.content.DialogInterface.OnClickListener
                public final void onClick(DialogInterface dialogInterface, int i) {
                    this.f$0.lambda$showDevOptionsDialog$8(devOptionHandlerArr, dialogInterface, i);
                }
            }).setOnCancelListener(new DialogInterface.OnCancelListener() { // from class: com.facebook.react.devsupport.DevSupportManagerBase$$ExternalSyntheticLambda8
    ...
    public /* synthetic */ void lambda$showDevOptionsDialog$3() {
        this.mDevServerHelper.openDebugger(this.mCurrentContext, this.mApplicationContext.getString(C1848R.string.catalyst_open_debugger_error));
    }
    ...
    public /* synthetic */ void lambda$showDevOptionsDialog$4() {
        Activity currentActivity = this.mReactInstanceDevHelper.getCurrentActivity();
        if (currentActivity == null || currentActivity.isFinishing()) {
            FLog.m1277e(ReactConstants.TAG, "Unable to launch change bundle location because react activity is not available");
            return;
        }
        final EditText editText = new EditText(currentActivity);
        editText.setHint("localhost:8081");
        new AlertDialog.Builder(currentActivity).setTitle(this.mApplicationContext.getString(C1848R.string.catalyst_change_bundle_location)).setView(editText).setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() { // from class: com.facebook.react.devsupport.DevSupportManagerBase.3
            @Override // android.content.DialogInterface.OnClickListener
    ...
    public /* synthetic */ void lambda$showDevOptionsDialog$5() {
        ...
        Toast.makeText(context, context.getString(C1848R.string.catalyst_hot_reloading_auto_enable), 1).show();
    ...
    public /* synthetic */ void lambda$showDevOptionsDialog$6() {
        if (!this.mDevSettings.isFpsDebugEnabled()) {
            ...
            if (currentActivity == null) {
                FLog.m1277e(ReactConstants.TAG, "Unable to get reference to react activity");
            } else {
    ...
    public boolean hasUpToDateJSBundleInCache() {
        if (this.mIsDevSupportEnabled && this.mJSBundleDownloadedFile.exists()) {
            try {
                ...
                FLog.m1277e(ReactConstants.TAG, "DevSupport is unable to get current app info");
            }
        }
        return false;
    }
    ...
    private void showDevLoadingViewForUrl(String str) {
        ...
        try {
            URL url = new URL(str);
            this.mDevLoadingViewManager.showMessage(this.mApplicationContext.getString(C1848R.string.catalyst_loading_from_url, url.getHost() + ":" + (url.getPort() != -1 ? url.getPort() : url.getDefaultPort())));
            this.mDevLoadingViewVisible = true;
        } catch (MalformedURLException e) {
            FLog.m1277e(ReactConstants.TAG, "Bundle url format is invalid. \n\n" + e.toString());
        }
    }
    ...
    protected void showDevLoadingViewForRemoteJSEnabled() {
        ...
        this.mDevLoadingViewManager.showMessage(context.getString(C1848R.string.catalyst_debug_connecting));
        this.mDevLoadingViewVisible = true;
    }
    ...
    public /* synthetic */ void lambda$fetchSplitBundleAndCreateBundleLoader$10(String str, File file, CallbackWithBundleLoader callbackWithBundleLoader) {
        ...
        this.mDevServerHelper.downloadBundleFromURL(new C19475(str, file, callbackWithBundleLoader), file, str, null);
    }

    /* JADX INFO: renamed from: com.facebook.react.devsupport.DevSupportManagerBase$5 */
    class C19475 implements DevBundleDownloadListener {
        ...
        C19475(String str, File file, CallbackWithBundleLoader callbackWithBundleLoader) {
    ...
    public void isPackagerRunning(final PackagerStatusCallback packagerStatusCallback) {
        Runnable runnable = new Runnable() { // from class: com.facebook.react.devsupport.DevSupportManagerBase$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public void reloadJSFromServer(String str) {
        reloadJSFromServer(str, new BundleLoadCallback() { // from class: com.facebook.react.devsupport.DevSupportManagerBase$$ExternalSyntheticLambda20
    ...
    public void reloadJSFromServer(String str, final BundleLoadCallback bundleLoadCallback) {
        ...
        this.mDevServerHelper.downloadBundleFromURL(new DevBundleDownloadListener() { // from class: com.facebook.react.devsupport.DevSupportManagerBase.7
            ...
            public void onFailure(Exception exc) {
                ...
                FLog.m1278e(ReactConstants.TAG, "Unable to download JS bundle", exc);
    ...
    public /* synthetic */ void lambda$reportBundleLoadingFailure$13(Exception exc) {
        if (exc instanceof DebugServerException) {
            ...
            showNewJavaError(this.mApplicationContext.getString(C1848R.string.catalyst_reload_error), exc);
        }
    }
    ...
    public void reload() {
        ...
        if (this.mIsDevSupportEnabled) {
            ...
            this.mDevServerHelper.openPackagerConnection(getClass().getSimpleName(), new C19508());
            return;
        }
    ...
    /* JADX INFO: renamed from: com.facebook.react.devsupport.DevSupportManagerBase$8 */
    class C19508 implements DevServerHelper.PackagerCommandListener {
