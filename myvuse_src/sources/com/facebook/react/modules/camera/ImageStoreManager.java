...
public class ImageStoreManager extends NativeImageStoreAndroidSpec {
    ...
    public void getBase64ForTag(String str, Callback callback, Callback callback2) {
        ...
        if (getBase64Task instanceof AsyncTask) {
            AsyncTaskInstrumentation.executeOnExecutor(getBase64Task, executor, voidArr);
        } else {
            getBase64Task.executeOnExecutor(executor, voidArr);
        }
    }
