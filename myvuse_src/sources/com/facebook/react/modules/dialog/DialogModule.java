...
public class DialogModule extends NativeDialogManagerAndroidSpec implements LifecycleEventListener {
    ...
    static final Map<String, Object> CONSTANTS = MapBuilder.m1353of("buttonClicked", "buttonClicked", "dismissed", "dismissed", KEY_BUTTON_POSITIVE, -1, KEY_BUTTON_NEGATIVE, -2, KEY_BUTTON_NEUTRAL, -3);
    ...
    public void onHostResume() {
        ...
        if (fragmentManagerHelper != null) {
            ...
            FLog.m1313w((Class<?>) DialogModule.class, "onHostResume called but no FragmentManager found");
        }
    }
