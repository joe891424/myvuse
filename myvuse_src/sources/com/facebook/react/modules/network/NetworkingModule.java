...
public final class NetworkingModule extends NativeNetworkingAndroidSpec {
    ...
    public void sendRequest(String str, String str2, double d, ReadableArray readableArray, ReadableMap readableMap, String str3, boolean z, double d2, boolean z2) {
        ...
        try {
            ...
            FLog.m1278e("Networking", "Failed to send url request: " + str2, th);
    ...
    public void sendRequestInternal(String str, String str2, final int i, ReadableArray readableArray, ReadableMap readableMap, final String str3, final boolean z, int i2, boolean z2) {
        ...
        try {
            ...
            try {
                ...
                String str4 = headersExtractHeaders.get("content-type");
                ...
                FirebasePerfOkHttpClient.enqueue(!(okHttpClientBuild instanceof OkHttpClient) ? okHttpClientBuild.newCall(requestBuild) : OkHttp3Instrumentation.newCall(okHttpClientBuild, requestBuild), new Callback() { // from class: com.facebook.react.modules.network.NetworkingModule.2
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        ...
                        try {
                            ...
                            if (Constants.Network.Encoding.GZIP.equalsIgnoreCase(response.header("Content-Encoding")) && responseBodyBody != null) {
    ...
    public /* synthetic */ Response lambda$sendRequestInternal$0(final String str, final ReactApplicationContext reactApplicationContext, final int i, Interceptor.Chain chain) throws IOException {
        ...
        ProgressResponseBody progressResponseBody = new ProgressResponseBody(responseProceed.body(), new ProgressListener() { // from class: com.facebook.react.modules.network.NetworkingModule.1
        ...
        Response.Builder builderNewBuilder = !(responseProceed instanceof Response.Builder) ? responseProceed.newBuilder() : OkHttp3Instrumentation.newBuilder((Response.Builder) responseProceed);
        return (!(builderNewBuilder instanceof Response.Builder) ? builderNewBuilder.body(progressResponseBody) : OkHttp3Instrumentation.body(builderNewBuilder, progressResponseBody)).build();
    }
    ...
    private void cancelRequest(final int i) {
        ?? r0 = new GuardedAsyncTask<Void, Void>(getReactApplicationContext()) { // from class: com.facebook.react.modules.network.NetworkingModule.4
    ...
    private MultipartBody.Builder constructMultipartBody(ReadableArray readableArray, String str, int i) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            String str2 = headersExtractHeaders.get("content-type");
            if (str2 != null) {
                mediaType = MediaType.parse(str2);
                headersExtractHeaders = headersExtractHeaders.newBuilder().removeAll("content-type").build();
            } else {
                mediaType = null;
            }
