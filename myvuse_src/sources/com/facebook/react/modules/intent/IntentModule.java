...
public class IntentModule extends NativeIntentAndroidSpec {
    ...
    public void sendIntent(String str, ReadableArray readableArray, Promise promise) {
        ...
        if (readableArray != null) {
            for (int i = 0; i < readableArray.size(); i++) {
                ...
                int i2 = C20082.$SwitchMap$com$facebook$react$bridge$ReadableType[map.getType("value").ordinal()];
                if (i2 == 1) {
    ...
    /* JADX INFO: renamed from: com.facebook.react.modules.intent.IntentModule$2 */
