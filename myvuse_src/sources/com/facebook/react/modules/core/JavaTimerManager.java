...
public class JavaTimerManager {
    ...
    private class IdleCallbackRunnable implements Runnable {
        ...
        public void run() {
            ...
            long jUptimeMillis = SystemClock.uptimeMillis() - (this.mFrameStartTime / Constants.Network.MAX_PAYLOAD_SIZE);
    ...
    public void createTimer(int i, long j, boolean z) {
        Timer timer = new Timer(i, (SystemClock.nanoTime() / Constants.Network.MAX_PAYLOAD_SIZE) + j, (int) j, z);
