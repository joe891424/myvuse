...
public class HeadlessJsTaskSupportModule extends NativeHeadlessJsTaskSupportSpec {
    ...
    public void notifyTaskRetry(double d, Promise promise) {
        ...
        if (headlessJsTaskContext.isTaskRunning(i)) {
            ...
            FLog.m1315w((Class<?>) HeadlessJsTaskSupportModule.class, "Tried to retry non-active task with id %d. Did it time out?", Integer.valueOf(i));
    ...
    public void notifyTaskFinished(double d) {
        ...
        if (headlessJsTaskContext.isTaskRunning(i)) {
            ...
            FLog.m1315w((Class<?>) HeadlessJsTaskSupportModule.class, "Tried to finish non-active task with id %d. Did it time out?", Integer.valueOf(i));
        }
    }
}
