...
public class ForwardingControllerListener2<I> extends BaseControllerListener2<I> {
        ...
        for (int i = 0; i < size; i++) {
            try {
                try {
                    ...
                    LogInstrumentation.m2729e(TAG, "InternalListener exception in " + methodName, e);
                }
    ...
    @Override // com.facebook.fresco.p037ui.common.BaseControllerListener2, com.facebook.fresco.p037ui.common.ControllerListener2
        ...
        for (int i = 0; i < size; i++) {
            try {
                try {
                    ...
                    LogInstrumentation.m2729e(TAG, "InternalListener exception in onSubmit", e);
                }
            } catch (IndexOutOfBoundsException unused) {
                return;
            }
        ...
        for (int i = 0; i < size; i++) {
            try {
                try {
                    ...
                    LogInstrumentation.m2729e(TAG, "InternalListener exception in onFinalImageSet", e);
                }
            } catch (IndexOutOfBoundsException unused) {
                return;
            }
        ...
        for (int i = 0; i < size; i++) {
            try {
                try {
                    ...
                    LogInstrumentation.m2729e(TAG, "InternalListener exception in onFailure", e);
                }
            } catch (IndexOutOfBoundsException unused) {
                return;
            }
        ...
        for (int i = 0; i < size; i++) {
            try {
                try {
                    ...
                    LogInstrumentation.m2729e(TAG, "InternalListener exception in onRelease", e);
                }
            } catch (IndexOutOfBoundsException unused) {
                return;
            }
        ...
        for (int i = 0; i < size; i++) {
            try {
                try {
                    ...
                    LogInstrumentation.m2729e(TAG, "InternalListener exception in onIntermediateImageSet", e);
                }
            } catch (IndexOutOfBoundsException unused) {
                return;
            }
        ...
        for (int i = 0; i < size; i++) {
            try {
                try {
                    ...
                    LogInstrumentation.m2729e(TAG, "InternalListener exception in onIntermediateImageFailed", e);
                }
            } catch (IndexOutOfBoundsException unused) {
                return;
            }
        ...
        for (int i = 0; i < size; i++) {
            try {
                try {
                    ...
                    LogInstrumentation.m2729e(TAG, "InternalListener exception in onEmptyEvent", e);
                }
            } catch (IndexOutOfBoundsException unused) {
                return;
            }
