...
public class PlatformCollatorAndroid implements IPlatformCollator {
    ...
    /* JADX INFO: renamed from: com.facebook.hermes.intl.PlatformCollatorAndroid$1 */
    static /* synthetic */ class C17331 {

        /* JADX INFO: renamed from: $SwitchMap$com$facebook$hermes$intl$IPlatformCollator$Sensitivity */
        static final /* synthetic */ int[] f2100x17be7a55;
        ...
        static {
            ...
            try {
                f2100x17be7a55[IPlatformCollator.Sensitivity.ACCENT.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f2100x17be7a55[IPlatformCollator.Sensitivity.VARIANT.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f2100x17be7a55[IPlatformCollator.Sensitivity.CASE.ordinal()] = 4;
    ...
    public IPlatformCollator setSensitivity(IPlatformCollator.Sensitivity sensitivity) {
        int i = C17331.f2100x17be7a55[sensitivity.ordinal()];
        if (i == 1) {
