...
public class PlatformNumberFormatterICU implements IPlatformNumberFormatter {
    ...
    public PlatformNumberFormatterICU setSignDisplay(IPlatformNumberFormatter.SignDisplay signDisplay) {
        ...
        if (numberFormat instanceof DecimalFormat) {
            DecimalFormat decimalFormat = (DecimalFormat) numberFormat;
            DecimalFormatSymbols decimalFormatSymbols = decimalFormat.getDecimalFormatSymbols();
            int i = C17371.f2105xa920794a[signDisplay.ordinal()];
            if (i == 1) {
    ...
    /* JADX INFO: renamed from: com.facebook.hermes.intl.PlatformNumberFormatterICU$1 */
    static /* synthetic */ class C17371 {
        ...
        static final /* synthetic */ int[] f2105xa920794a;
        ...
        static {
            ...
            try {
                f2105xa920794a[IPlatformNumberFormatter.SignDisplay.ALWAYS.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f2105xa920794a[IPlatformNumberFormatter.SignDisplay.EXCEPTZERO.ordinal()] = 3;
