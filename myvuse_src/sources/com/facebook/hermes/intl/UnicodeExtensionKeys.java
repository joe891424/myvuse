...
public class UnicodeExtensionKeys {
    ...
    private static Map<String, String[]> s_validKeywords = new HashMap<String, String[]>() { // from class: com.facebook.hermes.intl.UnicodeExtensionKeys.6
        {
            ...
            put(OTCCPAGeolocationConstants.f4105CA, new String[]{"buddhist", "chinese", "coptic", "dangi", "ethioaa", "ethiopic", "gregory", "hebrew", "indian", "islamic", "islamic-umalqura", "islamic-tbla", "islamic-civil", "islamic-rgsa", "iso8601", "japanese", "persian", "roc"});
        }
    };
    ...
    public static boolean isValidKeyword(String str, String str2, ILocaleObject iLocaleObject) throws JSRangeErrorException {
        ...
        if (str.equals("co")) {
            ...
            availableNames = RuleBasedCollator.getKeywordValuesForLocale("co", uLocale, false);
        } else if (str.equals(OTCCPAGeolocationConstants.f4105CA)) {
            availableNames = Calendar.getKeywordValuesForLocale(OTCCPAGeolocationConstants.f4105CA, uLocale, false);
