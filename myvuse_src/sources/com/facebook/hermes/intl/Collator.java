...
public class Collator {
    ...
    private void initializeCollator(List<String> list, Map<String, Object> map) throws JSRangeErrorException {
        ...
        HashMap<String, Object> mapResolveLocale = LocaleResolver.resolveLocale(list, objNewObject, Arrays.asList("co", Constants.COLLATION_EXTENSION_PARAM_CASEFIRST_SHORT, Constants.COLLATION_EXTENSION_PARAM_NUMERIC_SHORT));
        ...
        Object objGet = JSObjects.Get(mapResolveLocale, "co");
