...
public abstract class CloseableReference<T> implements Cloneable, Closeable {
    ...
    private static final LeakHandler DEFAULT_LEAK_HANDLER = new LeakHandler() { // from class: com.facebook.common.references.CloseableReference.2
        ...
        public void reportLeak(SharedReference<Object> sharedReference, @Nullable Throwable th) {
            ...
            FLog.m1315w((Class<?>) CloseableReference.TAG, "Finalized without closing: %x %x (type = %s)", Integer.valueOf(System.identityHashCode(this)), Integer.valueOf(System.identityHashCode(sharedReference)), obj == null ? null : obj.getClass().getName());
        }
    };
    ...
    public abstract CloseableReference<T> mo5955clone();
    ...
    public static CloseableReference m1331of(Closeable closeable) {
        return m1333of(closeable, DEFAULT_CLOSEABLE_RELEASER);
    }

    /* JADX INFO: renamed from: of */
    public static <T> CloseableReference<T> m1333of(T t, ResourceReleaser<T> resourceReleaser) {
        return m1334of(t, resourceReleaser, DEFAULT_LEAK_HANDLER);
    }
    ...
    /* JADX INFO: renamed from: of */
    public static CloseableReference m1332of(@Nullable Closeable closeable, LeakHandler leakHandler) {
        if (closeable == null) {
            return null;
        }
        return m1335of(closeable, DEFAULT_CLOSEABLE_RELEASER, leakHandler, leakHandler.requiresStacktrace() ? new Throwable() : null);
    }

    /* JADX INFO: renamed from: of */
    public static <T> CloseableReference<T> m1334of(T t, ResourceReleaser<T> resourceReleaser, LeakHandler leakHandler) {
        if (t == null) {
            return null;
        }
        return m1335of(t, resourceReleaser, leakHandler, leakHandler.requiresStacktrace() ? new Throwable() : null);
    }

    /* JADX INFO: renamed from: of */
    public static <T> CloseableReference<T> m1335of(T t, ResourceReleaser<T> resourceReleaser, LeakHandler leakHandler, @Nullable Throwable th) {
        if (t == null) {
            return null;
        }
