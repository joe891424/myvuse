...
public class MimeTypeMapWrapper {
    ...
    private static final Map<String, String> sMimeTypeToExtensionMap = ImmutableMap.m1250of("image/heif", "heif", "image/heic", "heic");
    private static final Map<String, String> sExtensionToMimeTypeMap = ImmutableMap.m1250of("heif", "image/heif", "heic", "image/heic");
