...
public final /* data */ class InitialQuestionTheme {
    ...
    public final InitialQuestionTheme copy(int color, FontTheme initialQuestion) {
        Intrinsics.checkNotNullParameter(initialQuestion, "initialQuestion");
        return new InitialQuestionTheme(color, initialQuestion);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof InitialQuestionTheme)) {
            return false;
        }
        InitialQuestionTheme initialQuestionTheme = (InitialQuestionTheme) other;
    ...
    public InitialQuestionTheme(int i, FontTheme initialQuestion) {
        Intrinsics.checkNotNullParameter(initialQuestion, "initialQuestion");
        this.color = i;
