...
public final class UploadErrorToViewDataMapper implements Mapper<Throwable, YdsFailure> {
    ...
    @Inject
    public UploadErrorToViewDataMapper(ExceptionToFailureMapper exceptionToFailureMapper) {
    ...
    public YdsFailure map(Throwable from) {
        ...
        return from instanceof YotiDocsUnprocessableMediaError ? new YdsFailure(new UnprocessableMedia(0, 0, 3, null), ((YotiDocsUnprocessableMediaError) from).getF7491a(), from) : this.exceptionToFailureMapper.map(from);
    }
}
