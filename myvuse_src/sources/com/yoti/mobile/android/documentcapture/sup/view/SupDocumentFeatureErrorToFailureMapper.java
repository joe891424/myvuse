...
public final class SupDocumentFeatureErrorToFailureMapper implements Mapper<Throwable, YdsFailure> {
    ...
    public YdsFailure map(Throwable from) {
        ...
        return from instanceof DocumentFeatureError.DocumentNotOwnedError ? new YdsFailure(SupDocumentNotOwnedFailureType.INSTANCE, ((DocumentFeatureError.DocumentNotOwnedError) from).getF7491a(), from) : from instanceof DocumentFeatureError.DocumentCountryNotListedError ? new YdsFailure(SupDocumentCountryNotListedFailureType.INSTANCE, ((DocumentFeatureError.DocumentCountryNotListedError) from).getF7491a(), from) : this.documentFeatureErrorToFailureMapper.map(from);
    }
}
