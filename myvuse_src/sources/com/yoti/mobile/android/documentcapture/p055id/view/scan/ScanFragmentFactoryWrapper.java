...
public final class ScanFragmentFactoryWrapper implements IScanFragmentFactoryWrapper {
    ...
    public IScanDocument create(DocumentScanDetailedConfig scanConfig, IdScanConfigurationViewData viewConfig, BlinkIDLicense blinkIdLicence, int scanLayout, ImageFormat imageFormat) {
        ...
        return ScanFragmentFactory.INSTANCE.getScanFragmentInstance(scanConfig, viewConfig, blinkIdLicence, scanLayout, imageFormat);
    }
}
