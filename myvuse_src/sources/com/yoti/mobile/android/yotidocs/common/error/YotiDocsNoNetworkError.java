...
public final /* data */ class YotiDocsNoNetworkError extends YotiDocsError {
    ...
    public static /* synthetic */ YotiDocsNoNetworkError copy$default(YotiDocsNoNetworkError yotiDocsNoNetworkError, Throwable th, int i, Object obj) {
        if ((i & 1) != 0) {
            th = yotiDocsNoNetworkError.f7494b;
        }
        return yotiDocsNoNetworkError.copy(th);
    }

    /* JADX INFO: renamed from: component1, reason: from getter */
    public final Throwable getF7494b() {
        return this.f7494b;
    }
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof YotiDocsNoNetworkError) && Intrinsics.areEqual(this.f7494b, ((YotiDocsNoNetworkError) other).f7494b);
    }
    ...
    public String toString() {
        return "YotiDocsNoNetworkError(error=" + this.f7494b + ')';
    }
}
