...
public final class LivenessUploadErrorToFailureMapper implements Mapper<Throwable, YdsFailure> {
    ...
    public YdsFailure map(Throwable from) {
        ...
        return from instanceof LivenessValidationError ? new YdsFailure(LivenessUploadValidationFailure.INSTANCE, false, from, 2, null) : this.exceptionToFailureMapper.map(from);
    }
}
