...
/* JADX INFO: renamed from: com.yoti.mobile.android.documentscan.a.a.e.a */
/* JADX INFO: loaded from: classes5.dex */
public final class C4707a extends AbstractC4696a<MrtdRecognizer.Result> {

    /* JADX INFO: renamed from: a */
    private final BlinkDateUtils f6875a;

    /* JADX INFO: renamed from: b */
    private final C4704b f6876b;

    public C4707a(BlinkDateUtils blinkDateUtils, C4704b coreDocumentTypeMapper) {
        ...
        this.f6875a = blinkDateUtils;
        this.f6876b = coreDocumentTypeMapper;
    }

    /* JADX INFO: renamed from: a */
    private final Country m4754a(String str) {
        return new Country(str);
    }

    /* JADX INFO: renamed from: a */
    private final DateResult m4755a(Date date) {
        if (date != null) {
            return new DateResult(this.f6875a.m4782a(date));
        }
        return null;
    }
    ...
    */
    private final com.yoti.mobile.android.documentscan.model.result.Gender m4756b(java.lang.String r3) {
        /*
            r2 = this;
            if (r3 != 0) goto L4
            goto L6a
        ...
        L6b:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.yoti.mobile.android.documentscan.domain.p059a.p064e.C4707a.m4756b(java.lang.String):com.yoti.mobile.android.documentscan.model.result.Gender");
    }

    @Override // com.yoti.mobile.android.documentscan.domain.AbstractC4696a
    /* JADX INFO: renamed from: a, reason: merged with bridge method [inline-methods] */
    public Address mo4706a(MrtdRecognizer.Result result) {
        return null;
    }

    @Override // com.yoti.mobile.android.documentscan.domain.AbstractC4696a
    /* JADX INFO: renamed from: b, reason: merged with bridge method [inline-methods] */
    public DocumentData mo4707b(MrtdRecognizer.Result result) {
        MrzResult mrzResult;
        ...
        DateResult dateResultM4755a = m4755a(dateOfExpiry.getDate());
        Country countryM4754a = m4754a(mrzResult.getIssuer());
        String documentNumber = mrzResult.getDocumentNumber();
        MrzData mrzDataM4761a = C4708b.m4761a(mrzResult);
        C4704b c4704b = this.f6876b;
        ...
        return new DocumentData(null, dateResultM4755a, countryM4754a, null, documentNumber, mrzDataM4761a, null, c4704b.m4752a(documentType), 64, null);
    }

    @Override // com.yoti.mobile.android.documentscan.domain.AbstractC4696a
    /* JADX INFO: renamed from: c, reason: merged with bridge method [inline-methods] */
    public Holder mo4708c(MrtdRecognizer.Result result) {
        return null;
    }

    @Override // com.yoti.mobile.android.documentscan.domain.AbstractC4696a
    /* JADX INFO: renamed from: d, reason: merged with bridge method [inline-methods] */
    public Holder mo4709d(MrtdRecognizer.Result result) {
        MrzResult mrzResult;
        if (result == null || (mrzResult = result.getMrzResult()) == null) {
            return null;
        }
        ...
        return new Holder(null, null, secondaryId, null, primaryId, null, null, m4755a(dateOfBirth.getDate()), null, m4756b(mrzResult.getGender()), m4754a(mrzResult.getNationality()));
    }
}
