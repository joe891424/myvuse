package com.yoti.mobile.android.facecapture.view.capture.view;
...
public class MaskableFrameLayout extends FrameLayout {
    ...
    private void registerMeasure() {
        ...
        viewTreeObserver.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.yoti.mobile.android.facecapture.view.capture.view.MaskableFrameLayout.1
