...
final class SFMCSdk$Companion$configure$1$3$2$4 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke2() {
        ...
        cdpModule$sfmcsdk_release.initModule(context, config, sFMCSdkComponents, new ModuleReadyListener() { // from class: com.salesforce.marketingcloud.sfmcsdk.SFMCSdk$Companion$configure$1$3$2$4$$ExternalSyntheticLambda0
            ...
            public final void ready(ModuleInterface moduleInterface) {
                SFMCSdk$Companion$configure$1$3$2$4.m6733invoke$lambda1(countDownLatch, config, moduleInterface);
            }
        });
    }
    ...
    public static final void m6733invoke$lambda1(CountDownLatch moduleInitLatch, final Config config, ModuleInterface module) {
        ...
        SFMCSdkLogger.INSTANCE.mo3976d("~$SFMCSdk", new Function0<String>() { // from class: com.salesforce.marketingcloud.sfmcsdk.SFMCSdk$Companion$configure$1$3$2$4$1$1$1
            {
                super(0);
            }
