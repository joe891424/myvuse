...
public class ScreenViewManager extends ViewGroupManager<Screen> implements RNSScreenManagerInterface<Screen> {
    ...
    */
    ...
    public Map<String, Object> getExportedCustomDirectEventTypeConstants() {
        return MapsKt.mutableMapOf(TuplesKt.m5605to(ScreenDismissedEvent.EVENT_NAME, MapBuilder.m1349of("registrationName", "onDismissed")), TuplesKt.m5605to(ScreenWillAppearEvent.EVENT_NAME, MapBuilder.m1349of("registrationName", "onWillAppear")), TuplesKt.m5605to(ScreenAppearEvent.EVENT_NAME, MapBuilder.m1349of("registrationName", "onAppear")), TuplesKt.m5605to(ScreenWillDisappearEvent.EVENT_NAME, MapBuilder.m1349of("registrationName", "onWillDisappear")), TuplesKt.m5605to(ScreenDisappearEvent.EVENT_NAME, MapBuilder.m1349of("registrationName", "onDisappear")), TuplesKt.m5605to(HeaderHeightChangeEvent.EVENT_NAME, MapBuilder.m1349of("registrationName", "onHeaderHeightChange")), TuplesKt.m5605to(HeaderBackButtonClickedEvent.EVENT_NAME, MapBuilder.m1349of("registrationName", "onHeaderBackButtonClicked")), TuplesKt.m5605to(ScreenTransitionProgressEvent.EVENT_NAME, MapBuilder.m1349of("registrationName", "onTransitionProgress")));
    }
