...
public final class ScreenStackHeaderConfigViewManager extends ViewGroupManager<ScreenStackHeaderConfig> implements RNSScreenStackHeaderConfigManagerInterface<ScreenStackHeaderConfig> {
    ...
    public Map<String, Object> getExportedCustomDirectEventTypeConstants() {
        return MapBuilder.m1350of(HeaderAttachedEvent.EVENT_NAME, MapBuilder.m1349of("registrationName", "onAttached"), HeaderDetachedEvent.EVENT_NAME, MapBuilder.m1349of("registrationName", "onDetached"));
    }
    ...
    private final void logNotAvailable(String propName) {
        LogInstrumentation.m2734w("RN SCREENS", propName + " prop is not available on Android");
    }
