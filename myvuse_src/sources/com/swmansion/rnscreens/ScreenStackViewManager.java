...
public final class ScreenStackViewManager extends ViewGroupManager<ScreenStack> implements RNSScreenStackManagerInterface<ScreenStack> {
    ...
    public Map<String, Object> getExportedCustomDirectEventTypeConstants() {
        return MapsKt.mutableMapOf(TuplesKt.m5605to(StackFinishTransitioningEvent.EVENT_NAME, MapsKt.mutableMapOf(TuplesKt.m5605to("registrationName", "onFinishTransitioning"))));
    }
}
