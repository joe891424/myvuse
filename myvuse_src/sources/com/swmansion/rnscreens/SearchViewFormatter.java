...
public final class SearchViewFormatter {
    ...
    private final EditText getSearchEditText() {
        View viewFindViewById = this.searchView.findViewById(C0261R.id.search_src_text);
    ...
    private final View getSearchTextPlate() {
        return this.searchView.findViewById(C0261R.id.search_plate);
    }

    private final ImageView getSearchIcon() {
        return (ImageView) this.searchView.findViewById(C0261R.id.search_button);
    }

    private final ImageView getSearchCloseIcon() {
        return (ImageView) this.searchView.findViewById(C0261R.id.search_close_btn);
    }
