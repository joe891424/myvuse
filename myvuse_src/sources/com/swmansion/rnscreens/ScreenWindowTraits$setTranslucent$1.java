...
@Metadata(m5597d1 = {"\u0000\u0011\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\b\u0010\u0002\u001a\u00020\u0003H\u0017¨\u0006\u0004"}, m5598d2 = {"com/swmansion/rnscreens/ScreenWindowTraits$setTranslucent$1", "Lcom/facebook/react/bridge/GuardedRunnable;", "runGuarded", "", "react-native-screens_release"}, m5599k = 1, m5600mv = {1, 9, 0}, m5602xi = 48)
public final class ScreenWindowTraits$setTranslucent$1 extends GuardedRunnable {
    ...
    public static final WindowInsetsCompat runGuarded$lambda$0(View v, WindowInsetsCompat insets) {
        ...
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            return new WindowInsetsCompat.Builder().setInsets(WindowInsetsCompat.Type.statusBars(), Insets.m1175of(insets2.left, 0, insets2.right, insets2.bottom)).build();
        }
