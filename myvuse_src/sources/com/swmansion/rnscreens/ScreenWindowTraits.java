...
public final class ScreenWindowTraits {
    ...
    public final void setColor$react_native_screens_release(Screen screen, Activity activity, ReactContext context) {
        ...
        UiThreadUtil.runOnUiThread(new ScreenWindowTraits$setColor$1(context, activity, statusBarColor, (screenFindScreenForTrait2 == null || (isStatusBarAnimated = screenFindScreenForTrait2.getIsStatusBarAnimated()) == null) ? false : isStatusBarAnimated.booleanValue()));
    }
    ...
    public final void setTranslucent$react_native_screens_release(Screen screen, Activity activity, ReactContext context) {
        ...
        UiThreadUtil.runOnUiThread(new ScreenWindowTraits$setTranslucent$1(context, activity, (screenFindScreenForTrait == null || (isStatusBarTranslucent = screenFindScreenForTrait.getIsStatusBarTranslucent()) == null) ? false : isStatusBarTranslucent.booleanValue()));
    }
