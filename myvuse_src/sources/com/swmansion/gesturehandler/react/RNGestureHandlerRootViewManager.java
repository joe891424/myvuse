...
public final class RNGestureHandlerRootViewManager extends ViewGroupManager<RNGestureHandlerRootView> implements RNGestureHandlerRootViewManagerInterface<RNGestureHandlerRootView> {
    ...
    public Map<String, Map<String, String>> getExportedCustomDirectEventTypeConstants() {
        return MapsKt.mutableMapOf(TuplesKt.m5605to("onGestureHandlerEvent", MapsKt.mutableMapOf(TuplesKt.m5605to("registrationName", "onGestureHandlerEvent"))), TuplesKt.m5605to(RNGestureHandlerStateChangeEvent.EVENT_NAME, MapsKt.mutableMapOf(TuplesKt.m5605to("registrationName", RNGestureHandlerStateChangeEvent.EVENT_NAME))));
    }
}
