    ...
    class InstallReferrerStateListenerProxy implements InvocationHandler {
        ...
        public void onInstallReferrerSetupFinished(int i) {
            if (i == 0) {
                ...
                LogInstrumentation.m2726d("InstallReferrerState", "SERVICE_UNAVAILABLE");
            } else {
                if (i != 2) {
                    return;
                }
                LogInstrumentation.m2726d("InstallReferrerState", "FEATURE_NOT_SUPPORTED");
            }
        }
        ...
        public /* synthetic */ void lambda$onInstallReferrerSetupFinished$0() {
            try {
                LogInstrumentation.m2726d("InstallReferrerState", "OK");
        ...
        public void onInstallReferrerServiceDisconnected() {
            LogInstrumentation.m2726d("RNInstallReferrerClient", "InstallReferrerService disconnected");
        }
    }
}
