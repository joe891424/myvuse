...
public class MapPolygon extends MapFeature {
    ...
    public void setCoordinates(ReadableArray readableArray) {
        ...
        for (int i = 0; i < readableArray.size(); i++) {
            ...
            this.coordinates.add(i, new LatLng(map.getDouble(C4349h.a.f5610b), map.getDouble(C4349h.a.f5611c)));
        }
        ...
        for (int i = 0; i < readableArray.size(); i++) {
            ...
            if (array.size() >= 3) {
                ...
                for (int i2 = 0; i2 < array.size(); i2++) {
                    ...
                    arrayList.add(new LatLng(map.getDouble(C4349h.a.f5610b), map.getDouble(C4349h.a.f5611c)));
                }
                if (arrayList.size() == 3) {
