...
public class MapManager extends ViewGroupManager<MapView> {
    ...
    private final Map<String, Integer> MAP_TYPES = MapBuilder.m1353of(Constants.COLLATION_STANDARD, 1, "satellite", 2, "hybrid", 4, "terrain", 3, "none", 0);
    private final Map<String, Integer> MY_LOCATION_PRIORITY = MapBuilder.m1352of("balanced", 102, "high", 100, "low", 104, "passive", 105);
        ...
        switch (str) {
            ...
            case "animateToRegion":
                if (readableArray != null) {
                    ...
                    double d = map.getDouble(C4349h.a.f5611c);
                    double d2 = map.getDouble(C4349h.a.f5610b);
    ...
    public Map getExportedCustomDirectEventTypeConstants() {
        Map mapM1353of = MapBuilder.m1353of("onMapReady", MapBuilder.m1349of("registrationName", "onMapReady"), "onPress", MapBuilder.m1349of("registrationName", "onPress"), "onLongPress", MapBuilder.m1349of("registrationName", "onLongPress"), "onMarkerPress", MapBuilder.m1349of("registrationName", "onMarkerPress"), "onCalloutPress", MapBuilder.m1349of("registrationName", "onCalloutPress"));
        mapM1353of.putAll(MapBuilder.m1355of("onUserLocationChange", MapBuilder.m1349of("registrationName", "onUserLocationChange"), "onMarkerDragStart", MapBuilder.m1349of("registrationName", "onMarkerDragStart"), "onMarkerDrag", MapBuilder.m1349of("registrationName", "onMarkerDrag"), "onMarkerDragEnd", MapBuilder.m1349of("registrationName", "onMarkerDragEnd"), "onPanDrag", MapBuilder.m1349of("registrationName", "onPanDrag"), "onKmlReady", MapBuilder.m1349of("registrationName", "onKmlReady"), "onPoiClick", MapBuilder.m1349of("registrationName", "onPoiClick")));
        mapM1353of.putAll(MapBuilder.m1354of("onIndoorLevelActivated", MapBuilder.m1349of("registrationName", "onIndoorLevelActivated"), "onIndoorBuildingFocused", MapBuilder.m1349of("registrationName", "onIndoorBuildingFocused"), "onDoublePress", MapBuilder.m1349of("registrationName", "onDoublePress"), "onMapLoaded", MapBuilder.m1349of("registrationName", "onMapLoaded"), "onMarkerSelect", MapBuilder.m1349of("registrationName", "onMarkerSelect"), "onMarkerDeselect", MapBuilder.m1349of("registrationName", "onMarkerDeselect")));
        return mapM1353of;
    }
