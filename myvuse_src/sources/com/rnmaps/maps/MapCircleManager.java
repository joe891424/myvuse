...
public class MapCircleManager extends ViewGroupManager<MapCircle> {
    ...
    @ReactProp(name = RadialGradientManager.PROP_CENTER)
    public void setCenter(MapCircle mapCircle, ReadableMap readableMap) {
        mapCircle.setCenter(new LatLng(readableMap.getDouble(C4349h.a.f5610b), readableMap.getDouble(C4349h.a.f5611c)));
    }

    @ReactProp(defaultDouble = 0.0d, name = RadialGradientManager.PROP_RADIUS)
