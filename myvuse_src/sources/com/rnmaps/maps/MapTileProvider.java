...
public class MapTileProvider implements TileProvider {
    ...
    byte[] getTileImage(int i, int i2, int i3) throws Throwable {
        ...
        if (this.tileCachePath != null) {
            ...
            if (bArrFetchTile != null) {
                LogInstrumentation.m2726d("urlTile", "tile cache HIT for " + i3 + "/" + i + "/" + i2);
            } else {
                LogInstrumentation.m2726d("urlTile", "tile cache MISS for " + i3 + "/" + i + "/" + i2);
            }
        ...
        if (bArrFetchTile == null && !this.offlineMode && this.tileCachePath != null) {
            ...
            try {
                ...
                Thread.sleep(500L);
                LogInstrumentation.m2726d("urlTile: ", workManager.getWorkInfosByTag(tileFilename).get(1L, TimeUnit.SECONDS).get(0).toString());
                if (this.tileCachePath != null) {
                    bArrFetchTile = readTileImage(i, i2, i3);
                    if (bArrFetchTile != null) {
                        LogInstrumentation.m2726d("urlTile", "tile cache fetch HIT for " + i3 + "/" + i + "/" + i2);
                    } else {
                        LogInstrumentation.m2726d("urlTile", "tile cache fetch MISS for " + i3 + "/" + i + "/" + i2);
                    }
                }
            } catch (Exception e) {
                e.printStackTrace();
            ...
            LogInstrumentation.m2726d("urlTile", "Normal fetch");
            bArrFetchTile = fetchTile(i, i2, i3);
            if (bArrFetchTile == null) {
                LogInstrumentation.m2726d("urlTile", "tile fetch TIMEOUT / FAIL for " + i3 + "/" + i + "/" + i2);
            }
        }
    ...
    byte[] pullTilesFromHigherZoom(int i, int i2, int i3) throws Throwable {
        ...
        Bitmap bitmapDecodeByteArray = BitmapFactoryInstrumentation.decodeByteArray(tileImage, 0, tileImage.length);
        canvas.drawBitmap(bitmapDecodeByteArray, 0.0f, 0.0f, paint);
        bitmapDecodeByteArray.recycle();
        Bitmap bitmapDecodeByteArray2 = BitmapFactoryInstrumentation.decodeByteArray(tileImage2, 0, tileImage2.length);
        canvas.drawBitmap(bitmapDecodeByteArray2, 0.0f, 256.0f, paint);
        bitmapDecodeByteArray2.recycle();
        Bitmap bitmapDecodeByteArray3 = BitmapFactoryInstrumentation.decodeByteArray(tileImage3, 0, tileImage3.length);
        canvas.drawBitmap(bitmapDecodeByteArray3, 256.0f, 0.0f, paint);
        bitmapDecodeByteArray3.recycle();
        Bitmap bitmapDecodeByteArray4 = BitmapFactoryInstrumentation.decodeByteArray(tileImage4, 0, tileImage4.length);
    ...
    void checkForRefresh(int i, int i2, int i3) {
        ...
        if ((System.currentTimeMillis() - new File(tileFilename).lastModified()) / 1000 > this.tileCacheMaxAge) {
            LogInstrumentation.m2726d("urlTile", "Refreshing");
    ...
    */
    byte[] fetchTile(int r7, int r8, int r9) throws java.lang.Throwable {
        /*
            ...
            r8 = 0
            java.net.URLConnection r7 = r7.openConnection()     // Catch: java.lang.Throwable -> L4a java.lang.OutOfMemoryError -> L4f java.io.IOException -> L51
            java.net.URLConnection r7 = com.newrelic.agent.android.instrumentation.URLConnectionInstrumentation.openConnection(r7)     // Catch: java.lang.Throwable -> L4a java.lang.OutOfMemoryError -> L4f java.io.IOException -> L51
            java.lang.Object r7 = com.google.firebase.perf.network.FirebasePerfUrlConnection.instrument(r7)     // Catch: java.lang.Throwable -> L4a java.lang.OutOfMemoryError -> L4f java.io.IOException -> L51
            java.net.URLConnection r7 = (java.net.URLConnection) r7     // Catch: java.lang.Throwable -> L4a java.lang.OutOfMemoryError -> L4f java.io.IOException -> L51
            java.io.InputStream r7 = r7.getInputStream()     // Catch: java.lang.Throwable -> L4a java.lang.OutOfMemoryError -> L4f java.io.IOException -> L51
            java.io.ByteArrayOutputStream r9 = new java.io.ByteArrayOutputStream     // Catch: java.lang.Throwable -> L40 java.lang.OutOfMemoryError -> L45 java.io.IOException -> L47
            r9.<init>()     // Catch: java.lang.Throwable -> L40 java.lang.OutOfMemoryError -> L45 java.io.IOException -> L47
            r0 = 16384(0x4000, float:2.2959E-41)
            byte[] r1 = new byte[r0]     // Catch: java.lang.OutOfMemoryError -> L3c java.io.IOException -> L3e java.lang.Throwable -> L62
        L20:
            r2 = 0
            int r3 = r7.read(r1, r2, r0)     // Catch: java.lang.OutOfMemoryError -> L3c java.io.IOException -> L3e java.lang.Throwable -> L62
            r4 = -1
            if (r3 == r4) goto L2c
            r9.write(r1, r2, r3)     // Catch: java.lang.OutOfMemoryError -> L3c java.io.IOException -> L3e java.lang.Throwable -> L62
            goto L20
        L2c:
            r9.flush()     // Catch: java.lang.OutOfMemoryError -> L3c java.io.IOException -> L3e java.lang.Throwable -> L62
            byte[] r8 = r9.toByteArray()     // Catch: java.lang.OutOfMemoryError -> L3c java.io.IOException -> L3e java.lang.Throwable -> L62
            if (r7 == 0) goto L38
