...
class RNSVGMarkerPosition {
    ...
    private static double SlopeAngleRadians(Point point) {
        return Math.atan2(point.f3995y, point.f3994x);
    }
    ...
    private static double CurrentAngle(RNSVGMarkerType rNSVGMarkerType) {
        ...
        int i = C35851.$SwitchMap$com$horcrux$svg$RNSVGMarkerType[rNSVGMarkerType.ordinal()];
        if (i == 1) {
    ...
    private static Point subtract(Point point, Point point2) {
        return new Point(point2.f3994x - point.f3994x, point2.f3995y - point.f3995y);
    }

    private static boolean isZero(Point point) {
        return point.f3994x == 0.0d && point.f3995y == 0.0d;
    }
    ...
    private static SegmentData ExtractPathElementFeatures(PathElement pathElement) {
        ...
        int i = C35851.$SwitchMap$com$horcrux$svg$ElementType[pathElement.type.ordinal()];
        if (i == 1) {
    ...
    /* JADX INFO: renamed from: com.horcrux.svg.RNSVGMarkerPosition$1 */
    static /* synthetic */ class C35851 {
