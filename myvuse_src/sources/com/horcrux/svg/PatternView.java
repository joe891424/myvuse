...
class PatternView extends GroupView {
    ...
    private SVGLength f3991mW;

    /* JADX INFO: renamed from: mX */
    private SVGLength f3992mX;

    /* JADX INFO: renamed from: mY */
    private SVGLength f3993mY;
    ...
    public void setX(Dynamic dynamic) {
        this.f3992mX = SVGLength.from(dynamic);
        invalidate();
    }

    @ReactProp(name = EllipticCurveJsonWebKey.Y_MEMBER_NAME)
    public void setY(Dynamic dynamic) {
        this.f3993mY = SVGLength.from(dynamic);
        invalidate();
    }

    @ReactProp(name = "width")
    public void setWidth(Dynamic dynamic) {
        this.f3991mW = SVGLength.from(dynamic);
        invalidate();
    }

    @ReactProp(name = "height")
    public void setHeight(Dynamic dynamic) {
        this.f3990mH = SVGLength.from(dynamic);
        invalidate();
    }
    ...
    void saveDefinition() {
        if (this.mName != null) {
            Brush brush = new Brush(Brush.BrushType.PATTERN, new SVGLength[]{this.f3992mX, this.f3993mY, this.f3991mW, this.f3990mH}, this.mPatternUnits);
