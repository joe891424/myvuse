...
public abstract class VirtualView extends ReactViewGroup {
    ...
    public void setMatrix(Dynamic dynamic) {
        ...
        if (!dynamic.isNull() && type.equals(ReadableType.Array)) {
            ...
            int matrixData = PropHelper.toMatrixData(readableArrayAsArray, fArr, this.mScale);
            if (matrixData == 6) {
    ...
    Path getClipPath(Canvas canvas, Paint paint) {
        if (this.mClipPath != null) {
            ...
            if (clipPathView == null) {
                FLog.m1317w(ReactConstants.TAG, "RNSVG: Undefined clipPath: " + this.mClipPath);
            } else {
                ...
                if (i == 0) {
                    ...
                    FLog.m1317w(ReactConstants.TAG, "RNSVG: clipRule: " + this.mClipRule + " unrecognized");
                }
    ...
    SvgView getSvgView() {
        ...
        if (parent instanceof SvgView) {
            ...
            FLog.m1277e(ReactConstants.TAG, "RNSVG: " + getClass().getName() + " should be descendant of a SvgView.");
        }
        return this.svgView;
    }
    ...
    private double fromRelativeFast(SVGLength sVGLength) {
        ...
        switch (C35941.$SwitchMap$com$horcrux$svg$SVGLength$UnitType[sVGLength.unit.ordinal()]) {
            case 1:
    ...
    void setClientRect(RectF rectF) {
        ...
        if (rectF2 == null || !rectF2.equals(rectF)) {
            ...
            if (this.mOnLayout) {
                ((UIManagerModule) this.mContext.getNativeModule(UIManagerModule.class)).getEventDispatcher().dispatchEvent(OnLayoutEvent.obtain(getId(), iFloor, iFloor2, iCeil, iCeil2));
            }
        }
    }
