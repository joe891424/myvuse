...
class GlyphContext {
    ...
    double nextX(double d) {
        ...
        if (i < sVGLengthArr.length) {
            this.mDX = 0.0d;
            this.mXIndex = i;
            this.f3977mX = PropHelper.fromRelative(sVGLengthArr[i], this.mWidth, 0.0d, this.mScale, this.mFontSize);
        }
        double d2 = this.f3977mX + d;
        this.f3977mX = d2;
        return d2;
    }
    ...
    double nextY() {
        ...
        if (i < sVGLengthArr.length) {
            this.mDY = 0.0d;
            this.mYIndex = i;
            this.f3978mY = PropHelper.fromRelative(sVGLengthArr[i], this.mHeight, 0.0d, this.mScale, this.mFontSize);
        }
        return this.f3978mY;
    }
