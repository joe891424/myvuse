...
public final class SafeAreaProviderManager extends ViewGroupManager<SafeAreaProvider> implements RNCSafeAreaProviderManagerInterface<SafeAreaProvider> {
    ...
    public Map<String, Map<String, String>> getExportedCustomDirectEventTypeConstants() {
        return MapsKt.mutableMapOf(TuplesKt.m5605to(InsetsChangeEvent.EVENT_NAME, MapsKt.mutableMapOf(TuplesKt.m5605to("registrationName", "onInsetsChange"))));
    }

    /* JADX INFO: renamed from: com.th3rdwave.safeareacontext.SafeAreaProviderManager$addEventEmitters$1 */
    /* JADX INFO: compiled from: SafeAreaProviderManager.kt */
    @Metadata(m5599k = 3, m5600mv = {1, 9, 0}, m5602xi = 48)
    /* synthetic */ class C44491 extends FunctionReferenceImpl implements Function3<SafeAreaProvider, EdgeInsets, Rect, Unit> {
    ...
    public void addEventEmitters(ThemedReactContext reactContext, SafeAreaProvider view) {
        ...
        view.setOnInsetsChangeHandler(C44491.INSTANCE);
    }
}
