...
public class RootBeer {
    ...
    public boolean checkForBinary(String str) {
        ...
        for (String str2 : Const.getPaths()) {
            ...
            if (new File(str2, str).exists()) {
                QLog.m4360v(str3 + " binary detected!");
                z = true;
            }
        }
        return z;
    ...
    private boolean isAnyPackageFromListInstalled(List<String> list) {
        ...
        for (String str : list) {
            try {
                ...
                QLog.m4357e(str + " ROOT management app detected!");
                z = true;
            ...
            for (String str2 : map.keySet()) {
                if (str.contains(str2)) {
                    ...
                    if (str.contains(str3)) {
                        QLog.m4360v(str2 + " = " + str3 + " detected!");
                        z = true;
                    }
                }
            }
    ...
    public boolean checkForRWPaths() {
        ...
        while (i2 < length) {
            ...
            if (strArrSplit.length < 6) {
                QLog.m4357e("Error formatting mount line: " + str);
            } else {
                    ...
                    if (str2.equalsIgnoreCase(str3)) {
                        ...
                        while (true) {
                            ...
                            if (strArrSplit2[i4].equalsIgnoreCase("rw")) {
                                QLog.m4360v(str3 + " path is mounted with rw permissions! " + str);
                                z = true;
                                break;
                            }
                            i4++;
    ...
    public boolean checkForRootNative() {
        if (!canLoadNativeLibrary()) {
            QLog.m4357e("We could not load the native library to test for root");
            return false;
        }
