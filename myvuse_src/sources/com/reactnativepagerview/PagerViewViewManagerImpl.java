...
public final class PagerViewViewManagerImpl {
    ...
    public final ViewPager2 getViewPager(NestedScrollableHost view) throws ClassNotFoundException {
    ...
    public final void addView(NestedScrollableHost host, View child, int index) throws ClassNotFoundException {
    ...
    public final void removeView(NestedScrollableHost parent, View view) throws ClassNotFoundException {
        Intrinsics.checkNotNullParameter(parent, "parent");
        Intrinsics.checkNotNullParameter(view, "view");
    ...
    public final void removeAllViews(NestedScrollableHost parent) throws ClassNotFoundException {
        Intrinsics.checkNotNullParameter(parent, "parent");
        ViewPager2 viewPager = getViewPager(parent);
    ...
    public final void removeViewAt(NestedScrollableHost parent, int index) throws ClassNotFoundException {
        Intrinsics.checkNotNullParameter(parent, "parent");
        ViewPager2 viewPager = getViewPager(parent);
        ViewPagerAdapter viewPagerAdapter = (ViewPagerAdapter) viewPager.getAdapter();
        if (viewPagerAdapter != null) {
    ...
    public final void setInitialPage(final NestedScrollableHost host, int value) throws ClassNotFoundException {
        Intrinsics.checkNotNullParameter(host, "host");
        ViewPager2 viewPager = getViewPager(host);
        if (host.getInitialIndex() == null) {
            ...
            viewPager.post(new Runnable() { // from class: com.reactnativepagerview.PagerViewViewManagerImpl$$ExternalSyntheticLambda2
                ...
                public final void run() {
                    PagerViewViewManagerImpl.setInitialPage$lambda$0(host);
                }
            });
        }
    }
