...
public final class PagerViewViewManager extends ViewGroupManager<NestedScrollableHost> {
    ...
    public Map<String, Map<String, String>> getExportedCustomDirectEventTypeConstants() {
        Map<String, Map<String, String>> mapM1351of = MapBuilder.m1351of(PageScrollEvent.EVENT_NAME, MapBuilder.m1349of("registrationName", "onPageScroll"), PageScrollStateChangedEvent.EVENT_NAME, MapBuilder.m1349of("registrationName", "onPageScrollStateChanged"), PageSelectedEvent.EVENT_NAME, MapBuilder.m1349of("registrationName", "onPageSelected"));
