...
public class AppReviewModule extends ReactContextBaseJavaModule implements ActivityEventListener {
    ...
    public void show(Promise promise) {
        ...
        if (isGooglePlayServicesAvailable()) {
            LogInstrumentation.m2728e("msg->GP", isGooglePlayServicesAvailable() + "");
            final ReviewManager reviewManagerCreate = ReviewManagerFactory.create(this.mContext);
            reviewManagerCreate.requestReviewFlow().addOnCompleteListener(new OnCompleteListener() { // from class: com.ibits.react_native_in_app_review.AppReviewModule$$ExternalSyntheticLambda0
    ...
    public void onActivityResult(Activity activity, int i, int i2, Intent intent) {
        if (i == 1001) {
            ...
            if (i2 == 106) {
                ...
                LogInstrumentation.m2728e("msg->107", "in-app commenting service is not supported");
            } else if (i2 == 108) {
                rejectPromiseHMS("108", new Error("The user canceled the comment"));
                LogInstrumentation.m2728e("msg->108", "user canceled");
            }
        }
    }
}
