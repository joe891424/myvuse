    ...
    private static Interceptor createInterceptor(final ResponseProgressListener responseProgressListener) {
        return new Interceptor() { // from class: com.dylanvann.fastimage.FastImageOkHttpProgressGlideModule.1
            ...
            public Response intercept(Interceptor.Chain chain) throws IOException {
                ...
                OkHttpProgressResponseBody okHttpProgressResponseBody = new OkHttpProgressResponseBody(url, responseProceed.body(), responseProgressListener);
                return (!(builderNewBuilder instanceof Response.Builder) ? builderNewBuilder.body(okHttpProgressResponseBody) : OkHttp3Instrumentation.body(builderNewBuilder, okHttpProgressResponseBody)).build();
            }
        };
    }
