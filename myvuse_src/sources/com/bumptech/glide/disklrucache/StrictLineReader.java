...
class StrictLineReader implements Closeable {
    ...
    private static final byte f2046CR = 13;

    /* JADX INFO: renamed from: LF */
    private static final byte f2047LF = 10;
    private byte[] buf;
    private final Charset charset;
    private int end;

    /* JADX INFO: renamed from: in */
    private final InputStream f2048in;
    private int pos;
    ...
    */
    public java.lang.String readLine() throws java.io.IOException {
        /*
            r7 = this;
            java.io.InputStream r0 = r7.f2048in
            monitor-enter(r0)
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f2048in;
        byte[] bArr = this.buf;
