...
public class RequestManagerRetriever implements Handler.Callback {
    ...
    public boolean handleMessage(Message message) {
        Object obj;
        TraceFieldInterface traceFieldInterfaceRemove;
        Object obj2;
        ...
        if (i == 1) {
            ...
            traceFieldInterfaceRemove = this.pendingRequestManagerFragments.remove(obj);
        } else if (i == 2) {
            obj = (androidx.fragment.app.FragmentManager) message.obj;
            traceFieldInterfaceRemove = this.pendingSupportRequestManagerFragments.remove(obj);
        } else {
            traceFieldInterface = null;
            z = false;
            obj2 = null;
            if (z && traceFieldInterface == null && Log.isLoggable(TAG, 5)) {
                LogInstrumentation.m2734w(TAG, "Failed to remove expected request manager fragment, manager: " + obj2);
            }
            return z;
        }
        TraceFieldInterface traceFieldInterface2 = traceFieldInterfaceRemove;
        obj2 = obj;
