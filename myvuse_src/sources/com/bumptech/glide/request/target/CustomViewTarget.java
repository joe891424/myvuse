...
import com.bumptech.glide.C1592R;
...
public abstract class CustomViewTarget<T extends View, Z> implements Target<Z> {
    ...
    private static final int VIEW_TAG_ID = C1592R.id.glide_custom_view_target_tag;
    ...
    static final class SizeDeterminer {
        ...
        private int getTargetDimen(int i, int i2, int i3) {
            ...
            if (Log.isLoggable(CustomViewTarget.TAG, 4)) {
                LogInstrumentation.m2730i(CustomViewTarget.TAG, "Glide treats LayoutParams.WRAP_CONTENT as a request for an image the size of this device's screen dimensions. If you want to load the original image and are ok with the corresponding memory cost and OOMs (depending on the input size), use .override(Target.SIZE_ORIGINAL). Otherwise, use LayoutParams.MATCH_PARENT, set layout_width and layout_height to fixed dimension, or use .override() with fixed dimensions.");
            }
        ...
        private static final class SizeDeterminerLayoutListener implements ViewTreeObserver.OnPreDrawListener {
            ...
            public boolean onPreDraw() {
                if (Log.isLoggable(CustomViewTarget.TAG, 2)) {
                    LogInstrumentation.m2732v(CustomViewTarget.TAG, "OnGlobalLayoutListener called attachStateListener=" + this);
                }
