...
public abstract class ViewTarget<T extends View, Z> extends BaseTarget<Z> {
    ...
    private static int tagId = C1592R.id.glide_custom_view_target_tag;
    ...
    static final class SizeDeterminer {
        ...
        private int getTargetDimen(int i, int i2, int i3) {
            ...
            if (Log.isLoggable(ViewTarget.TAG, 4)) {
                LogInstrumentation.m2730i(ViewTarget.TAG, "Glide treats LayoutParams.WRAP_CONTENT as a request for an image the size of this device's screen dimensions. If you want to load the original image and are ok with the corresponding memory cost and OOMs (depending on the input size), use override(Target.SIZE_ORIGINAL). Otherwise, use LayoutParams.MATCH_PARENT, set layout_width and layout_height to fixed dimension, or use .override() with fixed dimensions.");
            }
        ...
        private static final class SizeDeterminerLayoutListener implements ViewTreeObserver.OnPreDrawListener {
            ...
            public boolean onPreDraw() {
                if (Log.isLoggable(ViewTarget.TAG, 2)) {
                    LogInstrumentation.m2732v(ViewTarget.TAG, "OnGlobalLayoutListener called attachStateListener=" + this);
                }
