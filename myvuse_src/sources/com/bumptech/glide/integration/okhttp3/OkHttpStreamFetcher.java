...
public class OkHttpStreamFetcher implements DataFetcher<InputStream>, Callback {
    ...
    public void loadData(Priority priority, DataFetcher.DataCallback<? super InputStream> dataCallback) {
        ...
        this.call = !(factory instanceof OkHttpClient) ? factory.newCall(requestBuild) : OkHttp3Instrumentation.newCall((OkHttpClient) factory, requestBuild);
    ...
    public void onFailure(Call call, IOException iOException) {
        if (Log.isLoggable(TAG, 3)) {
            LogInstrumentation.m2727d(TAG, "OkHttp failed to obtain result", iOException);
        }
