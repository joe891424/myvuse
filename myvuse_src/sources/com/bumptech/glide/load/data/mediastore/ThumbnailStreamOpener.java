    ...
    int getOrientation(Uri uri) {
        ...
        try {
            ...
            if (Log.isLoggable(TAG, 3)) {
                LogInstrumentation.m2727d(TAG, "Failed to open uri: " + uri, e);
            }
            if (inputStreamOpenInputStream == null) {
                return -1;
            }
    ...
    */
    private java.lang.String getPath(android.net.Uri r7) throws java.lang.Throwable {
        ...
        L2a:
            ...
            com.newrelic.agent.android.instrumentation.LogInstrumentation.m2727d(r0, r7, r4)     // Catch: java.lang.Throwable -> L47
        L41:
            if (r3 == 0) goto L46
            r3.close()
        L46:
