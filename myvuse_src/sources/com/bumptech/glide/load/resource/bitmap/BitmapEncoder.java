        ...
        try {
            ...
            try {
                ...
                if (Log.isLoggable(TAG, 3)) {
                    LogInstrumentation.m2727d(TAG, "Failed to encode Bitmap", e);
                }
            ...
            if (Log.isLoggable(TAG, 2)) {
                LogInstrumentation.m2732v(TAG, "Compressed with type: " + format + " of size " + Util.getBitmapByteSize(bitmap) + " in " + LogTime.getElapsedMillis(logTime) + ", options format: " + options.get(COMPRESSION_FORMAT) + ", hasAlpha: " + bitmap.hasAlpha());
            }
            return z;
        } finally {
