...
public final class RoundedCorners extends BitmapTransformation {
    ...
    private static final String f2068ID = "com.bumptech.glide.load.resource.bitmap.RoundedCorners";
    private static final byte[] ID_BYTES = f2068ID.getBytes(CHARSET);
    ...
    @Override // com.bumptech.glide.load.Key
    public int hashCode() {
        return Util.hashCode(f2068ID.hashCode(), Util.hashCode(this.roundingRadius));
    }
