...
interface ImageReader {
    ...
    public static final class InputStreamImageReader implements ImageReader {
        ...
        public Bitmap decodeBitmap(BitmapFactory.Options options) throws IOException {
            return BitmapFactoryInstrumentation.decodeStream(this.dataRewinder.rewindAndGet(), null, options);
        }
    ...
    public static final class ParcelFileDescriptorImageReader implements ImageReader {
        ...
        @Override // com.bumptech.glide.load.resource.bitmap.ImageReader
        public Bitmap decodeBitmap(BitmapFactory.Options options) throws IOException {
            return BitmapFactoryInstrumentation.decodeFileDescriptor(this.dataRewinder.rewindAndGet().getFileDescriptor(), null, options);
        }
