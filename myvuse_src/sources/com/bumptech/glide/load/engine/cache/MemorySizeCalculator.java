...
public final class MemorySizeCalculator {
    ...
    MemorySizeCalculator(Builder builder) {
        ...
        if (Log.isLoggable(TAG, 3)) {
            LogInstrumentation.m2726d(TAG, "Calculation complete, Calculated memory cache size: " + toMb(this.memoryCacheSize) + ", pool size: " + toMb(this.bitmapPoolSize) + ", byte array size: " + toMb(i) + ", memory class limited? " + (i3 > maxSize) + ", max size: " + toMb(maxSize) + ", memoryClass: " + builder.activityManager.getMemoryClass() + ", isLowMemoryDevice: " + isLowMemoryDevice(builder.activityManager));
        }
    }
