    ...
    boolean allocate() {
        ...
        while (!this.toPrefill.isEmpty() && !isGcDetected(jNow)) {
            ...
            if (Log.isLoggable(TAG, 3)) {
                LogInstrumentation.m2726d(TAG, "allocated [" + preFillTypeRemove.getWidth() + EllipticCurveJsonWebKey.X_MEMBER_NAME + preFillTypeRemove.getHeight() + "] " + preFillTypeRemove.getConfig() + " size: " + bitmapByteSize);
            }
        }
