...
public class HexAttribute {
    ...
    public static final Set<String> HEX_SESSION_ATTR_WHITELIST = new HashSet(Arrays.asList(AnalyticsAttribute.OS_NAME_ATTRIBUTE, AnalyticsAttribute.OS_VERSION_ATTRIBUTE, AnalyticsAttribute.OS_BUILD_ATTRIBUTE, AnalyticsAttribute.OS_MAJOR_VERSION_ATTRIBUTE, AnalyticsAttribute.DEVICE_MANUFACTURER_ATTRIBUTE, AnalyticsAttribute.DEVICE_MODEL_ATTRIBUTE, AnalyticsAttribute.UUID_ATTRIBUTE, AnalyticsAttribute.CARRIER_ATTRIBUTE, AnalyticsAttribute.NEW_RELIC_VERSION_ATTRIBUTE, AnalyticsAttribute.MEM_USAGE_MB_ATTRIBUTE, "sessionId", "platform", "platformVersion", AnalyticsAttribute.RUNTIME_ATTRIBUTE, AnalyticsAttribute.ARCHITECTURE_ATTRIBUTE, "appBuild", "processId"));
    ...
    public static final Set<String> HEX_REQUIRED_ATTRIBUTES = new HashSet(Arrays.asList("appBuild", HEX_ATTR_APP_UUID_HI, HEX_ATTR_APP_UUID_LO, "sessionId", "message", HEX_ATTR_CAUSE, "name", HEX_ATTR_TIMESTAMP_MS, AnalyticsAttribute.SESSION_TIME_SINCE_LOAD_ATTRIBUTE));
}
