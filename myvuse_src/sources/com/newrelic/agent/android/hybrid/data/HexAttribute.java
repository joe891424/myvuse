...
public class HexAttribute {
    ...
    public static final Set<String> HEX_REQUIRED_ATTRIBUTES = new HashSet(Arrays.asList("name", "message", HEX_ATTR_JSERROR_FATAL, HEX_ATTR_JSERROR_BUILDID, HEX_ATTR_JSERROR_BUNDLEID, AnalyticsAttribute.SESSION_TIME_SINCE_LOAD_ATTRIBUTE));
}
