...
public final class DefaultDateTypeAdapter<T extends Date> extends TypeAdapter<T> {
    ...
    public static abstract class DateType<T extends Date> {
        public static final DateType<Date> DATE = new DateType<Date>(Date.class) { // from class: com.newrelic.com.google.gson.internal.bind.DefaultDateTypeAdapter.DateType.1
