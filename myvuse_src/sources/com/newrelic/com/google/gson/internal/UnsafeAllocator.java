...
public abstract class UnsafeAllocator {
    ...
    public static UnsafeAllocator create() {
        try {
            ...
            return new UnsafeAllocator() { // from class: com.newrelic.com.google.gson.internal.UnsafeAllocator.1
                @Override // com.newrelic.com.google.gson.internal.UnsafeAllocator
            ...
            try {
                try {
                    ...
                    return new UnsafeAllocator() { // from class: com.newrelic.com.google.gson.internal.UnsafeAllocator.2
                        @Override // com.newrelic.com.google.gson.internal.UnsafeAllocator
                        public <T> T newInstance(Class<T> cls2) throws Exception {
                            assertInstantiable(cls2);
                    ...
                    return new UnsafeAllocator() { // from class: com.newrelic.com.google.gson.internal.UnsafeAllocator.4
                        @Override // com.newrelic.com.google.gson.internal.UnsafeAllocator
                ...
                return new UnsafeAllocator() { // from class: com.newrelic.com.google.gson.internal.UnsafeAllocator.3
                    @Override // com.newrelic.com.google.gson.internal.UnsafeAllocator
                    public <T> T newInstance(Class<T> cls2) throws Exception {
                        assertInstantiable(cls2);
