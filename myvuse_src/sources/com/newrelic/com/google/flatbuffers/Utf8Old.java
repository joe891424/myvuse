...
public class Utf8Old extends Utf8 {
    private static final ThreadLocal<Cache> CACHE = ThreadLocal.withInitial(new Supplier() { // from class: com.newrelic.com.google.flatbuffers.Utf8Old$$ExternalSyntheticLambda0
    ...
    @Override // com.newrelic.com.google.flatbuffers.Utf8
    ...
    public String decodeUtf8(ByteBuffer byteBuffer, int i, int i2) {
        ...
        try {
            CharBuffer charBufferDecode = charsetDecoder.decode(byteBufferDuplicate);
            charBufferDecode.flip();
