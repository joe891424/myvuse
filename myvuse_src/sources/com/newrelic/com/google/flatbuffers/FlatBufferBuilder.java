...
public class FlatBufferBuilder {
    ...
    public FlatBufferBuilder(int i, ByteBufferFactory byteBufferFactory, ByteBuffer byteBuffer, Utf8 utf8) {
        ...
        if (byteBuffer != null) {
            this.f4045bb = byteBuffer;
            byteBuffer.clear();
            this.f4045bb.order(ByteOrder.LITTLE_ENDIAN);
        } else {
            this.f4045bb = byteBufferFactory.newByteBuffer(i);
        }
        this.utf8 = utf8;
    }
    ...
    public FlatBufferBuilder init(ByteBuffer byteBuffer, ByteBufferFactory byteBufferFactory) {
        ...
        this.f4045bb.order(ByteOrder.LITTLE_ENDIAN);
        this.minalign = 1;
        this.space = this.f4045bb.capacity();
        this.vtable_in_use = 0;
        this.nested = false;
        this.finished = false;
        this.object_start = 0;
    ...
    public static final class HeapByteBufferFactory extends ByteBufferFactory {
        ...
        @Override // com.newrelic.com.google.flatbuffers.FlatBufferBuilder.ByteBufferFactory
    ...
    static ByteBuffer growByteBuffer(ByteBuffer byteBuffer, ByteBufferFactory byteBufferFactory) {
        ...
        byteBufferNewByteBuffer.position(i - iCapacity);
        byteBufferNewByteBuffer.put(byteBuffer);
        return byteBufferNewByteBuffer;
    }

    public int offset() {
        return this.f4045bb.capacity() - this.space;
    }

    public void pad(int i) {
        for (int i2 = 0; i2 < i; i2++) {
            ByteBuffer byteBuffer = this.f4045bb;
            int i3 = this.space - 1;
            this.space = i3;
    ...
    public ByteBuffer createUnintializedVector(int i, int i2, int i3) {
        ...
        ByteBuffer byteBufferOrder = this.f4045bb.slice().order(ByteOrder.LITTLE_ENDIAN);
    ...
    public <T extends Table> int createSortedVectorOfTables(T t, int[] iArr) {
        t.sortTables(iArr, this.f4045bb);
    ...
    public int createString(CharSequence charSequence) {
        ...
        this.utf8.encodeUtf8(charSequence, this.f4045bb);
        return endVector();
    }
    ...
    public int createString(ByteBuffer byteBuffer) {
        ...
        ByteBuffer byteBuffer2 = this.f4045bb;
        int i = this.space - iRemaining;
        this.space = i;
        byteBuffer2.position(i);
        this.f4045bb.put(byteBuffer);
        return endVector();
    }
    ...
    public int endObject() {
        ...
        loop2: while (true) {
            ...
            int iCapacity = this.f4045bb.capacity() - this.vtables[i5];
            int i6 = this.space;
            short s = this.f4045bb.getShort(iCapacity);
            if (s == this.f4045bb.getShort(i6)) {
                for (int i7 = 2; i7 < s; i7 += 2) {
                    if (this.f4045bb.getShort(iCapacity + i7) != this.f4045bb.getShort(i6 + i7)) {
                        break;
                    }
                }
                i = this.vtables[i5];
        ...
        if (i != 0) {
            int iCapacity2 = this.f4045bb.capacity() - iOffset;
            this.space = iCapacity2;
            this.f4045bb.putInt(iCapacity2, i - iOffset);
        } else {
    ...
    public void required(int i, int i2) {
        int iCapacity = this.f4045bb.capacity() - i;
        if (this.f4045bb.getShort((iCapacity - this.f4045bb.getInt(iCapacity)) + i2) == 0) {
    ...
    protected void finish(int i, boolean z) {
        ...
        addOffset(i);
        if (z) {
            addInt(this.f4045bb.capacity() - this.space);
        }
        this.f4045bb.position(this.space);
        this.finished = true;
    }
    ...
    public byte[] sizedByteArray(int i, int i2) {
        ...
        this.f4045bb.position(i);
        this.f4045bb.get(bArr);
        return bArr;
    }

    public byte[] sizedByteArray() {
        return sizedByteArray(this.space, this.f4045bb.capacity() - this.space);
    }

    public InputStream sizedInputStream() {
        finished();
        ByteBuffer byteBufferDuplicate = this.f4045bb.duplicate();
        byteBufferDuplicate.position(this.space);
        byteBufferDuplicate.limit(this.f4045bb.capacity());
