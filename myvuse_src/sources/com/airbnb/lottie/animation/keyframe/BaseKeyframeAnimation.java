...
public abstract class BaseKeyframeAnimation<K, A> {
    ...
    public void setProgress(float f) {
        C1363L.beginSection("BaseKeyframeAnimation#setProgress");
        if (this.keyframesWrapper.isEmpty()) {
            C1363L.endSection("BaseKeyframeAnimation#setProgress");
            return;
        }
    ...
    public void notifyListeners() {
        C1363L.beginSection("BaseKeyframeAnimation#notifyListeners");
        for (int i = 0; i < this.listeners.size(); i++) {
            this.listeners.get(i).onValueChanged();
        }
        C1363L.endSection("BaseKeyframeAnimation#notifyListeners");
    }

    protected Keyframe<K> getCurrentKeyframe() {
        C1363L.beginSection("BaseKeyframeAnimation#getCurrentKeyframe");
        Keyframe<K> currentKeyframe = this.keyframesWrapper.getCurrentKeyframe();
        C1363L.endSection("BaseKeyframeAnimation#getCurrentKeyframe");
