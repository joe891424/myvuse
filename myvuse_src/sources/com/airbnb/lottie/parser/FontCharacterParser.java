...
class FontCharacterParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.m1243of("ch", "size", "w", "style", "fFamily", "data");
    private static final JsonReader.Options DATA_NAMES = JsonReader.Options.m1243of("shapes");
