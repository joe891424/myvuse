...
public class AnimatableTransformParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.m1243of("a", "p", "s", "rz", RsaJsonWebKey.PRIME_FACTOR_OTHER_MEMBER_NAME, "o", "so", "eo", "sk", "sa");
    private static final JsonReader.Options ANIMATABLE_NAMES = JsonReader.Options.m1243of(OctetSequenceJsonWebKey.KEY_VALUE_MEMBER_NAME);
