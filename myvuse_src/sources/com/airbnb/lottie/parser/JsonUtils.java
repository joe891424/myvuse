...
class JsonUtils {
    private static final JsonReader.Options POINT_NAMES = JsonReader.Options.m1243of(EllipticCurveJsonWebKey.X_MEMBER_NAME, EllipticCurveJsonWebKey.Y_MEMBER_NAME);
    ...
    static PointF jsonToPoint(JsonReader jsonReader, float f) throws IOException {
        int i = C13881.$SwitchMap$com$airbnb$lottie$parser$moshi$JsonReader$Token[jsonReader.peek().ordinal()];
        if (i == 1) {
    ...
    static float valueFromObject(JsonReader jsonReader) throws IOException {
        ...
        int i = C13881.$SwitchMap$com$airbnb$lottie$parser$moshi$JsonReader$Token[tokenPeek.ordinal()];
        if (i == 1) {
