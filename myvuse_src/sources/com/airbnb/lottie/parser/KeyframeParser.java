...
class KeyframeParser {
    ...
    static JsonReader.Options NAMES = JsonReader.Options.m1243of(RsaJsonWebKey.FACTOR_CRT_COEFFICIENT, "s", RsaJsonWebKey.EXPONENT_MEMBER_NAME, "o", ContextChain.TAG_INFRA, "h", TypedValues.TransitionType.S_TO, "ti");
    static JsonReader.Options INTERPOLATOR_NAMES = JsonReader.Options.m1243of(EllipticCurveJsonWebKey.X_MEMBER_NAME, EllipticCurveJsonWebKey.Y_MEMBER_NAME);
    ...
    */
    ...
    private static Interpolator interpolatorFor(PointF pointF, PointF pointF2) {
        ...
        WeakReference<Interpolator> interpolator = C1363L.getDisablePathInterpolatorCache() ? null : getInterpolator(iHashFor);
        ...
        if (interpolator == null || interpolator2 == null) {
            ...
            if (!C1363L.getDisablePathInterpolatorCache()) {
                try {
