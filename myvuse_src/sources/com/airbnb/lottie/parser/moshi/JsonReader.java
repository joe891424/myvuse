...
public abstract class JsonReader implements Closeable {
    ...
    public static JsonReader m1242of(BufferedSource bufferedSource) {
    ...
    public static final class Options {
        ...
        /* JADX INFO: renamed from: of */
        public static Options m1243of(String... strArr) {
            try {
                ...
                return new Options((String[]) strArr.clone(), okio.Options.m5636of(byteStringArr));
            } catch (IOException e) {
