...
public class LayerParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.m1243of("nm", "ind", "refId", "ty", "parent", "sw", "sh", "sc", "ks", "tt", "masksProperties", "shapes", RsaJsonWebKey.FACTOR_CRT_COEFFICIENT, "ef", "sr", "st", "w", "h", "ip", "op", "tm", "cl", "hd", "ao", "bm");
    private static final JsonReader.Options TEXT_NAMES = JsonReader.Options.m1243of("d", "a");
    private static final JsonReader.Options EFFECTS_NAMES = JsonReader.Options.m1243of("ty", "nm");
            ...
            switch (jsonReader.selectName(NAMES)) {
                ...
                case 9:
                    ...
                    if (iNextInt4 >= Layer.MatteType.values().length) {
                        ...
                        int i = C13891.$SwitchMap$com$airbnb$lottie$model$layer$Layer$MatteType[matteType2.ordinal()];
                        if (i == 1) {
