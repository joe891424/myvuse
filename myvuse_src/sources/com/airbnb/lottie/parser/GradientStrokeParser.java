...
class GradientStrokeParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.m1243of("nm", "g", "o", RsaJsonWebKey.FACTOR_CRT_COEFFICIENT, "s", RsaJsonWebKey.EXPONENT_MEMBER_NAME, "w", "lc", "lj", "ml", "hd", "d");
    private static final JsonReader.Options GRADIENT_NAMES = JsonReader.Options.m1243of("p", OctetSequenceJsonWebKey.KEY_VALUE_MEMBER_NAME);
    private static final JsonReader.Options DASH_PATTERN_NAMES = JsonReader.Options.m1243of(RsaJsonWebKey.MODULUS_MEMBER_NAME, "v");
