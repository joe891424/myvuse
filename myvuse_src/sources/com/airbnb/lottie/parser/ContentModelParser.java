...
class ContentModelParser {
    private static final JsonReader.Options NAMES = JsonReader.Options.m1243of("ty", "d");
    ...
    static ContentModel parse(JsonReader jsonReader, LottieComposition lottieComposition) throws IOException {
        ...
        switch (strNextString.hashCode()) {
            ...
            case 3679:
                ...
                break;
            case 3681:
                b = !strNextString.equals("st") ? (byte) -1 : Ascii.f3760VT;
                break;
            case 3705:
                b = !strNextString.equals("tm") ? (byte) -1 : Ascii.f3749FF;
                break;
            case 3710:
                b = !strNextString.equals("tr") ? (byte) -1 : Ascii.f3747CR;
                break;
            default:
                b = -1;
                break;
