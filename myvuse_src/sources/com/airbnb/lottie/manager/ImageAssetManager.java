    ...
    public Bitmap bitmapForId(String str) {
        ...
        if (fileName.startsWith("data:") && fileName.indexOf("base64,") > 0) {
            try {
                ...
                return putBitmap(str, BitmapFactoryInstrumentation.decodeByteArray(bArrDecode, 0, bArrDecode.length, options));
        ...
        try {
            ...
            try {
                Bitmap bitmapDecodeStream = BitmapFactoryInstrumentation.decodeStream(context.getAssets().open(this.imagesFolder + fileName), null, options);
