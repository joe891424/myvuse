...
public class CompositionLayer extends BaseLayer {
        ...
        while (true) {
            ...
            if (baseLayerForModel != null) {
                ...
                if (baseLayer2 != null) {
                    ...
                    int i2 = C13831.$SwitchMap$com$airbnb$lottie$model$layer$Layer$MatteType[layer2.getMatteType().ordinal()];
                    if (i2 == 1 || i2 == 2) {
    ...
    void drawLayer(Canvas canvas, Matrix matrix, int i) {
        C1363L.beginSection("CompositionLayer#draw");
        ...
        canvas.restore();
        C1363L.endSection("CompositionLayer#draw");
    }
    ...
    public void setProgress(float f) {
        C1363L.beginSection("CompositionLayer#setProgress");
        this.progress = f;
        super.setProgress(f);
        ...
        C1363L.endSection("CompositionLayer#setProgress");
    }
