...
public class RNCWebViewModuleImpl implements ActivityEventListener {
    ...
    public void startPhotoPickerIntent(String str, ValueCallback<Uri> valueCallback) {
        ...
        if (intentCreateChooser.resolveActivity(currentActivity.getPackageManager()) != null) {
            ...
            LogInstrumentation.m2734w(NAME, "there is no Activity to handle this Intent");
        }
    }
    ...
    public boolean startPhotoPickerIntent(String[] strArr, boolean z, ValueCallback<Uri[]> valueCallback, boolean z2) {
        ...
        if (photoIntent == null) {
            LogInstrumentation.m2734w(NAME, "there is no Camera permission");
    ...
    public void downloadFile(String str) {
        try {
            ...
            LogInstrumentation.m2735w(NAME, "Unsupported URI, aborting download", e);
        }
    }
    ...
    public Intent getPhotoIntent() {
        ...
        try {
            ...
            e = e3;
            LogInstrumentation.m2729e("CREATE FILE", "Error occurred while creating the File", e);
            e.printStackTrace();
    ...
    /* JADX INFO: renamed from: com.reactnativecommunity.webview.RNCWebViewModuleImpl$2 */
    static /* synthetic */ class C39652 {

        /* JADX INFO: renamed from: $SwitchMap$com$reactnativecommunity$webview$RNCWebViewModuleImpl$MimeType */
        static final /* synthetic */ int[] f4198xec4499b;
        ...
        static {
            ...
            try {
                f4198xec4499b[MimeType.VIDEO.ordinal()] = 2;
    ...
    public File getCapturedFile(MimeType mimeType) throws IOException {
        String str;
        String str2;
        int i = C39652.f4198xec4499b[mimeType.ordinal()];
        if (i == 1) {
            String str3 = Environment.DIRECTORY_PICTURES;
            str = "image-";
            str2 = FaceTecConstantsKt.IMAGE_FILE_EXTENSION;
        } else if (i != 2) {
            str = "";
            str2 = "";
        } else {
