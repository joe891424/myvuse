...
public abstract class BaseLocationManager {
    ...
    protected static WritableMap locationToMap(Location location) {
        ...
        writableMapCreateMap2.putDouble(C4349h.a.f5610b, location.getLatitude());
        writableMapCreateMap2.putDouble(C4349h.a.f5611c, location.getLongitude());
