...
public class LocalModel {
    ...
    public String toString() {
        zzt zztVarZza = zzu.zza(this);
        zztVarZza.zza("absoluteFilePath", this.zza);
        zztVarZza.zza("assetFilePath", this.zzb);
        zztVarZza.zza("uri", this.zzc);
        zzio.zza();
        zztVarZza.zzb("isManifestFile", this.zzd);
        return zztVarZza.toString();
    }
}
