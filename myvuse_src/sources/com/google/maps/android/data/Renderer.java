...
public class Renderer {
    ...
    private void createInfoWindow() {
        this.mMarkers.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() { // from class: com.google.maps.android.data.Renderer.1
            ...
            public View getInfoContents(Marker marker) {
                View viewInflate = LayoutInflater.from(Renderer.this.mContext).inflate(C3434R.layout.amu_info_window, (ViewGroup) null);
                TextView textView = (TextView) viewInflate.findViewById(C3434R.id.window);
    ...
    void setOnFeatureClickListener(final Layer.OnFeatureClickListener onFeatureClickListener) {
        this.mPolygons.setOnPolygonClickListener(new GoogleMap.OnPolygonClickListener() { // from class: com.google.maps.android.data.Renderer$$ExternalSyntheticLambda0
            ...
            public final void onPolygonClick(Polygon polygon) {
                this.f$0.m2693x2cc520ac(onFeatureClickListener, polygon);
            }
        });
        this.mMarkers.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() { // from class: com.google.maps.android.data.Renderer$$ExternalSyntheticLambda1
            ...
            public final boolean onMarkerClick(Marker marker) {
                return this.f$0.m2694xf5c617ed(onFeatureClickListener, marker);
            }
        });
        this.mPolylines.setOnPolylineClickListener(new GoogleMap.OnPolylineClickListener() { // from class: com.google.maps.android.data.Renderer$$ExternalSyntheticLambda2
            ...
            public final void onPolylineClick(Polyline polyline) {
                this.f$0.m2695xbec70f2e(onFeatureClickListener, polyline);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$setOnFeatureClickListener$0$com-google-maps-android-data-Renderer */
    /* synthetic */ void m2693x2cc520ac(Layer.OnFeatureClickListener onFeatureClickListener, Polygon polygon) {
    ...
    /* JADX INFO: renamed from: lambda$setOnFeatureClickListener$1$com-google-maps-android-data-Renderer */
    /* synthetic */ boolean m2694xf5c617ed(Layer.OnFeatureClickListener onFeatureClickListener, Marker marker) {
    ...
    /* JADX INFO: renamed from: lambda$setOnFeatureClickListener$2$com-google-maps-android-data-Renderer */
    /* synthetic */ void m2695xbec70f2e(Layer.OnFeatureClickListener onFeatureClickListener, Polyline polyline) {
