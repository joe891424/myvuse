            ...
            if (nextEntry != null) {
                ...
                while (nextEntry != null) {
                    if (kml == null && nextEntry.getName().toLowerCase().endsWith(".kml")) {
                        ...
                        Bitmap bitmapDecodeStream = BitmapFactoryInstrumentation.decodeStream(zipInputStream);
                        if (bitmapDecodeStream != null) {
                            map.put(nextEntry.getName(), bitmapDecodeStream);
                        } else {
                            LogInstrumentation.m2734w("KmlLayer", "Unsupported KMZ contents file type: " + nextEntry.getName());
                        }
                    }
