...
public class KmlRenderer extends Renderer {
    ...
    private void downloadMarkerIcons() {
        ...
        while (it2.hasNext()) {
            MarkerIconImageDownload markerIconImageDownload = new MarkerIconImageDownload(it2.next());
            String[] strArr = new String[0];
            if (markerIconImageDownload instanceof AsyncTask) {
                AsyncTaskInstrumentation.execute(markerIconImageDownload, strArr);
            } else {
                markerIconImageDownload.execute(strArr);
            }
            it2.remove();
        }
    }
    ...
    private void downloadGroundOverlays() {
        ...
        while (it2.hasNext()) {
            GroundOverlayImageDownload groundOverlayImageDownload = new GroundOverlayImageDownload(it2.next());
            String[] strArr = new String[0];
            if (groundOverlayImageDownload instanceof AsyncTask) {
                AsyncTaskInstrumentation.execute(groundOverlayImageDownload, strArr);
            } else {
                groundOverlayImageDownload.execute(strArr);
            }
            it2.remove();
        }
    }
    ...
    private class MarkerIconImageDownload extends AsyncTask<String, Void, Bitmap> implements TraceFieldInterface {
        ...
        protected /* bridge */ /* synthetic */ Bitmap doInBackground(String[] strArr) {
            try {
                TraceMachine.enterMethod(this._nr_trace, "KmlRenderer$MarkerIconImageDownload#doInBackground", null);
            } catch (NoSuchFieldError unused) {
                TraceMachine.enterMethod(null, "KmlRenderer$MarkerIconImageDownload#doInBackground", null);
            }
            Bitmap bitmapDoInBackground2 = doInBackground2(strArr);
            TraceMachine.exitMethod();
            return bitmapDoInBackground2;
        }

        @Override // android.os.AsyncTask
        protected /* bridge */ /* synthetic */ void onPostExecute(Bitmap bitmap) {
            try {
                TraceMachine.enterMethod(this._nr_trace, "KmlRenderer$MarkerIconImageDownload#onPostExecute", null);
            } catch (NoSuchFieldError unused) {
        ...
        protected Bitmap doInBackground2(String... strArr) {
            try {
                ...
                return BitmapFactoryInstrumentation.decodeFile(this.mIconUrl);
            } catch (IOException e) {
                e.printStackTrace();
                return null;
            }
        ...
        protected void onPostExecute2(Bitmap bitmap) {
            if (bitmap != null) {
                ...
                LogInstrumentation.m2728e(KmlRenderer.LOG_TAG, "Image at this URL could not be found " + this.mIconUrl);
            }
            KmlRenderer.this.downloadFinished();
        }
    }

    private class GroundOverlayImageDownload extends AsyncTask<String, Void, Bitmap> implements TraceFieldInterface {
        public Trace _nr_trace;
        ...
        protected /* bridge */ /* synthetic */ Bitmap doInBackground(String[] strArr) {
            try {
                TraceMachine.enterMethod(this._nr_trace, "KmlRenderer$GroundOverlayImageDownload#doInBackground", null);
            } catch (NoSuchFieldError unused) {
        ...
        protected /* bridge */ /* synthetic */ void onPostExecute(Bitmap bitmap) {
            try {
                TraceMachine.enterMethod(this._nr_trace, "KmlRenderer$GroundOverlayImageDownload#onPostExecute", null);
            } catch (NoSuchFieldError unused) {
        ...
        protected Bitmap doInBackground2(String... strArr) {
            try {
                ...
                return BitmapFactoryInstrumentation.decodeFile(this.mGroundOverlayUrl);
            } catch (IOException e) {
                LogInstrumentation.m2729e(KmlRenderer.LOG_TAG, "Image [" + this.mGroundOverlayUrl + "] download issue", e);
                return null;
            }
        }
        ...
        protected void onPostExecute2(Bitmap bitmap) {
            if (bitmap != null) {
                ...
                LogInstrumentation.m2728e(KmlRenderer.LOG_TAG, "Image at this URL could not be found " + this.mGroundOverlayUrl);
            }
            KmlRenderer.this.downloadFinished();
        }
    }
    ...
    public Bitmap getBitmapFromUrl(String str) throws IOException {
        return BitmapFactoryInstrumentation.decodeStream(openConnectionCheckRedirects((URLConnection) FirebasePerfUrlConnection.instrument(URLConnectionInstrumentation.openConnection(new URL(str).openConnection()))));
    }
