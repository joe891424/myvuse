...
public abstract class Style extends Observable {
    ...
    public void setMarkerHotSpot(float f, float f2, String str, String str2) {
        if (!str.equals("fraction")) {
            LogInstrumentation.m2734w(LOG_TAG, "Hotspot xUnits other than \"fraction\" are not supported.");
            f = 0.5f;
        }
        if (!str2.equals("fraction")) {
            LogInstrumentation.m2734w(LOG_TAG, "Hotspot yUnits other than \"fraction\" are not supported.");
            f2 = 1.0f;
        }
