...
public class GeoJsonParser {
    ...
    private static GeoJsonFeature parseFeature(JSONObject jSONObject) {
        ...
        try {
            ...
            LogInstrumentation.m2734w(LOG_TAG, "Feature could not be successfully parsed " + (!(jSONObject instanceof JSONObject) ? jSONObject.toString() : JSONObjectInstrumentation.toString(jSONObject)));
            return null;
        }
    }
    ...
    private static GeoJsonFeature parseGeometryToFeature(JSONObject jSONObject) {
        ...
        LogInstrumentation.m2734w(LOG_TAG, "Geometry could not be parsed");
        return null;
    }
    ...
    private void parseGeoJson() {
        try {
            ...
            if (string.equals(FEATURE)) {
                ...
                LogInstrumentation.m2734w(LOG_TAG, "GeoJSON file could not be parsed.");
            }
        } catch (JSONException unused) {
            LogInstrumentation.m2734w(LOG_TAG, "GeoJSON file could not be parsed.");
        }
    ...
    private ArrayList<GeoJsonFeature> parseFeatureCollection(JSONObject jSONObject) {
        ...
        try {
            ...
            for (int i = 0; i < jSONArray.length(); i++) {
                try {
                    ...
                    if (jSONObject2.getString("type").equals(FEATURE)) {
                        ...
                        if (feature == null) {
                            LogInstrumentation.m2734w(LOG_TAG, "Index of Feature in Feature Collection that could not be created: " + i);
                        } else {
            ...
            LogInstrumentation.m2734w(LOG_TAG, "Feature Collection could not be created.");
            return arrayList;
        }
    }
