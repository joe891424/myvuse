...
public class PointQuadTree<T extends Item> {
    ...
    public void add(T t) {
        ...
        if (this.mBounds.contains(point.f3881x, point.f3882y)) {
            insert(point.f3881x, point.f3882y, t);
        }
    }
    ...
    private void split() {
        ...
        this.mItems = null;
        for (T t : set) {
            insert(t.getPoint().f3881x, t.getPoint().f3882y, t);
        }
    }
    ...
    public boolean remove(T t) {
        Point point = t.getPoint();
        if (this.mBounds.contains(point.f3881x, point.f3882y)) {
            return remove(point.f3881x, point.f3882y, t);
        }
        return false;
    }
