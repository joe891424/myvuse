...
public class SphericalMercatorProjection {
    ...
    public LatLng toLatLng(com.google.maps.android.geometry.Point point) {
        return new LatLng(90.0d - Math.toDegrees(Math.atan(Math.exp(((-(0.5d - (point.f3882y / this.mWorldWidth))) * 2.0d) * 3.141592653589793d)) * 2.0d), ((point.f3881x / this.mWorldWidth) - 0.5d) * 360.0d);
    }
}
