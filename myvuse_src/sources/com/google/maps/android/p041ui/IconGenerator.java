package com.google.maps.android.p041ui;
...
public class IconGenerator {
    ...
    public IconGenerator(Context context) {
        ...
        ViewGroup viewGroup = (ViewGroup) LayoutInflater.from(context).inflate(C3434R.layout.amu_text_bubble, (ViewGroup) null);
        this.mContainer = viewGroup;
        RotationLayout rotationLayout = (RotationLayout) viewGroup.getChildAt(0);
        this.mRotationLayout = rotationLayout;
        TextView textView = (TextView) rotationLayout.findViewById(C3434R.id.amu_text);
    ...
    public void setContentView(View view) {
        ...
        View viewFindViewById = this.mRotationLayout.findViewById(C3434R.id.amu_text);
    ...
    private static int getTextStyle(int i) {
        if (i != 3 && i != 4 && i != 5 && i != 6 && i != 7) {
            return C3434R.style.amu_Bubble_TextAppearance_Dark;
        }
        return C3434R.style.amu_Bubble_TextAppearance_Light;
    }
}
