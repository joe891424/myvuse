...
class BubbleDrawable extends Drawable {
    ...
    public BubbleDrawable(Context context) {
        this.mMask = ContextCompat.getDrawable(context, C3434R.drawable.amu_bubble_mask);
        this.mShadow = ContextCompat.getDrawable(context, C3434R.drawable.amu_bubble_shadow);
    }
