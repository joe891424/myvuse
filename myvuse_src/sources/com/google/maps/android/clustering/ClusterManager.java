...
public class ClusterManager<T extends ClusterItem> implements GoogleMap.OnCameraIdleListener, GoogleMap.OnMarkerClickListener, GoogleMap.OnInfoWindowClickListener {
    ...
    public void cluster() {
        ...
        try {
            ...
            if (clusterTask instanceof AsyncTask) {
                AsyncTaskInstrumentation.executeOnExecutor(clusterTask, executor, fArr);
            } else {
                clusterTask.executeOnExecutor(executor, fArr);
            }
        } finally {
    ...
    private class ClusterTask extends AsyncTask<Float, Void, Set<? extends Cluster<T>>> implements TraceFieldInterface {
        ...
        protected /* bridge */ /* synthetic */ Object doInBackground(Float[] fArr) {
            ...
            Set<? extends Cluster<T>> setDoInBackground2 = doInBackground2(fArr);
            TraceMachine.exitMethod();
            return setDoInBackground2;
        }
