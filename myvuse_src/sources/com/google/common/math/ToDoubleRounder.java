...
abstract class ToDoubleRounder<X extends Number & Comparable<X>> {
    ...
    final double roundToDouble(X x, RoundingMode roundingMode) {
        Number x2;
        double dNextUp;
        Preconditions.checkNotNull(x, EllipticCurveJsonWebKey.X_MEMBER_NAME);
        ...
        if (Double.isInfinite(dRoundToDoubleArbitrarily)) {
            switch (C30191.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
                case 1:
                case 2:
                case 3:
                case 4:
        ...
        switch (C30191.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            ...
            case 4:
                ...
                int i = C30191.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()];
                if (i == 2) {
