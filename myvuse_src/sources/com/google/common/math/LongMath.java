...
public final class LongMath {
    ...
    static final byte[] maxLog10ForLeadingZeros = {19, Ascii.DC2, Ascii.DC2, Ascii.DC2, Ascii.DC2, 17, 17, 17, Ascii.DLE, Ascii.DLE, Ascii.DLE, Ascii.f3756SI, Ascii.f3756SI, Ascii.f3756SI, Ascii.f3756SI, Ascii.f3757SO, Ascii.f3757SO, Ascii.f3757SO, Ascii.f3747CR, Ascii.f3747CR, Ascii.f3747CR, Ascii.f3749FF, Ascii.f3749FF, Ascii.f3749FF, Ascii.f3749FF, Ascii.f3760VT, Ascii.f3760VT, Ascii.f3760VT, 10, 10, 10, 9, 9, 9, 9, 8, 8, 8, 7, 7, 7, 6, 6, 6, 6, 5, 5, 5, 4, 4, 4, 3, 3, 3, 3, 2, 2, 2, 1, 1, 1, 0, 0, 0};
    static final long[] powersOf10 = {1, 10, 100, 1000, WorkRequest.MIN_BACKOFF_MILLIS, 100000, Constants.Network.MAX_PAYLOAD_SIZE, 10000000, 100000000, MathMethodsKt.NANOS_PER_SECOND, RealConnection.IDLE_CONNECTION_HEALTHY_NS, 100000000000L, 1000000000000L, 10000000000000L, 100000000000000L, 1000000000000000L, 10000000000000000L, 100000000000000000L, 1000000000000000000L};
    static final long[] halfPowersOf10 = {3, 31, 316, 3162, 31622, 316227, 3162277, 31622776, 316227766, 3162277660L, 31622776601L, 316227766016L, 3162277660168L, 31622776601683L, 316227766016837L, 3162277660168379L, 31622776601683793L, 316227766016837933L, 3162277660168379331L};
    static final long[] factorials = {1, 1, 2, 6, 24, 120, 720, 5040, 40320, 362880, 3628800, 39916800, 479001600, 6227020800L, 87178291200L, 1307674368000L, 20922789888000L, 355687428096000L, 6402373705728000L, 121645100408832000L, 2432902008176640000L};
    static final int[] biggestBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 3810779, 121977, 16175, 4337, 1733, 887, 534, 361, 265, OTUIDisplayReasonCode.UIShownCode.PC_SHOWN_SERVICE_SPECIFIC_OFF, 169, 143, 125, OTUIDisplayReasonCode.UIShownCode.BANNER_SHOWN_NEW_GROUP_ADDED, 101, 94, 88, 83, 79, 76, 74, 72, 70, 69, 68, 67, 67, 66, 66, 66, 66};
    static final int[] biggestSimpleBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 2642246, 86251, 11724, 3218, 1313, 684, 419, 287, ISO7816Kt.INS_UPDATE_BINARY, 169, 139, 119, 105, 95, 87, 81, 76, 73, 70, 68, 66, 64, 63, 62, 62, 61, 61, 61};
    ...
    public static long ceilingPowerOfTwo(long j) {
        MathPreconditions.checkPositive(EllipticCurveJsonWebKey.X_MEMBER_NAME, j);
    ...
    public static int log2(long j, RoundingMode roundingMode) {
        MathPreconditions.checkPositive(EllipticCurveJsonWebKey.X_MEMBER_NAME, j);
        switch (C30151.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
    ...
    public static long sqrt(long j, RoundingMode roundingMode) {
        MathPreconditions.checkNonNegative(EllipticCurveJsonWebKey.X_MEMBER_NAME, j);
        if (fitsInInt(j)) {
    ...
    public static long factorial(int i) {
        MathPreconditions.checkNonNegative(RsaJsonWebKey.MODULUS_MEMBER_NAME, i);
    ...
    public static long binomial(int i, int i2) {
        MathPreconditions.checkNonNegative(RsaJsonWebKey.MODULUS_MEMBER_NAME, i);
        MathPreconditions.checkNonNegative(OctetSequenceJsonWebKey.KEY_VALUE_MEMBER_NAME, i2);
    ...
    public static boolean isPrime(long j) {
        if (j < 2) {
            MathPreconditions.checkNonNegative(RsaJsonWebKey.MODULUS_MEMBER_NAME, j);
            return false;
        }
        if (j < 66) {
    ...
    private enum MillerRabinTester {
        ...
        /* synthetic */ MillerRabinTester(C30151 c30151) {
            this();
        }
    ...
    public static double roundToDouble(long j, RoundingMode roundingMode) {
        ...
        switch (C30151.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            ...
            case 8:
                ...
                int i = C30151.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()];
                if (i == 6) {
