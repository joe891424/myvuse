...
public final class IntMath {
    ...
    static final int[] powersOf10 = {1, 10, 100, 1000, AndroidLocationEnablerModule.DEFAULT_INTERVAL_DURATION, 100000, DurationKt.NANOS_IN_MILLIS, 10000000, 100000000, 1000000000};
    ...
    private static final int[] factorials = {1, 1, 2, 6, 24, 120, CameraConfiguration.TARGET_WIDTH, 5040, 40320, 362880, 3628800, 39916800, 479001600};
    static int[] biggestBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, 65536, 2345, 477, 193, OTUIDisplayReasonCode.UIShownCode.BANNER_SHOWN_SHOW_BANNER_CALLED, 75, 58, 49, 43, 39, 37, 35, 34, 34, 33};
    ...
    public static int ceilingPowerOfTwo(int i) {
        MathPreconditions.checkPositive(EllipticCurveJsonWebKey.X_MEMBER_NAME, i);
        if (i > 1073741824) {
    ...
    public static int log2(int i, RoundingMode roundingMode) {
        MathPreconditions.checkPositive(EllipticCurveJsonWebKey.X_MEMBER_NAME, i);
        switch (C30131.$SwitchMap$java$math$RoundingMode[roundingMode.ordinal()]) {
            case 1:
    ...
    public static int sqrt(int i, RoundingMode roundingMode) {
        int iLessThanBranchFree;
        MathPreconditions.checkNonNegative(EllipticCurveJsonWebKey.X_MEMBER_NAME, i);
