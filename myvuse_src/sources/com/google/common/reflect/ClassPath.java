...
public final class ClassPath {
    ...
    private static final Splitter CLASS_PATH_ATTRIBUTE_SEPARATOR = Splitter.m2416on(" ").omitEmptyStrings();
    ...
    public static class ResourceInfo {
        ...
        static ResourceInfo m2585of(File file, String str, ClassLoader classLoader) {
        ...
        private void scanJarFile(JarFile jarFile, ImmutableSet.Builder<ResourceInfo> builder) {
            ...
            while (enumerationEntries.hasMoreElements()) {
                ...
                if (!jarEntryNextElement.isDirectory() && !jarEntryNextElement.getName().equals("META-INF/MANIFEST.MF")) {
                    builder.add(ResourceInfo.m2585of(new File(jarFile.getName()), jarEntryNextElement.getName(), this.classloader));
                }
            }
        }
            ...
            for (File file2 : fileArrListFiles) {
                ...
                if (file2.isDirectory()) {
                    ...
                    if (!strConcat.equals("META-INF/MANIFEST.MF")) {
                        builder.add(ResourceInfo.m2585of(file2, strConcat, this.classloader));
                    }
                }
            }
        }
    ...
    static ImmutableList<URL> parseJavaClassPath() {
        ...
        for (String str : Splitter.m2416on(StandardSystemProperty.PATH_SEPARATOR.value()).split(StandardSystemProperty.JAVA_CLASS_PATH.value())) {
            try {
                try {
