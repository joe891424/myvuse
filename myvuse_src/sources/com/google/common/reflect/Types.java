...
final class Types {
    private static final Joiner COMMA_JOINER = Joiner.m2407on(", ").useForNull("null");
    ...
    static final class WildcardTypeImpl implements WildcardType, Serializable {
        ...
        public String toString() {
            ...
            while (it2.hasNext()) {
                sb.append(" super ").append(JavaVersion.CURRENT.typeName(it2.next()));
            }
            Iterator it3 = Types.filterUpperBounds(this.upperBounds).iterator();
            while (it3.hasNext()) {
                sb.append(" extends ").append(JavaVersion.CURRENT.typeName((Type) it3.next()));
            }
            return sb.toString();
        }
    }
