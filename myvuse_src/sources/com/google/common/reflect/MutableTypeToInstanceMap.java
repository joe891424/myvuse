...
public final class MutableTypeToInstanceMap<B> extends ForwardingMap<TypeToken<? extends B>, B> implements TypeToInstanceMap<B> {
    ...
    public <T extends B> T getInstance(Class<T> cls) {
        return (T) trustedGet(TypeToken.m2588of((Class) cls));
    }
    ...
    public <T extends B> T putInstance(Class<T> cls, T t) {
        return (T) trustedPut(TypeToken.m2588of((Class) cls), t);
    }
    ...
    static final class UnmodifiableEntry<K, V> extends ForwardingMapEntry<K, V> {
        ...
        public static /* synthetic */ UnmodifiableEntry m6290$r8$lambda$PXRRP_NYxQ7IKAyO13H8YX2pq0(Map.Entry entry) {
        ...
        public static <K, V> Iterator<Map.Entry<K, V>> transformEntries(Iterator<Map.Entry<K, V>> it2) {
            return Iterators.transform(it2, new Function() { // from class: com.google.common.reflect.MutableTypeToInstanceMap$UnmodifiableEntry$$ExternalSyntheticLambda0
                @Override // com.google.common.base.Function
                public final Object apply(Object obj) {
                    return MutableTypeToInstanceMap.UnmodifiableEntry.m6290$r8$lambda$PXRRP_NYxQ7IKAyO13H8YX2pq0((Map.Entry) obj);
                }
            });
        }
