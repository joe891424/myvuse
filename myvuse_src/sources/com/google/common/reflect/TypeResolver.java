...
public final class TypeResolver {
    ...
    private static class WildcardCapturer {
        ...
        private final AtomicInteger f3835id;
        ...
        TypeVariable<?> captureAsTypeVariable(Type[] typeArr) {
            int iIncrementAndGet = this.f3835id.incrementAndGet();
            String strJoin = Joiner.m2406on(Typography.amp).join(typeArr);
        ...
        private WildcardCapturer forTypeVariable(final TypeVariable<?> typeVariable) {
            return new WildcardCapturer(this, this.f3835id) { // from class: com.google.common.reflect.TypeResolver.WildcardCapturer.1
        ...
        private WildcardCapturer notForTypeVariable() {
            return new WildcardCapturer(this.f3835id);
        }
