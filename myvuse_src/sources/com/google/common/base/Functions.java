...
public final class Functions {
    ...
    private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        ...
        private final Function<A, ? extends B> f3761f;

        /* JADX INFO: renamed from: g */
        private final Function<B, C> f3762g;

        public FunctionComposition(Function<B, C> function, Function<A, ? extends B> function2) {
            this.f3762g = (Function) Preconditions.checkNotNull(function);
            this.f3761f = (Function) Preconditions.checkNotNull(function2);
        }

        @Override // com.google.common.base.Function
        @ParametricNullness
        public C apply(@ParametricNullness A a2) {
            return (C) this.f3762g.apply(this.f3761f.apply(a2));
        }
        ...
        public boolean equals(@CheckForNull Object obj) {
            ...
            return this.f3761f.equals(functionComposition.f3761f) && this.f3762g.equals(functionComposition.f3762g);
        }

        public int hashCode() {
            return this.f3761f.hashCode() ^ this.f3762g.hashCode();
        }

        public String toString() {
            String strValueOf = String.valueOf(this.f3762g);
            String strValueOf2 = String.valueOf(this.f3761f);
