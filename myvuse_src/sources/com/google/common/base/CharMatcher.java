...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    public static CharMatcher m2404is(char c) {
        return new C2677Is(c);
    }
    ...
    public static CharMatcher anyOf(CharSequence charSequence) {
        ...
        if (length == 1) {
            return m2404is(charSequence.charAt(0));
        }
        if (length == 2) {
    ...
    public CharMatcher mo2405or(CharMatcher charMatcher) {
        return new C2678Or(this, charMatcher);
    }
    ...
    private static CharMatcher precomputedPositive(int i, BitSet bitSet, String str) {
        ...
        if (i == 1) {
            return m2404is((char) bitSet.nextSetBit(0));
        }
        if (i == 2) {
    ...
    private static final class C2678Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;
        ...
        C2678Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
            this.first = (CharMatcher) Preconditions.checkNotNull(charMatcher);
            this.second = (CharMatcher) Preconditions.checkNotNull(charMatcher2);
        }
    ...
    private static final class C2677Is extends FastMatcher {
        ...
        /* JADX INFO: renamed from: or */
        public CharMatcher mo2405or(CharMatcher charMatcher) {
            return charMatcher.matches(this.match) ? charMatcher : super.mo2405or(charMatcher);
        }
