...
public final class Predicates {
    ...
    public static <T> Predicate<T> m2411or(Iterable<? extends Predicate<? super T>> iterable) {
        return new OrPredicate(defensiveCopy(iterable));
    }

    @SafeVarargs
    /* JADX INFO: renamed from: or */
    public static <T> Predicate<T> m2412or(Predicate<? super T>... predicateArr) {
        return new OrPredicate(defensiveCopy(predicateArr));
    }

    /* JADX INFO: renamed from: or */
    public static <T> Predicate<T> m2410or(Predicate<? super T> predicate, Predicate<? super T> predicate2) {
    ...
    public static <T> Predicate<T> m2409in(Collection<? extends T> collection) {
    ...
    private static class CompositionPredicate<A, B> implements Predicate<A>, Serializable {
        ...
        final Function<A, ? extends B> f3763f;

        /* JADX INFO: renamed from: p */
        final Predicate<B> f3764p;

        private CompositionPredicate(Predicate<B> predicate, Function<A, ? extends B> function) {
            this.f3764p = (Predicate) Preconditions.checkNotNull(predicate);
            this.f3763f = (Function) Preconditions.checkNotNull(function);
        }

        @Override // com.google.common.base.Predicate
        public boolean apply(@ParametricNullness A a2) {
            return this.f3764p.apply(this.f3763f.apply(a2));
        }
        ...
        public boolean equals(@CheckForNull Object obj) {
            ...
            return this.f3763f.equals(compositionPredicate.f3763f) && this.f3764p.equals(compositionPredicate.f3764p);
        }

        public int hashCode() {
            return this.f3763f.hashCode() ^ this.f3764p.hashCode();
        }

        public String toString() {
            String strValueOf = String.valueOf(this.f3764p);
            String strValueOf2 = String.valueOf(this.f3763f);
