...
public final class ServiceManager implements ServiceManagerBridge {
    ...
    public ServiceManager(Iterable<? extends Service> iterable) {
        ...
        if (immutableListCopyOf.isEmpty()) {
            ...
            immutableListCopyOf = ImmutableList.m2436of(new NoOpService());
        }
    ...
    private static final class ServiceManagerState {
        ...
        void awaitHealthy(long j, TimeUnit timeUnit) throws TimeoutException {
            ...
            try {
                if (!this.monitor.waitForUninterruptibly(this.awaitHealthGuard, j, timeUnit)) {
                    String strValueOf = String.valueOf(Multimaps.filterKeys((SetMultimap) this.servicesByState, Predicates.m2409in(ImmutableSet.m2484of(Service.State.NEW, Service.State.STARTING))));
        ...
        void awaitStopped(long j, TimeUnit timeUnit) throws TimeoutException {
            ...
            try {
                ...
                String strValueOf = String.valueOf(Multimaps.filterKeys((SetMultimap) this.servicesByState, Predicates.not(Predicates.m2409in(EnumSet.of(Service.State.TERMINATED, Service.State.FAILED)))));
