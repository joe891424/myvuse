...
public abstract class ByteSource {
    ...
    private final class SlicedByteSource extends ByteSource {
        ...
        public Optional<Long> sizeIfKnown() {
            ...
            if (optionalSizeIfKnown.isPresent()) {
                ...
                return Optional.m2408of(Long.valueOf(Math.min(this.length, jLongValue - Math.min(this.offset, jLongValue))));
            }
            return Optional.absent();
        }
    ...
    private static class ByteArrayByteSource extends ByteSource {
        ...
        @Override // com.google.common.p039io.ByteSource
        public Optional<Long> sizeIfKnown() {
            return Optional.m2408of(Long.valueOf(this.length));
        }
    ...
    private static final class ConcatenatedByteSource extends ByteSource {
        ...
        public Optional<Long> sizeIfKnown() {
            ...
            while (it2.hasNext()) {
                ...
                if (jLongValue < 0) {
                    return Optional.m2408of(Long.MAX_VALUE);
                }
            }
            return Optional.m2408of(Long.valueOf(jLongValue));
        }
