...
public final class ImmutableDoubleArray implements Serializable {
    ...
    public static ImmutableDoubleArray m2561of() {
        return EMPTY;
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m2562of(double d) {
        return new ImmutableDoubleArray(new double[]{d});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m2563of(double d, double d2) {
        return new ImmutableDoubleArray(new double[]{d, d2});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m2564of(double d, double d2, double d3) {
        return new ImmutableDoubleArray(new double[]{d, d2, d3});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m2565of(double d, double d2, double d3, double d4) {
        return new ImmutableDoubleArray(new double[]{d, d2, d3, d4});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m2566of(double d, double d2, double d3, double d4, double d5) {
        return new ImmutableDoubleArray(new double[]{d, d2, d3, d4, d5});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m2567of(double d, double d2, double d3, double d4, double d5, double d6) {
        return new ImmutableDoubleArray(new double[]{d, d2, d3, d4, d5, d6});
    }

    /* JADX INFO: renamed from: of */
    public static ImmutableDoubleArray m2568of(double d, double... dArr) {
