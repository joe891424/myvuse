...
public final class MediaType {
    ...
    private static final ImmutableListMultimap<String, String> UTF_8_CONSTANT_PARAMETERS = ImmutableListMultimap.m2449of(CHARSET_ATTRIBUTE, Ascii.toLowerCase(Charsets.UTF_8.name()));
    private static final CharMatcher TOKEN_MATCHER = CharMatcher.ascii().and(CharMatcher.javaIsoControl().negate()).and(CharMatcher.isNot(SafeJsonPrimitive.NULL_CHAR)).and(CharMatcher.noneOf("()<>@,;:\\\"/[]?="));
    ...
    private static final Joiner.MapJoiner PARAMETER_JOINER = Joiner.m2407on("; ").withKeyValueSeparator("=");

    private static MediaType createConstant(String str, String str2) {
        MediaType mediaTypeAddKnownType = addKnownType(new MediaType(str, str2, ImmutableListMultimap.m2448of()));
    ...
    private static MediaType createConstantUtf8(String str, String str2) {
        ...
        mediaTypeAddKnownType.parsedCharset = Optional.m2408of(Charsets.UTF_8);
        return mediaTypeAddKnownType;
    }
    ...
    public Optional<Charset> charset() {
        ...
        if (optionalAbsent == null) {
            ...
            while (it2.hasNext()) {
                ...
                if (str == null) {
                    optionalAbsent = Optional.m2408of(Charset.forName(next));
                    str = next;
    ...
    public MediaType withParameter(String str, String str2) {
        return withParameters(str, ImmutableSet.m2483of(str2));
    }

    public MediaType withCharset(Charset charset) {
        Preconditions.checkNotNull(charset);
        MediaType mediaTypeWithParameter = withParameter(CHARSET_ATTRIBUTE, charset.name());
        mediaTypeWithParameter.parsedCharset = Optional.m2408of(charset);
    ...
    public boolean m2560is(MediaType mediaType) {
    ...
    public static MediaType create(String str, String str2) {
        MediaType mediaTypeCreate = create(str, str2, ImmutableListMultimap.m2448of());
