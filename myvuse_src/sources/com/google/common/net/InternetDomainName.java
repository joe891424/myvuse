...
public final class InternetDomainName {
    ...
    private static final Splitter DOT_SPLITTER = Splitter.m2413on('.');
    private static final Joiner DOT_JOINER = Joiner.m2406on('.');
    ...
    static {
        ...
        CharMatcher charMatcherMo2405or = CharMatcher.inRange('a', 'z').mo2405or(CharMatcher.inRange('A', 'Z'));
        LETTER_MATCHER = charMatcherMo2405or;
        PART_CHAR_MATCHER = charMatcherInRange.mo2405or(charMatcherMo2405or).mo2405or(charMatcherAnyOf);
    }
    ...
    InternetDomainName(String str) {
        ...
        this.registrySuffixIndex = findSuffixOfType(Optional.m2408of(PublicSuffixType.REGISTRY));
    }
