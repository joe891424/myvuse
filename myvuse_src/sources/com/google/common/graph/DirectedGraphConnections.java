...
final class DirectedGraphConnections<N, V> implements GraphConnections<N, V> {
    ...
    static <N, V> DirectedGraphConnections<N, V> m2545of(ElementOrder<N> elementOrder) {
        ArrayList arrayList;
        int i = C29535.$SwitchMap$com$google$common$graph$ElementOrder$Type[elementOrder.type().ordinal()];
        if (i == 1) {
            arrayList = null;
        } else if (i == 2) {
