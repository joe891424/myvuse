...
final class UndirectedGraphConnections<N, V> implements GraphConnections<N, V> {
    ...
    static <N, V> UndirectedGraphConnections<N, V> m2551of(ElementOrder<N> elementOrder) {
        int i = C29731.$SwitchMap$com$google$common$graph$ElementOrder$Type[elementOrder.type().ordinal()];
        if (i == 1) {
