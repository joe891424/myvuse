...
public abstract class AbstractNetwork<N, E> implements Network<N, E> {
    ...
    class C29441 extends AbstractGraph<N> {
        C29441() {
        }
        ...
        public Set<EndpointPair<N>> edges() {
            ...
            return new AbstractSet<EndpointPair<N>>() { // from class: com.google.common.graph.AbstractNetwork.1.1
                ...
                public boolean contains(@CheckForNull Object obj) {
                    ...
                    return C29441.this.isOrderingCompatible(endpointPair) && C29441.this.nodes().contains(endpointPair.nodeU()) && C29441.this.successors(endpointPair.nodeU()).contains(endpointPair.nodeV());
                }
            };
        }
    ...
    public Set<E> adjacentEdges(E e) {
        ...
        return Sets.difference(Sets.union(incidentEdges(endpointPairIncidentNodes.nodeU()), incidentEdges(endpointPairIncidentNodes.nodeV())), ImmutableSet.m2483of((Object) e));
    }
