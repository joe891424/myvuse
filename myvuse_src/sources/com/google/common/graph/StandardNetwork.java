...
class StandardNetwork<N, E> extends AbstractNetwork<N, E> {
    ...
    StandardNetwork(NetworkBuilder<? super N, ? super E> networkBuilder) {
        this(networkBuilder, networkBuilder.nodeOrder.createMap(networkBuilder.expectedNodeCount.mo2402or(10).intValue()), networkBuilder.edgeOrder.createMap(networkBuilder.expectedEdgeCount.mo2402or(20).intValue()));
    }
    ...
    public EndpointPair<N> incidentNodes(E e) {
        ...
        return EndpointPair.m2549of(this, nCheckedReferenceNode, ((NetworkConnections) Objects.requireNonNull(this.nodeConnections.get(nCheckedReferenceNode))).adjacentNode(e));
    }
