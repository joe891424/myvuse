...
abstract class AbstractBaseGraph<N> implements BaseGraph<N> {
    ...
    public Set<EndpointPair<N>> edges() {
        return new AbstractSet<EndpointPair<N>>() { // from class: com.google.common.graph.AbstractBaseGraph.1
            ...
            public UnmodifiableIterator<EndpointPair<N>> iterator() {
                return EndpointPairIterator.m2550of(AbstractBaseGraph.this);
            }
    ...
    public Set<EndpointPair<N>> incidentEdges(N n) {
        ...
        return new C29422(this, this, n);
    }

    /* JADX INFO: renamed from: com.google.common.graph.AbstractBaseGraph$2 */
    class C29422 extends IncidentEdgeSet<N> {
        C29422(AbstractBaseGraph abstractBaseGraph, BaseGraph baseGraph, Object obj) {
            super(baseGraph, obj);
        }
        ...
        public UnmodifiableIterator<EndpointPair<N>> iterator() {
            if (this.graph.isDirected()) {
                return Iterators.unmodifiableIterator(Iterators.concat(Iterators.transform(this.graph.predecessors((Object) this.node).iterator(), new Function() { // from class: com.google.common.graph.AbstractBaseGraph$2$$ExternalSyntheticLambda0
                    ...
                    public final Object apply(Object obj) {
                        return this.f$0.m6287lambda$iterator$0$comgooglecommongraphAbstractBaseGraph$2(obj);
                    }
                }), Iterators.transform(Sets.difference(this.graph.successors((Object) this.node), ImmutableSet.m2483of(this.node)).iterator(), new Function() { // from class: com.google.common.graph.AbstractBaseGraph$2$$ExternalSyntheticLambda1
                    @Override // com.google.common.base.Function
                    public final Object apply(Object obj) {
                        return this.f$0.m6288lambda$iterator$1$comgooglecommongraphAbstractBaseGraph$2(obj);
                    }
                })));
            }
            return Iterators.unmodifiableIterator(Iterators.transform(this.graph.adjacentNodes(this.node).iterator(), new Function() { // from class: com.google.common.graph.AbstractBaseGraph$2$$ExternalSyntheticLambda2
                @Override // com.google.common.base.Function
                public final Object apply(Object obj) {
                    return this.f$0.m6289lambda$iterator$2$comgooglecommongraphAbstractBaseGraph$2(obj);
                }
            }));
        }

        /* JADX INFO: renamed from: lambda$iterator$0$com-google-common-graph-AbstractBaseGraph$2, reason: not valid java name */
        /* synthetic */ EndpointPair m6287lambda$iterator$0$comgooglecommongraphAbstractBaseGraph$2(Object obj) {
        ...
        /* synthetic */ EndpointPair m6288lambda$iterator$1$comgooglecommongraphAbstractBaseGraph$2(Object obj) {
        ...
        /* synthetic */ EndpointPair m6289lambda$iterator$2$comgooglecommongraphAbstractBaseGraph$2(Object obj) {
