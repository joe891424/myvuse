...
public final class ImmutableRangeSet<C extends Comparable> extends AbstractRangeSet<C> implements Serializable {
    ...
    private static final ImmutableRangeSet<Comparable<?>> EMPTY = new ImmutableRangeSet<>(ImmutableList.m2435of());
    private static final ImmutableRangeSet<Comparable<?>> ALL = new ImmutableRangeSet<>(ImmutableList.m2436of(Range.all()));
    ...
    public static <C extends Comparable> ImmutableRangeSet<C> m2480of() {
        return EMPTY;
    }

    /* JADX INFO: renamed from: of */
    public static <C extends Comparable> ImmutableRangeSet<C> m2481of(Range<C> range) {
        ...
        return new ImmutableRangeSet<>(ImmutableList.m2436of(range));
    }
    ...
    public ImmutableRangeSet<C> complement() {
        ...
        if (this.ranges.size() == 1 && this.ranges.get(0).equals(Range.all())) {
            ImmutableRangeSet<C> immutableRangeSetM2480of = m2480of();
            this.complement = immutableRangeSetM2480of;
            return immutableRangeSetM2480of;
        }
    ...
    public ImmutableSortedSet<C> asSet(DiscreteDomain<C> discreteDomain) {
        ...
        if (isEmpty()) {
            return ImmutableSortedSet.m2530of();
        }
    ...
    public static class Builder<C extends Comparable<?>> {
        ...
        public ImmutableRangeSet<C> build() {
            ...
            if (immutableListBuild.isEmpty()) {
                return ImmutableRangeSet.m2480of();
            }
    ...
    private static final class SerializedForm<C extends Comparable> implements Serializable {
        ...
        Object readResolve() {
            ...
            if (this.ranges.equals(ImmutableList.m2436of(Range.all()))) {
                return ImmutableRangeSet.all();
            }
