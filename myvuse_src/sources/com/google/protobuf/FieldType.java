...
public enum FieldType {
    ...
    static {
        ...
        for (FieldType fieldType : fieldTypeArrValues) {
            VALUES[fieldType.f3898id] = fieldType;
        }
    }
    ...
    FieldType(int i, Collection collection, JavaType javaType) {
        ...
        int i3 = C34861.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        if (i3 == 1 || i3 == 2) {
            this.elementType = javaType.getBoxedType();
        } else {
            this.elementType = null;
        }
        this.primitiveScalar = (collection != Collection.SCALAR || (i2 = C34861.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i2 == 2 || i2 == 3) ? false : true;
    }
