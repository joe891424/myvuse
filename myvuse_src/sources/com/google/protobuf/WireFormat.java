...
public final class WireFormat {
    ...
    public static class FieldType {
        ...
        /* synthetic */ FieldType(String str, int i, JavaType javaType, int i2, C35221 c35221) {
    ...
    enum Utf8Validation {
        ...
        /* synthetic */ Utf8Validation(C35221 c35221) {
            this();
        }
    }
    ...
    static Object readPrimitiveField(CodedInputStream codedInputStream, FieldType fieldType, Utf8Validation utf8Validation) throws IOException {
        switch (C35221.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            case 1:
