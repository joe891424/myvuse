...
public class DynamicColors {
    ...
    private static final int[] DYNAMIC_COLOR_THEME_OVERLAY_ATTRIBUTE = {C2309R.attr.dynamicColorThemeOverlay};
    ...
    static {
        ...
        map.put(OTVendorListMode.GOOGLE, deviceSupportCondition);
