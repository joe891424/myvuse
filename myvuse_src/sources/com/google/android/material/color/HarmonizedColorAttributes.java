...
public final class HarmonizedColorAttributes {
    private static final int[] HARMONIZED_MATERIAL_ATTRIBUTES = {C2309R.attr.colorError, C2309R.attr.colorOnError, C2309R.attr.colorErrorContainer, C2309R.attr.colorOnErrorContainer};
    ...
    public static HarmonizedColorAttributes createMaterialDefaults() {
        return create(HARMONIZED_MATERIAL_ATTRIBUTES, C2309R.style.ThemeOverlay_Material3_HarmonizedColors);
    }
