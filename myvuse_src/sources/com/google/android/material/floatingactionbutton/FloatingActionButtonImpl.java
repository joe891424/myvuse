...
class FloatingActionButtonImpl {
    ...
    private AnimatorSet createDefaultAnimator(final float f, final float f2, final float f3) {
        ...
        AnimatorSetCompat.playTogether(animatorSet, arrayList);
        animatorSet.setDuration(MotionUtils.resolveThemeDuration(this.view.getContext(), C2309R.attr.motionDurationLong1, this.view.getContext().getResources().getInteger(C2309R.integer.material_motion_duration_long_1)));
        animatorSet.setInterpolator(MotionUtils.resolveThemeInterpolator(this.view.getContext(), C2309R.attr.motionEasingStandard, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
        return animatorSet;
    }
