...
public class MaterialButtonToggleGroup extends LinearLayout {
    private static final int DEF_STYLE_RES = C2309R.style.Widget_MaterialComponents_MaterialButtonToggleGroup;
    ...
    public MaterialButtonToggleGroup(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C2309R.attr.materialButtonToggleGroupStyle);
    }
    ...
    public MaterialButtonToggleGroup(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, C2309R.styleable.MaterialButtonToggleGroup, i, i2, new int[0]);
        setSingleSelection(typedArrayObtainStyledAttributes.getBoolean(C2309R.styleable.MaterialButtonToggleGroup_singleSelection, false));
        this.defaultCheckId = typedArrayObtainStyledAttributes.getResourceId(C2309R.styleable.MaterialButtonToggleGroup_checkedButton, -1);
        this.selectionRequired = typedArrayObtainStyledAttributes.getBoolean(C2309R.styleable.MaterialButtonToggleGroup_selectionRequired, false);
    ...
    public void addView(View view, int i, ViewGroup.LayoutParams layoutParams) {
        if (!(view instanceof MaterialButton)) {
            LogInstrumentation.m2728e(LOG_TAG, "Child views must be of type MaterialButton.");
            return;
        }
    ...
    private void checkInternal(int i, boolean z) {
        if (i == -1) {
            LogInstrumentation.m2728e(LOG_TAG, "Button ID is not valid: " + i);
            return;
        }
    ...
    protected int getChildDrawingOrder(int i, int i2) {
        ...
        if (numArr == null || i2 >= numArr.length) {
            LogInstrumentation.m2734w(LOG_TAG, "Child order wasn't updated");
            return i2;
        }
