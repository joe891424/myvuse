...
public class ElevationOverlayProvider {
    ...
    public ElevationOverlayProvider(Context context) {
        this(MaterialAttributes.resolveBoolean(context, C2309R.attr.elevationOverlayEnabled, false), MaterialColors.getColor(context, C2309R.attr.elevationOverlayColor, 0), MaterialColors.getColor(context, C2309R.attr.elevationOverlayAccentColor, 0), MaterialColors.getColor(context, C2309R.attr.colorSurface, 0), context.getResources().getDisplayMetrics().density);
    }
