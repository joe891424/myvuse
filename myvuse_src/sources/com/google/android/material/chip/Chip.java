...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable, MaterialCheckable<Chip> {
    ...
    private static final int DEF_STYLE_RES = C2309R.style.Widget_MaterialComponents_Chip_Action;
    ...
    public Chip(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C2309R.attr.chipStyle);
    }
    ...
    public Chip(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C2309R.styleable.Chip, i, i2, new int[0]);
        boolean zHasValue = typedArrayObtainStyledAttributes.hasValue(C2309R.styleable.Chip_shapeAppearance);
    ...
    private void initMinTouchTarget(Context context, AttributeSet attributeSet, int i) {
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, C2309R.styleable.Chip, i, DEF_STYLE_RES, new int[0]);
        this.ensureMinTouchTargetSize = typedArrayObtainStyledAttributes.getBoolean(C2309R.styleable.Chip_ensureMinTouchTargetSize, false);
        this.minTouchTargetSize = (int) Math.ceil(typedArrayObtainStyledAttributes.getDimension(C2309R.styleable.Chip_chipMinTouchTargetSize, (float) Math.ceil(ViewUtils.dpToPx(getContext(), 48))));
        typedArrayObtainStyledAttributes.recycle();
    }
    ...
    private void validateAttributes(AttributeSet attributeSet) {
        ...
        if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, "background") != null) {
            LogInstrumentation.m2734w(TAG, "Do not set the background; Chip manages its own background drawable.");
        }
        ...
        if (attributeSet.getAttributeIntValue(NAMESPACE_ANDROID, "gravity", 8388627) != 8388627) {
            LogInstrumentation.m2734w(TAG, "Chip text must be vertically center and start aligned");
        }
    }
    ...
    public void setBackgroundTintList(ColorStateList colorStateList) {
        LogInstrumentation.m2734w(TAG, "Do not set the background tint list; Chip manages its own background drawable.");
    }

    @Override // android.view.View
    public void setBackgroundTintMode(PorterDuff.Mode mode) {
        LogInstrumentation.m2734w(TAG, "Do not set the background tint mode; Chip manages its own background drawable.");
    }

    @Override // android.view.View
    public void setBackgroundColor(int i) {
        LogInstrumentation.m2734w(TAG, "Do not set the background color; Chip manages its own background drawable.");
    }

    @Override // androidx.appcompat.widget.AppCompatCheckBox, android.view.View
    public void setBackgroundResource(int i) {
        LogInstrumentation.m2734w(TAG, "Do not set the background resource; Chip manages its own background drawable.");
    }
    ...
    public void setBackgroundDrawable(Drawable drawable) {
        if (drawable != getBackgroundDrawable() && drawable != this.ripple) {
            LogInstrumentation.m2734w(TAG, "Do not set the background drawable; Chip manages its own background drawable.");
        } else {
        ...
        protected void onPopulateNodeForVirtualView(int i, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
            if (i == 1) {
                ...
                if (closeIconContentDescription != null) {
                    ...
                    accessibilityNodeInfoCompat.setContentDescription(Chip.this.getContext().getString(C2309R.string.mtrl_chip_close_icon_content_description, TextUtils.isEmpty(text) ? "" : text).trim());
                }
