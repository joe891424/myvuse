...
public class BadgeUtils {
    ...
    public static void detachBadgeDrawable(BadgeDrawable badgeDrawable, Toolbar toolbar, int i) {
        ...
        LogInstrumentation.m2734w(LOG_TAG, "Trying to remove badge from a null menuItemView: " + i);
    }
    ...
    static void setToolbarOffset(BadgeDrawable badgeDrawable, Resources resources) {
        badgeDrawable.setAdditionalHorizontalOffset(resources.getDimensionPixelOffset(C2309R.dimen.mtrl_badge_toolbar_action_menu_item_horizontal_offset));
        badgeDrawable.setAdditionalVerticalOffset(resources.getDimensionPixelOffset(C2309R.dimen.mtrl_badge_toolbar_action_menu_item_vertical_offset));
    }
