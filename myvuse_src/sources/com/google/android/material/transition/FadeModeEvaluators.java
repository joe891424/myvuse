...
class FadeModeEvaluators {
    ...
    private static final FadeModeEvaluator f3687IN = new FadeModeEvaluator() { // from class: com.google.android.material.transition.FadeModeEvaluators.1
    ...
    static FadeModeEvaluator get(int i, boolean z) {
        if (i == 0) {
            return z ? f3687IN : OUT;
        }
        if (i == 1) {
            return z ? OUT : f3687IN;
        }
        if (i == 2) {
            return CROSS;
        }
