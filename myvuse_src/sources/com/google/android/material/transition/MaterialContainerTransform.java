...
public final class MaterialContainerTransform extends Transition {
    ...
    private static void captureValues(TransitionValues transitionValues, View view, int i, ShapeAppearanceModel shapeAppearanceModel) {
        ...
        } else if (transitionValues.view.getTag(C2309R.id.mtrl_motion_snapshot_view) instanceof View) {
            View view2 = (View) transitionValues.view.getTag(C2309R.id.mtrl_motion_snapshot_view);
            transitionValues.view.setTag(C2309R.id.mtrl_motion_snapshot_view, null);
    ...
    private static ShapeAppearanceModel getShapeAppearance(View view, ShapeAppearanceModel shapeAppearanceModel) {
        ...
        if (view.getTag(C2309R.id.mtrl_motion_snapshot_view) instanceof ShapeAppearanceModel) {
            return (ShapeAppearanceModel) view.getTag(C2309R.id.mtrl_motion_snapshot_view);
        }
    ...
    private static int getTransitionShapeAppearanceResId(Context context) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(new int[]{C2309R.attr.transitionShapeAppearance});
    ...
    public Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        if (transitionValues != null && transitionValues2 != null) {
            ...
            if (rectF == null || shapeAppearanceModel == null) {
                LogInstrumentation.m2734w(TAG, "Skipping due to null start bounds. Ensure start view is laid out and measured.");
            } else {
                ...
                if (rectF2 == null || shapeAppearanceModel2 == null) {
                    LogInstrumentation.m2734w(TAG, "Skipping due to null end bounds. Ensure end view is laid out and measured.");
                    return null;
                }
    ...
    private void maybeApplyThemeValues(Context context, boolean z) {
        TransitionUtils.maybeApplyThemeInterpolator(this, context, C2309R.attr.motionEasingStandard, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
        TransitionUtils.maybeApplyThemeDuration(this, context, z ? C2309R.attr.motionDurationLong1 : C2309R.attr.motionDurationMedium2);
        if (this.pathMotionCustom) {
            return;
        }
        TransitionUtils.maybeApplyThemePath(this, context, C2309R.attr.motionPath);
    }
