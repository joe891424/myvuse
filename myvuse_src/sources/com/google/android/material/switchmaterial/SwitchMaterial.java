...
public class SwitchMaterial extends SwitchCompat {
    private static final int DEF_STYLE_RES = C2309R.style.Widget_MaterialComponents_CompoundButton_Switch;
    ...
    public SwitchMaterial(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C2309R.attr.switchStyle);
    }
    ...
    public SwitchMaterial(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C2309R.styleable.SwitchMaterial, i, i2, new int[0]);
        this.useMaterialThemeColors = typedArrayObtainStyledAttributes.getBoolean(C2309R.styleable.SwitchMaterial_useMaterialThemeColors, false);
    ...
    private ColorStateList getMaterialThemeColorsThumbTintList() {
        if (this.materialThemeColorsThumbTintList == null) {
            int color = MaterialColors.getColor(this, C2309R.attr.colorSurface);
            int color2 = MaterialColors.getColor(this, C2309R.attr.colorControlActivated);
            float dimension = getResources().getDimension(C2309R.dimen.mtrl_switch_thumb_elevation);
