...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
    ...
    public static MaterialShapeDrawable createWithElevationOverlay(Context context, float f) {
        int color = MaterialColors.getColor(context, C2309R.attr.colorSurface, "MaterialShapeDrawable");
    ...
    private void drawCompatShadow(Canvas canvas) {
        if (this.containsIncompatibleShadowOp.cardinality() > 0) {
            LogInstrumentation.m2734w(TAG, "Compatibility shadow requested but can't be drawn for all operations in this shape.");
        }
