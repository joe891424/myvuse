...
public class ShapePath {
    ...
    public void lineTo(float f, float f2) {
        ...
        pathLineOperation.f3684x = f;
        pathLineOperation.f3685y = f2;
    ...
    static class LineShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i, Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot(this.operation.f3685y - this.startY, this.operation.f3684x - this.startX), 0.0f);
        ...
        float getAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation.f3685y - this.startY) / (this.operation.f3684x - this.startX)));
        }
    }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        private float f3684x;

        /* JADX INFO: renamed from: y */
        private float f3685y;
        ...
        public void applyToPath(Matrix matrix, Path path) {
            ...
            path.lineTo(this.f3684x, this.f3685y);
