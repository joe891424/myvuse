...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    void initialize() {
        int i;
        float dimensionPixelOffset = this.context.getResources().getDimensionPixelOffset(C2309R.dimen.mtrl_shape_corner_size_small_component);
        float dimensionPixelOffset2 = this.context.getResources().getDimensionPixelOffset(C2309R.dimen.mtrl_exposed_dropdown_menu_popup_elevation);
        int dimensionPixelOffset3 = this.context.getResources().getDimensionPixelOffset(C2309R.dimen.mtrl_exposed_dropdown_menu_popup_vertical_padding);
        ...
        if (this.customEndIcon == 0) {
            i = IS_LOLLIPOP ? C2309R.drawable.mtrl_dropdown_arrow : C2309R.drawable.mtrl_ic_arrow_drop_down;
        } else {
            i = this.customEndIcon;
        }
        this.textInputLayout.setEndIconDrawable(i);
        this.textInputLayout.setEndIconContentDescription(this.textInputLayout.getResources().getText(C2309R.string.exposed_dropdown_menu_content_description));
    ...
    public void addRippleEffect(AutoCompleteTextView autoCompleteTextView) {
        ...
        int color = MaterialColors.getColor(autoCompleteTextView, C2309R.attr.colorControlHighlight);
    ...
    private void addRippleEffectOnOutlinedLayout(AutoCompleteTextView autoCompleteTextView, int i, int[][] iArr, MaterialShapeDrawable materialShapeDrawable) {
        ...
        int color = MaterialColors.getColor(autoCompleteTextView, C2309R.attr.colorSurface);
