...
public class MaterialThemeOverlay {
    private static final int[] ANDROID_THEME_OVERLAY_ATTRS = {R.attr.theme, C2309R.attr.theme};
    private static final int[] MATERIAL_THEME_OVERLAY_ATTR = {C2309R.attr.materialThemeOverlay};
