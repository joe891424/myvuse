...
public class SignInClientImpl extends GmsClient<zaf> implements com.google.android.gms.signin.zae {
    ...
    public final void zaa() {
        try {
            ...
            LogInstrumentation.m2734w("SignInClientImpl", "Remote service probably died when clearAccountFromSessionStore is called");
        }
    }
    ...
    public final void zac(IAccountAccessor iAccountAccessor, boolean z) {
        try {
            ...
            LogInstrumentation.m2734w("SignInClientImpl", "Remote service probably died when saveDefaultAccount is called");
        }
    }
    ...
    public final void zad(zae zaeVar) {
        ...
        try {
            ...
            LogInstrumentation.m2734w("SignInClientImpl", "Remote service probably died when signIn is called");
            try {
