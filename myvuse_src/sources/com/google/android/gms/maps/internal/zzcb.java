...
public final class zzcb {
    ...
    public static zzf zza(Context context, MapsInitializer.Renderer renderer) throws GooglePlayServicesNotAvailableException {
        ...
        String str = zza;
        LogInstrumentation.m2726d(str, "preferredRenderer: ".concat(String.valueOf(String.valueOf(renderer))));
        zzf zzfVar = zzc;
        if (zzfVar != null) {
            return zzfVar;
        }
        ...
        LogInstrumentation.m2730i(str, "Making Creator dynamically");
        try {
    ...
    private static Context zzb(Exception exc, Context context) {
        LogInstrumentation.m2729e(zza, "Failed to load maps module, use pre-Chimera", exc);
    ...
    */
    private static android.content.Context zzc(android.content.Context r2, com.google.android.gms.maps.MapsInitializer.Renderer r3) {
        ...
        L27:
            ...
            com.newrelic.agent.android.instrumentation.LogInstrumentation.m2726d(r3, r1)     // Catch: java.lang.Exception -> L40
