...
public class zzl {
        ...
        try {
            try {
                ...
                try {
                    ...
                    LogInstrumentation.m2731i("GoogleAuthUtil", "Error on service connection.", e);
            ...
            LogInstrumentation.m2734w("GoogleAuthUtil", String.format("SecurityException while bind to auth service: %s", e2.getMessage()));
    ...
    private static Object zzj(Object obj) throws IOException {
        ...
        zzd.m2377w("Service call returned null.", new Object[0]);
    ...
    private static void zzl(ApiException apiException, String str) {
        zzd.m2377w("%s failed via GoogleAuthServiceClient, falling back to previous approach:\n%s", str, Log.getStackTraceString(apiException));
    }
    ...
    public static void zzn(Context context, String str, String str2, Intent intent, PendingIntent pendingIntent) throws GoogleAuthException, IOException {
        ...
        Logger logger = zzd;
        logger.m2377w(String.format("[GoogleAuthUtil] error status:%s with method:%s", zzbyVarZza, str), new Object[0]);
        ...
        if (GoogleApiAvailability.getInstance().getApkVersion(context) >= Integer.MAX_VALUE && pendingIntent == null) {
            logger.m2373e(String.format("Recovery PendingIntent is missing on current Gms version: %s for method: %s. It should always be present on or above Gms version %s. This indicates a bug in Gms implementation.", Integer.MAX_VALUE, str, Integer.MAX_VALUE), new Object[0]);
        }
        if (intent == null) {
            logger.m2373e(String.format("no recovery Intent found with status=%s for method=%s. This shouldn't happen", str2, str), new Object[0]);
        }
        throw new UserRecoverableAuthException(str2, intent);
    }
