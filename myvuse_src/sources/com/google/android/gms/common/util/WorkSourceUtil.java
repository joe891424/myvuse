...
public class WorkSourceUtil {
    ...
    static {
        ...
        if (PlatformVersion.isAtLeastP()) {
            try {
                ...
                LogInstrumentation.m2735w("WorkSourceUtil", "Missing WorkChain API createWorkChain", e);
                method6 = null;
            }
        } else {
            method6 = null;
        ...
        if (PlatformVersion.isAtLeastP()) {
            try {
                ...
                LogInstrumentation.m2735w("WorkSourceUtil", "Missing WorkChain class", e2);
                method7 = null;
            }
        } else {
            method7 = null;
        ...
        if (context != null && context.getPackageManager() != null && str != null) {
            try {
                ...
                if (applicationInfo == null) {
                    LogInstrumentation.m2728e("WorkSourceUtil", "Could not get applicationInfo from package: ".concat(str));
                    return null;
                }
                ...
                LogInstrumentation.m2728e("WorkSourceUtil", "Could not find package: ".concat(str));
            }
        }
        return null;
    }
    ...
    public static WorkSource fromPackageAndModuleExperimentalPi(Context context, String str, String str2) {
        ...
        if (context == null || context.getPackageManager() == null || str2 == null || str == null) {
            LogInstrumentation.m2734w("WorkSourceUtil", "Unexpected null arguments");
            return null;
        }
        int i = -1;
        try {
        ...
        if (method2 == null || (method = zzh) == null) {
            ...
            try {
                ...
                LogInstrumentation.m2735w("WorkSourceUtil", "Unable to assign chained blame through WorkSource", e);
            }
        }
        return workSource;
    }
    ...
    public static boolean isEmpty(WorkSource workSource) {
        ...
        if (method != null) {
            try {
                ...
                LogInstrumentation.m2729e("WorkSourceUtil", "Unable to check WorkSource emptiness", e);
            }
        }
