...
public final class zaaw implements zabf {
    ...
    public final boolean zaG(int i) {
        ...
        LogInstrumentation.m2734w("GACConnecting", this.zaa.zag.zaf());
        LogInstrumentation.m2734w("GACConnecting", "Unexpected callback in ".concat(toString()));
        LogInstrumentation.m2734w("GACConnecting", "mRemainingConnections=" + this.zah);
        LogInstrumentation.m2729e("GACConnecting", "GoogleApiClient connecting is in step " + zaJ(this.zag) + " but received callback for step " + zaJ(i), new Exception());
