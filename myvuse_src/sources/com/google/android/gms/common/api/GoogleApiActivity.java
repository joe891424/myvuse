...
public class GoogleApiActivity extends Activity implements DialogInterface.OnCancelListener, TraceFieldInterface {
    ...
    private final void zab() {
        ...
        if (extras == null) {
            LogInstrumentation.m2728e("GoogleApiActivity", "Activity started without extras");
            finish();
            return;
        }
        ...
        if (pendingIntent == null && num == null) {
            LogInstrumentation.m2728e("GoogleApiActivity", "Activity started without resolution");
            finish();
            return;
        }
        ...
        try {
            ...
            if (extras.getBoolean("notify_manager", true)) {
                ...
                LogInstrumentation.m2729e("GoogleApiActivity", strConcat, e);
            }
            this.zaa = 1;
            finish();
        } catch (IntentSender.SendIntentException e2) {
            LogInstrumentation.m2729e("GoogleApiActivity", "Failed to launch pendingIntent", e2);
            finish();
        }
    }
