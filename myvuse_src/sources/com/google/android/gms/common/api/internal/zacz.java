    ...
    public final void handleMessage(Message message) {
        ...
        if (i != 0) {
            if (i == 1) {
                ...
                LogInstrumentation.m2728e("TransformedResultImpl", "Runtime exception on the transformation worker thread: ".concat(String.valueOf(runtimeException.getMessage())));
                throw runtimeException;
            }
            LogInstrumentation.m2728e("TransformedResultImpl", "TransformationResultHandler received unknown message type: " + message.what);
            return;
        }
