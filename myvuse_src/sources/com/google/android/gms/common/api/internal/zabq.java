...
public final class zabq implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, zau {
    ...
    private final boolean zaL(zai zaiVar) {
        ...
        LogInstrumentation.m2734w("GoogleApiManager", this.zac.getClass().getName() + " could not execute call because it requires feature (" + featureZaB.getName() + ", " + featureZaB.getVersion() + ").");
        ...
        googleApiManager3.zar.sendMessageDelayed(Message.obtain(googleApiManager3.zar, 16, zabsVar), PayloadController.PAYLOAD_REQUEUE_PERIOD_MS);
    ...
    public final void zao() {
        ...
        try {
            ...
            if (iZab != 0) {
                ...
                LogInstrumentation.m2734w("GoogleApiManager", "The service for " + this.zac.getClass().getName() + " is not available: " + connectionResult.toString());
                zar(connectionResult, null);
                return;
            }
            GoogleApiManager googleApiManager2 = this.zaa;
