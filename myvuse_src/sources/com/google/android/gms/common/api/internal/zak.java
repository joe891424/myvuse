...
public final class zak extends zap {
    ...
    public final void onStart() {
        super.onStart();
        LogInstrumentation.m2726d("AutoManageHelper", "onStart " + this.zaa + " " + String.valueOf(this.zad));
    ...
    protected final void zab(ConnectionResult connectionResult, int i) {
        LogInstrumentation.m2734w("AutoManageHelper", "Unresolved error while connecting client. Stopping auto-manage.");
        if (i < 0) {
    ...
    public final void zad(int i, GoogleApiClient googleApiClient, GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
        ...
        LogInstrumentation.m2726d("AutoManageHelper", "starting AutoManage for client " + i + " " + this.zaa + " " + String.valueOf(zamVar));
        ...
        if (this.zaa && zamVar == null) {
            LogInstrumentation.m2726d("AutoManageHelper", "connecting ".concat(googleApiClient.toString()));
