    ...
    public final boolean handleMessage(Message message) {
        ...
        switch (i) {
            ...
            case 2:
                ...
                while (true) {
                    if (it2.hasNext()) {
                        ApiKey apiKey2 = (ApiKey) it2.next();
            ...
            case 10:
                ...
                while (it4.hasNext()) {
                    zabq zabqVar5 = (zabq) this.zan.remove((ApiKey) it4.next());
                    if (zabqVar5 != null) {
                        zabqVar5.zav();
                    }
                }
            ...
            case 19:
                ...
                return true;
            default:
                LogInstrumentation.m2734w("GoogleApiManager", "Unknown message id: " + message.what);
                return false;
        }
    }
