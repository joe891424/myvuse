...
public final class zzs extends AbstractSafeParcelable {
        ...
        if (iBinder != null) {
            try {
                ...
                if (bArr != null) {
                    ...
                    LogInstrumentation.m2728e("GoogleCertificatesQuery", "Could not unwrap certificate");
                }
            } catch (RemoteException e) {
                LogInstrumentation.m2729e("GoogleCertificatesQuery", "Could not unwrap certificate", e);
            }
        }
        this.zzb = zzkVar;
        this.zzc = z;
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        zzj zzjVar = this.zzb;
        if (zzjVar == null) {
            LogInstrumentation.m2734w("GoogleCertificatesQuery", "certificate binder is null");
            zzjVar = null;
        }
