...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:53:0x0135, code lost:
        ...
        com.newrelic.agent.android.instrumentation.LogInstrumentation.m2726d("DataHolder", "Couldn't populate window data for row " + r4 + " - allocating new window.");
        r2.freeLastRow();
    ...
    protected final void finalize() throws Throwable {
        try {
            if (this.zak && this.zah.length > 0 && !isClosed()) {
                close();
                LogInstrumentation.m2728e("DataBuffer", "Internal data leak within a DataBuffer object detected!  Be sure to explicitly call release() on all DataBuffer extending objects when you are done with them. (internal object: " + toString() + ")");
            }
        } finally {
            super.finalize();
        }
