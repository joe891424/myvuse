...
final class zzn {
    ...
    static /* synthetic */ String zzd(boolean z, String str, zzj zzjVar) throws Exception {
        ...
        MessageDigest messageDigestZza = AndroidUtilsLight.zza(HashUtil.SHA_256);
    ...
    static synchronized void zze(Context context) {
        if (zzg != null) {
            LogInstrumentation.m2734w("GoogleCertificates", "GoogleCertificates has been initialized already");
    ...
    static boolean zzf() {
        ...
        try {
            ...
            LogInstrumentation.m2729e("GoogleCertificates", "Failed to get Google certificates from remote", e);
            zZzg = false;
        }
        return zZzg;
    }
    ...
    private static zzx zzh(final String str, final zzj zzjVar, final boolean z, boolean z2) {
        try {
            ...
            LogInstrumentation.m2729e("GoogleCertificates", "Failed to get Google certificates from remote", e2);
