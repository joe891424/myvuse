...
public class GooglePlayServicesUtilLight {
    ...
    public static void cancelAvailabilityErrorNotifications(Context context) {
        ...
        try {
            ...
            LogInstrumentation.m2727d("GooglePlayServicesUtil", "Suppressing Security Exception %s in cancelAvailabilityErrorNotifications.", e);
        }
    }
    ...
    public static void ensurePlayServicesAvailable(Context context, int i) throws GooglePlayServicesRepairableException, GooglePlayServicesNotAvailableException {
        ...
        if (iIsGooglePlayServicesAvailable != 0) {
            Intent errorResolutionIntent = GoogleApiAvailabilityLight.getInstance().getErrorResolutionIntent(context, iIsGooglePlayServicesAvailable, RsaJsonWebKey.EXPONENT_MEMBER_NAME);
            LogInstrumentation.m2728e("GooglePlayServicesUtil", "GooglePlayServices not available due to error " + iIsGooglePlayServicesAvailable);
    ...
    public static int getApkVersion(Context context) {
        try {
            ...
            LogInstrumentation.m2734w("GooglePlayServicesUtil", "Google Play services is missing.");
            return 0;
        }
    }
    ...
    public static boolean honorsDebugCertificates(Context context) {
        try {
            ...
            LogInstrumentation.m2735w("GooglePlayServicesUtil", "Cannot find Google Play services package name.", e);
        } finally {
            zza = true;
        }
