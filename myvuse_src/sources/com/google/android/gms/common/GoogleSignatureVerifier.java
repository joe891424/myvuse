...
public class GoogleSignatureVerifier {
    ...
    static final zzj zza(PackageInfo packageInfo, zzj... zzjVarArr) {
        if (packageInfo.signatures != null) {
            if (packageInfo.signatures.length != 1) {
                LogInstrumentation.m2734w("GoogleSignatureVerifier", "Package has more than one signature.");
                return null;
            }
    ...
    public boolean isGooglePublicSignedPackage(PackageInfo packageInfo) {
        ...
        if (zzb(packageInfo, true)) {
            ...
            LogInstrumentation.m2734w("GoogleSignatureVerifier", "Test-keys aren't accepted on this build.");
        }
        return false;
    }
