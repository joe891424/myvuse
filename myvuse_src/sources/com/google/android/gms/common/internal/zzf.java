    ...
    protected final boolean zzd() {
        try {
            ...
            if (!this.zzf.getServiceDescriptor().equals(interfaceDescriptor)) {
                LogInstrumentation.m2734w("GmsClient", "service descriptor mismatch: " + this.zzf.getServiceDescriptor() + " vs. " + interfaceDescriptor);
                return false;
            }
            ...
            LogInstrumentation.m2734w("GmsClient", "service probably died");
            return false;
        }
    }
}
