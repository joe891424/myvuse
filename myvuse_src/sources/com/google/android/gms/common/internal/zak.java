...
public final class zak implements Handler.Callback {
    ...
    public final void zaf(GoogleApiClient.ConnectionCallbacks connectionCallbacks) {
        ...
        synchronized (this.zai) {
            if (this.zac.contains(connectionCallbacks)) {
                LogInstrumentation.m2734w("GmsClientEvents", "registerConnectionCallbacks(): listener " + String.valueOf(connectionCallbacks) + " is already registered");
            } else {
    ...
    public final void zag(GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
        ...
        synchronized (this.zai) {
            if (this.zad.contains(onConnectionFailedListener)) {
                LogInstrumentation.m2734w("GmsClientEvents", "registerConnectionFailedListener(): listener " + String.valueOf(onConnectionFailedListener) + " is already registered");
            } else {
    ...
    public final void zah(GoogleApiClient.ConnectionCallbacks connectionCallbacks) {
        ...
        synchronized (this.zai) {
            if (!this.zac.remove(connectionCallbacks)) {
                LogInstrumentation.m2734w("GmsClientEvents", "unregisterConnectionCallbacks(): listener " + String.valueOf(connectionCallbacks) + " not found");
            } else if (this.zag) {
    ...
    public final void zai(GoogleApiClient.OnConnectionFailedListener onConnectionFailedListener) {
        ...
        synchronized (this.zai) {
            if (!this.zad.remove(onConnectionFailedListener)) {
                LogInstrumentation.m2734w("GmsClientEvents", "unregisterConnectionFailedListener(): listener " + String.valueOf(onConnectionFailedListener) + " not found");
            }
        }
    }
