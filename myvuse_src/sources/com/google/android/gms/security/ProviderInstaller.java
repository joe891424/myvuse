...
public class ProviderInstaller {
    ...
    public static void installIfNeeded(Context context) throws GooglePlayServicesRepairableException, GooglePlayServicesNotAvailableException {
        ...
        synchronized (zzb) {
            ...
            try {
                ...
                LogInstrumentation.m2734w("ProviderInstaller", "Failed to load providerinstaller module: ".concat(String.valueOf(e.getMessage())));
                moduleContext = null;
            }
            ...
            if (remoteContext != null) {
                try {
                    ...
                    LogInstrumentation.m2734w("ProviderInstaller", "Failed to report request stats: ".concat(String.valueOf(e2.getMessage())));
                }
            }
            if (remoteContext != null) {
                zzc(remoteContext, context, "com.google.android.gms.common.security.ProviderInstallerImpl");
            } else {
                LogInstrumentation.m2728e("ProviderInstaller", "Failed to get remote context");
    ...
    public static void installIfNeededAsync(Context context, ProviderInstallListener providerInstallListener) {
        ...
        zza zzaVar = new zza(context, providerInstallListener);
        Void[] voidArr = new Void[0];
        if (zzaVar instanceof AsyncTask) {
            AsyncTaskInstrumentation.execute(zzaVar, voidArr);
        } else {
            zzaVar.execute(voidArr);
        }
    }
    ...
    private static void zzc(Context context, Context context2, String str) throws GooglePlayServicesNotAvailableException {
        try {
            ...
            if (Log.isLoggable("ProviderInstaller", 6)) {
                LogInstrumentation.m2728e("ProviderInstaller", "Failed to install provider: ".concat(String.valueOf(cause == null ? e.getMessage() : cause.getMessage())));
            }
            throw new GooglePlayServicesNotAvailableException(8);
        }
    }
