...
final class zzi extends GmsClient {
    zzi(Context context, Looper looper, ClientSettings clientSettings, ConnectionCallbacks connectionCallbacks, OnConnectionFailedListener onConnectionFailedListener) {
        super(context, looper, ISO7816Kt.INS_CREATE_FILE, clientSettings, connectionCallbacks, onConnectionFailedListener);
    }
    ...
    public final void disconnect(String str) {
        LogInstrumentation.m2734w("GoogleAuthSvcClientImpl", "GoogleAuthServiceClientImpl disconnected with reason: ".concat(String.valueOf(str)));
