...
public final class zzge implements Parcelable.Creator<zzgf> {
    ...
    public final /* synthetic */ zzgf createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < iValidateObjectHeader) {
            ...
            switch (SafeParcelReader.getFieldId(header)) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    arrayListCreateTypedList = SafeParcelReader.createTypedList(parcel, header, zzgn.CREATOR);
                    break;
                case 11:
                    arrayListCreateTypedList2 = SafeParcelReader.createTypedList(parcel, header, zzgb.CREATOR);
                    break;
                default:
        ...
        return new zzgf(i, rect, f, f2, f3, f4, f5, f6, f7, arrayListCreateTypedList, arrayListCreateTypedList2);
    }
}
