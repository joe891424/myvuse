...
public final class zzk {
    ...
    public static long zza(byte[] bArr) {
        ...
        if (length <= 32) {
            ...
            if (length >= 4) {
                return zza(((long) length) + ((((long) zza(bArr, 0)) & InternalZipConstants.ZIP_64_SIZE_LIMIT) << 3), ((long) zza(bArr, length - 4)) & InternalZipConstants.ZIP_64_SIZE_LIMIT, ((long) (length << 1)) - 7286425919675154353L);
            }
            if (length <= 0) {
                return -7286425919675154353L;
            }
            long j3 = (((long) ((bArr[0] & 255) + ((bArr[length >> 1] & 255) << 8))) * (-7286425919675154353L)) ^ (((long) (length + ((bArr[length - 1] & 255) << 2))) * (-4348849565147123417L));
        ...
        while (true) {
            ...
            if (i9 == i7) {
                ...
                long j9 = jArr2[c2] + ((long) i8);
                jArr2[c2] = j9;
                long j10 = jArr[c2] + j9;
                jArr[c2] = j10;
                jArr2[c2] = jArr2[c2] + j10;
                long jRotateRight5 = Long.rotateRight(jRotateRight4 + jZzb13 + jArr[c2] + zzb(bArr, i4 - 55), 37) * j8;
                long jRotateRight6 = Long.rotateRight(jZzb13 + jArr[1] + zzb(bArr, i4 - 15), 42) * j8;
                long j11 = jRotateRight5 ^ (jArr2[1] * 9);
                long jZzb14 = jRotateRight6 + (jArr[c2] * 9) + zzb(bArr, i4 - 23);
                ...
                return zza(zza(jArr[c2], jArr2[c2], j8) + (((jZzb14 >>> 47) ^ jZzb14) * (-4348849565147123417L)) + j11, zza(jArr[1], jArr2[1], j8) + jRotateRight7, j8);
            }
            i6 = i9;
            i3 = i8;
            i2 = i7;
