...
public final class zzp implements ClearcutLogger.zza {
    ...
    private static zzgw.zza.zzb zza(String str) {
        ...
        if (iIndexOf2 <= 0) {
            ...
            LogInstrumentation.m2728e("LogSamplerImpl", strValueOf.length() != 0 ? "Failed to parse the rule: ".concat(strValueOf) : new String("Failed to parse the rule: "));
            return null;
        }
        try {
            ...
            LogInstrumentation.m2728e("LogSamplerImpl", new StringBuilder(72).append("negative values not supported: ").append(j).append("/").append(j2).toString());
            return null;
        } catch (NumberFormatException e) {
            String strValueOf2 = String.valueOf(str);
            LogInstrumentation.m2729e("LogSamplerImpl", strValueOf2.length() != 0 ? "parseLong() failed while parsing: ".concat(strValueOf2) : new String("parseLong() failed while parsing: "), e);
            return null;
        }
    }
