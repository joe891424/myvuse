...
final class zzkp implements Runnable {
    ...
    public final void run() throws Throwable {
        ...
        int responseCode = 0;
        try {
            URLConnection uRLConnectionZza = com.google.android.gms.internal.measurement.zzcn.zza().zza(this.zza, "client-measurement");
            ...
            try {
                ...
                try {
                    ...
                    byte[] bArrZza = zzkn.zza(httpURLConnection);
