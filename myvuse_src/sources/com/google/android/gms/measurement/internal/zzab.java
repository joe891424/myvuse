...
abstract class zzab {
    ...
    private static Boolean zza(BigDecimal bigDecimal, zzff.zzd zzdVar, double d) {
        ...
        if (zzdVar.zzh() && zzdVar.zza() != zzff.zzd.zzb.UNKNOWN_COMPARISON_TYPE) {
            ...
            zzff.zzd.zzb zzbVarZza = zzdVar.zza();
            if (zzdVar.zza() == zzff.zzd.zzb.BETWEEN) {
            ...
            if (zzbVarZza == zzff.zzd.zzb.BETWEEN) {
                if (bigDecimal3 == null) {
                    return null;
                }
            } else if (bigDecimal2 != null) {
            }
            int i = zzv.zzb[zzbVarZza.ordinal()];
            if (i != 1) {
                if (i != 2) {
                    if (i != 3) {
    ...
    static Boolean zza(String str, zzff.zzf zzfVar, zzfw zzfwVar) {
        ...
        zzff.zzf.zzb zzbVarZzb = zzfVar.zzb();
        boolean zZzg = zzfVar.zzg();
        if (zZzg || zzbVarZzb == zzff.zzf.zzb.REGEXP || zzbVarZzb == zzff.zzf.zzb.IN_LIST) {
            strZze = zzfVar.zze();
        } else {
        ...
        return zza(str, zzbVarZzb, zZzg, str2, list, zzbVarZzb == zzff.zzf.zzb.REGEXP ? str2 : null, zzfwVar);
    }
