...
final class zzat extends SQLiteOpenHelper {
    ...
    public final void onOpen(SQLiteDatabase sQLiteDatabase) {
        ...
        zzas.zza(this.zza.zzj(), sQLiteDatabase, "consent_settings", "CREATE TABLE IF NOT EXISTS consent_settings ( app_id TEXT NOT NULL, consent_state TEXT NOT NULL, PRIMARY KEY (app_id));", "app_id,consent_state", zzan.zzj);
        if (zzpd.zza()) {
