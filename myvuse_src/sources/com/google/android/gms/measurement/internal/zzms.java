...
public final class zzms {
    ...
    public static zzms zza(SharedPreferences sharedPreferences) {
        ...
        String strZzb = zzb(sharedPreferences, OTIABTCFKeys.IABTCF_VENDORCONSENTS);
        ...
        int iZza = zza(sharedPreferences, OTIABTCFKeys.IABTCF_GDPRAPPLIES);
        if (iZza != -1) {
        ...
        int iZza3 = zza(sharedPreferences, OTIABTCFKeys.IABTCF_POLICYVERSION);
        if (iZza3 != -1) {
            map.put("PolicyVersion", String.valueOf(iZza3));
        }
        String strZzb2 = zzb(sharedPreferences, OTIABTCFKeys.IABTCF_PURPOSECONSENTS);
        if (!WebViewProviderFactoryBoundaryInterface.MULTI_COOKIE_VALUE_SEPARATOR.equals(strZzb2)) {
            map.put("PurposeConsents", strZzb2);
        }
        int iZza4 = zza(sharedPreferences, OTIABTCFKeys.IABTCF_CMPSDKID);
        if (iZza4 != -1) {
