...
public class FlagProviderImpl extends com.google.android.gms.flags.zzd {
    ...
    public void init(IObjectWrapper iObjectWrapper) {
        ...
        try {
            ...
            LogInstrumentation.m2734w("FlagProviderImpl", strValueOf.length() != 0 ? "Could not retrieve sdk flags, continuing with defaults: ".concat(strValueOf) : new String("Could not retrieve sdk flags, continuing with defaults: "));
        }
    }
