...
abstract class zzs {
    ...
    final void zzc(zzt zztVar) {
        if (Log.isLoggable("MessengerIpcClient", 3)) {
            LogInstrumentation.m2726d("MessengerIpcClient", "Failing " + toString() + " with " + zztVar.toString());
        }
    ...
    final void zzd(Object obj) {
        if (Log.isLoggable("MessengerIpcClient", 3)) {
            LogInstrumentation.m2726d("MessengerIpcClient", "Finishing " + toString() + " with " + String.valueOf(obj));
        }
