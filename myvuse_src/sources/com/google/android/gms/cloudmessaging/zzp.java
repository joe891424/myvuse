...
final class zzp implements ServiceConnection {
    ...
    final Messenger zzb = new Messenger(new com.google.android.gms.internal.cloudmessaging.zzf(Looper.getMainLooper(), new Handler.Callback() { // from class: com.google.android.gms.cloudmessaging.zzm
        ...
        public final boolean handleMessage(Message message) {
            ...
            if (Log.isLoggable("MessengerIpcClient", 3)) {
                LogInstrumentation.m2726d("MessengerIpcClient", "Received response to request: " + i);
            }
            zzp zzpVar = this.zza;
            synchronized (zzpVar) {
                zzs zzsVar = (zzs) zzpVar.zze.get(i);
                if (zzsVar == null) {
                    LogInstrumentation.m2734w("MessengerIpcClient", "Received response for unknown request: " + i);
                    return true;
                }
                zzpVar.zze.remove(i);
                zzpVar.zzf();
    ...
    public final void onServiceConnected(ComponentName componentName, final IBinder iBinder) {
        if (Log.isLoggable("MessengerIpcClient", 2)) {
            LogInstrumentation.m2732v("MessengerIpcClient", "Service connected");
        }
    ...
    public final void onServiceDisconnected(ComponentName componentName) {
        if (Log.isLoggable("MessengerIpcClient", 2)) {
            LogInstrumentation.m2732v("MessengerIpcClient", "Service disconnected");
        }
    ...
    final synchronized void zzb(int i, String str, Throwable th) {
        if (Log.isLoggable("MessengerIpcClient", 3)) {
            LogInstrumentation.m2726d("MessengerIpcClient", "Disconnected: ".concat(String.valueOf(str)));
        }
        int i2 = this.zza;
        if (i2 == 0) {
        ...
        if (Log.isLoggable("MessengerIpcClient", 2)) {
            LogInstrumentation.m2732v("MessengerIpcClient", "Unbinding service");
        }
        this.zza = 4;
        ...
        this.zzf.zzc.execute(new Runnable() { // from class: com.google.android.gms.cloudmessaging.zzj
            ...
            public final void run() {
                ...
                while (true) {
                    ...
                    if (Log.isLoggable("MessengerIpcClient", 3)) {
                        LogInstrumentation.m2726d("MessengerIpcClient", "Sending ".concat(String.valueOf(String.valueOf(zzsVar))));
                    }
    ...
    final synchronized void zze(int i) {
        ...
        if (zzsVar != null) {
            LogInstrumentation.m2734w("MessengerIpcClient", "Timing out request: " + i);
            this.zze.remove(i);
    ...
    final synchronized void zzf() {
        if (this.zza == 2 && this.zzd.isEmpty() && this.zze.size() == 0) {
            if (Log.isLoggable("MessengerIpcClient", 2)) {
                LogInstrumentation.m2732v("MessengerIpcClient", "Finished handling requests, unbinding");
            }
            this.zza = 3;
            ConnectionTracker.getInstance().unbindService(this.zzf.zzb, this);
        }
    ...
    final synchronized boolean zzg(zzs zzsVar) {
        ...
        if (Log.isLoggable("MessengerIpcClient", 2)) {
            LogInstrumentation.m2732v("MessengerIpcClient", "Starting bind to GmsCore");
        }
        this.zza = 1;
