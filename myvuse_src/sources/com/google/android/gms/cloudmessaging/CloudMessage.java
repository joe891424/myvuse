...
public final class CloudMessage extends AbstractSafeParcelable {
    ...
    public long getSentTime() {
        ...
        try {
            ...
            LogInstrumentation.m2734w("CloudMessage", "Invalid sent time: ".concat(String.valueOf(String.valueOf(obj))));
            return 0L;
        }
    }

    public String getTo() {
        return this.zza.getStringExtra(Constants.MessagePayloadKeys.f3849TO);
    }
    ...
    public int getTtl() {
        ...
        try {
            ...
            LogInstrumentation.m2734w("CloudMessage", "Invalid TTL: ".concat(String.valueOf(String.valueOf(obj))));
            return 0;
        }
    }
