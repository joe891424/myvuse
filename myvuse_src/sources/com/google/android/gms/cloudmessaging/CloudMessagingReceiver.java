    ...
    private final int zzb(Context context, Intent intent) {
        ...
        if (pendingIntent != null) {
            try {
                ...
                LogInstrumentation.m2728e("CloudMessagingReceiver", "Notification pending intent canceled");
            }
        }
        ...
        LogInstrumentation.m2728e("CloudMessagingReceiver", "Unknown notification action");
        return 500;
    }
            ...
            if (intent2 != null) {
                ...
                try {
                    if (!countDownLatch.await(TimeUnit.SECONDS.toMillis(1L), TimeUnit.MILLISECONDS)) {
                        LogInstrumentation.m2734w("CloudMessagingReceiver", "Message ack timed out");
                    }
                } catch (InterruptedException e) {
                    LogInstrumentation.m2734w("CloudMessagingReceiver", "Message ack failed: ".concat(e.toString()));
                }
