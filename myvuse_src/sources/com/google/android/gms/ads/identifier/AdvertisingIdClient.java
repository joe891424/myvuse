...
public class AdvertisingIdClient {
                ...
                if (advertisingIdClient.zzc) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            LogInstrumentation.m2731i("AdvertisingIdClient", "GMS remote exception ", e);
    ...
    public final void zza() {
        ...
        synchronized (this) {
            ...
            try {
                ...
                LogInstrumentation.m2731i("AdvertisingIdClient", "AdvertisingIdClient unbindService failed.", th);
            }
            this.zzc = false;
            this.zzb = null;
            this.zza = null;
    ...
    final boolean zzc(Info info, boolean z, float f, long j, String str, Throwable th) {
        ...
        map.put(HeaderParameterNames.AUTHENTICATION_TAG, "AdvertisingIdClient");
