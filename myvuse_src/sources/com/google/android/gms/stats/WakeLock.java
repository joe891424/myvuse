...
public class WakeLock {
    ...
    public static /* synthetic */ void zza(WakeLock wakeLock) {
        synchronized (wakeLock.zzf) {
            if (wakeLock.isHeld()) {
                LogInstrumentation.m2728e("WakeLock", String.valueOf(wakeLock.zzp).concat(" ** IS FORCE-RELEASED ON TIMEOUT **"));
                wakeLock.zzc();
                if (wakeLock.isHeld()) {
                    wakeLock.zzh = 1;
                    wakeLock.zzd(0);
                ...
                try {
                    if (this.zzg.isHeld()) {
                        try {
                            ...
                            LogInstrumentation.m2729e("WakeLock", String.valueOf(this.zzp).concat(" failed to release!"), e);
                            if (this.zza != null) {
                                this.zza = null;
                            }
                        }
                    } else {
                        LogInstrumentation.m2728e("WakeLock", String.valueOf(this.zzp).concat(" should be held!"));
                    }
                } catch (Throwable th) {
                    if (this.zza != null) {
                        this.zza = null;
    ...
    public void release() {
        if (this.zzt.decrementAndGet() < 0) {
            LogInstrumentation.m2728e("WakeLock", String.valueOf(this.zzp).concat(" release without a matched acquire!"));
        }
        synchronized (this.zzf) {
            zzb(null);
            if (this.zzs.containsKey(null)) {
                ...
                LogInstrumentation.m2734w("WakeLock", String.valueOf(this.zzp).concat(" counter does not exist"));
            }
            zzd(0);
        }
    }
