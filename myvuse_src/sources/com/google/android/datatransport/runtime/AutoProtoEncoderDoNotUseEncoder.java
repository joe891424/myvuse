...
public final class AutoProtoEncoderDoNotUseEncoder implements Configurator {
    ...
    private static final class ProtoEncoderDoNotUseEncoder implements ObjectEncoder<ProtoEncoderDoNotUse> {
        ...
        private static final FieldDescriptor CLIENTMETRICS_DESCRIPTOR = FieldDescriptor.m2628of("clientMetrics");
    ...
    private static final class LogEventDroppedEncoder implements ObjectEncoder<LogEventDropped> {
        ...
        private static final FieldDescriptor REASON_DESCRIPTOR = FieldDescriptor.builder(AnalyticsAttribute.APP_EXIT_REASON_ATTRIBUTE).withProperty(AtProtobuf.builder().tag(3).build()).build();
