...
public final class RSSExpandedReader extends AbstractRSSReader {
    ...
    private static final int[] EVEN_TOTAL_SUBSET = {4, 20, 52, 104, OTUIDisplayReasonCode.UIShownCode.PC_SHOWN_TC_STRING_EXPIRED};
    private static final int[] GSUM = {0, 348, 1388, 2948, 3988};
    private static final int[][] FINDER_PATTERNS = {new int[]{1, 8, 4, 1}, new int[]{3, 6, 4, 1}, new int[]{3, 4, 6, 1}, new int[]{3, 2, 8, 1}, new int[]{2, 6, 5, 1}, new int[]{2, 2, 9, 1}};
    private static final int[][] WEIGHTS = {new int[]{1, 3, 9, 27, 81, 32, 96, 77}, new int[]{20, 60, RotationOptions.ROTATE_180, 118, 143, 7, 21, 63}, new int[]{189, 145, 13, 39, 117, 140, OTUIDisplayReasonCode.UIShownCode.PC_SHOWN_MOVED_REGION, OTUIDisplayReasonCode.UIShownCode.PC_SHOWN_CONSENT_EXPIRED}, new int[]{193, 157, 49, 147, 19, 57, 171, 91}, new int[]{62, 186, 136, 197, 169, 85, 44, 132}, new int[]{185, FirmwareInstallationState.Error.ERROR_BLE_LINK_LOSS_GATT, 188, 142, 4, 12, 36, 108}, new int[]{113, 128, 173, 97, 80, 29, 87, 50}, new int[]{150, 28, 84, 41, 123, 158, 52, 156}, new int[]{46, 138, OTUIDisplayReasonCode.UIShownCode.PC_SHOWN_RE_CONSENT_EXPIRED, 187, 139, OTUIDisplayReasonCode.UIShownCode.PC_SHOWN_SERVICE_SPECIFIC_OFF, 196, 166}, new int[]{76, 17, 51, 153, 37, OTUIDisplayReasonCode.UIShownCode.BANNER_SHOWN_NEW_GROUP_ADDED, 122, 155}, new int[]{43, 129, ISO7816Kt.INS_READ_BINARY, 106, 107, OTUIDisplayReasonCode.UIShownCode.BANNER_SHOWN_SHOW_BANNER_CALLED, 119, 146}, new int[]{16, 48, 144, 10, 30, 90, 59, 177}, new int[]{109, 116, 137, 200, 178, 112, 125, ISO7816Kt.INS_SELECT}, new int[]{70, OTUIDisplayReasonCode.UIShownCode.PC_SHOWN_SHOW_PC_CALLED, 208, OTUIDisplayReasonCode.UIShownCode.PC_SHOWN_RE_CONSENT, 184, ISO7816Kt.INS_EXTERNAL_AUTHENTICATE, 179, ModuleDescriptor.MODULE_VERSION}, new int[]{134, 191, 151, 31, 93, 68, OTUIDisplayReasonCode.UIShownCode.PC_SHOWN_TC_STRING_EXPIRED, 190}, new int[]{148, 22, 66, 198, 172, 94, 71, 2}, new int[]{6, 18, 54, 162, 64, JfifUtil.MARKER_SOFn, 154, 40}, new int[]{120, 149, 25, 75, 14, 42, WebSocketProtocol.PAYLOAD_SHORT, 167}, new int[]{79, 26, 78, 23, 69, OTUIDisplayReasonCode.UIShownCode.PC_SHOWN_SYNC_FAILED, 199, 175}, new int[]{103, 98, 83, 38, 114, 131, 182, 124}, new int[]{161, 61, 183, 127, 170, 88, 53, 159}, new int[]{55, 165, 73, 8, 24, 72, 5, 15}, new int[]{45, 135, 194, 160, 58, 174, 100, 89}};
    ...
    private static boolean isPartialRow(Iterable<ExpandedPair> iterable, Iterable<ExpandedRow> iterable2) {
        for (ExpandedRow expandedRow : iterable2) {
            for (ExpandedPair expandedPair : iterable) {
                ...
                while (it2.hasNext()) {
                    if (expandedPair.equals(it2.next())) {
                        break;
                    }
                }
            }
    ...
    private boolean checkChecksum() {
        ...
        return ((i + (-4)) * OTUIDisplayReasonCode.UIShownCode.PC_SHOWN_NEW_GROUP_ADDED) + (checksumPortion % OTUIDisplayReasonCode.UIShownCode.PC_SHOWN_NEW_GROUP_ADDED) == leftChar.getValue();
    }
