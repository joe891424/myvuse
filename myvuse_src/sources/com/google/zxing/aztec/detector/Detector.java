...
public final class Detector {
    ...
    static final class Point {
        ...
        private final int f3945x;

        /* JADX INFO: renamed from: y */
        private final int f3946y;

        ResultPoint toResultPoint() {
            return new ResultPoint(this.f3945x, this.f3946y);
        }
        ...
        public String toString() {
            return "<" + this.f3945x + SafeJsonPrimitive.NULL_CHAR + this.f3946y + Typography.greater;
        }
    }
}
