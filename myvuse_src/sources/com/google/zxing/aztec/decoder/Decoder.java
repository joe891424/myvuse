...
public final class Decoder {
    ...
    private static final String[] LOWER_TABLE = {"CTRL_PS", " ", "a", "b", "c", "d", RsaJsonWebKey.EXPONENT_MEMBER_NAME, "f", "g", "h", ContextChain.TAG_INFRA, "j", OctetSequenceJsonWebKey.KEY_VALUE_MEMBER_NAME, "l", "m", RsaJsonWebKey.MODULUS_MEMBER_NAME, "o", "p", RsaJsonWebKey.SECOND_PRIME_FACTOR_MEMBER_NAME, RsaJsonWebKey.PRIME_FACTOR_OTHER_MEMBER_NAME, "s", RsaJsonWebKey.FACTOR_CRT_COEFFICIENT, "u", "v", "w", EllipticCurveJsonWebKey.X_MEMBER_NAME, EllipticCurveJsonWebKey.Y_MEMBER_NAME, "z", "CTRL_US", "CTRL_ML", "CTRL_DL", "CTRL_BS"};
    ...
    private static String getCharacter(Table table, int i) {
        int i2 = C35571.$SwitchMap$com$google$zxing$aztec$decoder$Decoder$Table[table.ordinal()];
        if (i2 == 1) {
