...
public final class VINParsedResult extends ParsedResult {
    ...
    public String getDisplayResult() {
        ...
        sb.append(this.worldManufacturerID).append(SafeJsonPrimitive.NULL_CHAR);
        sb.append(this.vehicleDescriptorSection).append(SafeJsonPrimitive.NULL_CHAR);
        sb.append(this.vehicleIdentifierSection).append('\n');
        String str = this.countryCode;
        if (str != null) {
            sb.append(str).append(SafeJsonPrimitive.NULL_CHAR);
        }
        sb.append(this.modelYear).append(SafeJsonPrimitive.NULL_CHAR);
        sb.append(this.plantCode).append(SafeJsonPrimitive.NULL_CHAR);
