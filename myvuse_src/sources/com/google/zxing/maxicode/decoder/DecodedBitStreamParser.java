...
final class DecodedBitStreamParser {
    ...
    private static final char f3948FS = 28;

    /* JADX INFO: renamed from: GS */
    private static final char f3949GS = 29;
    ...
    private static final char f3950NS = 65531;
    private static final char PAD = 65532;

    /* JADX INFO: renamed from: RS */
    private static final char f3951RS = 30;
    ...
    static DecoderResult decode(byte[] bArr, int i) {
        ...
        if (i == 2 || i == 3) {
            ...
            if (sb.toString().startsWith("[)>\u001e01\u001d")) {
                sb.insert(9, postCode3 + f3949GS + str + f3949GS + str2 + f3949GS);
            } else {
                sb.insert(0, postCode3 + f3949GS + str + f3949GS + str2 + f3949GS);
            }
        } else if (i == 4) {
    ...
    private static int getPostCode2Length(byte[] bArr) {
        return getInt(bArr, new byte[]{39, 40, 41, 42, Ascii.f3759US, 32});
    }

    private static int getPostCode2(byte[] bArr) {
        return getInt(bArr, new byte[]{33, 34, 35, 36, Ascii.f3748EM, Ascii.SUB, Ascii.ESC, Ascii.f3750FS, Ascii.f3751GS, Ascii.f3755RS, 19, Ascii.DC4, Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, Ascii.f3747CR, Ascii.f3757SO, Ascii.f3756SI, Ascii.DLE, 17, Ascii.DC2, 7, 8, 9, 10, Ascii.f3760VT, Ascii.f3749FF, 1, 2});
    }

    private static String getPostCode3(byte[] bArr) {
        String[] strArr = SETS;
        return String.valueOf(new char[]{strArr[0].charAt(getInt(bArr, new byte[]{39, 40, 41, 42, Ascii.f3759US, 32})), strArr[0].charAt(getInt(bArr, new byte[]{33, 34, 35, 36, Ascii.f3748EM, Ascii.SUB})), strArr[0].charAt(getInt(bArr, new byte[]{Ascii.ESC, Ascii.f3750FS, Ascii.f3751GS, Ascii.f3755RS, 19, Ascii.DC4})), strArr[0].charAt(getInt(bArr, new byte[]{Ascii.NAK, Ascii.SYN, Ascii.ETB, Ascii.CAN, Ascii.f3747CR, Ascii.f3757SO})), strArr[0].charAt(getInt(bArr, new byte[]{Ascii.f3756SI, Ascii.DLE, 17, Ascii.DC2, 7, 8})), strArr[0].charAt(getInt(bArr, new byte[]{9, 10, Ascii.f3760VT, Ascii.f3749FF, 1, 2}))});
    }
        ...
        while (i3 < i + i2) {
            ...
            switch (cCharAt) {
                ...
                default:
                    ...
                    break;
                case 65531:
                    int i7 = (bArr[i3 + 1] << Ascii.CAN) + (bArr[i3 + 2] << Ascii.DC2) + (bArr[i3 + 3] << Ascii.f3749FF) + (bArr[i3 + 4] << 6);
                    i3 += 5;
