...
public class FirebaseRemoteConfig {
    ...
    public Task<Boolean> activate() {
        ...
        return Tasks.whenAllComplete((Task<?>[]) new Task[]{task, task2}).continueWithTask(this.executor, new Continuation() { // from class: com.google.firebase.remoteconfig.FirebaseRemoteConfig$$ExternalSyntheticLambda0
            ...
            public final Object then(Task task3) {
                return this.f$0.m2668x98ca96b0(task, task2, task3);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$activate$2$com-google-firebase-remoteconfig-FirebaseRemoteConfig */
    /* synthetic */ Task m2668x98ca96b0(Task task, Task task2, Task task3) throws Exception {
    ...
    public Task<Void> setConfigSettingsAsync(final FirebaseRemoteConfigSettings firebaseRemoteConfigSettings) {
        return Tasks.call(this.executor, new Callable() { // from class: com.google.firebase.remoteconfig.FirebaseRemoteConfig$$ExternalSyntheticLambda5
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.f$0.m2671xd6203cf5(firebaseRemoteConfigSettings);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$setConfigSettingsAsync$5$com-google-firebase-remoteconfig-FirebaseRemoteConfig */
    /* synthetic */ Void m2671xd6203cf5(FirebaseRemoteConfigSettings firebaseRemoteConfigSettings) throws Exception {
    ...
    public boolean processActivatePutTask(Task<ConfigContainer> task) {
        ...
        LogInstrumentation.m2728e(TAG, "Activated configs written to disk are null.");
        return true;
    }
    ...
    private Task<Void> setDefaultsWithStringsMapAsync(Map<String, String> map) {
        try {
            ...
            LogInstrumentation.m2729e(TAG, "The provided defaults map could not be processed.", e);
            return Tasks.forResult(null);
        }
    }
    ...
    void updateAbtWithActivatedExperiments(JSONArray jSONArray) {
        ...
        try {
            ...
            LogInstrumentation.m2735w(TAG, "Could not update ABT experiments.", e);
        } catch (JSONException e2) {
            LogInstrumentation.m2729e(TAG, "Could not parse ABT experiments from the JSON response.", e2);
        }
    }
