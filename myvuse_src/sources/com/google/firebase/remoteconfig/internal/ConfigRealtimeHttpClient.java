...
public class ConfigRealtimeHttpClient {
    ...
    private String getFingerprintHashForPackage() {
        try {
            ...
            LogInstrumentation.m2728e(FirebaseRemoteConfig.TAG, "Could not get fingerprint hash for package: " + this.context.getPackageName());
            return null;
        } catch (PackageManager.NameNotFoundException unused) {
            LogInstrumentation.m2730i(FirebaseRemoteConfig.TAG, "No such package: " + this.context.getPackageName());
            return null;
        }
    }
    ...
    public void setRequestParams(HttpURLConnection httpURLConnection, String str, String str2) throws IOException {
        ...
        JSONObject jSONObjectCreateRequestBody = createRequestBody(str);
        byte[] bytes = (!(jSONObjectCreateRequestBody instanceof JSONObject) ? jSONObjectCreateRequestBody.toString() : JSONObjectInstrumentation.toString(jSONObjectCreateRequestBody)).getBytes("utf-8");
    ...
    */
    ...
    private URL getUrl() {
        try {
            ...
            LogInstrumentation.m2728e(FirebaseRemoteConfig.TAG, "URL is malformed");
            return null;
        }
    }
    ...
    public Task<HttpURLConnection> createRealtimeConnection() {
        ...
        return Tasks.whenAllComplete((Task<?>[]) new Task[]{token, id}).continueWithTask(this.scheduledExecutorService, new Continuation() { // from class: com.google.firebase.remoteconfig.internal.ConfigRealtimeHttpClient$$ExternalSyntheticLambda0
            ...
            public final Object then(Task task) {
                return this.f$0.m2680xad28ecdf(token, id, task);
            }
        });
    }
    ...
    /* synthetic */ Task m2680xad28ecdf(Task task, Task task2, Task task3) throws Exception {
        ...
        if (canMakeHttpStreamConnection()) {
            if (new Date(this.clock.currentTimeMillis()).before(this.metadataClient.getRealtimeBackoffMetadata().getBackoffEndTime())) {
                ...
                Tasks.whenAllComplete((Task<?>[]) new Task[]{taskCreateRealtimeConnection}).continueWith(this.scheduledExecutorService, new Continuation() { // from class: com.google.firebase.remoteconfig.internal.ConfigRealtimeHttpClient$$ExternalSyntheticLambda1
                    @Override // com.google.android.gms.tasks.Continuation
                    public final Object then(Task task) {
                        return this.f$0.m2679x5fb1dc1(taskCreateRealtimeConnection, task);
                    }
                });
            }
        }
    ...
    /* synthetic */ Task m2679x5fb1dc1(Task task, Task task2) throws Exception {
        Integer num;
        Throwable th;
        Integer numValueOf;
        ...
        try {
            ...
            try {
                ...
                e = e2;
                LogInstrumentation.m2727d(FirebaseRemoteConfig.TAG, "Exception connecting to real-time RC backend. Retrying the connection...", e);
                closeRealtimeHttpStream(task);
                setIsHttpConnectionRunning(false);
                if (numValueOf != null && !isStatusCodeRetryable(numValueOf.intValue())) {
                    z = false;
