...
public class ConfigCacheClient {
    ...
    ConfigContainer getBlocking(long j) {
        synchronized (this) {
            ...
            try {
                ...
                LogInstrumentation.m2727d(FirebaseRemoteConfig.TAG, "Reading from storage file failed.", e);
                return null;
            }
        }
    }
    ...
    /* synthetic */ Void m2673xddaae01c(ConfigContainer configContainer) throws Exception {
    ...
    public Task<ConfigContainer> put(final ConfigContainer configContainer, final boolean z) {
        return Tasks.call(this.executor, new Callable() { // from class: com.google.firebase.remoteconfig.internal.ConfigCacheClient$$ExternalSyntheticLambda0
            ...
            public final Object call() {
                return this.f$0.m2673xddaae01c(configContainer);
            }
            ...
            public final Task then(Object obj) {
                return this.f$0.m2674x9820809d(z, configContainer, (Void) obj);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$put$1$com-google-firebase-remoteconfig-internal-ConfigCacheClient */
    /* synthetic */ Task m2674x9820809d(boolean z, ConfigContainer configContainer, Void r3) throws Exception {
        if (z) {
