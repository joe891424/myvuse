...
import androidx.core.content.p031pm.PackageInfoCompat;
...
public class ConfigFetchHttpClient {
    ...
    ConfigFetchHandler.FetchResponse fetch(HttpURLConnection httpURLConnection, String str, String str2, Map<String, String> map, String str3, Map<String, String> map2, Long l, Date date) throws FirebaseRemoteConfigException {
        ...
        try {
            try {
                JSONObject jSONObjectCreateFetchRequestBody = createFetchRequestBody(str, str2, map, l);
                if (jSONObjectCreateFetchRequestBody instanceof JSONObject) {
                    JSONObject jSONObject = jSONObjectCreateFetchRequestBody;
                    string = JSONObjectInstrumentation.toString(jSONObjectCreateFetchRequestBody);
                } else {
                    string = jSONObjectCreateFetchRequestBody.toString();
                }
                setFetchRequestBody(httpURLConnection, string.getBytes("utf-8"));
    ...
    private String getFingerprintHashForPackage() {
        try {
            ...
            LogInstrumentation.m2729e(FirebaseRemoteConfig.TAG, "No such package: " + this.context.getPackageName(), e);
            return null;
        }
    }
