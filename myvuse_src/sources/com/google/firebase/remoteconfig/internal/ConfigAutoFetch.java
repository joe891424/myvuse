    ...
    public void listenForNotifications() {
        ...
        try {
            try {
                ...
                LogInstrumentation.m2727d(FirebaseRemoteConfig.TAG, "Stream was cancelled due to an exception. Retrying the connection...", e);
            }
        } finally {
    ...
    */
    private void handleNotifications(java.io.InputStream r10) throws java.io.IOException {
        ...
        L7d:
            ...
            com.newrelic.agent.android.instrumentation.LogInstrumentation.m2729e(r5, r6, r4)
            goto L12
        L97:
            r2.close()
            r10.close()
    ...
    public synchronized Task<Void> fetchLatestConfig(int i, final long j) {
        ...
        return Tasks.whenAllComplete((Task<?>[]) new Task[]{taskFetchNowWithTypeAndAttemptNumber, task}).continueWithTask(this.scheduledExecutorService, new Continuation() { // from class: com.google.firebase.remoteconfig.internal.ConfigAutoFetch$$ExternalSyntheticLambda0
            ...
            public final Object then(Task task2) {
                return this.f$0.m2672xc4c7076e(taskFetchNowWithTypeAndAttemptNumber, task, j, i2, task2);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$fetchLatestConfig$0$com-google-firebase-remoteconfig-internal-ConfigAutoFetch */
    /* synthetic */ Task m2672xc4c7076e(Task task, Task task2, long j, int i, Task task3) throws Exception {
        ...
        if (!fetchResponseIsUpToDate(fetchResponse, j).booleanValue()) {
            LogInstrumentation.m2726d(FirebaseRemoteConfig.TAG, "Fetched template version is the same as SDK's current version. Retrying fetch.");
            autoFetch(i, j);
            return Tasks.forResult(null);
        }
        if (fetchResponse.getFetchedConfigs() == null) {
            LogInstrumentation.m2726d(FirebaseRemoteConfig.TAG, "The fetch succeeded, but the backend had no updates.");
            return Tasks.forResult(null);
        }
        ...
        if (changedParams.isEmpty()) {
            LogInstrumentation.m2726d(FirebaseRemoteConfig.TAG, "Config was fetched, but no params changed.");
            return Tasks.forResult(null);
        }
