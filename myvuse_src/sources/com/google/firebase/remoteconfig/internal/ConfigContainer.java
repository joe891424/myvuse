...
public class ConfigContainer {
    ...
    private static ConfigContainer deepCopyOf(JSONObject jSONObject) throws JSONException {
        return copyOf(new JSONObject(!(jSONObject instanceof JSONObject) ? jSONObject.toString() : JSONObjectInstrumentation.toString(jSONObject)));
    }
        ...
        while (itKeys.hasNext()) {
            ...
            if (!configContainer.getConfigs().has(next)) {
                ...
                if (getPersonalizationMetadata().has(next) && configContainer.getPersonalizationMetadata().has(next)) {
                    ...
                    if (!string.equals(!(jSONObject2 instanceof JSONObject) ? jSONObject2.toString() : JSONObjectInstrumentation.toString(jSONObject2))) {
                        hashSet.add(next);
                    }
                }
    ...
    public static class Builder {
        ...
        public Builder replaceConfigsWith(JSONObject jSONObject) {
            ...
            try {
                ...
                this.builderConfigsJson = new JSONObject(string);
        ...
        public Builder withAbtExperiments(JSONArray jSONArray) {
            ...
            try {
                ...
                this.builderAbtExperiments = new JSONArray(string);
            } catch (JSONException unused) {
            }
            return this;
        }
        ...
        public Builder withPersonalizationMetadata(JSONObject jSONObject) {
            ...
            try {
                ...
                this.builderPersonalizationMetadata = new JSONObject(string);
            } catch (JSONException unused) {
            }
            return this;
        }
        ...
        public Builder withRolloutMetadata(JSONArray jSONArray) {
            ...
            try {
                ...
                this.builderRolloutMetadata = new JSONArray(string);
            } catch (JSONException unused) {
            }
            return this;
        }
