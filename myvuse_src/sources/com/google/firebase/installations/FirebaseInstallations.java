...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    /* synthetic */ void m2632xc18eb11d() {
        m2633x7147f7aa(false);
    }
    ...
    public final void m2633x7147f7aa(final boolean z) {
    ...
    public void m2631x5a306a82(boolean z) {
    ...
    private PersistedInstallationEntry registerFidWithServer(PersistedInstallationEntry persistedInstallationEntry) throws FirebaseInstallationsException {
        ...
        int i = C32203.f3844xc38d2559[installationResponseCreateFirebaseInstallation.getResponseCode().ordinal()];
        if (i == 1) {
    ...
    private PersistedInstallationEntry fetchAuthTokenFromServer(PersistedInstallationEntry persistedInstallationEntry) throws FirebaseInstallationsException {
        ...
        int i = C32203.f3845xe5baa01a[tokenResultGenerateAuthToken.getResponseCode().ordinal()];
        if (i == 1) {
    ...
    static /* synthetic */ class C32203 {
        ...
        static {
            ...
            try {
                f3845xe5baa01a[TokenResult.ResponseCode.BAD_CONFIG.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f3845xe5baa01a[TokenResult.ResponseCode.AUTH_ERROR.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            int[] iArr2 = new int[InstallationResponse.ResponseCode.values().length];
            f3844xc38d2559 = iArr2;
            try {
                iArr2[InstallationResponse.ResponseCode.OK.ordinal()] = 1;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f3844xc38d2559[InstallationResponse.ResponseCode.BAD_CONFIG.ordinal()] = 2;
