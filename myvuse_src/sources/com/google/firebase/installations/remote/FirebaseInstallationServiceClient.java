...
public class FirebaseInstallationServiceClient {
    ...
    private static void logBadConfigError() {
        LogInstrumentation.m2728e(FIS_TAG, "Firebase Installations can not communicate with Firebase server APIs due to invalid configuration. Please update your Firebase initialization process and set valid Firebase options (API key, Project ID, Application ID) when initializing Firebase.");
    }
        ...
        try {
            ...
            if (heartBeatController != null) {
                try {
                    ...
                    LogInstrumentation.m2735w("ContentValues", "Failed to get heartbeats header", e);
                } catch (ExecutionException e2) {
                    LogInstrumentation.m2735w("ContentValues", "Failed to get heartbeats header", e2);
                }
            }
    ...
    private String getFingerprintHashForPackage() {
        try {
            ...
            LogInstrumentation.m2728e("ContentValues", "Could not get fingerprint hash for package: " + this.context.getPackageName());
            return null;
        } catch (PackageManager.NameNotFoundException e) {
            LogInstrumentation.m2729e("ContentValues", "No such package: " + this.context.getPackageName(), e);
            return null;
        }
    }
    ...
    private static void logFisCommunicationError(HttpURLConnection httpURLConnection, String str, String str2, String str3) {
        ...
        LogInstrumentation.m2734w(FIS_TAG, errorResponse);
        LogInstrumentation.m2734w(FIS_TAG, availableFirebaseOptions(str, str2, str3));
    }
