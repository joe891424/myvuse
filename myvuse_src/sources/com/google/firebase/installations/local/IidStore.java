...
public class IidStore {
    ...
    private static String getIdFromPublicKey(PublicKey publicKey) {
        try {
            ...
            bArrDigest[0] = (byte) (((bArrDigest[0] & Ascii.f3756SI) + 112) & 255);
            return Base64.encodeToString(bArrDigest, 0, 8, 11);
        } catch (NoSuchAlgorithmException unused) {
            LogInstrumentation.m2734w("ContentValues", "Unexpected error, device missing required algorithms");
            return null;
        }
    }
    ...
    private PublicKey parseKey(String str) {
        try {
            ...
            LogInstrumentation.m2734w("ContentValues", "Invalid key stored " + e);
            return null;
        }
    }
}
