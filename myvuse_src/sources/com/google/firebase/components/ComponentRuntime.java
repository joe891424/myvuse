...
public class ComponentRuntime implements ComponentContainer, ComponentLoader {
    ...
    private ComponentRuntime(Executor executor, Iterable<Provider<ComponentRegistrar>> iterable, Collection<Component<?>> collection, ComponentRegistrarProcessor componentRegistrarProcessor) {
        ...
        arrayList.add(Component.m2595of(eventBus, (Class<EventBus>) EventBus.class, (Class<? super EventBus>[]) new Class[]{Subscriber.class, Publisher.class}));
        arrayList.add(Component.m2595of(this, (Class<ComponentRuntime>) ComponentLoader.class, (Class<? super ComponentRuntime>[]) new Class[0]));
        ...
        synchronized (this) {
            ...
            while (it2.hasNext()) {
                try {
                    ...
                    it2.remove();
                    LogInstrumentation.m2735w("ComponentDiscovery", "Invalid component registrar.", e);
                }
            }
            ...
            for (final Component<?> component : list) {
                this.components.put(component, new Lazy(new Provider() { // from class: com.google.firebase.components.ComponentRuntime$$ExternalSyntheticLambda2
                    @Override // com.google.firebase.inject.Provider
                    public final Object get() {
                        return this.f$0.m2596xc080f8d8(component);
                    }
                }));
            }
    ...
    /* synthetic */ Object m2596xc080f8d8(Component component) {
    ...
    public <T> Deferred<T> getDeferred(Qualified<T> qualified) {
        ...
        return OptionalProvider.m2597of(provider);
    }
    ...
    public void initializeEagerComponents(boolean z) {
        HashMap map;
        if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m1161m(this.eagerComponentsInitializedWith, null, Boolean.valueOf(z))) {
            synchronized (this) {
