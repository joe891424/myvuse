...
public final class Component<T> {
    ...
    public static <T> Component<T> m2593of(Class<T> cls, final T t) {
    ...
    @SafeVarargs
    /* JADX INFO: renamed from: of */
    public static <T> Component<T> m2595of(final T t, Class<T> cls, Class<? super T>... clsArr) {
    ...
    @SafeVarargs
    /* JADX INFO: renamed from: of */
    public static <T> Component<T> m2594of(final T t, Qualified<T> qualified, Qualified<? super T>... qualifiedArr) {
