...
public final class FirebaseSessionsDependencies {
    ...
    public static final void addDependency(SessionSubscriber.Name subscriberName) {
        ...
        if (dependencies2.containsKey(subscriberName)) {
            LogInstrumentation.m2726d(TAG, "Dependency " + subscriberName + " already added.");
            return;
        }
        ...
        LogInstrumentation.m2726d(TAG, "Dependency to " + subscriberName + " added.");
    }
    ...
    public static final void register(SessionSubscriber subscriber) {
        ...
        if (dependency.getSubscriber() != null) {
            LogInstrumentation.m2726d(TAG, "Subscriber " + sessionSubscriberName + " already registered.");
            return;
        }
        dependency.setSubscriber(subscriber);
        LogInstrumentation.m2726d(TAG, "Subscriber " + sessionSubscriberName + " registered.");
