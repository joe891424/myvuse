...
@DebugMetadata(m5607c = "com.google.firebase.sessions.SessionLifecycleClient$ClientUpdateHandler$handleSessionUpdate$1", m5608f = "SessionLifecycleClient.kt", m5609i = {}, m5610l = {74}, m5611m = "invokeSuspend", m5612n = {}, m5613s = {})
final class SessionLifecycleClient$ClientUpdateHandler$handleSessionUpdate$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        for (SessionSubscriber sessionSubscriber : collectionValues) {
            ...
            LogInstrumentation.m2726d(SessionLifecycleClient.TAG, "Notified " + sessionSubscriber.getSessionSubscriberName() + " of new session " + str);
        }
