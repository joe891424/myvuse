...
public final class SessionFirelogPublisherImpl implements SessionFirelogPublisher {
    ...
    @DebugMetadata(m5607c = "com.google.firebase.sessions.SessionFirelogPublisherImpl", m5608f = "SessionFirelogPublisher.kt", m5609i = {0}, m5610l = {94}, m5611m = "shouldLogSession", m5612n = {"this"}, m5613s = {"L$0"})
    static final class C32961 extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C32961(Continuation<? super C32961> continuation) {
            super(continuation);
        }
    ...
    @DebugMetadata(m5607c = "com.google.firebase.sessions.SessionFirelogPublisherImpl$logSession$1", m5608f = "SessionFirelogPublisher.kt", m5609i = {2}, m5610l = {HtmlCompat.FROM_HTML_MODE_COMPACT, 64, 70}, m5611m = "invokeSuspend", m5612n = {"installationId"}, m5613s = {"L$0"})
    static final class C32951 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C32951(SessionDetails sessionDetails, Continuation<? super C32951> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return SessionFirelogPublisherImpl.this.new C32951(this.$sessionDetails, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C32951) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r12) {
            ...
            Lbb:
                ...
                return r12
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.sessions.SessionFirelogPublisherImpl.C32951.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
    ...
    public void logSession(SessionDetails sessionDetails) {
        ...
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(this.backgroundDispatcher), null, null, new C32951(sessionDetails, null), 3, null);
    }
    ...
    public final void attemptLoggingSessionEvent(SessionEvent sessionEvent) {
        try {
            ...
            LogInstrumentation.m2726d(TAG, "Successfully logged Session Start event: " + sessionEvent.getSessionData().getSessionId());
        } catch (RuntimeException e) {
            LogInstrumentation.m2729e(TAG, "Error logging Session Start event to DataTransport: ", e);
        }
    }
    ...
    */
    public final java.lang.Object shouldLogSession(kotlin.coroutines.Continuation<? super java.lang.Boolean> r6) {
        /*
            r5 = this;
            boolean r0 = r6 instanceof com.google.firebase.sessions.SessionFirelogPublisherImpl.C32961
            if (r0 == 0) goto L14
            r0 = r6
            com.google.firebase.sessions.SessionFirelogPublisherImpl$shouldLogSession$1 r0 = (com.google.firebase.sessions.SessionFirelogPublisherImpl.C32961) r0
            int r1 = r0.label
        ...
        L38:
            ...
            com.newrelic.agent.android.instrumentation.LogInstrumentation.m2726d(r3, r6)
