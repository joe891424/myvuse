...
public final class SessionLifecycleClient {
    ...
    public SessionLifecycleClient(CoroutineContext backgroundDispatcher) {
        ...
        this.serviceConnection = new ServiceConnection() { // from class: com.google.firebase.sessions.SessionLifecycleClient$serviceConnection$1
            ...
            public void onServiceConnected(ComponentName className, IBinder serviceBinder) {
                LogInstrumentation.m2726d(SessionLifecycleClient.TAG, "Connected to SessionLifecycleService. Queue size " + this.this$0.queuedMessages.size());
            ...
            public void onServiceDisconnected(ComponentName className) {
                LogInstrumentation.m2726d(SessionLifecycleClient.TAG, "Disconnected from SessionLifecycleService");
    ...
    /* JADX INFO: compiled from: SessionLifecycleClient.kt */
    @Metadata(m5597d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0000\u0018\u00002\u00020\u0001B\r\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\u0010\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0016J\u0010\u0010\t\u001a\u00020\u00062\u0006\u0010\n\u001a\u00020\u000bH\u0002R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\f"}, m5598d2 = {"Lcom/google/firebase/sessions/SessionLifecycleClient$ClientUpdateHandler;", "Landroid/os/Handler;", "backgroundDispatcher", "Lkotlin/coroutines/CoroutineContext;", "(Lkotlin/coroutines/CoroutineContext;)V", "handleMessage", "", NotificationCompat.CATEGORY_MESSAGE, "Landroid/os/Message;", "handleSessionUpdate", "sessionId", "", "com.google.firebase-firebase-sessions"}, m5599k = 1, m5600mv = {1, 8, 0}, m5602xi = 48)
    public static final class ClientUpdateHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            LogInstrumentation.m2734w(SessionLifecycleClient.TAG, "Received unexpected event from the SessionLifecycleService: " + msg);
            super.handleMessage(msg);
        }

        private final void handleSessionUpdate(String sessionId) {
            LogInstrumentation.m2726d(SessionLifecycleClient.TAG, "Session update received: " + sessionId);
    ...
    @DebugMetadata(m5607c = "com.google.firebase.sessions.SessionLifecycleClient$sendLifecycleEvents$1", m5608f = "SessionLifecycleClient.kt", m5609i = {}, m5610l = {151}, m5611m = "invokeSuspend", m5612n = {}, m5613s = {})
    static final class C32981 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ List<Message> $messages;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C32981(List<Message> list, Continuation<? super C32981> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return SessionLifecycleClient.this.new C32981(this.$messages, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C32981) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            Map map = (Map) obj;
            if (map.isEmpty()) {
                LogInstrumentation.m2726d(SessionLifecycleClient.TAG, "Sessions SDK did not have any dependent SDKs register as dependencies. Events will not be sent.");
            } else {
                Collection collectionValues = map.values();
                if ((collectionValues instanceof Collection) && collectionValues.isEmpty()) {
                    LogInstrumentation.m2726d(SessionLifecycleClient.TAG, "Data Collection is disabled for all subscribers. Skipping this Event");
                } else {
    ...
    public final Job sendLifecycleEvents(List<Message> messages) {
        return BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(this.backgroundDispatcher), null, null, new C32981(messages, null), 3, null);
    }
    ...
    public final void sendMessageToServer(Message msg) {
        ...
        try {
            LogInstrumentation.m2726d(TAG, "Sending lifecycle " + msg.what + " to service");
            Messenger messenger = this.service;
            if (messenger != null) {
                messenger.send(msg);
            }
        } catch (RemoteException e) {
            LogInstrumentation.m2735w(TAG, "Unable to deliver message: " + msg.what, e);
            queueMessage(msg);
        }
    }
    ...
    private final void queueMessage(Message msg) {
        if (this.queuedMessages.offer(msg)) {
            LogInstrumentation.m2726d(TAG, "Queued message " + msg.what + ". Queue size " + this.queuedMessages.size());
        } else {
            LogInstrumentation.m2726d(TAG, "Failed to enqueue message " + msg.what + ". Dropping.");
        }
    }
