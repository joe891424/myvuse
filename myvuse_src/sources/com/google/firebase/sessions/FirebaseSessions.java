...
public final class FirebaseSessions {
    ...
    public FirebaseSessions(FirebaseApp firebaseApp, SessionsSettings settings, CoroutineContext backgroundDispatcher, SessionLifecycleServiceBinder lifecycleServiceBinder) {
        ...
        LogInstrumentation.m2726d(TAG, "Initializing Firebase Sessions SDK.");
        ...
        if (applicationContext instanceof Application) {
            ...
            BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(backgroundDispatcher), null, null, new C32901(backgroundDispatcher, lifecycleServiceBinder, null), 3, null);
        } else {
            LogInstrumentation.m2728e(TAG, "Failed to register lifecycle callbacks, unexpected context " + applicationContext.getClass() + '.');
        }
    }
    ...
    @DebugMetadata(m5607c = "com.google.firebase.sessions.FirebaseSessions$1", m5608f = "FirebaseSessions.kt", m5609i = {}, m5610l = {45, ConstraintLayout.LayoutParams.Table.LAYOUT_EDITOR_ABSOLUTEX}, m5611m = "invokeSuspend", m5612n = {}, m5613s = {})
    static final class C32901 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C32901(CoroutineContext coroutineContext, SessionLifecycleServiceBinder sessionLifecycleServiceBinder, Continuation<? super C32901> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return FirebaseSessions.this.new C32901(this.$backgroundDispatcher, this.$lifecycleServiceBinder, continuation);
        }
        ...
        */
        public final java.lang.Object invokeSuspend(java.lang.Object r6) {
            ...
            L6f:
                ...
                com.newrelic.agent.android.instrumentation.LogInstrumentation.m2726d(r2, r6)
                goto La6
            L81:
            ...
            La6:
                ...
                return r6
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.sessions.FirebaseSessions.C32901.invokeSuspend(java.lang.Object):java.lang.Object");
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final void invokeSuspend$lambda$1(String str, FirebaseOptions firebaseOptions) {
            LogInstrumentation.m2734w(FirebaseSessions.TAG, "FirebaseApp instance deleted. Sessions library will stop collecting data.");
            SessionsActivityLifecycleCallbacks.INSTANCE.setLifecycleClient(null);
        }
    }

    /* JADX INFO: compiled from: FirebaseSessions.kt */
    @Metadata(m5597d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000R\u0011\u0010\u0005\u001a\u00020\u00068F¢\u0006\u0006\u001a\u0004\b\u0007\u0010\b¨\u0006\t"}, m5598d2 = {"Lcom/google/firebase/sessions/FirebaseSessions$Companion;", "", "()V", "TAG", "", "instance", "Lcom/google/firebase/sessions/FirebaseSessions;", "getInstance", "()Lcom/google/firebase/sessions/FirebaseSessions;", "com.google.firebase-firebase-sessions"}, m5599k = 1, m5600mv = {1, 8, 0}, m5602xi = 48)
