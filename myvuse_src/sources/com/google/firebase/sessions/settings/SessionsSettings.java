...
public final class SessionsSettings {
    ...
    private static final ReadOnlyProperty<Context, DataStore<Preferences>> dataStore$delegate = PreferenceDataStoreDelegateKt.preferencesDataStore$default(SessionDataStoreConfigs.INSTANCE.getSETTINGS_CONFIG_NAME(), new ReplaceFileCorruptionHandler(new Function1<CorruptionException, Preferences>() { // from class: com.google.firebase.sessions.settings.SessionsSettings$Companion$dataStore$2
        ...
        public final Preferences invoke(CorruptionException ex) {
            ...
            LogInstrumentation.m2735w("SessionsSettings", "CorruptionException in settings DataStore in " + ProcessDetailsProvider.INSTANCE.getProcessName$com_google_firebase_firebase_sessions() + '.', ex);
    ...
    @DebugMetadata(m5607c = "com.google.firebase.sessions.settings.SessionsSettings", m5608f = "SessionsSettings.kt", m5609i = {0}, m5610l = {138, 139}, m5611m = "updateSettings", m5612n = {"this"}, m5613s = {"L$0"})
    static final class C33021 extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C33021(Continuation<? super C33021> continuation) {
            super(continuation);
        }
    ...
    public final long m6317getSessionRestartTimeoutUwyO8pc() {
        Duration durationMo6315getSessionRestartTimeoutFghU774 = this.localOverrideSettings.mo6315getSessionRestartTimeoutFghU774();
        if (durationMo6315getSessionRestartTimeoutFghU774 != null) {
            long rawValue = durationMo6315getSessionRestartTimeoutFghU774.getRawValue();
            if (m6316isValidSessionRestartTimeoutLRDsOJo(rawValue)) {
                return rawValue;
            }
        }
        Duration durationMo6315getSessionRestartTimeoutFghU7742 = this.remoteSettings.mo6315getSessionRestartTimeoutFghU774();
        if (durationMo6315getSessionRestartTimeoutFghU7742 != null) {
            long rawValue2 = durationMo6315getSessionRestartTimeoutFghU7742.getRawValue();
            if (m6316isValidSessionRestartTimeoutLRDsOJo(rawValue2)) {
                return rawValue2;
            }
        }
    ...
    private final boolean m6316isValidSessionRestartTimeoutLRDsOJo(long sessionRestartTimeout) {
        return Duration.m8593isPositiveimpl(sessionRestartTimeout) && Duration.m8588isFiniteimpl(sessionRestartTimeout);
    }
    ...
    */
    public final java.lang.Object updateSettings(kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
        /*
            r5 = this;
            boolean r0 = r6 instanceof com.google.firebase.sessions.settings.SessionsSettings.C33021
            if (r0 == 0) goto L14
            r0 = r6
            com.google.firebase.sessions.settings.SessionsSettings$updateSettings$1 r0 = (com.google.firebase.sessions.settings.SessionsSettings.C33021) r0
            int r1 = r0.label
