...
public final class RemoteSettingsFetcher implements CrashlyticsSettingsFetcher {
    ...
    @DebugMetadata(m5607c = "com.google.firebase.sessions.settings.RemoteSettingsFetcher$doConfigFetch$2", m5608f = "RemoteSettingsFetcher.kt", m5609i = {}, m5610l = {68, 70, 73}, m5611m = "invokeSuspend", m5612n = {}, m5613s = {})
    static final class C33012 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C33012(Map<String, String> map, Function2<? super JSONObject, ? super Continuation<? super Unit>, ? extends Object> function2, Function2<? super String, ? super Continuation<? super Unit>, ? extends Object> function22, Continuation<? super C33012> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return RemoteSettingsFetcher.this.new C33012(this.$headerOptions, this.$onSuccess, this.$onFailure, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C33012) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                if (i == 0) {
                    ...
                    URLConnection uRLConnectionOpenConnection = URLConnectionInstrumentation.openConnection(RemoteSettingsFetcher.this.settingsUrl().openConnection());
    ...
    public Object doConfigFetch(Map<String, String> map, Function2<? super JSONObject, ? super Continuation<? super Unit>, ? extends Object> function2, Function2<? super String, ? super Continuation<? super Unit>, ? extends Object> function22, Continuation<? super Unit> continuation) {
        Object objWithContext = BuildersKt.withContext(this.blockingDispatcher, new C33012(map, function2, function22, null), continuation);
