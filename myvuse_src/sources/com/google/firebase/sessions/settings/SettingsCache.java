...
public final class SettingsCache {
    ...
    @DebugMetadata(m5607c = "com.google.firebase.sessions.settings.SettingsCache", m5608f = "SettingsCache.kt", m5609i = {}, m5610l = {119}, m5611m = "updateConfigValue", m5612n = {}, m5613s = {})
    static final class C33041<T> extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;

        C33041(Continuation<? super C33041> continuation) {
            super(continuation);
        }
    ...
    public SettingsCache(DataStore<Preferences> dataStore) throws InterruptedException {
        ...
        BuildersKt__BuildersKt.runBlocking$default(null, new C33031(null), 1, null);
    }
    ...
    @DebugMetadata(m5607c = "com.google.firebase.sessions.settings.SettingsCache$1", m5608f = "SettingsCache.kt", m5609i = {}, m5610l = {46}, m5611m = "invokeSuspend", m5612n = {}, m5613s = {})
    static final class C33031 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        Object L$0;
        int label;

        C33031(Continuation<? super C33031> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return SettingsCache.this.new C33031(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C33031) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    */
    public final java.lang.Object removeConfigs$com_google_firebase_firebase_sessions(kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
        ...
        L4a:
            ...
            com.newrelic.agent.android.instrumentation.LogInstrumentation.m2734w(r0, r6)
        L5e:
    ...
    */
    public final <T> java.lang.Object updateConfigValue(androidx.datastore.preferences.core.Preferences.Key<T> r6, T r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) {
        /*
            r5 = this;
            boolean r0 = r8 instanceof com.google.firebase.sessions.settings.SettingsCache.C33041
            if (r0 == 0) goto L14
            r0 = r8
            com.google.firebase.sessions.settings.SettingsCache$updateConfigValue$1 r0 = (com.google.firebase.sessions.settings.SettingsCache.C33041) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
        ...
        L4a:
            ...
            com.newrelic.agent.android.instrumentation.LogInstrumentation.m2734w(r7, r6)
        L5e:
            kotlin.Unit r6 = kotlin.Unit.INSTANCE
            return r6
        */
    ...
    /* JADX INFO: compiled from: SettingsCache.kt */
    @Metadata(m5597d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u00020\u0004H\u008a@"}, m5598d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "preferences", "Landroidx/datastore/preferences/core/MutablePreferences;"}, m5599k = 3, m5600mv = {1, 8, 0}, m5602xi = 48)
    @DebugMetadata(m5607c = "com.google.firebase.sessions.settings.SettingsCache$updateConfigValue$2", m5608f = "SettingsCache.kt", m5609i = {}, m5610l = {}, m5611m = "invokeSuspend", m5612n = {}, m5613s = {})
    static final class C33052 extends SuspendLambda implements Function2<MutablePreferences, Continuation<? super Unit>, Object> {
        ...
        C33052(T t, Preferences.Key<T> key, SettingsCache settingsCache, Continuation<? super C33052> continuation) {
            super(2, continuation);
            this.$value = t;
            this.$key = key;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C33052 c33052 = new C33052(this.$value, this.$key, this.this$0, continuation);
            c33052.L$0 = obj;
            return c33052;
        }
        ...
        public final Object invoke(MutablePreferences mutablePreferences, Continuation<? super Unit> continuation) {
            return ((C33052) create(mutablePreferences, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* JADX INFO: compiled from: SettingsCache.kt */
    @Metadata(m5597d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\t\n\u0002\b\u0004\n\u0002\u0010\u0006\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0082\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0017\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007R\u0017\u0010\b\u001a\b\u0012\u0004\u0012\u00020\t0\u0004¢\u0006\b\n\u0000\u001a\u0004\b\n\u0010\u0007R\u0017\u0010\u000b\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004¢\u0006\b\n\u0000\u001a\u0004\b\f\u0010\u0007R\u0017\u0010\r\u001a\b\u0012\u0004\u0012\u00020\u000e0\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u000f\u0010\u0007R\u0017\u0010\u0010\u001a\b\u0012\u0004\u0012\u00020\u00110\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0012\u0010\u0007R\u000e\u0010\u0013\u001a\u00020\u0014X\u0086T¢\u0006\u0002\n\u0000¨\u0006\u0015"}, m5598d2 = {"Lcom/google/firebase/sessions/settings/SettingsCache$Companion;", "", "()V", "CACHE_DURATION_SECONDS", "Landroidx/datastore/preferences/core/Preferences$Key;", "", "getCACHE_DURATION_SECONDS", "()Landroidx/datastore/preferences/core/Preferences$Key;", "CACHE_UPDATED_TIME", "", "getCACHE_UPDATED_TIME", "RESTART_TIMEOUT_SECONDS", "getRESTART_TIMEOUT_SECONDS", "SAMPLING_RATE", "", "getSAMPLING_RATE", "SESSIONS_ENABLED", "", "getSESSIONS_ENABLED", "TAG", "", "com.google.firebase-firebase-sessions"}, m5599k = 1, m5600mv = {1, 8, 0}, m5602xi = 48)
