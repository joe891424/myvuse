...
public final class SessionDatastoreImpl implements SessionDatastore {
    ...
    private static final ReadOnlyProperty<Context, DataStore<Preferences>> dataStore$delegate = PreferenceDataStoreDelegateKt.preferencesDataStore$default(SessionDataStoreConfigs.INSTANCE.getSESSIONS_CONFIG_NAME(), new ReplaceFileCorruptionHandler(new Function1<CorruptionException, Preferences>() { // from class: com.google.firebase.sessions.SessionDatastoreImpl$Companion$dataStore$2
        ...
        public final Preferences invoke(CorruptionException ex) {
            ...
            LogInstrumentation.m2735w("FirebaseSessionsRepo", "CorruptionException in sessions DataStore in " + ProcessDetailsProvider.INSTANCE.getProcessName$com_google_firebase_firebase_sessions() + '.', ex);
    ...
    public SessionDatastoreImpl(Context context, CoroutineContext backgroundDispatcher) {
        ...
        final Flow flowM8766catch = FlowKt.m8766catch(Companion.getDataStore(context).getData(), new SessionDatastoreImpl$firebaseSessionDataFlow$1(null));
        this.firebaseSessionDataFlow = new Flow<FirebaseSessionsData>() { // from class: com.google.firebase.sessions.SessionDatastoreImpl$special$$inlined$map$1
            ...
            public static final class C32932<T> implements FlowCollector {
                ...
                @DebugMetadata(m5607c = "com.google.firebase.sessions.SessionDatastoreImpl$special$$inlined$map$1$2", m5608f = "SessionDatastore.kt", m5609i = {}, m5610l = {223}, m5611m = "emit", m5612n = {}, m5613s = {})
                ...
                public C32932(FlowCollector flowCollector, SessionDatastoreImpl sessionDatastoreImpl) {
                ...
                */
                public final java.lang.Object emit(java.lang.Object r5, kotlin.coroutines.Continuation r6) {
                    /*
                        r4 = this;
                        boolean r0 = r6 instanceof com.google.firebase.sessions.SessionDatastoreImpl$special$$inlined$map$1.C32932.AnonymousClass1
                        if (r0 == 0) goto L14
                        r0 = r6
                        com.google.firebase.sessions.SessionDatastoreImpl$special$$inlined$map$1$2$1 r0 = (com.google.firebase.sessions.SessionDatastoreImpl$special$$inlined$map$1.C32932.AnonymousClass1) r0
                        int r1 = r0.label
                    ...
                    L4b:
                        ...
                        return r5
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.sessions.SessionDatastoreImpl$special$$inlined$map$1.C32932.emit(java.lang.Object, kotlin.coroutines.Continuation):java.lang.Object");
                }
            }

            @Override // kotlinx.coroutines.flow.Flow
            public Object collect(FlowCollector<? super FirebaseSessionsData> flowCollector, Continuation continuation) {
                Object objCollect = flowM8766catch.collect(new C32932(flowCollector, this), continuation);
                return objCollect == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objCollect : Unit.INSTANCE;
            }
        };
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(backgroundDispatcher), null, null, new C32921(null), 3, null);
    }

    /* JADX INFO: compiled from: SessionDatastore.kt */
    @Metadata(m5597d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\b\u0003\bÂ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0017\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0006\u0010\u0007¨\u0006\b"}, m5598d2 = {"Lcom/google/firebase/sessions/SessionDatastoreImpl$FirebaseSessionDataKeys;", "", "()V", "SESSION_ID", "Landroidx/datastore/preferences/core/Preferences$Key;", "", "getSESSION_ID", "()Landroidx/datastore/preferences/core/Preferences$Key;", "com.google.firebase-firebase-sessions"}, m5599k = 1, m5600mv = {1, 8, 0}, m5602xi = 48)
    private static final class FirebaseSessionDataKeys {
        ...
        private static final Preferences.Key<String> SESSION_ID = PreferencesKeys.stringKey(RemoteDefsKt.PATH_SESSION_ID_KEY);
    ...
    @DebugMetadata(m5607c = "com.google.firebase.sessions.SessionDatastoreImpl$1", m5608f = "SessionDatastore.kt", m5609i = {}, m5610l = {82}, m5611m = "invokeSuspend", m5612n = {}, m5613s = {})
    static final class C32921 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return SessionDatastoreImpl.this.new C32921(continuation);
        }
    ...
    /* JADX INFO: compiled from: SessionDatastore.kt */
    @Metadata(m5597d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@"}, m5598d2 = {"<anonymous>", "", "Lkotlinx/coroutines/CoroutineScope;"}, m5599k = 3, m5600mv = {1, 8, 0}, m5602xi = 48)
    @DebugMetadata(m5607c = "com.google.firebase.sessions.SessionDatastoreImpl$updateSessionId$1", m5608f = "SessionDatastore.kt", m5609i = {}, m5610l = {89}, m5611m = "invokeSuspend", m5612n = {}, m5613s = {})
    static final class C32941 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C32941(String str, Continuation<? super C32941> continuation) {
            super(2, continuation);
            this.$sessionId = str;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return SessionDatastoreImpl.this.new C32941(this.$sessionId, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                ...
                LogInstrumentation.m2734w(SessionDatastoreImpl.TAG, "Failed to update session Id: " + e);
            }
            return Unit.INSTANCE;
        }
        ...
        /* JADX INFO: compiled from: SessionDatastore.kt */
        @Metadata(m5597d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\u008a@"}, m5598d2 = {"<anonymous>", "", "preferences", "Landroidx/datastore/preferences/core/MutablePreferences;"}, m5599k = 3, m5600mv = {1, 8, 0}, m5602xi = 48)
        @DebugMetadata(m5607c = "com.google.firebase.sessions.SessionDatastoreImpl$updateSessionId$1$1", m5608f = "SessionDatastore.kt", m5609i = {}, m5610l = {}, m5611m = "invokeSuspend", m5612n = {}, m5613s = {})
    ...
    public void updateSessionId(String sessionId) {
        ...
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(this.backgroundDispatcher), null, null, new C32941(sessionId, null), 3, null);
    }
