...
public class AnalyticsDeferredProxy {
    ...
    private void init() {
        this.analyticsConnectorDeferred.whenAvailable(new Deferred.DeferredHandler() { // from class: com.google.firebase.crashlytics.AnalyticsDeferredProxy$$ExternalSyntheticLambda2
            ...
            public final void handle(Provider provider) {
                this.f$0.m2610xec284ea4(provider);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$init$2$com-google-firebase-crashlytics-AnalyticsDeferredProxy */
    /* synthetic */ void m2610xec284ea4(Provider provider) {
        Logger.getLogger().m2612d("AnalyticsConnector now available.");
        ...
        if (subscribeToAnalyticsEvents(analyticsConnector, crashlyticsAnalyticsListener) != null) {
            Logger.getLogger().m2612d("Registered Firebase Analytics listener.");
        ...
        Logger.getLogger().m2620w("Could not register Firebase Analytics listener; a listener is already registered.");
    }
    ...
    private static AnalyticsConnector.AnalyticsConnectorHandle subscribeToAnalyticsEvents(AnalyticsConnector analyticsConnector, CrashlyticsAnalyticsListener crashlyticsAnalyticsListener) {
        ...
        if (analyticsConnectorHandleRegisterAnalyticsConnectorListener == null) {
            Logger.getLogger().m2612d("Could not register AnalyticsConnectorListener with Crashlytics origin.");
            ...
            if (analyticsConnectorHandleRegisterAnalyticsConnectorListener != null) {
                Logger.getLogger().m2620w("A new version of the Google Analytics for Firebase SDK is now available. For improved performance and compatibility with Crashlytics, please update to the latest version.");
            }
        }
