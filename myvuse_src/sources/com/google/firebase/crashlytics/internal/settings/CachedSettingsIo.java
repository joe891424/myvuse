...
public class CachedSettingsIo {
    ...
    public JSONObject readCachedSettings() throws Throwable {
        ...
        Logger.getLogger().m2612d("Checking for cached settings...");
            ...
            try {
                ...
                if (settingsFile.exists()) {
                    ...
                    try {
                        ...
                        e = e;
                        Logger.getLogger().m2615e("Failed to fetch cached settings", e);
                        CommonUtils.closeOrLog(fileInputStream, "Error while closing settings cache file.");
                        return null;
                    }
                } else {
                    Logger.getLogger().m2618v("Settings file does not exist.");
                    jSONObject = null;
                }
    ...
    public void writeCachedSettings(long j, JSONObject jSONObject) throws Throwable {
        ...
        String string;
        Logger.getLogger().m2618v("Writing settings to cache file...");
        if (jSONObject != null) {
            ...
            try {
                ...
                Logger.getLogger().m2615e("Failed to cache settings", e);
