...
final class AutoValue_CrashlyticsReport_Session extends CrashlyticsReport.Session {
    ...
    private final CrashlyticsReport.Session.OperatingSystem f3837os;
    ...
    public String toString() {
        return "Session{generator=" + this.generator + ", identifier=" + this.identifier + ", appQualitySessionId=" + this.appQualitySessionId + ", startedAt=" + this.startedAt + ", endedAt=" + this.endedAt + ", crashed=" + this.crashed + ", app=" + this.app + ", user=" + this.user + ", os=" + this.f3837os + ", device=" + this.device + ", events=" + this.events + ", generatorType=" + this.generatorType + "}";
    }
    ...
    public int hashCode() {
        ...
        CrashlyticsReport.Session.OperatingSystem operatingSystem = this.f3837os;
    ...
    static final class Builder extends CrashlyticsReport.Session.Builder {
        ...
        /* JADX INFO: renamed from: os */
        private CrashlyticsReport.Session.OperatingSystem f3838os;
        ...
        public CrashlyticsReport.Session build() {
            ...
            return new AutoValue_CrashlyticsReport_Session(this.generator, this.identifier, this.appQualitySessionId, this.startedAt.longValue(), this.endedAt, this.crashed.booleanValue(), this.app, this.user, this.f3838os, this.device, this.events, this.generatorType.intValue());
        }
    }
}
