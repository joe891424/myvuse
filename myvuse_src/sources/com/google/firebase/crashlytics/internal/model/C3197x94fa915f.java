...
final class C3197x94fa915f extends CrashlyticsReport.Session.Event.Application.ProcessDetails {
    private final boolean defaultProcess;
    private final int importance;
    private final int pid;
    private final String processName;

    private C3197x94fa915f(String str, int i, int i2, boolean z) {
    ...
    static final class Builder extends CrashlyticsReport.Session.Event.Application.ProcessDetails.Builder {
        ...
        public CrashlyticsReport.Session.Event.Application.ProcessDetails build() {
            ...
            return new C3197x94fa915f(this.processName, this.pid.intValue(), this.importance.intValue(), this.defaultProcess.booleanValue());
        }
    }
}
