...
public class HttpGetRequest {
    ...
    public HttpResponse execute() throws Throwable {
        ...
        try {
            ...
            Logger.getLogger().m2618v("GET Request URL: " + strCreateUrlWithParams);
            httpsURLConnection = (HttpsURLConnection) URLConnectionInstrumentation.openConnection(new URL(strCreateUrlWithParams).openConnection());
            try {
