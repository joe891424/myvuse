...
public class FirebaseApp {
    ...
    public static FirebaseApp initializeApp(Context context) {
        synchronized (LOCK) {
            ...
            if (firebaseOptionsFromResource == null) {
                LogInstrumentation.m2734w(LOG_TAG, "Default FirebaseApp failed to initialize because no default options were found. This usually means that com.google.gms:google-services was not applied to your gradle project.");
                return null;
            }
    ...
    protected FirebaseApp(final Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        ComponentRuntime.Builder processor = ComponentRuntime.builder(UiExecutor.INSTANCE).addLazyComponentRegistrars(listDiscoverLazy).addComponentRegistrar(new FirebaseCommonRegistrar()).addComponentRegistrar(new ExecutorsRegistrar()).addComponent(Component.m2595of(context, (Class<Context>) Context.class, (Class<? super Context>[]) new Class[0])).addComponent(Component.m2595of(this, (Class<FirebaseApp>) FirebaseApp.class, (Class<? super FirebaseApp>[]) new Class[0])).addComponent(Component.m2595of(firebaseOptions, (Class<FirebaseOptions>) FirebaseOptions.class, (Class<? super FirebaseOptions>[]) new Class[0])).setProcessor(new ComponentMonitor());
        if (UserManagerCompat.isUserUnlocked(context) && FirebaseInitProvider.isCurrentlyInitializing()) {
            processor.addComponent(Component.m2595of(startupTime, (Class<StartupTime>) StartupTime.class, (Class<? super StartupTime>[]) new Class[0]));
        }
        ...
        this.dataCollectionConfigStorage = new Lazy<>(new Provider() { // from class: com.google.firebase.FirebaseApp$$ExternalSyntheticLambda0
            ...
            public final Object get() {
                return this.f$0.m6293lambda$new$0$comgooglefirebaseFirebaseApp(context);
            }
        });
        ...
        addBackgroundStateChangeListener(new BackgroundStateChangeListener() { // from class: com.google.firebase.FirebaseApp$$ExternalSyntheticLambda1
            ...
            public final void onBackgroundStateChanged(boolean z) {
                this.f$0.m6294lambda$new$1$comgooglefirebaseFirebaseApp(z);
            }
        });
        FirebaseTrace.popTrace();
    }
    ...
    /* synthetic */ DataCollectionConfigStorage m6293lambda$new$0$comgooglefirebaseFirebaseApp(Context context) {
    ...
    /* synthetic */ void m6294lambda$new$1$comgooglefirebaseFirebaseApp(boolean z) {
        if (z) {
            return;
        }
    ...
    public void notifyBackgroundStateChangeListeners(boolean z) {
        LogInstrumentation.m2726d(LOG_TAG, "Notifying background state change listeners.");
    ...
    public void initializeAllApis() {
        if (UserManagerCompat.isUserUnlocked(this.applicationContext)) {
            LogInstrumentation.m2730i(LOG_TAG, "Device unlocked: initializing all Firebase APIs for app " + getName());
            this.componentRuntime.initializeEagerComponents(isDefaultApp());
            this.defaultHeartBeatController.get().registerHeartBeat();
        } else {
            LogInstrumentation.m2730i(LOG_TAG, "Device in Direct Boot Mode: postponing initialization of Firebase APIs for app " + getName());
    ...
    private static class UserUnlockReceiver extends BroadcastReceiver {
        ...
        public static void ensureReceiverRegistered(Context context) {
            if (INSTANCE.get() == null) {
                ...
                if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m1161m(INSTANCE, null, userUnlockReceiver)) {
        ...
        public static void ensureBackgroundStateListenerRegistered(Context context) {
            if (PlatformVersion.isAtLeastIceCreamSandwich() && (context.getApplicationContext() instanceof Application)) {
                ...
                if (INSTANCE.get() == null) {
                    ...
                    if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m1161m(INSTANCE, null, globalBackgroundStateListener)) {
