...
public final class zzb {
    private static final ImmutableSet<String> zza = ImmutableSet.m2488of("_in", "_xa", "_xu", "_aq", "_aa", "_ai", "_ac", FirebaseAnalytics.Event.CAMPAIGN_DETAILS, "_ug", "_iapx", "_exp_set", "_exp_clear", "_exp_activate", "_exp_timeout", "_exp_expire");
    private static final ImmutableList<String> zzb = ImmutableList.m2442of("_e", "_f", "_iap", "_s", "_au", "_ui", "_cd");
    private static final ImmutableList<String> zzc = ImmutableList.m2438of("auto", "app", "am");
    private static final ImmutableList<String> zzd = ImmutableList.m2437of(NotificationMessage.NOTIF_KEY_REQUEST_ID, "_dbg");
    private static final ImmutableList<String> zze = new ImmutableList.Builder().add((Object[]) zzis.zza).add((Object[]) zzis.zzb).build();
    private static final ImmutableList<String> zzf = ImmutableList.m2437of("^_ltv_[A-Z]{3}$", "^_cc[1-5]{1}$");
    ...
    public static String zza(String str) {
        String strZza = zzir.zza(str);
        return strZza != null ? strZza : str;
    }

    public static String zzb(String str) {
        String strZzb = zzir.zzb(str);
