...
public abstract class Logger {
    ...
    private static final class AndroidLogger extends Logger {
        ...
        public int log(Level level, String format, Object[] args, Throwable throwable) {
            ...
            if (i == 1) {
                String tag = getTag();
                return throwable != null ? LogInstrumentation.m2733v(tag, format, throwable) : LogInstrumentation.m2732v(tag, format);
            }
            if (i == 2) {
                String tag2 = getTag();
                return throwable != null ? LogInstrumentation.m2727d(tag2, format, throwable) : LogInstrumentation.m2726d(tag2, format);
            }
            if (i == 3) {
                String tag3 = getTag();
                return throwable != null ? LogInstrumentation.m2731i(tag3, format, throwable) : LogInstrumentation.m2730i(tag3, format);
            }
            if (i == 4) {
                String tag4 = getTag();
                return throwable != null ? LogInstrumentation.m2735w(tag4, format, throwable) : LogInstrumentation.m2734w(tag4, format);
            }
            if (i != 5) {
                throw new NoWhenBranchMatchedException();
            }
            String tag5 = getTag();
            return throwable != null ? LogInstrumentation.m2729e(tag5, format, throwable) : LogInstrumentation.m2728e(tag5, format);
        }
    }

    /* JADX INFO: compiled from: Logger.kt */
    @Metadata(m5597d1 = {"\u0000L\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010!\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u0011\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0003\n\u0002\b\u0004\b\u0007\u0018\u00002\u00020\u0001B\u001f\b\u0000\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005\u0012\u0006\u0010\u0006\u001a\u00020\u0007¢\u0006\u0002\u0010\bJ\b\u0010\u000b\u001a\u00020\fH\u0007J\u0010\u0010\r\u001a\u00020\u00052\u0006\u0010\u000e\u001a\u00020\u0003H\u0007J\u001c\u0010\u000f\u001a\u00020\u00052\u0012\u0010\u0010\u001a\u000e\u0012\u0004\u0012\u00020\u0003\u0012\u0004\u0012\u00020\u00050\u0011H\u0007J9\u0010\u0012\u001a\u00020\u00132\u0006\u0010\u0014\u001a\u00020\u00072\u0006\u0010\u0015\u001a\u00020\u00032\u0010\u0010\u0016\u001a\f\u0012\b\b\u0001\u0012\u0004\u0018\u00010\u00180\u00172\b\u0010\u0019\u001a\u0004\u0018\u00010\u001aH\u0016¢\u0006\u0002\u0010\u001bJ9\u0010\u001c\u001a\u00020\u00032\u0006\u0010\u0014\u001a\u00020\u00072\u0006\u0010\u0015\u001a\u00020\u00032\u0010\u0010\u0016\u001a\f\u0012\b\b\u0001\u0012\u0004\u0018\u00010\u00180\u00172\b\u0010\u0019\u001a\u0004\u0018\u00010\u001aH\u0002¢\u0006\u0002\u0010\u001dR\u0014\u0010\t\u001a\b\u0012\u0004\u0012\u00020\u00030\nX\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u001e"}, m5598d2 = {"Lcom/google/firebase/logger/Logger$FakeLogger;", "Lcom/google/firebase/logger/Logger;", HeaderParameterNames.AUTHENTICATION_TAG, "", ViewProps.ENABLED, "", "minLevel", "Lcom/google/firebase/logger/Logger$Level;", "(Ljava/lang/String;ZLcom/google/firebase/logger/Logger$Level;)V", "record", "", "clearLogMessages", "", "hasLogMessage", "message", "hasLogMessageThat", "predicate", "Lkotlin/Function1;", "log", "", FirebaseAnalytics.Param.LEVEL, "format", "args", "", "", "throwable", "", "(Lcom/google/firebase/logger/Logger$Level;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/Throwable;)I", "toLogMessage", "(Lcom/google/firebase/logger/Logger$Level;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/Throwable;)Ljava/lang/String;", "com.google.firebase-firebase-common"}, m5599k = 1, m5600mv = {1, 8, 0}, m5602xi = 48)
    public static final class FakeLogger extends Logger {
        ...
        private final String toLogMessage(Level level, String format, Object[] args, Throwable throwable) {
            ...
            return (throwable == null || (string = new StringBuilder().append(level).append(SafeJsonPrimitive.NULL_CHAR).append(format).append(SafeJsonPrimitive.NULL_CHAR).append(Log.getStackTraceString(throwable)).toString()) == null) ? level + SafeJsonPrimitive.NULL_CHAR + format : string;
        }
    }

    /* JADX INFO: compiled from: Logger.kt */
    @Metadata(m5597d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0000\n\u0002\u0010\b\n\u0002\b\t\b\u0086\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u000f\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004R\u0014\u0010\u0002\u001a\u00020\u0003X\u0080\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006j\u0002\b\u0007j\u0002\b\bj\u0002\b\tj\u0002\b\nj\u0002\b\u000b¨\u0006\f"}, m5598d2 = {"Lcom/google/firebase/logger/Logger$Level;", "", "priority", "", "(Ljava/lang/String;II)V", "getPriority$com_google_firebase_firebase_common", "()I", "VERBOSE", "DEBUG", "INFO", "WARN", RemoteDebugPreferencesKt.DEBUG_OPTIONS_REMOTE_BEHAVIOUR_ERROR, "com.google.firebase-firebase-common"}, m5599k = 1, m5600mv = {1, 8, 0}, m5602xi = 48)
    public enum Level {
        VERBOSE(2),
        DEBUG(3),
        INFO(4),
