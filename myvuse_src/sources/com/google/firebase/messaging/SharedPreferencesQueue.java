...
final class SharedPreferencesQueue {
        ...
        synchronized (this.internalQueue) {
            ...
            if (!TextUtils.isEmpty(string) && string.contains(this.itemSeparator)) {
                ...
                if (strArrSplit.length == 0) {
                    LogInstrumentation.m2728e(Constants.TAG, "Corrupted queue. Please check the queue contents and item separator provided");
                }
    ...
    public String serialize() {
        ...
        while (it2.hasNext()) {
            sb.append(it2.next()).append(this.itemSeparator);
        }
        return sb.toString();
    }
