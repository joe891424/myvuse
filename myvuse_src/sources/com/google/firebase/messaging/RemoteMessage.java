...
public final class RemoteMessage extends AbstractSafeParcelable {
    ...
    public String getTo() {
        return this.bundle.getString(Constants.MessagePayloadKeys.f3849TO);
    }
    ...
    public long getSentTime() {
        ...
        try {
            ...
            LogInstrumentation.m2734w(Constants.TAG, "Invalid sent time: " + obj);
            return 0L;
        }
    }
    ...
    public static class Builder {
        ...
        public Builder(String str) {
            ...
            bundle.putString(Constants.MessagePayloadKeys.f3849TO, str);
        }
