...
public class FirebaseMessaging {
    ...
    FirebaseMessaging(FirebaseApp firebaseApp, FirebaseInstanceIdInternal firebaseInstanceIdInternal, Provider<TransportFactory> provider, Subscriber subscriber, Metadata metadata, GmsRpc gmsRpc, Executor executor, Executor executor2, Executor executor3) {
        ...
        if (applicationContext2 instanceof Application) {
            ...
            LogInstrumentation.m2734w("FirebaseMessaging", "Context " + applicationContext2 + " was not an application, can't register for lifecycle callbacks. Some notification events may be dropped as a result.");
        }
        if (firebaseInstanceIdInternal != null) {
            firebaseInstanceIdInternal.addNewTokenListener(new FirebaseInstanceIdInternal.NewTokenListener() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda3
                ...
                public final void onNewToken(String str) {
                    this.f$0.m6301lambda$new$1$comgooglefirebasemessagingFirebaseMessaging(str);
                }
            });
        }
        executor2.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda4
            ...
            public final void run() {
                this.f$0.m6302lambda$new$2$comgooglefirebasemessagingFirebaseMessaging();
            }
        });
        ...
        taskCreateInstance.addOnSuccessListener(executor2, new OnSuccessListener() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda5
            ...
            public final void onSuccess(Object obj) {
                this.f$0.m6303lambda$new$3$comgooglefirebasemessagingFirebaseMessaging((TopicsSubscriber) obj);
            }
        });
        executor2.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m6304lambda$new$4$comgooglefirebasemessagingFirebaseMessaging();
            }
        });
    }

    /* JADX INFO: renamed from: lambda$new$2$com-google-firebase-messaging-FirebaseMessaging, reason: not valid java name */
    /* synthetic */ void m6302lambda$new$2$comgooglefirebasemessagingFirebaseMessaging() {
    ...
    /* synthetic */ void m6303lambda$new$3$comgooglefirebasemessagingFirebaseMessaging(TopicsSubscriber topicsSubscriber) {
        if (isAutoInitEnabled()) {
    ...
    public void m6304lambda$new$4$comgooglefirebasemessagingFirebaseMessaging() {
    ...
    public Task<String> getToken() {
        ...
        this.initExecutor.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m2641x6a533e85(taskCompletionSource);
            }
        });
    ...
    /* synthetic */ void m2641x6a533e85(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    public Task<Void> deleteToken() {
        if (this.iid != null) {
            ...
            this.initExecutor.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m2639xd5738b77(taskCompletionSource);
                }
            });
            return taskCompletionSource.getTask();
        }
        ...
        FcmExecutors.newNetworkIOExecutor().execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m2640xd4fd2578(taskCompletionSource2);
            }
        });
    ...
    /* synthetic */ void m2639xd5738b77(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    /* synthetic */ void m2640xd4fd2578(TaskCompletionSource taskCompletionSource) {
        try {
        ...
        try {
            return (String) Tasks.await(this.requestDeduplicator.getOrStartGetTokenRequest(defaultSenderId, new RequestDeduplicator.GetTokenRequest() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda14
                ...
                public final Task start() {
                    return this.f$0.m2638xb7d2b1c4(defaultSenderId, tokenWithoutTriggeringSync);
                }
            }));
    ...
    /* synthetic */ Task m2638xb7d2b1c4(final String str, final Store.Token token) {
    ...
    public void m6301lambda$new$1$comgooglefirebasemessagingFirebaseMessaging(String str) {
        if (FirebaseApp.DEFAULT_APP_NAME.equals(this.firebaseApp.getName())) {
            if (Log.isLoggable("FirebaseMessaging", 3)) {
                LogInstrumentation.m2726d("FirebaseMessaging", "Invoking onNewToken for app: " + this.firebaseApp.getName());
            }
    ...
    class AutoInit {
        ...
        /* synthetic */ void m2644x1061f0b8(Event event) {
            if (isEnabled()) {
