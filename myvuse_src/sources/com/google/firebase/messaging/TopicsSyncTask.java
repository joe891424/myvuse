        ...
        try {
            try {
                try {
                    ...
                    LogInstrumentation.m2728e(Constants.TAG, "Failed to sync topics. Won't retry sync. " + e.getMessage());
                ...
                if (!this.metadata.isGmscorePresent()) {
                    ...
                    if (hasWakeLockPermission(this.context)) {
                        try {
                            ...
                            LogInstrumentation.m2730i(Constants.TAG, "TopicsSyncTask's wakelock was already released due to timeout.");
                            return;
                        }
                    }
                    return;
    ...
    */
    ...
    private static boolean hasPermission(Context context, String str, Boolean bool) {
        ...
        if (!z && Log.isLoggable(Constants.TAG, 3)) {
            LogInstrumentation.m2726d(Constants.TAG, createPermissionMissingLog(str));
        }
        return z;
    }
