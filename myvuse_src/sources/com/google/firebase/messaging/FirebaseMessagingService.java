...
public class FirebaseMessagingService extends EnhancedIntentService {
    ...
    public void handleIntent(Intent intent) {
        ...
        if (ACTION_REMOTE_INTENT.equals(action) || ACTION_DIRECT_BOOT_REMOTE_INTENT.equals(action)) {
            ...
            LogInstrumentation.m2726d(Constants.TAG, "Unknown intent action: " + intent.getAction());
        }
    }
    ...
    private void passMessageIntentToSdk(Intent intent) {
        ...
        switch (stringExtra) {
            ...
            case "send_event":
                ...
                break;
            default:
                LogInstrumentation.m2734w(Constants.TAG, "Received message with unknown type: " + stringExtra);
                break;
        }
    }
    ...
    private boolean alreadyReceivedMessage(String str) {
        ...
        if (queue.contains(str)) {
            ...
            LogInstrumentation.m2726d(Constants.TAG, "Received duplicate message: " + str);
            return true;
        }
        if (queue.size() >= 10) {
            queue.remove();
