...
class FcmLifecycleCallbacks implements Application.ActivityLifecycleCallbacks {
    ...
    public void m2636xd8132052(Intent intent) {
        Bundle bundle = null;
        try {
            ...
            LogInstrumentation.m2735w(Constants.TAG, "Failed trying to get analytics data from Intent extras.", e);
        }
