...
public class NotificationParams {
    ...
    Integer getNotificationCount() {
        ...
        LogInstrumentation.m2734w(Constants.TAG, "notificationCount is invalid: " + integer + ". Skipping setting notificationCount.");
        return null;
    }
    ...
    Integer getNotificationPriority() {
        ...
        LogInstrumentation.m2734w(Constants.TAG, "notificationPriority is invalid " + integer + ". Skipping setting notificationPriority.");
        return null;
    }
    ...
    Integer getVisibility() {
        ...
        LogInstrumentation.m2734w(TAG, "visibility is invalid: " + integer + ". Skipping setting visibility.");
        return null;
    }
    ...
    public Integer getInteger(String str) {
        ...
        try {
            ...
            LogInstrumentation.m2734w(TAG, "Couldn't parse value of " + userFriendlyKey(str) + "(" + string + ") into an int");
            return null;
        }
    }
    ...
    public Long getLong(String str) {
        ...
        try {
            ...
            LogInstrumentation.m2734w(TAG, "Couldn't parse value of " + userFriendlyKey(str) + "(" + string + ") into a long");
            return null;
        }
    }
    ...
    public JSONArray getJSONArray(String str) {
        ...
        try {
            ...
            LogInstrumentation.m2734w(TAG, "Malformed JSON for key " + userFriendlyKey(str) + ": " + string + ", falling back to default");
            return null;
        }
    }
    ...
    public long[] getVibrateTimings() {
        ...
        try {
            ...
            LogInstrumentation.m2734w(TAG, "User defined vibrateTimings is invalid: " + jSONArray + ". Skipping setting vibrateTimings.");
            return null;
        }
    }
    ...
    int[] getLightSettings() {
        ...
        try {
            ...
            LogInstrumentation.m2734w(TAG, "LightSettings is invalid: " + jSONArray + ". " + e.getMessage() + ". Skipping setting LightSettings");
            return null;
        } catch (JSONException unused) {
            LogInstrumentation.m2734w(TAG, "LightSettings is invalid: " + jSONArray + ". Skipping setting LightSettings");
            return null;
        }
    }
    ...
    public String getLocalizedString(Resources resources, String str, String str2) {
        ...
        if (identifier == 0) {
            LogInstrumentation.m2734w(TAG, userFriendlyKey(str2 + Constants.MessageNotificationKeys.TEXT_RESOURCE_SUFFIX) + " resource not found: " + str2 + " Default value will be used.");
            return null;
        }
        ...
        try {
            ...
            LogInstrumentation.m2735w(TAG, "Missing format argument for " + userFriendlyKey(str2) + ": " + Arrays.toString(localizationArgsForKey) + " Default value will be used.", e);
            return null;
        }
    }
