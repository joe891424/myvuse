...
public final class CommonNotificationBuilder {
    ...
    private static boolean isValidIcon(Resources resources, int i) {
        ...
        try {
            ...
            LogInstrumentation.m2728e(Constants.TAG, "Adaptive icons cannot be used in notifications. Ignoring icon id: " + i);
            return false;
        } catch (Resources.NotFoundException unused) {
            LogInstrumentation.m2728e(Constants.TAG, "Couldn't find resource " + i + ", treating it as an invalid icon");
            return false;
        }
    }
    ...
    private static int getSmallIcon(PackageManager packageManager, Resources resources, String str, String str2, Bundle bundle) {
        if (!TextUtils.isEmpty(str2)) {
            ...
            LogInstrumentation.m2734w(Constants.TAG, "Icon resource " + str2 + " not found. Notification will use default icon.");
        }
        ...
        if (i == 0 || !isValidIcon(resources, i)) {
            try {
                ...
                LogInstrumentation.m2734w(Constants.TAG, "Couldn't get own application info: " + e);
            }
        }
    ...
    private static Integer getColor(Context context, String str, Bundle bundle) {
        if (!TextUtils.isEmpty(str)) {
            try {
                ...
                LogInstrumentation.m2734w(Constants.TAG, "Color is invalid: " + str + ". Notification will use default color.");
            }
        }
        ...
        try {
            ...
            LogInstrumentation.m2734w(Constants.TAG, "Cannot find the color resource referenced in AndroidManifest.");
            return null;
        }
    }
    ...
    private static Intent createTargetIntent(String str, NotificationParams notificationParams, PackageManager packageManager) {
        ...
        if (launchIntentForPackage == null) {
            LogInstrumentation.m2734w(Constants.TAG, "No activity found to launch app");
        }
    ...
    public static String getOrCreateChannel(Context context, String str, Bundle bundle) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                LogInstrumentation.m2734w(Constants.TAG, "Notification Channel requested (" + str + ") has not been created by the app. Manifest configuration, or default, value will be used.");
            }
            ...
            if (!TextUtils.isEmpty(string2)) {
                ...
                LogInstrumentation.m2734w(Constants.TAG, "Notification Channel set in AndroidManifest.xml has not been created by the app. Default value will be used.");
            } else {
                LogInstrumentation.m2734w(Constants.TAG, "Missing Default Notification Channel metadata in AndroidManifest. Default value will be used.");
            }
            if (notificationManager.getNotificationChannel(FCM_FALLBACK_NOTIFICATION_CHANNEL) == null) {
                ...
                if (identifier == 0) {
                    LogInstrumentation.m2728e(Constants.TAG, "String resource \"fcm_fallback_notification_channel_label\" is not found. Using default string channel name.");
