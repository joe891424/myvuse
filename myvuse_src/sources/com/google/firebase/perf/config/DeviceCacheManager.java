...
public class DeviceCacheManager {
        ...
        if (this.sharedPref == null && context != null) {
            this.serialExecutor.execute(new Runnable() { // from class: com.google.firebase.perf.config.DeviceCacheManager$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m2648xa0ef4a14(context);
                }
            });
        }
    }
    ...
    /* synthetic */ void m2648xa0ef4a14(Context context) {
        if (this.sharedPref != null || context == null) {
            return;
        }
    ...
    public Optional<Boolean> getBoolean(String str) {
        ...
        try {
            return Optional.m2667of(Boolean.valueOf(this.sharedPref.getBoolean(str, false)));
    ...
    public Optional<String> getString(String str) {
        ...
        try {
            return Optional.m2667of(this.sharedPref.getString(str, ""));
        } catch (ClassCastException e) {
    ...
    public Optional<Double> getDouble(String str) {
        ...
        try {
            try {
                return Optional.m2667of(Double.valueOf(Double.longBitsToDouble(this.sharedPref.getLong(str, 0L))));
            } catch (ClassCastException unused) {
                return Optional.m2667of(Double.valueOf(Float.valueOf(this.sharedPref.getFloat(str, 0.0f)).doubleValue()));
            }
        } catch (ClassCastException e) {
    ...
    public Optional<Long> getLong(String str) {
        ...
        try {
            return Optional.m2667of(Long.valueOf(this.sharedPref.getLong(str, 0L)));
        } catch (ClassCastException e) {
            logger.debug("Key %s from sharedPreferences has type other than long: %s", str, e.getMessage());
            return Optional.absent();
        }
