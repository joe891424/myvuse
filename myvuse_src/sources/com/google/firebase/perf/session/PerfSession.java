...
import com.google.firebase.perf.p040v1.SessionVerbosity;
...
public class PerfSession implements Parcelable {
    ...
    static boolean isVerbose(com.google.firebase.perf.p040v1.PerfSession perfSession) {
    ...
    public com.google.firebase.perf.p040v1.PerfSession build() {
        PerfSession.Builder sessionId = com.google.firebase.perf.p040v1.PerfSession.newBuilder().setSessionId(this.sessionId);
    ...
    public static com.google.firebase.perf.p040v1.PerfSession[] buildAndSort(List<PerfSession> list) {
        if (list.isEmpty()) {
            return null;
        }
        com.google.firebase.perf.p040v1.PerfSession[] perfSessionArr = new com.google.firebase.perf.p040v1.PerfSession[list.size()];
        com.google.firebase.perf.p040v1.PerfSession perfSessionBuild = list.get(0).build();
        boolean z = false;
        for (int i = 1; i < list.size(); i++) {
            com.google.firebase.perf.p040v1.PerfSession perfSessionBuild2 = list.get(i).build();
