...
@Deprecated
public final class PassportRecognizer extends Recognizer<Result> implements GlareDetectorOptions, FaceImageOptions, FaceImageDpiOptions, EncodeFaceImageOptions, FullDocumentImageOptions, FullDocumentImageDpiOptions, FullDocumentImageExtensionOptions, EncodeFullDocumentImagesOptions {
    public static final Parcelable.Creator<PassportRecognizer> CREATOR;
    ...
    public static final class Result extends Recognizer.Result implements FaceImageResult, EncodedFaceImageResult, FullDocumentImageResult, EncodedFullDocumentImageResult {
        public static final Parcelable.Creator<Result> CREATOR = new Parcelable.Creator<Result>() { // from class: com.microblink.entities.recognizers.blinkid.passport.PassportRecognizer.Result.1
    ...
    static {
        ...
        CREATOR = new Parcelable.Creator<PassportRecognizer>() { // from class: com.microblink.entities.recognizers.blinkid.passport.PassportRecognizer.1
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
            public PassportRecognizer createFromParcel(Parcel parcel) {
                return new PassportRecognizer(parcel, PassportRecognizer.nativeConstruct());
            }

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
            public PassportRecognizer[] newArray(int i) {
                return new PassportRecognizer[i];
            }
        };
    }
    ...
    public void consumeResultFrom(Entity entity) {
        if (this != entity) {
            if (!(entity instanceof PassportRecognizer)) {
                throw new IllegalArgumentException("Parameter type has to be PassportRecognizer");
            }
    ...
    public void setAnonymizeNetherlandsMrz(boolean z) {
    ...
    public boolean shouldAnonymizeNetherlandsMrz() {
    ...
    private PassportRecognizer(Parcel parcel, long j) {
    ...
    /* JADX INFO: renamed from: clone */
    public PassportRecognizer mo6353clone() {
        return new PassportRecognizer(nativeCopy(getNativeContext()));
    }
}
