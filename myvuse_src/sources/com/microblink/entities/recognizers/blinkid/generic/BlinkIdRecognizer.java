...
public final class BlinkIdRecognizer extends Recognizer<Result> implements FaceImageOptions, FaceImageDpiOptions, EncodeFaceImageOptions, FullDocumentImageOptions, FullDocumentImageDpiOptions, FullDocumentImageExtensionOptions, EncodeFullDocumentImagesOptions, SignatureImageOptions, SignatureImageDpiOptions, EncodeSignatureImageOptions, ClassifierCallbackOptions, BarcodeScanningStartedCallbackOptions {
    ...
    /* JADX INFO: compiled from: line */
    public static final class Result extends Recognizer.Result implements FaceImageResult, EncodedFaceImageResult, FullDocumentImageResult, EncodedFullDocumentImageResult, SignatureImageResult, EncodedSignatureImageResult, ProcessingStatusResult, ClassInfoResult {
        ...
        public Image getCameraFrame() {
            long jCameraFrameNativeGet = cameraFrameNativeGet(getNativeContext());
            if (jCameraFrameNativeGet != 0) {
                return ImageBuilder.buildImageFromNativeContext(jCameraFrameNativeGet, true, this);
            }
            return null;
        }
        ...
        public VizResult getVizResult() {
            long jVizResultNativeGet = vizResultNativeGet(getNativeContext());
            if (jVizResultNativeGet != 0) {
                return new VizResult(jVizResultNativeGet, this);
            }
    ...
    static {
        ...
        CREATOR = new Parcelable.Creator<BlinkIdRecognizer>() { // from class: com.microblink.entities.recognizers.blinkid.generic.BlinkIdRecognizer.1
            ...
            public BlinkIdRecognizer createFromParcel(Parcel parcel) {
                return new BlinkIdRecognizer(parcel, BlinkIdRecognizer.nativeConstruct());
            }

            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.os.Parcelable.Creator
            public BlinkIdRecognizer[] newArray(int i) {
    ...
    /* JADX INFO: renamed from: clone */
    public BlinkIdRecognizer mo6353clone() {
