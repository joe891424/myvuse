...
class DfuServiceProvider implements DfuCallback {
    ...
    DfuService getServiceImpl(final Intent intent, final DfuBaseService service, final BluetoothGatt gatt) throws UploadAbortedException, DfuException, DeviceDisconnectedException {
        try {
