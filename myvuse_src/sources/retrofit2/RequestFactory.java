...
final class RequestFactory {
    ...
    Request create(Object[] objArr) throws IOException {
        ...
        Request.Builder builderTag = requestBuilder.get().tag(Invocation.class, new Invocation(this.method, arrayList));
        return !(builderTag instanceof Request.Builder) ? builderTag.build() : OkHttp3Instrumentation.build(builderTag);
    }
    ...
    static final class Builder {
        ...
        private ParameterHandler<?> parseParameterAnnotation(int i, Type type, Annotation[] annotationArr, Annotation annotation) {
            ...
            if (annotation instanceof Part) {
                ...
                Headers headersM5627of = Headers.m5627of(HttpHeaders.CONTENT_DISPOSITION, "form-data; name=\"" + strValue5 + "\"", "Content-Transfer-Encoding", part.encoding());
                if (Iterable.class.isAssignableFrom(rawType8)) {
                    if (!(type instanceof ParameterizedType)) {
                        throw Utils.parameterError(this.method, i, rawType8.getSimpleName() + " must include generic type (e.g., " + rawType8.getSimpleName() + "<String>)", new Object[0]);
                    }
                    ...
                    return new ParameterHandler.Part(this.method, i, headersM5627of, this.retrofit.requestBodyConverter(parameterUpperBound4, annotationArr, this.methodAnnotations)).iterable();
                }
                if (rawType8.isArray()) {
                    ...
                    return new ParameterHandler.Part(this.method, i, headersM5627of, this.retrofit.requestBodyConverter(clsBoxIfPrimitive, annotationArr, this.methodAnnotations)).array();
                }
                if (MultipartBody.Part.class.isAssignableFrom(rawType8)) {
                    throw Utils.parameterError(this.method, i, "@Part parameters using the MultipartBody.Part must not include a part name in the annotation.", new Object[0]);
                }
                return new ParameterHandler.Part(this.method, i, headersM5627of, this.retrofit.requestBodyConverter(type, annotationArr, this.methodAnnotations));
            }
