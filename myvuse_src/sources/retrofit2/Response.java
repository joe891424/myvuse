...
public final class Response<T> {
    ...
    public static <T> Response<T> success(@Nullable T t) {
        ...
        return success(t, builderProtocol.request(!(builderUrl instanceof Request.Builder) ? builderUrl.build() : OkHttp3Instrumentation.build(builderUrl)).build());
    }
    ...
    public static <T> Response<T> success(@Nullable T t, Headers headers) {
        ...
        Request.Builder builderUrl = new Request.Builder().url("http://localhost/");
        return success(t, builderHeaders.request(!(builderUrl instanceof Request.Builder) ? builderUrl.build() : OkHttp3Instrumentation.build(builderUrl)).build());
    }
    ...
    public static <T> Response<T> error(int i, ResponseBody responseBody) {
        ...
        Response.Builder builderProtocol = (!(builder instanceof Response.Builder) ? builder.body(noContentResponseBody) : OkHttp3Instrumentation.body(builder, noContentResponseBody)).code(i).message("Response.error()").protocol(Protocol.HTTP_1_1);
        Request.Builder builderUrl = new Request.Builder().url("http://localhost/");
        return error(responseBody, builderProtocol.request(!(builderUrl instanceof Request.Builder) ? builderUrl.build() : OkHttp3Instrumentation.build(builderUrl)).build());
    }
