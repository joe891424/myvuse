...
final class OkHttpCall<T> implements Call<T> {
    ...
    private okhttp3.Call createRawCall() throws IOException {
        ...
        Request requestCreate = this.requestFactory.create(this.args);
        okhttp3.Call callNewCall = !(factory instanceof OkHttpClient) ? factory.newCall(requestCreate) : OkHttp3Instrumentation.newCall((OkHttpClient) factory, requestCreate);
        if (callNewCall != null) {
            return callNewCall;
        }
    ...
    Response<T> parseResponse(okhttp3.Response response) throws IOException {
        ...
        NoContentResponseBody noContentResponseBody = new NoContentResponseBody(responseBodyBody.get$contentType(), responseBodyBody.getContentLength());
        okhttp3.Response responseBuild = (!(builderNewBuilder instanceof Response.Builder) ? builderNewBuilder.body(noContentResponseBody) : OkHttp3Instrumentation.body(builderNewBuilder, noContentResponseBody)).build();
