...
abstract class HttpServiceMethod<ResponseT, ReturnT> extends ServiceMethod<ReturnT> {
    ...
    static <ResponseT, ReturnT> HttpServiceMethod<ResponseT, ReturnT> parseAnnotations(Retrofit retrofit, Method method, RequestFactory requestFactory) {
        ...
        Type successType = callAdapterCreateCallAdapter.getSuccessType();
        ...
        if (requestFactory.httpMethod.equals(FirebasePerformance.HttpMethod.HEAD) && !Void.class.equals(successType)) {
            throw Utils.methodError(method, "HEAD method must use Void as response type.", new Object[0]);
        }
        Converter converterCreateResponseConverter = createResponseConverter(retrofit, method, successType);
