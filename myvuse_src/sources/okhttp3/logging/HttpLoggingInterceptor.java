...
public final class HttpLoggingInterceptor implements Interceptor {
    ...
    /* JADX INFO: compiled from: HttpLoggingInterceptor.kt */
    @Metadata(m5596bv = {1, 0, 3}, m5597d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0002\b\u0006\b\u0086\u0001\u0018\u00002\b\u0012\u0004\u0012\u00020\u00000\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002j\u0002\b\u0003j\u0002\b\u0004j\u0002\b\u0005j\u0002\b\u0006¨\u0006\u0007"}, m5598d2 = {"Lokhttp3/logging/HttpLoggingInterceptor$Level;", "", "(Ljava/lang/String;I)V", "NONE", "BASIC", "HEADERS", "BODY", "okhttp-logging-interceptor"}, m5599k = 1, m5600mv = {1, 4, 0})
    public enum Level {
        NONE,
        BASIC,
        HEADERS,
    ...
    /* JADX INFO: compiled from: HttpLoggingInterceptor.kt */
    @Metadata(m5596bv = {1, 0, 3}, m5597d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\bæ\u0080\u0001\u0018\u0000 \u00062\u00020\u0001:\u0001\u0006J\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H&¨\u0006\u0007"}, m5598d2 = {"Lokhttp3/logging/HttpLoggingInterceptor$Logger;", "", "log", "", "message", "", "Companion", "okhttp-logging-interceptor"}, m5599k = 1, m5600mv = {1, 4, 0})
    public interface Logger {
        ...
        /* JADX INFO: compiled from: HttpLoggingInterceptor.kt */
        @Metadata(m5596bv = {1, 0, 3}, m5597d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001:\u0001\u0005B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0016\u0010\u0003\u001a\u00020\u00048\u0006X\u0087\u0004ø\u0001\u0000¢\u0006\u0002\n\u0000¨\u0006\u0001\u0082\u0002\u0007\n\u0005\b\u0091F0\u0001¨\u0006\u0006"}, m5598d2 = {"Lokhttp3/logging/HttpLoggingInterceptor$Logger$Companion;", "", "()V", "DEFAULT", "Lokhttp3/logging/HttpLoggingInterceptor$Logger;", "DefaultLogger", "okhttp-logging-interceptor"}, m5599k = 1, m5600mv = {1, 4, 0})
        public static final class Companion {
            ...
            /* JADX INFO: compiled from: HttpLoggingInterceptor.kt */
            @Metadata(m5596bv = {1, 0, 3}, m5597d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\b\u0002\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0016¨\u0006\u0007"}, m5598d2 = {"Lokhttp3/logging/HttpLoggingInterceptor$Logger$Companion$DefaultLogger;", "Lokhttp3/logging/HttpLoggingInterceptor$Logger;", "()V", "log", "", "message", "", "okhttp-logging-interceptor"}, m5599k = 1, m5600mv = {1, 4, 0})
    ...
    public Response intercept(Interceptor.Chain chain) throws Exception {
        ...
        String str2 = "--> " + request.method() + SafeJsonPrimitive.NULL_CHAR + request.url() + (connection != null ? " " + connection.protocol() : "");
        ...
        try {
            ...
            if (responseProceed.message().length() == 0) {
                ...
                str = "-byte body omitted)";
                c = SafeJsonPrimitive.NULL_CHAR;
                string = sb.append(String.valueOf(SafeJsonPrimitive.NULL_CHAR)).append(strMessage).toString();
            }
            ...
            if (z2) {
                ...
                if (!z || !HttpHeaders.promisesBody(responseProceed)) {
                    ...
                    Long l = null;
                    if (StringsKt.equals(Constants.Network.Encoding.GZIP, headers2.get("Content-Encoding"), true)) {
    ...
    private final boolean bodyHasUnknownEncoding(Headers headers) {
        ...
        return (str == null || StringsKt.equals(str, "identity", true) || StringsKt.equals(str, Constants.Network.Encoding.GZIP, true)) ? false : true;
    }
}
