...
public final class ByteString {
    ...
    public static final String commonHex(okio.ByteString byteString) {
        ...
        for (byte b : byteString.getData()) {
            ...
            i += 2;
            cArr[i2] = getHEX_DIGIT_CHARS()[b & Ascii.f3756SI];
        }
