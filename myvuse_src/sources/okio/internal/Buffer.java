    ...
    */
    ...
    public static final okio.Buffer commonWriteDecimalLong(okio.Buffer buffer, long j) {
        ...
        if (j >= 100000000) {
            ...
            i = j < Constants.Network.MAX_PAYLOAD_SIZE ? j < 100000 ? 5 : 6 : j < 10000000 ? 7 : 8;
        } else if (j >= 100) {
            i = j < 1000 ? 3 : 4;
        } else if (j >= 10) {
            i = 2;
    ...
    */
    ...
    public static final okio.Buffer commonWriteUtf8CodePoint(okio.Buffer buffer, int i) {
        ...
        if (i < 128) {
            ...
            segmentWritableSegment$okio2.data[segmentWritableSegment$okio2.limit] = (byte) ((i >> 12) | ISO7816Kt.INS_CREATE_FILE);
