...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public final ByteString sha256() {
        return digest(HashUtil.SHA_256);
    }
    ...
    public final ByteString hmacSha256(ByteString key) {
        Intrinsics.checkNotNullParameter(key, "key");
        return hmac(MacUtil.HMAC_SHA256, key);
    }

    public final ByteString hmacSha512(ByteString key) {
        Intrinsics.checkNotNullParameter(key, "key");
        return hmac(MacUtil.HMAC_SHA512, key);
    }
    ...
    public final byte m8941deprecated_getByte(long index) {
    ...
    */
        ...
        while (beginIndex < endIndex) {
            ...
            if (cCharAt2 < 128) {
                ...
                if (cCharAt2 < 2048) {
                    ...
                    segmentWritableSegment$okio3.data[segmentWritableSegment$okio3.limit] = (byte) ((cCharAt2 >> '\f') | ISO7816Kt.INS_CREATE_FILE);
    ...
    public Buffer writeUtf8CodePoint(int codePoint) {
        if (codePoint < 128) {
            ...
            segmentWritableSegment$okio2.data[segmentWritableSegment$okio2.limit] = (byte) ((codePoint >> 12) | ISO7816Kt.INS_CREATE_FILE);
    ...
    public Buffer writeDecimalLong(long v) {
        ...
        if (v >= 100000000) {
            ...
            i = v < Constants.Network.MAX_PAYLOAD_SIZE ? v < 100000 ? 5 : 6 : v < 10000000 ? 7 : 8;
        } else if (v >= 100) {
            i = v < 1000 ? 3 : 4;
        } else if (v >= 10) {
            i = 2;
