...
/* JADX INFO: renamed from: a.a.a.a.b.b.b */
/* JADX INFO: loaded from: classes.dex */
public class C0070b {
    /* JADX INFO: renamed from: a */
    public boolean m380a(FragmentActivity fragmentActivity, C0002a eventListenerSetter, OTConfiguration oTConfiguration, OTUIDisplayReason oTUIDisplayReason) {
        boolean z;
        ...
        if (sharedPreferences.getInt("OT_UI_MODE_TYPE", 102) == 101) {
            C0170b.m956a(fragmentActivity, C0093d.m533a(OTFragmentTags.OT_TV_MAIN_FRAGMENT_TAG, eventListenerSetter, 0, oTConfiguration), OTFragmentTags.OT_TV_MAIN_FRAGMENT_TAG);
        } else {
            OTBannerFragment.f1136k.getClass();
            ...
            Bundle bundleBundleOf = BundleKt.bundleOf(TuplesKt.m5605to(OTFragmentTags.FRAGMENT_TAG, OTFragmentTags.OT_BANNER_FRAGMENT_TAG));
            OTBannerFragment oTBannerFragment = new OTBannerFragment();
            oTBannerFragment.setArguments(bundleBundleOf);
            oTBannerFragment.f1140c = eventListenerSetter;
            oTBannerFragment.f1141d = oTConfiguration;
            C0170b.m956a(fragmentActivity, oTBannerFragment, OTFragmentTags.OT_BANNER_FRAGMENT_TAG);
        }
        OTLogger.m2743a(4, "OneTrust", "Showing Banner");
        OTLogger.m2743a(4, "OneTrust", oTUIDisplayReason.logReason());
        C0003b c0003b = new C0003b(1);
        c0003b.f7f = oTUIDisplayReason;
        if (eventListenerSetter != null) {
            eventListenerSetter.m0a(c0003b);
        } else {
