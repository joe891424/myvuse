...
/* JADX INFO: renamed from: a.a.a.a.d.g.d */
...
public class C0195d {
    ...
    public void m1057a() {
        ...
        try {
            ...
            if (c0045d2.m271a().getBoolean("OT_GPP_IS_ENABLED", false)) {
                ...
                if ("USNATIONAL".equalsIgnoreCase(str)) {
                    String strM1058b = m1058b();
                    OTLogger.m2743a(4, "OneTrust", "Gpp - US NATIONAL String : " + strM1058b);
                    if (C0048h.m305b(strM1058b)) {
                        return;
                    }
                    PreferenceManager.getDefaultSharedPreferences(this.f1681a).edit().putString(OTGppKeys.IAB_GPP_US_NAT_STRING, strM1058b).apply();
                }
            }
        } catch (Exception e) {
            OTLogger.m2743a(6, "OneTrust", "computeUSNationalString failed:" + e);
        }
    }
    ...
    */
    public final java.lang.String m1058b() throws org.json.JSONException {
        /*
            Method dump skipped, instruction units count: 954
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: p000a.p001a.p002a.p003a.p028d.p029g.C0195d.m1058b():java.lang.String");
    }
}
