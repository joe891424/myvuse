...
public class JsonWebSignature extends JsonWebStructure {
    ...
    public CryptoPrimitive prepareSigningPrimitive() throws JoseException {
        CryptoPrimitive cryptoPrimitiveCreateSigningPrimitive = createSigningPrimitive();
        this.signingPrimitive = cryptoPrimitiveCreateSigningPrimitive;
        return cryptoPrimitiveCreateSigningPrimitive;
    }
    ...
    public void sign() throws JoseException {
        CryptoPrimitive cryptoPrimitiveCreateSigningPrimitive = this.signingPrimitive;
        if (cryptoPrimitiveCreateSigningPrimitive == null) {
            cryptoPrimitiveCreateSigningPrimitive = createSigningPrimitive();
        }
        setSignature(getAlgorithm().sign(cryptoPrimitiveCreateSigningPrimitive, getSigningInputBytes()));
    }
    ...
    private JsonWebSignatureAlgorithm getAlgorithm(boolean z) throws InvalidAlgorithmException {
        ...
        return (JsonWebSignatureAlgorithm) AlgorithmFactoryFactory.getInstance().getJwsAlgorithmFactory().getAlgorithm(algorithmHeaderValue);
    }
