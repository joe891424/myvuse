...
public class AlgorithmFactoryFactory {
    ...
    private void initialize() {
        ...
        Logger logger = log;
        logger.debug("Initializing jose4j (running with Java {} from {} at {} with {} security providers installed)...", property, property2, property3, string);
        ...
        logger.debug("JWS signature algorithms: {}", this.jwsAlgorithmFactory.getSupportedAlgorithms());
        ...
        logger.debug("JWE key management algorithms: {}", this.jweKeyMgmtModeAlgorithmFactory.getSupportedAlgorithms());
        ...
        logger.debug("JWE content encryption algorithms: {}", this.jweContentEncryptionAlgorithmFactory.getSupportedAlgorithms());
        ...
        logger.debug("JWE compression algorithms: {}", this.compressionAlgorithmFactory.getSupportedAlgorithms());
        logger.debug("Initialized jose4j in {}ms", Long.valueOf(System.currentTimeMillis() - jCurrentTimeMillis));
    }
