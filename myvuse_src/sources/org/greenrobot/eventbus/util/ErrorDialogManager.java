...
public class ErrorDialogManager {
    ...
    public static class SupportManagerFragment extends Fragment implements TraceFieldInterface {
        ...
        public void onCreate(Bundle bundle) {
            ...
            try {
                TraceMachine.enterMethod(this._nr_trace, "ErrorDialogManager$SupportManagerFragment#onCreate", null);
    ...
    public static class HoneycombManagerFragment extends android.app.Fragment implements TraceFieldInterface {
        public Trace _nr_trace;
        protected Bundle argumentsForErrorDialog;
        private EventBus eventBus;
        private Object executionScope;
    ...
    protected static void checkLogException(ThrowableFailureEvent throwableFailureEvent) {
        if (factory.config.logExceptions) {
            ...
            LogInstrumentation.m2731i(str, "Error dialog manager received exception", throwableFailureEvent.throwable);
        }
    }
