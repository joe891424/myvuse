...
public class SplashScreen {
    ...
    public static void show(final Activity activity, final int i, final boolean z) {
        ...
        activity.runOnUiThread(new Runnable() { // from class: org.devio.rn.splashscreen.SplashScreen.1
            ...
            public void run() {
                ...
                SplashScreen.mSplashDialog.setContentView(C5901R.layout.launch_screen);
    ...
    public static void show(Activity activity, boolean z) {
        show(activity, z ? C5901R.style.SplashScreen_Fullscreen : C5901R.style.SplashScreen_SplashTheme, z);
    }
