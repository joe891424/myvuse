...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
    ...
    @DebugMetadata(m5607c = "kotlinx.coroutines.channels.BroadcastChannelImpl", m5608f = "BroadcastChannel.kt", m5609i = {0, 0}, m5610l = {230}, m5611m = "send", m5612n = {"this", "element"}, m5613s = {"L$0", "L$1"})
    static final class C56421 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        Object L$2;
        int label;
        ...
        C56421(BroadcastChannelImpl<E> broadcastChannelImpl, Continuation<? super C56421> continuation) {
            super(continuation);
        ...
        try {
            ...
            if (!isClosedForSend() || this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                if (this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                    subscriberConflated.mo8737trySendJP2dKIU(getValue());
                }
    ...
    */
    public java.lang.Object send(E r7, kotlin.coroutines.Continuation<? super kotlin.Unit> r8) throws java.lang.Throwable {
        /*
            r6 = this;
            boolean r0 = r8 instanceof kotlinx.coroutines.channels.BroadcastChannelImpl.C56421
            if (r0 == 0) goto L14
            r0 = r8
            kotlinx.coroutines.channels.BroadcastChannelImpl$send$1 r0 = (kotlinx.coroutines.channels.BroadcastChannelImpl.C56421) r0
            int r1 = r0.label
    ...
    public Object mo8737trySendJP2dKIU(E element) {
        ReentrantLock reentrantLock = this.lock;
        reentrantLock.lock();
        try {
            if (isClosedForSend()) {
                return super.mo8737trySendJP2dKIU(element);
            }
            List<? extends BufferedChannel<E>> list = this.subscribers;
            ...
            while (it3.hasNext()) {
                ((BufferedChannel) it3.next()).mo8737trySendJP2dKIU(element);
            }
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        ...
        try {
            ...
            Unit unit = Unit.INSTANCE;
            reentrantLock.unlock();
            BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(select.getContext()), null, CoroutineStart.UNDISPATCHED, new C56412(this, element, select, null), 1, null);
        } finally {
            reentrantLock.unlock();
        }
    }
    ...
    @DebugMetadata(m5607c = "kotlinx.coroutines.channels.BroadcastChannelImpl$registerSelectForSend$2", m5608f = "BroadcastChannel.kt", m5609i = {}, m5610l = {291}, m5611m = "invokeSuspend", m5612n = {}, m5613s = {})
    static final class C56412 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C56412(BroadcastChannelImpl<E> broadcastChannelImpl, Object obj, SelectInstance<?> selectInstance, Continuation<? super C56412> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C56412(this.this$0, this.$element, this.$select, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C56412) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* JADX INFO: compiled from: BroadcastChannel.kt */
    @Metadata(m5597d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0003\n\u0000\b\u0082\u0004\u0018\u00002\b\u0012\u0004\u0012\u00028\u00000\u0001B\u0005¢\u0006\u0002\u0010\u0002J\u0012\u0010\u0003\u001a\u00020\u00042\b\u0010\u0005\u001a\u0004\u0018\u00010\u0006H\u0016¨\u0006\u0007"}, m5598d2 = {"Lkotlinx/coroutines/channels/BroadcastChannelImpl$SubscriberBuffered;", "Lkotlinx/coroutines/channels/BufferedChannel;", "(Lkotlinx/coroutines/channels/BroadcastChannelImpl;)V", "cancelImpl", "", HexAttribute.HEX_ATTR_CAUSE, "", "kotlinx-coroutines-core"}, m5599k = 1, m5600mv = {1, 8, 0}, m5602xi = 48)
