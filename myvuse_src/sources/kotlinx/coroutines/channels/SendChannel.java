...
public interface SendChannel<E> {
    ...
    Object mo8737trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m8757isSuccessimpl(objMo8737trySendJP2dKIU)) {
                return true;
            }
            Throwable thM8751exceptionOrNullimpl = ChannelResult.m8751exceptionOrNullimpl(objMo8737trySendJP2dKIU);
