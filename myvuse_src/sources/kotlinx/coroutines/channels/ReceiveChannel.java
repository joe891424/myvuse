...
public interface ReceiveChannel<E> {
    ...
    @DebugMetadata(m5607c = "kotlinx.coroutines.channels.ReceiveChannel$DefaultImpls", m5608f = "Channel.kt", m5609i = {}, m5610l = {372}, m5611m = "receiveOrNull", m5612n = {}, m5613s = {})
    static final class C56951<E> extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;

        C56951(Continuation<? super C56951> continuation) {
            super(continuation);
        }
    ...
    Object mo8741receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo8742tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo8742tryReceivePtdJZtk = receiveChannel.mo8742tryReceivePtdJZtk();
            if (ChannelResult.m8757isSuccessimpl(objMo8742tryReceivePtdJZtk)) {
                return (E) ChannelResult.m8753getOrThrowimpl(objMo8742tryReceivePtdJZtk);
            }
            Throwable thM8751exceptionOrNullimpl = ChannelResult.m8751exceptionOrNullimpl(objMo8742tryReceivePtdJZtk);
            if (thM8751exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM8751exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) {
            /*
                boolean r0 = r5 instanceof kotlinx.coroutines.channels.ReceiveChannel.C56951
                if (r0 == 0) goto L14
                r0 = r5
                kotlinx.coroutines.channels.ReceiveChannel$receiveOrNull$1 r0 = (kotlinx.coroutines.channels.ReceiveChannel.C56951) r0
                int r1 = r0.label
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo8741receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m8752getOrNullimpl(r4)
                return r4
            */
