...
@Metadata(m5597d1 = {"\u0000*\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\t\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u001a/\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00032\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00010\u0006H\u0082@ø\u0001\u0000¢\u0006\u0002\u0010\u0007\u001a/\u0010\b\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00032\f\u0010\u0005\u001a\b\u0012\u0004\u0012\u00020\u00010\u0006H\u0082@ø\u0001\u0000¢\u0006\u0002\u0010\u0007\u001a4\u0010\t\u001a\b\u0012\u0004\u0012\u00020\u00010\n2\u0006\u0010\u0002\u001a\u00020\u00032\b\b\u0002\u0010\u0004\u001a\u00020\u00032\b\b\u0002\u0010\u000b\u001a\u00020\f2\b\b\u0002\u0010\r\u001a\u00020\u000eH\u0007\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006\u000f"}, m5598d2 = {"fixedDelayTicker", "", "delayMillis", "", "initialDelayMillis", "channel", "Lkotlinx/coroutines/channels/SendChannel;", "(JJLkotlinx/coroutines/channels/SendChannel;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;", "fixedPeriodTicker", "ticker", "Lkotlinx/coroutines/channels/ReceiveChannel;", "context", "Lkotlin/coroutines/CoroutineContext;", "mode", "Lkotlinx/coroutines/channels/TickerMode;", "kotlinx-coroutines-core"}, m5599k = 2, m5600mv = {1, 8, 0}, m5602xi = 48)
public final class TickerChannelsKt {
    ...
    @DebugMetadata(m5607c = "kotlinx.coroutines.channels.TickerChannelsKt", m5608f = "TickerChannels.kt", m5609i = {0, 0, 1, 1, 2, 2}, m5610l = {106, 108, 109}, m5611m = "fixedDelayTicker", m5612n = {"channel", "delayMillis", "channel", "delayMillis", "channel", "delayMillis"}, m5613s = {"L$0", "J$0", "L$0", "J$0", "L$0", "J$0"})
    static final class C56961 extends ContinuationImpl {
        long J$0;
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C56961(Continuation<? super C56961> continuation) {
            super(continuation);
        }
    ...
    /* JADX INFO: compiled from: TickerChannels.kt */
    @Metadata(m5599k = 3, m5600mv = {1, 8, 0}, m5602xi = 48)
    @DebugMetadata(m5607c = "kotlinx.coroutines.channels.TickerChannelsKt", m5608f = "TickerChannels.kt", m5609i = {0, 0, 0, 1, 1, 1, 2, 2, 2, 3, 3, 3}, m5610l = {84, 88, 94, ImageQualityKt.QUALITY_MEDIUM}, m5611m = "fixedPeriodTicker", m5612n = {"channel", "delayMillis", "deadline", "channel", "deadline", "delayNs", "channel", "deadline", "delayNs", "channel", "deadline", "delayNs"}, m5613s = {"L$0", "J$0", "J$1", "L$0", "J$0", "J$1", "L$0", "J$0", "J$1", "L$0", "J$0", "J$1"})
    static final class C56971 extends ContinuationImpl {
        long J$0;
        long J$1;
        Object L$0;
        int label;
        ...
        C56971(Continuation<? super C56971> continuation) {
            super(continuation);
        }
    ...
    public static final ReceiveChannel<Unit> ticker(long j, long j2, CoroutineContext coroutineContext, TickerMode tickerMode) {
        ...
        return ProduceKt.produce(GlobalScope.INSTANCE, Dispatchers.getUnconfined().plus(coroutineContext), 0, new C56983(tickerMode, j, j2, null));
    }
    ...
    @DebugMetadata(m5607c = "kotlinx.coroutines.channels.TickerChannelsKt$ticker$3", m5608f = "TickerChannels.kt", m5609i = {}, m5610l = {72, 73}, m5611m = "invokeSuspend", m5612n = {}, m5613s = {})
    static final class C56983 extends SuspendLambda implements Function2<ProducerScope<? super Unit>, Continuation<? super Unit>, Object> {
        ...
        C56983(TickerMode tickerMode, long j, long j2, Continuation<? super C56983> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C56983 c56983 = new C56983(this.$mode, this.$delayMillis, this.$initialDelayMillis, continuation);
            c56983.L$0 = obj;
            return c56983;
        }
        ...
        public final Object invoke(ProducerScope<? super Unit> producerScope, Continuation<? super Unit> continuation) {
            return ((C56983) create(producerScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    */
    public static final java.lang.Object fixedDelayTicker(long r6, long r8, kotlinx.coroutines.channels.SendChannel<? super kotlin.Unit> r10, kotlin.coroutines.Continuation<? super kotlin.Unit> r11) {
        /*
            boolean r0 = r11 instanceof kotlinx.coroutines.channels.TickerChannelsKt.C56961
            if (r0 == 0) goto L14
            r0 = r11
            kotlinx.coroutines.channels.TickerChannelsKt$fixedDelayTicker$1 r0 = (kotlinx.coroutines.channels.TickerChannelsKt.C56961) r0
            int r1 = r0.label
