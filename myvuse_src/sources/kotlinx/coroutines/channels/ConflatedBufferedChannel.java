...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM8765trySendImplMj0NB7M = conflatedBufferedChannel.m8765trySendImplMj0NB7M(e, true);
        if (objM8765trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m8751exceptionOrNullimpl(objM8765trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM8765trySendImplMj0NB7M = conflatedBufferedChannel.m8765trySendImplMj0NB7M(e, true);
        if (!(objM8765trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo8737trySendJP2dKIU(E element) {
        return m8765trySendImplMj0NB7M(element, false);
    }

    /* JADX INFO: renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m8765trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m8763trySendDropLatestMj0NB7M(element, isSendOp) : m8764trySendDropOldestJP2dKIU(element);
    }

    /* JADX INFO: renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m8763trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo8737trySendJP2dKIU = super.mo8737trySendJP2dKIU(element);
        if (ChannelResult.m8757isSuccessimpl(objMo8737trySendJP2dKIU) || ChannelResult.m8755isClosedimpl(objMo8737trySendJP2dKIU)) {
            return objMo8737trySendJP2dKIU;
        }
    ...
    private final Object m8764trySendDropOldestJP2dKIU(E element) {
        ...
        while (true) {
            ...
            if (channelSegment2.id != j2) {
                ...
                if (channelSegmentFindSegmentSend != null) {
                    ...
                    return ChannelResult.INSTANCE.m8760closedJP2dKIU(getSendException());
                }
            } else {
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo8737trySendJP2dKIU = mo8737trySendJP2dKIU(element);
        if (!(objMo8737trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo8737trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m8751exceptionOrNullimpl(objMo8737trySendJP2dKIU);
