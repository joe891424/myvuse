...
public final class DispatchedContinuation<T> extends DispatchedTask<T> implements CoroutineStackFrame, Continuation<T> {
    ...
    public final CancellableContinuationImpl<T> claimReusableCancellableContinuation$kotlinx_coroutines_core() {
        ...
        while (true) {
            ...
            if (obj instanceof CancellableContinuationImpl) {
                if (C0526xc40028dd.m1169m(_reusableCancellableContinuation$FU, this, obj, DispatchedContinuationKt.REUSABLE_CLAIMED)) {
                    return (CancellableContinuationImpl) obj;
                }
    ...
    public final Throwable tryReleaseClaimedContinuation$kotlinx_coroutines_core(CancellableContinuation<?> continuation) {
        ...
        do {
            ...
            if (obj != DispatchedContinuationKt.REUSABLE_CLAIMED) {
                if (obj instanceof Throwable) {
                    if (!C0526xc40028dd.m1169m(_reusableCancellableContinuation$FU, this, obj, null)) {
        ...
        } while (!C0526xc40028dd.m1169m(_reusableCancellableContinuation$FU, this, DispatchedContinuationKt.REUSABLE_CLAIMED, continuation));
        return null;
    }
    ...
    public final boolean postponeCancellation$kotlinx_coroutines_core(Throwable cause) {
        ...
        while (true) {
            ...
            if (Intrinsics.areEqual(obj, DispatchedContinuationKt.REUSABLE_CLAIMED)) {
                if (C0526xc40028dd.m1169m(_reusableCancellableContinuation$FU, this, DispatchedContinuationKt.REUSABLE_CLAIMED, cause)) {
                    return true;
                }
            } else {
                if (obj instanceof Throwable) {
    ...
    public void resumeWith(Object result) {
        ...
        if (this.dispatcher.isDispatchNeeded(context2)) {
            ...
            this.resumeMode = 0;
            this.dispatcher.mo8793dispatch(context2, this);
            return;
        }
    ...
    */
    ...
    public final boolean resumeCancelled$kotlinx_coroutines_core(Object state) {
        ...
        resumeWith(Result.m7233constructorimpl(ResultKt.createFailure(cancellationException)));
        return true;
    }
