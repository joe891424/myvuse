...
public final class ConcurrentLinkedListKt {
    ...
    public static final <S extends Segment<S>> Object findSegmentInternal(S s, long j, Function2<? super Long, ? super S, ? extends S> function2) {
        while (true) {
            if (s.id >= j && !s.isRemoved()) {
                return SegmentOrClosed.m8796constructorimpl(s);
            }
            Object nextOrClosed = s.getNextOrClosed();
            if (nextOrClosed == CLOSED) {
                return SegmentOrClosed.m8796constructorimpl(CLOSED);
            }
    ...
    public static final boolean moveForward$atomicfu(Object obj, AtomicReferenceFieldUpdater atomicReferenceFieldUpdater, Segment segment) {
        while (true) {
            ...
            if (C0526xc40028dd.m1169m(atomicReferenceFieldUpdater, obj, segment2, segment)) {
    ...
    public static final boolean moveForward$atomicfu$array(Object obj, AtomicReferenceArray atomicReferenceArray, int i, Segment segment) {
        while (true) {
            ...
            if (C3124xa7a47114.m2591m(atomicReferenceArray, i, segment2, segment)) {
                if (segment2.decPointers$kotlinx_coroutines_core()) {
                    segment2.remove();
                }
                return true;
    ...
    public static final Object findSegmentAndMoveForward$atomicfu(Object obj, AtomicReferenceFieldUpdater atomicReferenceFieldUpdater, long j, Segment segment, Function2 function2) {
        ...
        loop0: while (true) {
            ...
            if (!SegmentOrClosed.m8801isClosedimpl(objFindSegmentInternal)) {
                ...
                while (true) {
                    Segment segment2 = (Segment) atomicReferenceFieldUpdater.get(obj);
                    if (segment2.id >= segmentM8799getSegmentimpl.id) {
                        break loop0;
                    }
                    if (!segmentM8799getSegmentimpl.tryIncPointers$kotlinx_coroutines_core()) {
                        break;
                    }
                    if (C0526xc40028dd.m1169m(atomicReferenceFieldUpdater, obj, segment2, segmentM8799getSegmentimpl)) {
                        if (segment2.decPointers$kotlinx_coroutines_core()) {
                            segment2.remove();
                        }
        ...
        loop0: while (true) {
            ...
            if (!SegmentOrClosed.m8801isClosedimpl(objFindSegmentInternal)) {
                ...
                while (true) {
                    ...
                    if (C3124xa7a47114.m2591m(atomicReferenceArray, i, segment2, segmentM8799getSegmentimpl)) {
                        if (segment2.decPointers$kotlinx_coroutines_core()) {
                            segment2.remove();
                        }
                    } else if (segmentM8799getSegmentimpl.decPointers$kotlinx_coroutines_core()) {
