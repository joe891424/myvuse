...
public final class LintKt {
    ...
    private static final <T> Flow<T> m8778catch(SharedFlow<? extends T> sharedFlow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        ...
        return FlowKt.m8766catch(sharedFlow, function3);
    }

    /* JADX INFO: renamed from: kotlinx.coroutines.flow.LintKt$retry$1 */
    /* JADX INFO: compiled from: Lint.kt */
    @Metadata(m5597d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u0003\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u00020\u0004H\u008a@"}, m5598d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "it", ""}, m5599k = 3, m5600mv = {1, 8, 0}, m5602xi = ISO7816Kt.INS_READ_BINARY)
    @DebugMetadata(m5607c = "kotlinx.coroutines.flow.LintKt$retry$1", m5608f = "Lint.kt", m5609i = {}, m5610l = {}, m5611m = "invokeSuspend", m5612n = {}, m5613s = {})
    public static final class C58081 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
        int label;

        public C58081(Continuation<? super C58081> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C58081(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Throwable th, Continuation<? super Boolean> continuation) {
            return ((C58081) create(th, continuation)).invokeSuspend(Unit.INSTANCE);
        }
