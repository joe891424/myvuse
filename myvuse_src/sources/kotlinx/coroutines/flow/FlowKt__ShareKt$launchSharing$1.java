...
@DebugMetadata(m5607c = "kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharing$1", m5608f = "Share.kt", m5609i = {}, m5610l = {ISO7816Kt.INS_UPDATE_BINARY, JfifUtil.MARKER_SOS, 219, JfifUtil.MARKER_APP1}, m5611m = "invokeSuspend", m5612n = {}, m5613s = {})
final class FlowKt__ShareKt$launchSharing$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    */
    ...
    /* JADX INFO: compiled from: Share.kt */
    @Metadata(m5597d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\b\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u00020\u0004H\u008a@"}, m5598d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "it", ""}, m5599k = 3, m5600mv = {1, 8, 0}, m5602xi = 48)
    @DebugMetadata(m5607c = "kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharing$1$1", m5608f = "Share.kt", m5609i = {}, m5610l = {}, m5611m = "invokeSuspend", m5612n = {}, m5613s = {})
    static final class C57771 extends SuspendLambda implements Function2<Integer, Continuation<? super Boolean>, Object> {
        /* synthetic */ int I$0;
        int label;

        C57771(Continuation<? super C57771> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C57771 c57771 = new C57771(continuation);
            c57771.I$0 = ((Number) obj).intValue();
            return c57771;
        }

        public final Object invoke(int i, Continuation<? super Boolean> continuation) {
            return ((C57771) create(Integer.valueOf(i), continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* JADX INFO: compiled from: Share.kt */
    @Metadata(m5597d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u00020\u0004H\u008a@"}, m5598d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "it", "Lkotlinx/coroutines/flow/SharingCommand;"}, m5599k = 3, m5600mv = {1, 8, 0}, m5602xi = 48)
    @DebugMetadata(m5607c = "kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharing$1$2", m5608f = "Share.kt", m5609i = {}, m5610l = {227}, m5611m = "invokeSuspend", m5612n = {}, m5613s = {})
    static final class C57782 extends SuspendLambda implements Function2<SharingCommand, Continuation<? super Unit>, Object> {
        final /* synthetic */ T $initialValue;
        final /* synthetic */ MutableSharedFlow<T> $shared;
        final /* synthetic */ Flow<T> $upstream;
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C57782(Flow<? extends T> flow, MutableSharedFlow<T> mutableSharedFlow, T t, Continuation<? super C57782> continuation) {
            super(2, continuation);
            this.$upstream = flow;
            this.$shared = mutableSharedFlow;
            this.$initialValue = t;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C57782 c57782 = new C57782(this.$upstream, this.$shared, this.$initialValue, continuation);
            c57782.L$0 = obj;
            return c57782;
        }
        ...
        public final Object invoke(SharingCommand sharingCommand, Continuation<? super Unit> continuation) {
            return ((C57782) create(sharingCommand, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        public final java.lang.Object invokeSuspend(java.lang.Object r5) {
            ...
            L17:
                ...
                int[] r1 = kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharing$1.C57782.WhenMappings.$EnumSwitchMapping$0
                int r5 = r5.ordinal()
                r5 = r1[r5]
                if (r5 == r2) goto L40
                r0 = 3
            ...
            L52:
                ...
                return r5
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharing$1.C57782.invokeSuspend(java.lang.Object):java.lang.Object");
        }
    }
}
