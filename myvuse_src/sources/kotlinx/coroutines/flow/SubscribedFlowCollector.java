...
public final class SubscribedFlowCollector<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(m5607c = "kotlinx.coroutines.flow.SubscribedFlowCollector", m5608f = "Share.kt", m5609i = {0, 0}, m5610l = {419, TypedValues.CycleType.TYPE_WAVE_PERIOD}, m5611m = "onSubscription", m5612n = {"this", "safeCollector"}, m5613s = {"L$0", "L$1"})
    static final class C58141 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        ...
        C58141(SubscribedFlowCollector<T> subscribedFlowCollector, Continuation<? super C58141> continuation) {
            super(continuation);
    ...
    */
    public final java.lang.Object onSubscription(kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
        /*
            r6 = this;
            boolean r0 = r7 instanceof kotlinx.coroutines.flow.SubscribedFlowCollector.C58141
            if (r0 == 0) goto L14
            r0 = r7
            kotlinx.coroutines.flow.SubscribedFlowCollector$onSubscription$1 r0 = (kotlinx.coroutines.flow.SubscribedFlowCollector.C58141) r0
            int r1 = r0.label
