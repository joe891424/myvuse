...
public final class FlowKt__BuildersKt$flowOf$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    @DebugMetadata(m5607c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$flowOf$$inlined$unsafeFlow$1", m5608f = "Builders.kt", m5609i = {0, 0}, m5610l = {ModuleDescriptor.MODULE_VERSION}, m5611m = "collect", m5612n = {"this", "$this$flowOf_u24lambda_u248"}, m5613s = {"L$0", "L$1"})
    public static final class C57191 extends ContinuationImpl {
        int I$0;
        int I$1;
        Object L$0;
        Object L$1;
        ...
        public C57191(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r8, kotlin.coroutines.Continuation<? super kotlin.Unit> r9) {
        /*
            r7 = this;
            boolean r0 = r9 instanceof kotlinx.coroutines.flow.FlowKt__BuildersKt$flowOf$$inlined$unsafeFlow$1.C57191
            if (r0 == 0) goto L14
            r0 = r9
            kotlinx.coroutines.flow.FlowKt__BuildersKt$flowOf$$inlined$unsafeFlow$1$1 r0 = (kotlinx.coroutines.flow.FlowKt__BuildersKt$flowOf$$inlined$unsafeFlow$1.C57191) r0
            int r1 = r0.label
