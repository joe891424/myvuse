...
final /* synthetic */ class FlowKt__LimitKt {
    ...
    @DebugMetadata(m5607c = "kotlinx.coroutines.flow.FlowKt__LimitKt", m5608f = "Limit.kt", m5609i = {0}, m5610l = {136}, m5611m = "collectWhile", m5612n = {"collector"}, m5613s = {"L$0"})
    static final class C57461<T> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C57461(Continuation<? super C57461> continuation) {
            super(continuation);
        }
    ...
    */
    ...
    /* JADX INFO: compiled from: Limit.kt */
    @Metadata(m5597d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0003*\b\u0012\u0004\u0012\u0002H\u00030\u0004H\u008a@"}, m5598d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "R", "Lkotlinx/coroutines/flow/FlowCollector;"}, m5599k = 3, m5600mv = {1, 8, 0}, m5602xi = 48)
    @DebugMetadata(m5607c = "kotlinx.coroutines.flow.FlowKt__LimitKt$transformWhile$1", m5608f = "Limit.kt", m5609i = {0}, m5610l = {152}, m5611m = "invokeSuspend", m5612n = {"collector$iv"}, m5613s = {"L$0"})
    static final class C57501<R> extends SuspendLambda implements Function2<FlowCollector<? super R>, Continuation<? super Unit>, Object> {
        ...
        C57501(Flow<? extends T> flow, Function3<? super FlowCollector<? super R>, ? super T, ? super Continuation<? super Boolean>, ? extends Object> function3, Continuation<? super C57501> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C57501 c57501 = new C57501(this.$this_transformWhile, this.$transform, continuation);
            c57501.L$0 = obj;
            return c57501;
        }
        ...
        public final Object invoke(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) {
            return ((C57501) create(flowCollector, continuation)).invokeSuspend(Unit.INSTANCE);
        }

        /* JADX WARN: Type inference incomplete: some casts might be missing */
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Object invokeSuspend(Object obj) {
            C5751xdf1aa1b6 c5751xdf1aa1b6;
            ...
            if (i == 0) {
                ...
                C5751xdf1aa1b6 c5751xdf1aa1b62 = new C5751xdf1aa1b6(this.$transform, flowCollector);
                try {
                    this.L$0 = c5751xdf1aa1b62;
                    this.label = 1;
                    if (flow.collect(c5751xdf1aa1b62, this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } catch (AbortFlowException e) {
                    e = e;
                    c5751xdf1aa1b6 = c5751xdf1aa1b62;
                    FlowExceptions_commonKt.checkOwnership(e, c5751xdf1aa1b6);
                }
            } else {
                if (i != 1) {
                    throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
                }
                c5751xdf1aa1b6 = (C5751xdf1aa1b6) this.L$0;
                try {
                    ResultKt.throwOnFailure(obj);
    ...
    public static final <T, R> Flow<R> transformWhile(Flow<? extends T> flow, Function3<? super FlowCollector<? super R>, ? super T, ? super Continuation<? super Boolean>, ? extends Object> function3) {
        return FlowKt.flow(new C57501(flow, function3, null));
    }
    ...
    */
    public static final <T> java.lang.Object collectWhile(kotlinx.coroutines.flow.Flow<? extends T> r4, kotlin.jvm.functions.Function2<? super T, ? super kotlin.coroutines.Continuation<? super java.lang.Boolean>, ? extends java.lang.Object> r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
        /*
            boolean r0 = r6 instanceof kotlinx.coroutines.flow.FlowKt__LimitKt.C57461
            if (r0 == 0) goto L14
            r0 = r6
            kotlinx.coroutines.flow.FlowKt__LimitKt$collectWhile$1 r0 = (kotlinx.coroutines.flow.FlowKt__LimitKt.C57461) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
