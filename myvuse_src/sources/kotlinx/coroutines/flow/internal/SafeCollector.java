...
public final class SafeCollector<T> extends ContinuationImpl implements FlowCollector<T>, CoroutineStackFrame {
    ...
    public Object invokeSuspend(Object result) {
        Throwable thM7236exceptionOrNullimpl = Result.m7236exceptionOrNullimpl(result);
        if (thM7236exceptionOrNullimpl != null) {
            this.lastEmissionContext = new DownstreamExceptionContext(thM7236exceptionOrNullimpl, getContext());
        }
        Continuation<? super Unit> continuation = this.completion;
