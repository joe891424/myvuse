...
public abstract class ChannelFlow<T> implements FusibleFlow<T> {
    ...
    */
    ...
    @DebugMetadata(m5607c = "kotlinx.coroutines.flow.internal.ChannelFlow$collect$2", m5608f = "ChannelFlow.kt", m5609i = {}, m5610l = {123}, m5611m = "invokeSuspend", m5612n = {}, m5613s = {})
    static final class C58162 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C58162(FlowCollector<? super T> flowCollector, ChannelFlow<T> channelFlow, Continuation<? super C58162> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C58162 c58162 = new C58162(this.$collector, this.this$0, continuation);
            c58162.L$0 = obj;
            return c58162;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C58162) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    static /* synthetic */ <T> Object collect$suspendImpl(ChannelFlow<T> channelFlow, FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C58162(flowCollector, channelFlow, null), continuation);
