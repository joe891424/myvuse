...
final class CallbackFlowBuilder<T> extends ChannelFlowBuilder<T> {
    ...
    @DebugMetadata(m5607c = "kotlinx.coroutines.flow.CallbackFlowBuilder", m5608f = "Builders.kt", m5609i = {0}, m5610l = {334}, m5611m = "collectTo", m5612n = {"scope"}, m5613s = {"L$0"})
    static final class C57071 extends ContinuationImpl {
        Object L$0;
        int label;
        ...
        C57071(CallbackFlowBuilder<T> callbackFlowBuilder, Continuation<? super C57071> continuation) {
            super(continuation);
    ...
    */
    protected java.lang.Object collectTo(kotlinx.coroutines.channels.ProducerScope<? super T> r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
        /*
            r4 = this;
            boolean r0 = r6 instanceof kotlinx.coroutines.flow.CallbackFlowBuilder.C57071
            if (r0 == 0) goto L14
            r0 = r6
            kotlinx.coroutines.flow.CallbackFlowBuilder$collectTo$1 r0 = (kotlinx.coroutines.flow.CallbackFlowBuilder.C57071) r0
            int r1 = r0.label
