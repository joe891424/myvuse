...
final /* synthetic */ class FlowKt__CollectionKt {
    ...
    @DebugMetadata(m5607c = "kotlinx.coroutines.flow.FlowKt__CollectionKt", m5608f = "Collection.kt", m5609i = {0}, m5610l = {26}, m5611m = "toCollection", m5612n = {FirebaseAnalytics.Param.DESTINATION}, m5613s = {"L$0"})
    static final class C57231<T, C extends Collection<? super T>> extends ContinuationImpl {
        Object L$0;
        int label;
        /* synthetic */ Object result;

        C57231(Continuation<? super C57231> continuation) {
            super(continuation);
        }
    ...
    */
    public static final <T, C extends java.util.Collection<? super T>> java.lang.Object toCollection(kotlinx.coroutines.flow.Flow<? extends T> r4, final C r5, kotlin.coroutines.Continuation<? super C> r6) {
        /*
            boolean r0 = r6 instanceof kotlinx.coroutines.flow.FlowKt__CollectionKt.C57231
            if (r0 == 0) goto L14
            r0 = r6
            kotlinx.coroutines.flow.FlowKt__CollectionKt$toCollection$1 r0 = (kotlinx.coroutines.flow.FlowKt__CollectionKt.C57231) r0
            int r1 = r0.label
