...
final class SubscribedSharedFlow<T> implements SharedFlow<T> {
    ...
    @DebugMetadata(m5607c = "kotlinx.coroutines.flow.SubscribedSharedFlow", m5608f = "Share.kt", m5609i = {}, m5610l = {409}, m5611m = "collect", m5612n = {}, m5613s = {})
    static final class C58151 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;
        final /* synthetic */ SubscribedSharedFlow<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C58151(SubscribedSharedFlow<T> subscribedSharedFlow, Continuation<? super C58151> continuation) {
            super(continuation);
    ...
    */
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r6, kotlin.coroutines.Continuation<?> r7) {
        /*
            r5 = this;
            boolean r0 = r7 instanceof kotlinx.coroutines.flow.SubscribedSharedFlow.C58151
            if (r0 == 0) goto L14
            r0 = r7
            kotlinx.coroutines.flow.SubscribedSharedFlow$collect$1 r0 = (kotlinx.coroutines.flow.SubscribedSharedFlow.C58151) r0
            int r1 = r0.label
