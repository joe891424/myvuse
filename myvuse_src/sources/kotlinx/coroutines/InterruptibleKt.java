...
public final class InterruptibleKt {
    ...
    @DebugMetadata(m5607c = "kotlinx.coroutines.InterruptibleKt$runInterruptible$2", m5608f = "Interruptible.kt", m5609i = {}, m5610l = {}, m5611m = "invokeSuspend", m5612n = {}, m5613s = {})
    static final class C56352<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
        ...
        C56352(Function0<? extends T> function0, Continuation<? super C56352> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C56352 c56352 = new C56352(this.$block, continuation);
            c56352.L$0 = obj;
            return c56352;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super T> continuation) {
            return ((C56352) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Object runInterruptible(CoroutineContext coroutineContext, Function0<? extends T> function0, Continuation<? super T> continuation) {
        return BuildersKt.withContext(coroutineContext, new C56352(function0, null), continuation);
    }
