...
public class SelectImplementation<R> extends CancelHandler implements SelectBuilder<R>, SelectInstanceInternal<R> {
    ...
    @DebugMetadata(m5607c = "kotlinx.coroutines.selects.SelectImplementation", m5608f = "Select.kt", m5609i = {0}, m5610l = {431, 434}, m5611m = "doSelectSuspend", m5612n = {"this"}, m5613s = {"L$0"})
    static final class C58331 extends ContinuationImpl {
        Object L$0;
        int label;
        ...
        C58331(SelectImplementation<R> selectImplementation, Continuation<? super C58331> continuation) {
            super(continuation);
    ...
    /* JADX INFO: compiled from: Select.kt */
    @Metadata(m5599k = 3, m5600mv = {1, 8, 0}, m5602xi = 48)
    @DebugMetadata(m5607c = "kotlinx.coroutines.selects.SelectImplementation", m5608f = "Select.kt", m5609i = {}, m5610l = {TypedValues.TransitionType.TYPE_STAGGERED}, m5611m = "processResultAndInvokeBlockRecoveringException", m5612n = {}, m5613s = {})
    static final class C58341 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;
        final /* synthetic */ SelectImplementation<R> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C58341(SelectImplementation<R> selectImplementation, Continuation<? super C58341> continuation) {
            super(continuation);
            this.this$0 = selectImplementation;
        }
    ...
    */
    public final java.lang.Object doSelectSuspend(kotlin.coroutines.Continuation<? super R> r6) {
        /*
            r5 = this;
            boolean r0 = r6 instanceof kotlinx.coroutines.selects.SelectImplementation.C58331
            if (r0 == 0) goto L14
            r0 = r6
            kotlinx.coroutines.selects.SelectImplementation$doSelectSuspend$1 r0 = (kotlinx.coroutines.selects.SelectImplementation.C58331) r0
            int r1 = r0.label
        ...
        while (true) {
            ...
            if (!(obj instanceof CancellableContinuation)) {
                ...
                if (Intrinsics.areEqual(obj, SelectKt.STATE_REG)) {
                    if (C0526xc40028dd.m1169m(atomicReferenceFieldUpdater, this, obj, CollectionsKt.listOf(clauseObject))) {
                        return 1;
                    }
                } else {
                    ...
                    if (C0526xc40028dd.m1169m(atomicReferenceFieldUpdater, this, obj, CollectionsKt.plus((Collection<? extends Object>) obj, clauseObject))) {
                        return 1;
                    }
                }
            } else {
                ...
                if (clauseDataFindClause == null) {
                    ...
                    if (C0526xc40028dd.m1169m(atomicReferenceFieldUpdater, this, obj, clauseDataFindClause)) {
                        this.internalResult = internalResult;
    ...
    */
    public final java.lang.Object processResultAndInvokeBlockRecoveringException(kotlinx.coroutines.selects.SelectImplementation<R>.ClauseData r5, java.lang.Object r6, kotlin.coroutines.Continuation<? super R> r7) throws java.lang.Throwable {
        /*
            r4 = this;
            boolean r0 = r7 instanceof kotlinx.coroutines.selects.SelectImplementation.C58341
            if (r0 == 0) goto L14
            r0 = r7
            kotlinx.coroutines.selects.SelectImplementation$processResultAndInvokeBlockRecoveringException$1 r0 = (kotlinx.coroutines.selects.SelectImplementation.C58341) r0
            int r1 = r0.label
            r2 = -2147483648(0xffffffff80000000, float:-0.0)
            r1 = r1 & r2
            if (r1 == 0) goto L14
    ...
    public void invoke2(Throwable cause) {
        ...
        } while (!C0526xc40028dd.m1169m(atomicReferenceFieldUpdater, this, obj, SelectKt.STATE_CANCELLED));
        List<SelectImplementation<R>.ClauseData> list = this.clauses;
        if (list == null) {
            return;
        }
    ...
    */
    public final java.lang.Object waitUntilSelected(kotlin.coroutines.Continuation<? super kotlin.Unit> r7) {
        ...
        L14:
            ...
            boolean r3 = androidx.concurrent.futures.C0526xc40028dd.m1169m(r4, r6, r3, r1)
            if (r3 == 0) goto L14
            r2 = r6
        ...
        L31:
            ...
            boolean r4 = androidx.concurrent.futures.C0526xc40028dd.m1169m(r4, r6, r3, r5)
            if (r4 == 0) goto L14
            r4 = r3
