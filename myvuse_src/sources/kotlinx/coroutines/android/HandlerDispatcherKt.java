...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM7233constructorimpl = Result.m7233constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM7233constructorimpl = Result.m7233constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m7239isFailureimpl(objM7233constructorimpl) ? null : objM7233constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo8793dispatch(cancellableContinuationImpl2.get$context(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
