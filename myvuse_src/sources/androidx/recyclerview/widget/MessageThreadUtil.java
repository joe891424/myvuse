...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    class C10551 implements ThreadUtil.MainThreadCallback<T> {
        ...
        private Runnable mMainThreadRunnable = new Runnable() { // from class: androidx.recyclerview.widget.MessageThreadUtil.1.1
            ...
            public void run() {
                SyncQueueItem next = C10551.this.mQueue.next();
                while (next != null) {
                    int i = next.what;
                    if (i == 1) {
                        C10551.this.val$callback.updateItemCount(next.arg1, next.arg2);
                    } else if (i == 2) {
                        C10551.this.val$callback.addTile(next.arg1, (TileList.Tile) next.data);
                    } else if (i == 3) {
                        C10551.this.val$callback.removeTile(next.arg1, next.arg2);
                    } else {
                        Log.e("ThreadUtil", "Unsupported message, what=" + next.what);
                    }
                    next = C10551.this.mQueue.next();
                }
            }
        };

        C10551(ThreadUtil.MainThreadCallback mainThreadCallback) {
    ...
    public ThreadUtil.MainThreadCallback<T> getMainThreadProxy(ThreadUtil.MainThreadCallback<T> mainThreadCallback) {
        return new C10551(mainThreadCallback);
    }

    /* JADX INFO: renamed from: androidx.recyclerview.widget.MessageThreadUtil$2 */
    class C10562 implements ThreadUtil.BackgroundCallback<T> {
        ...
        private Runnable mBackgroundRunnable = new Runnable() { // from class: androidx.recyclerview.widget.MessageThreadUtil.2.1
            ...
            public void run() {
                while (true) {
                    SyncQueueItem next = C10562.this.mQueue.next();
                    if (next != null) {
                        int i = next.what;
                        if (i == 1) {
                            C10562.this.mQueue.removeMessages(1);
                            C10562.this.val$callback.refresh(next.arg1);
                        } else if (i == 2) {
                            C10562.this.mQueue.removeMessages(2);
                            C10562.this.mQueue.removeMessages(3);
                            C10562.this.val$callback.updateRange(next.arg1, next.arg2, next.arg3, next.arg4, next.arg5);
                        } else if (i == 3) {
                            C10562.this.val$callback.loadTile(next.arg1, next.arg2);
                        } else if (i == 4) {
                            C10562.this.val$callback.recycleTile((TileList.Tile) next.data);
                        } else {
                            Log.e("ThreadUtil", "Unsupported message, what=" + next.what);
                        }
                    } else {
                        C10562.this.mBackgroundRunning.set(false);
                        return;
                    }
                }
            }
        ...
        C10562(ThreadUtil.BackgroundCallback backgroundCallback) {
    ...
    public ThreadUtil.BackgroundCallback<T> getBackgroundProxy(ThreadUtil.BackgroundCallback<T> backgroundCallback) {
        return new C10562(backgroundCallback);
    }
