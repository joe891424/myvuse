...
public final class SharedPreferencesMigrationKt {
    ...
    /* JADX INFO: compiled from: SharedPreferencesMigration.kt */
    @Metadata(m5597d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0001H\u008a@"}, m5598d2 = {"<anonymous>", "Landroidx/datastore/preferences/core/Preferences;", "sharedPrefs", "Landroidx/datastore/migrations/SharedPreferencesView;", "currentData"}, m5599k = 3, m5600mv = {1, 5, 1}, m5602xi = 48)
    @DebugMetadata(m5607c = "androidx.datastore.preferences.SharedPreferencesMigrationKt$getMigrationFunction$1", m5608f = "SharedPreferencesMigration.kt", m5609i = {}, m5610l = {}, m5611m = "invokeSuspend", m5612n = {}, m5613s = {})
    static final class C07011 extends SuspendLambda implements Function3<SharedPreferencesView, Preferences, Continuation<? super Preferences>, Object> {
        ...
        public final Object invoke(SharedPreferencesView sharedPreferencesView, Preferences preferences, Continuation<? super Preferences> continuation) {
            ...
            c07011.L$0 = sharedPreferencesView;
            c07011.L$1 = preferences;
            return c07011.invokeSuspend(Unit.INSTANCE);
        }
    ...
    private static final Function3<SharedPreferencesView, Preferences, Continuation<? super Preferences>, Object> getMigrationFunction() {
        return new C07011(null);
    }

    /* JADX INFO: renamed from: androidx.datastore.preferences.SharedPreferencesMigrationKt$getShouldRunMigration$1 */
    /* JADX INFO: compiled from: SharedPreferencesMigration.kt */
    @Metadata(m5597d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\u008a@"}, m5598d2 = {"<anonymous>", "", "prefs", "Landroidx/datastore/preferences/core/Preferences;"}, m5599k = 3, m5600mv = {1, 5, 1}, m5602xi = 48)
    @DebugMetadata(m5607c = "androidx.datastore.preferences.SharedPreferencesMigrationKt$getShouldRunMigration$1", m5608f = "SharedPreferencesMigration.kt", m5609i = {}, m5610l = {}, m5611m = "invokeSuspend", m5612n = {}, m5613s = {})
    static final class C07021 extends SuspendLambda implements Function2<Preferences, Continuation<? super Boolean>, Object> {
        final /* synthetic */ Set<String> $keysToMigrate;
        /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C07021(Set<String> set, Continuation<? super C07021> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C07021 c07021 = new C07021(this.$keysToMigrate, continuation);
            c07021.L$0 = obj;
            return c07021;
        }
        ...
        public final Object invoke(Preferences preferences, Continuation<? super Boolean> continuation) {
            return ((C07021) create(preferences, continuation)).invokeSuspend(Unit.INSTANCE);
        }
            ...
            if (this.label == 0) {
                ...
                if (this.$keysToMigrate != SharedPreferencesMigrationKt.getMIGRATE_ALL_KEYS()) {
                    ...
                    if ((set instanceof Collection) && set.isEmpty()) {
                        ...
                        while (it3.hasNext()) {
                            if (Boxing.boxBoolean(!arrayList2.contains((String) it3.next())).booleanValue()) {
                                break;
                            }
                        }
                        z = false;
