...
public final class WireFormat {
    ...
    public static class FieldType {
        ...
        /* synthetic */ FieldType(String str, int i, JavaType javaType, int i2, C07701 c07701) {
    ...
    enum Utf8Validation {
        ...
        /* synthetic */ Utf8Validation(C07701 c07701) {
            this();
        }
    }
    ...
    static Object readPrimitiveField(CodedInputStream codedInputStream, FieldType fieldType, Utf8Validation utf8Validation) throws IOException {
        switch (C07701.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            case 1:
