...
public final class SharedPreferencesMigration<T> implements DataMigration<T> {
    ...
    @DebugMetadata(m5607c = "androidx.datastore.migrations.SharedPreferencesMigration", m5608f = "SharedPreferencesMigration.kt", m5609i = {0}, m5610l = {147}, m5611m = "shouldMigrate", m5612n = {"this"}, m5613s = {"L$0"})
    static final class C06971 extends ContinuationImpl {
        Object L$0;
        int label;
        ...
        C06971(SharedPreferencesMigration<T> sharedPreferencesMigration, Continuation<? super C06971> continuation) {
            super(continuation);
    ...
    /* JADX INFO: compiled from: SharedPreferencesMigration.kt */
    @Metadata(m5597d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@"}, m5598d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "it"}, m5599k = 3, m5600mv = {1, 5, 1}, m5602xi = 48)
    @DebugMetadata(m5607c = "androidx.datastore.migrations.SharedPreferencesMigration$1", m5608f = "SharedPreferencesMigration.kt", m5609i = {}, m5610l = {}, m5611m = "invokeSuspend", m5612n = {}, m5613s = {})
    static final class C06931 extends SuspendLambda implements Function2<T, Continuation<? super Boolean>, Object> {
        int label;
        ...
        public final Object invoke(T t, Continuation<? super Boolean> continuation) {
            return ((C06931) create(t, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    /* synthetic */ SharedPreferencesMigration(Function0 function0, Set set, C06931 c06931, Function3 function3, Context context, String str, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((Function0<? extends SharedPreferences>) function0, (Set<String>) set, (i & 4) != 0 ? new C06931(null) : c06931, function3, context, str);
    }
    ...
    /* JADX INFO: compiled from: SharedPreferencesMigration.kt */
    @Metadata(m5597d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@"}, m5598d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "it"}, m5599k = 3, m5600mv = {1, 5, 1}, m5602xi = 48)
    @DebugMetadata(m5607c = "androidx.datastore.migrations.SharedPreferencesMigration$2", m5608f = "SharedPreferencesMigration.kt", m5609i = {}, m5610l = {}, m5611m = "invokeSuspend", m5612n = {}, m5613s = {})
    public static final class C06942 extends SuspendLambda implements Function2<T, Continuation<? super Boolean>, Object> {
        int label;

        C06942(Continuation<? super C06942> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C06942(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(T t, Continuation<? super Boolean> continuation) {
            return ((C06942) create(t, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public /* synthetic */ SharedPreferencesMigration(Function0 function0, Set set, C06942 c06942, Function3 function3, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((Function0<? extends SharedPreferences>) function0, (Set<String>) ((i & 2) != 0 ? SharedPreferencesMigrationKt.getMIGRATE_ALL_KEYS() : set), (i & 4) != 0 ? new C06942(null) : c06942, function3);
    }
    ...
    /* JADX INFO: compiled from: SharedPreferencesMigration.kt */
    @Metadata(m5597d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u00022\u0006\u0010\u0003\u001a\u0002H\u0002H\u008a@"}, m5598d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "it"}, m5599k = 3, m5600mv = {1, 5, 1}, m5602xi = 48)
    @DebugMetadata(m5607c = "androidx.datastore.migrations.SharedPreferencesMigration$3", m5608f = "SharedPreferencesMigration.kt", m5609i = {}, m5610l = {}, m5611m = "invokeSuspend", m5612n = {}, m5613s = {})
    public static final class C06953 extends SuspendLambda implements Function2<T, Continuation<? super Boolean>, Object> {
        int label;

        C06953(Continuation<? super C06953> continuation) {
            super(2, continuation);
        }

        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C06953(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(T t, Continuation<? super Boolean> continuation) {
            return ((C06953) create(t, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public /* synthetic */ SharedPreferencesMigration(Context context, String str, Set set, C06953 c06953, Function3 function3, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, str, (i & 4) != 0 ? SharedPreferencesMigrationKt.getMIGRATE_ALL_KEYS() : set, (i & 8) != 0 ? new C06953(null) : c06953, function3);
    }
    ...
    */
    public java.lang.Object shouldMigrate(T r5, kotlin.coroutines.Continuation<? super java.lang.Boolean> r6) {
        /*
            r4 = this;
            boolean r0 = r6 instanceof androidx.datastore.migrations.SharedPreferencesMigration.C06971
            if (r0 == 0) goto L14
            r0 = r6
            androidx.datastore.migrations.SharedPreferencesMigration$shouldMigrate$1 r0 = (androidx.datastore.migrations.SharedPreferencesMigration.C06971) r0
            int r1 = r0.label
    ...
    /* JADX INFO: compiled from: SharedPreferencesMigration.kt */
    @Metadata(m5597d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\bÃ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0018\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0007¨\u0006\t"}, m5598d2 = {"Landroidx/datastore/migrations/SharedPreferencesMigration$Api24Impl;", "", "()V", "deleteSharedPreferences", "", "context", "Landroid/content/Context;", "name", "", "datastore_release"}, m5599k = 1, m5600mv = {1, 5, 1}, m5602xi = 48)
