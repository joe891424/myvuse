...
public final class BlockRunner<T> {
    ...
    public final void maybeRun() {
        ...
        this.runningJob = BuildersKt__Builders_commonKt.launch$default(this.scope, null, null, new C08881(this, null), 3, null);
    }
    ...
    @DebugMetadata(m5607c = "androidx.lifecycle.BlockRunner$maybeRun$1", m5608f = "CoroutineLiveData.kt", m5609i = {}, m5610l = {177}, m5611m = "invokeSuspend", m5612n = {}, m5613s = {})
    static final class C08881 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        C08881(BlockRunner<T> blockRunner, Continuation<? super C08881> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C08881 c08881 = new C08881(this.this$0, continuation);
            c08881.L$0 = obj;
            return c08881;
        }
    ...
    public final void cancel() {
        if (this.cancellationJob == null) {
            this.cancellationJob = BuildersKt__Builders_commonKt.launch$default(this.scope, Dispatchers.getMain().getImmediate(), null, new C08871(this, null), 2, null);
            return;
        }
    ...
    /* JADX INFO: compiled from: CoroutineLiveData.kt */
    @Metadata(m5597d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u0003H\u008a@"}, m5598d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "Lkotlinx/coroutines/CoroutineScope;"}, m5599k = 3, m5600mv = {1, 8, 0}, m5602xi = 48)
    @DebugMetadata(m5607c = "androidx.lifecycle.BlockRunner$cancel$1", m5608f = "CoroutineLiveData.kt", m5609i = {}, m5610l = {188}, m5611m = "invokeSuspend", m5612n = {}, m5613s = {})
    static final class C08871 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        int label;
        final /* synthetic */ BlockRunner<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C08871(BlockRunner<T> blockRunner, Continuation<? super C08871> continuation) {
            super(2, continuation);
            this.this$0 = blockRunner;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C08871(this.this$0, continuation);
        }
