...
public final class PausingDispatcherKt {
    ...
    /* JADX INFO: compiled from: PausingDispatcher.jvm.kt */
    @Metadata(m5597d1 = {"\u0000\b\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u0002H\u0001\"\u0004\b\u0000\u0010\u0001*\u00020\u0002H\u008a@"}, m5598d2 = {"<anonymous>", ExifInterface.GPS_DIRECTION_TRUE, "Lkotlinx/coroutines/CoroutineScope;"}, m5599k = 3, m5600mv = {1, 8, 0}, m5602xi = 48)
    @DebugMetadata(m5607c = "androidx.lifecycle.PausingDispatcherKt$whenStateAtLeast$2", m5608f = "PausingDispatcher.jvm.kt", m5609i = {0}, m5610l = {OTUIDisplayReasonCode.UIShownCode.PC_SHOWN_CONSENT_EXPIRED}, m5611m = "invokeSuspend", m5612n = {"controller"}, m5613s = {"L$0"})
    static final class C09052<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
        ...
        C09052(Lifecycle lifecycle, Lifecycle.State state, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super C09052> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C09052 c09052 = new C09052(this.$this_whenStateAtLeast, this.$minState, this.$block, continuation);
            c09052.L$0 = obj;
            return c09052;
        }
    ...
    public static final <T> Object whenStateAtLeast(Lifecycle lifecycle, Lifecycle.State state, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return BuildersKt.withContext(Dispatchers.getMain().getImmediate(), new C09052(lifecycle, state, function2, null), continuation);
    }
}
