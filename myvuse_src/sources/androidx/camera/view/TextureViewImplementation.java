...
final class TextureViewImplementation extends PreviewViewImplementation {
    ...
    void onSurfaceRequested(final SurfaceRequest surfaceRequest, PreviewViewImplementation.OnSurfaceNotInUseListener onSurfaceNotInUseListener) {
        ...
        surfaceRequest.addRequestCancellationListener(ContextCompat.getMainExecutor(this.mTextureView.getContext()), new Runnable() { // from class: androidx.camera.view.TextureViewImplementation$$ExternalSyntheticLambda1
            ...
            public final void run() {
                this.f$0.m1164xce057d29(surfaceRequest);
            }
        });
        tryToProvidePreviewSurface();
    }

    /* JADX INFO: renamed from: lambda$onSurfaceRequested$0$androidx-camera-view-TextureViewImplementation */
    /* synthetic */ void m1164xce057d29(SurfaceRequest surfaceRequest) {
        SurfaceRequest surfaceRequest2 = this.mSurfaceRequest;
    ...
    public void initializePreview() {
        ...
        this.mTextureView.setSurfaceTextureListener(new TextureView.SurfaceTextureListener() { // from class: androidx.camera.view.TextureViewImplementation.1
            ...
            public void onSurfaceTextureAvailable(final SurfaceTexture surfaceTexture, final int width, final int height) {
                Logger.m1137d(TextureViewImplementation.TAG, "SurfaceTexture available. Size: " + width + EllipticCurveJsonWebKey.X_MEMBER_NAME + height);
                ...
                if (TextureViewImplementation.this.mSurfaceReleaseFuture != null) {
                    ...
                    Logger.m1137d(TextureViewImplementation.TAG, "Surface invalidated " + TextureViewImplementation.this.mSurfaceRequest);
            ...
            public void onSurfaceTextureSizeChanged(final SurfaceTexture surfaceTexture, final int width, final int height) {
                Logger.m1137d(TextureViewImplementation.TAG, "SurfaceTexture size changed: " + width + EllipticCurveJsonWebKey.X_MEMBER_NAME + height);
            }
            ...
            public boolean onSurfaceTextureDestroyed(final SurfaceTexture surfaceTexture) {
                ...
                if (TextureViewImplementation.this.mSurfaceReleaseFuture != null) {
                    Futures.addCallback(TextureViewImplementation.this.mSurfaceReleaseFuture, new FutureCallback<SurfaceRequest.Result>() { // from class: androidx.camera.view.TextureViewImplementation.1.1
                        ...
                        public void onSuccess(SurfaceRequest.Result result) {
                            ...
                            Logger.m1137d(TextureViewImplementation.TAG, "SurfaceTexture about to manually be destroyed");
                ...
                Logger.m1137d(TextureViewImplementation.TAG, "SurfaceTexture about to be destroyed");
                return true;
            }
    ...
    void tryToProvidePreviewSurface() {
        ...
        final ListenableFuture<SurfaceRequest.Result> future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.view.TextureViewImplementation$$ExternalSyntheticLambda3
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m1165xdd0bd278(surface, completer);
            }
        });
        ...
        future.addListener(new Runnable() { // from class: androidx.camera.view.TextureViewImplementation$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m1166x16d67457(surface, future, surfaceRequest);
            }
        }, ContextCompat.getMainExecutor(this.mTextureView.getContext()));
        onSurfaceProvided();
    }

    /* JADX INFO: renamed from: lambda$tryToProvidePreviewSurface$1$androidx-camera-view-TextureViewImplementation */
    /* synthetic */ Object m1165xdd0bd278(Surface surface, final CallbackToFutureAdapter.Completer completer) throws Exception {
        Logger.m1137d(TAG, "Surface set on Preview.");
    ...
    /* JADX INFO: renamed from: lambda$tryToProvidePreviewSurface$2$androidx-camera-view-TextureViewImplementation */
    /* synthetic */ void m1166x16d67457(Surface surface, ListenableFuture listenableFuture, SurfaceRequest surfaceRequest) {
        Logger.m1137d(TAG, "Safe to release surface.");
        notifySurfaceNotInUse();
        surface.release();
    ...
    ListenableFuture<Void> waitForNextFrame() {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.view.TextureViewImplementation$$ExternalSyntheticLambda0
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m1167x86b0fc00(completer);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$waitForNextFrame$3$androidx-camera-view-TextureViewImplementation */
    /* synthetic */ Object m1167x86b0fc00(CallbackToFutureAdapter.Completer completer) throws Exception {
