...
public class ExifData {
        ...
        if (exifAttribute != null) {
            ...
            if (tag.equals(ExifInterface.TAG_GPS_TIMESTAMP)) {
                if (exifAttribute.format != 5 && exifAttribute.format != 10) {
                    Logger.m1143w(TAG, "GPS Timestamp format is not rational. format=" + exifAttribute.format);
                    return null;
                }
                ...
                if (longRationalArr == null || longRationalArr.length != 3) {
                    Logger.m1143w(TAG, "Invalid GPS Timestamp array. array=" + Arrays.toString(longRationalArr));
                    return null;
                }
    ...
    public static final class Builder {
        ...
        public Builder setOrientationDegrees(int orientationDegrees) {
            ...
            if (orientationDegrees == 0) {
                ...
                Logger.m1143w(ExifData.TAG, "Unexpected orientation value: " + orientationDegrees + ". Must be one of 0, 90, 180, 270.");
                i = 0;
            } else {
                i = 8;
            }
        ...
        public Builder setFlashState(CameraCaptureMetaData.FlashState flashState) {
            ...
            int i2 = C04711.f1711x649fcb98[flashState.ordinal()];
            if (i2 == 1) {
                i = 0;
            } else if (i2 == 2) {
                i = 32;
                ...
                if (i2 != 3) {
                    Logger.m1143w(ExifData.TAG, "Unknown flash state: " + flashState);
                    return this;
                }
                i = 1;
            }
        ...
        public Builder setWhiteBalanceMode(WhiteBalanceMode whiteBalanceMode) {
            String strValueOf;
            int i = C04711.f1712x2b240c2a[whiteBalanceMode.ordinal()];
            if (i == 1) {
        ...
        private void setAttributeIfMissing(String tag, String value, List<Map<String, ExifAttribute>> attributes) {
            Iterator<Map<String, ExifAttribute>> it2 = attributes.iterator();
            while (it2.hasNext()) {
                if (it2.next().containsKey(tag)) {
                    return;
                }
            }
        ...
        private void setAttributeInternal(String tag, String value, List<Map<String, ExifAttribute>> attributes) {
            ...
            String str = tag;
            String strReplaceAll = value;
            if ((ExifInterface.TAG_DATETIME.equals(str) || ExifInterface.TAG_DATETIME_ORIGINAL.equals(str) || ExifInterface.TAG_DATETIME_DIGITIZED.equals(str)) && strReplaceAll != null) {
                ...
                if (value.length() != 19 || (!zFind && !zFind2)) {
                    Logger.m1143w(ExifData.TAG, "Invalid value for " + str + " : " + strReplaceAll);
                    return;
                } else if (zFind2) {
            ...
            int i4 = 2;
            int i5 = 1;
            if (strReplaceAll != null && ExifData.sTagSetForCompatibility.contains(str2)) {
                if (str2.equals(ExifInterface.TAG_GPS_TIMESTAMP)) {
                    Matcher matcher = GPS_TIMESTAMP_PATTERN.matcher(strReplaceAll);
                    if (!matcher.find()) {
                        Logger.m1143w(ExifData.TAG, "Invalid value for " + str2 + " : " + strReplaceAll);
                        return;
                    }
                    ...
                    try {
                        ...
                        Logger.m1144w(ExifData.TAG, "Invalid value for " + str2 + " : " + strReplaceAll, e);
                        return;
                    }
                }
            }
            ...
            while (i7 < ExifData.EXIF_TAGS.length) {
                ExifTag exifTag = sExifTagMapsForWriting.get(i7).get(str2);
                if (exifTag == null) {
                    i = i7;
                    i2 = i5;
                } else {
                    if (strReplaceAll == null) {
                        attributes.get(i7).remove(str2);
                    } else {
                        ...
                        switch (i3) {
                            case 1:
                                i = i7;
                                i2 = i5;
                                attributes.get(i).put(str2, ExifAttribute.createByte(strReplaceAll));
                                break;
                            case 2:
                            case 7:
                                i = i7;
                                i2 = i5;
                                attributes.get(i).put(str2, ExifAttribute.createString(strReplaceAll));
                                break;
                            case 3:
                                i = i7;
                                i2 = i5;
                                ...
                                attributes.get(i).put(str2, ExifAttribute.createUShort(iArr, builder.mByteOrder));
                                break;
                            case 4:
                                i = i7;
                                i2 = i5;
                                ...
                                attributes.get(i).put(str2, ExifAttribute.createULong(jArr, builder.mByteOrder));
                                break;
                            case 5:
                                String str4 = "/";
                                ...
                                while (i10 < strArrSplit3.length) {
                                    String str5 = str4;
                                    String[] strArrSplit4 = strArrSplit3[i10].split(str5, -1);
                                ...
                                i = i7;
                                i2 = 1;
                                attributes.get(i).put(str2, ExifAttribute.createURational(longRationalArr, builder.mByteOrder));
                                break;
                            case 9:
                                ...
                                attributes.get(i7).put(str2, ExifAttribute.createSLong(iArr2, builder.mByteOrder));
                                i = i7;
                                i2 = 1;
                                break;
                            case 10:
                                ...
                                while (i12 < strArrSplit6.length) {
                                    String[] strArrSplit7 = strArrSplit6[i12].split(str3, -1);
                                ...
                                builder = this;
                                attributes.get(i7).put(str2, ExifAttribute.createSRational(longRationalArr2, builder.mByteOrder));
                                i = i7;
                                i2 = 1;
                                break;
                            case 12:
                                ...
                                attributes.get(i7).put(str2, ExifAttribute.createDouble(dArr, builder.mByteOrder));
                                break;
                        }
                    }
                    i = i7;
    ...
    static /* synthetic */ class C04711 {
        ...
        static final /* synthetic */ int[] f1711x649fcb98;

        /* JADX INFO: renamed from: $SwitchMap$androidx$camera$core$impl$utils$ExifData$WhiteBalanceMode */
        static final /* synthetic */ int[] f1712x2b240c2a;
        ...
        static {
            ...
            try {
                f1712x2b240c2a[WhiteBalanceMode.MANUAL.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            int[] iArr2 = new int[CameraCaptureMetaData.FlashState.values().length];
            f1711x649fcb98 = iArr2;
            try {
                iArr2[CameraCaptureMetaData.FlashState.READY.ordinal()] = 1;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f1711x649fcb98[CameraCaptureMetaData.FlashState.NONE.ordinal()] = 2;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f1711x649fcb98[CameraCaptureMetaData.FlashState.FIRED.ordinal()] = 3;
