...
final class SequentialExecutor implements Executor {
        ...
        synchronized (this.mQueue) {
            if (this.mWorkerRunningState != WorkerRunningState.RUNNING && this.mWorkerRunningState != WorkerRunningState.QUEUED) {
                ...
                try {
                    ...
                    synchronized (this.mQueue) {
                        boolean z = (this.mWorkerRunningState == WorkerRunningState.IDLE || this.mWorkerRunningState == WorkerRunningState.QUEUING) && this.mQueue.removeLastOccurrence(runnable);
    ...
    final class QueueWorker implements Runnable {
        ...
        /* JADX WARN: Code restructure failed: missing block: B:26:0x0054, code lost:
            ...
            androidx.camera.core.Logger.m1140e(androidx.camera.core.impl.utils.executor.SequentialExecutor.TAG, "Exception while executing runnable " + r3, r2);
         */
        ...
        */
        private void workOnQueue() {
            ...
            L53:
                ...
                androidx.camera.core.Logger.m1140e(r4, r3, r2)     // Catch: java.lang.Throwable -> L70
                goto L2
            L6d:
                r0 = move-exception
                monitor-exit(r2)     // Catch: java.lang.Throwable -> L6d
