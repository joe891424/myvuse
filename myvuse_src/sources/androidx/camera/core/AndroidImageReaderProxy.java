    ...
    public synchronized void setOnImageAvailableListener(final ImageReaderProxy.OnImageAvailableListener listener, final Executor executor) {
        this.mImageReader.setOnImageAvailableListener(new ImageReader.OnImageAvailableListener() { // from class: androidx.camera.core.AndroidImageReaderProxy$$ExternalSyntheticLambda1
            ...
            public final void onImageAvailable(ImageReader imageReader) {
                this.f$0.m1129x2fd48a6(executor, listener, imageReader);
            }
        }, MainThreadAsyncHandler.getInstance());
    }

    /* JADX INFO: renamed from: lambda$setOnImageAvailableListener$0$androidx-camera-core-AndroidImageReaderProxy */
    /* synthetic */ void m1128x4985bb07(ImageReaderProxy.OnImageAvailableListener onImageAvailableListener) {
        onImageAvailableListener.onImageAvailable(this);
    }

    /* JADX INFO: renamed from: lambda$setOnImageAvailableListener$1$androidx-camera-core-AndroidImageReaderProxy */
    /* synthetic */ void m1129x2fd48a6(Executor executor, final ImageReaderProxy.OnImageAvailableListener onImageAvailableListener, ImageReader imageReader) {
        executor.execute(new Runnable() { // from class: androidx.camera.core.AndroidImageReaderProxy$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m1128x4985bb07(onImageAvailableListener);
            }
        });
    }
