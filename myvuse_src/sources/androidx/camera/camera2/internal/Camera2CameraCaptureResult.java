...
public class Camera2CameraCaptureResult implements CameraCaptureResult {
    ...
    public CameraCaptureMetaData.AfMode getAfMode() {
        ...
        if (iIntValue != 0) {
            ...
            if (iIntValue != 5) {
                Logger.m1139e(TAG, "Undefined af mode: " + num);
                return CameraCaptureMetaData.AfMode.UNKNOWN;
            }
        }
    ...
    public CameraCaptureMetaData.AfState getAfState() {
        ...
        switch (num.intValue()) {
            ...
            case 5:
                break;
            default:
                Logger.m1139e(TAG, "Undefined af state: " + num);
                break;
        }
        return CameraCaptureMetaData.AfState.UNKNOWN;
    }
    ...
    public CameraCaptureMetaData.AeState getAeState() {
        ...
        if (iIntValue != 1) {
            ...
            if (iIntValue != 5) {
                Logger.m1139e(TAG, "Undefined ae state: " + num);
                return CameraCaptureMetaData.AeState.UNKNOWN;
            }
        }
    ...
    public CameraCaptureMetaData.AwbState getAwbState() {
        ...
        Logger.m1139e(TAG, "Undefined awb state: " + num);
        return CameraCaptureMetaData.AwbState.UNKNOWN;
    }
    ...
    public CameraCaptureMetaData.FlashState getFlashState() {
        ...
        Logger.m1139e(TAG, "Undefined flash state: " + num);
        return CameraCaptureMetaData.FlashState.UNKNOWN;
    }
    ...
    public void populateExifData(ExifData.Builder exifData) {
        ...
        if (num != null) {
            exifData.setOrientationDegrees(num.intValue());
        }
