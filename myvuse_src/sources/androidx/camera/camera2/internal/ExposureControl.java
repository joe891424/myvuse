...
public class ExposureControl {
    ...
    ListenableFuture<Integer> setExposureCompensationIndex(final int exposure) {
        ...
        if (!exposureCompensationRange.contains(Integer.valueOf(exposure))) {
        ...
        return Futures.nonCancellationPropagating(CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.ExposureControl$$ExternalSyntheticLambda2
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m1097x8eaf9914(exposure, completer);
            }
        }));
    }

    /* JADX INFO: renamed from: lambda$setExposureCompensationIndex$2$androidx-camera-camera2-internal-ExposureControl */
    /* synthetic */ Object m1097x8eaf9914(final int i, final CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new Runnable() { // from class: androidx.camera.camera2.internal.ExposureControl$$ExternalSyntheticLambda1
            ...
            public final void run() {
                this.f$0.m1096x9d05f2f5(completer, i);
            }
        });
        return "setExposureCompensationIndex[" + i + "]";
    }

    /* JADX INFO: renamed from: lambda$setExposureCompensationIndex$1$androidx-camera-camera2-internal-ExposureControl */
    /* synthetic */ void m1096x9d05f2f5(final CallbackToFutureAdapter.Completer completer, final int i) {
        if (!this.mIsActive) {
            this.mExposureStateImpl.setExposureCompensationIndex(0);
