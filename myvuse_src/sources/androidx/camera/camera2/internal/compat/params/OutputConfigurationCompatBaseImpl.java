    ...
    private static final class OutputConfigurationParamsApi21 {
        ...
        private static Size getSurfaceSize(Surface surface) {
            try {
                ...
                Logger.m1140e(OutputConfigurationCompatBaseImpl.TAG, "Unable to retrieve surface size.", e);
                return null;
            }
        }
        ...
        private static int getSurfaceFormat(Surface surface) {
            try {
                ...
                Logger.m1140e(OutputConfigurationCompatBaseImpl.TAG, "Unable to retrieve surface format.", e);
                return 0;
            }
        }
        ...
        private static int getSurfaceGenerationId(Surface surface) {
            try {
                ...
                Logger.m1140e(OutputConfigurationCompatBaseImpl.TAG, "Unable to retrieve surface generation id.", e);
                return -1;
            }
        }
