...
class OutputConfigurationCompatApi26Impl extends OutputConfigurationCompatApi24Impl {
    ...
    public void removeSurface(Surface surface) {
        ...
        try {
            ...
            Logger.m1140e("OutputConfigCompat", "Unable to remove surface from this output configuration.", e);
        }
    }
    ...
    public int getMaxSharedSurfaceCount() {
        try {
            ...
            Logger.m1140e("OutputConfigCompat", "Unable to retrieve max shared surface count.", e);
