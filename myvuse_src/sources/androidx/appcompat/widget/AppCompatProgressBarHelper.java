...
class AppCompatProgressBarHelper {
    ...
    private Drawable tileifyIndeterminate(Drawable drawable) {
        ...
        for (int i = 0; i < numberOfFrames; i++) {
            ...
            drawableTileify.setLevel(AndroidLocationEnablerModule.DEFAULT_INTERVAL_DURATION);
            animationDrawable2.addFrame(drawableTileify, animationDrawable.getDuration(i));
        }
        animationDrawable2.setLevel(AndroidLocationEnablerModule.DEFAULT_INTERVAL_DURATION);
