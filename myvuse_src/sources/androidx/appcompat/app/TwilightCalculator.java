...
class TwilightCalculator {
    ...
    private static final float f1695C1 = 0.0334196f;

    /* JADX INFO: renamed from: C2 */
    private static final float f1696C2 = 3.49066E-4f;

    /* JADX INFO: renamed from: C3 */
    private static final float f1697C3 = 5.236E-6f;
    public static final int DAY = 0;
    private static final float DEGREES_TO_RADIANS = 0.017453292f;

    /* JADX INFO: renamed from: J0 */
    private static final float f1698J0 = 9.0E-4f;
    ...
    public void calculateTwilight(long j, double d, double d2) {
        ...
        double dRound = ((double) (Math.round(((double) (r3 - f1698J0)) - r7) + f1698J0)) + ((-d2) / 360.0d) + (Math.sin(d3) * 0.0053d) + (Math.sin(2.0d * dSin) * (-0.0069d));
