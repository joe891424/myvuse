...
@Metadata(m5597d1 = {"\u0000\u0010\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\r\u0012\t\u0012\u0007H\u0002¢\u0006\u0002\b\u00040\u0003H\u008a@"}, m5598d2 = {"<anonymous>", "", "R", "Lkotlinx/coroutines/flow/FlowCollector;", "Lkotlin/jvm/JvmSuppressWildcards;"}, m5599k = 3, m5600mv = {1, 8, 0}, m5602xi = 48)
@DebugMetadata(m5607c = "androidx.room.CoroutinesRoom$Companion$createFlow$1", m5608f = "CoroutinesRoom.kt", m5609i = {}, m5610l = {OTUIDisplayReasonCode.UIShownCode.BANNER_SHOWN_NEW_GROUP_ADDED}, m5611m = "invokeSuspend", m5612n = {}, m5613s = {})
final class CoroutinesRoom$Companion$createFlow$1<R> extends SuspendLambda implements Function2<FlowCollector<R>, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(m5607c = "androidx.room.CoroutinesRoom$Companion$createFlow$1$1", m5608f = "CoroutinesRoom.kt", m5609i = {}, m5610l = {137}, m5611m = "invokeSuspend", m5612n = {}, m5613s = {})
    static final class C11061 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C11061(boolean z, RoomDatabase roomDatabase, FlowCollector<R> flowCollector, String[] strArr, Callable<R> callable, Continuation<? super C11061> continuation) {
            super(2, continuation);
            this.$inTransaction = z;
            this.$db = roomDatabase;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C11061 c11061 = new C11061(this.$inTransaction, this.$db, this.$$this$flow, this.$tableNames, this.$callable, continuation);
            c11061.L$0 = obj;
            return c11061;
        }
            ...
            if (i == 0) {
                ...
                ?? r7 = new InvalidationTracker.Observer(strArr) { // from class: androidx.room.CoroutinesRoom$Companion$createFlow$1$1$observer$1
                    ...
                    public void onInvalidated(Set<String> tables) {
                        channelChannel$default.mo8737trySendJP2dKIU(Unit.INSTANCE);
                    }
                };
                channelChannel$default.mo8737trySendJP2dKIU(Unit.INSTANCE);
        ...
        /* JADX INFO: compiled from: CoroutinesRoom.kt */
        @Metadata(m5597d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u0003H\u008a@"}, m5598d2 = {"<anonymous>", "", "R", "Lkotlinx/coroutines/CoroutineScope;"}, m5599k = 3, m5600mv = {1, 8, 0}, m5602xi = 48)
        @DebugMetadata(m5607c = "androidx.room.CoroutinesRoom$Companion$createFlow$1$1$1", m5608f = "CoroutinesRoom.kt", m5609i = {}, m5610l = {128, ISO7816Kt.INS_EXTERNAL_AUTHENTICATE}, m5611m = "invokeSuspend", m5612n = {}, m5613s = {})
            ...
            */
            public final java.lang.Object invokeSuspend(java.lang.Object r8) {
                ...
                L7f:
                    ...
                    throw r8
                */
                throw new UnsupportedOperationException("Method not decompiled: androidx.room.CoroutinesRoom$Companion$createFlow$1.C11061.AnonymousClass1.invokeSuspend(java.lang.Object):java.lang.Object");
            }
        }
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (CoroutineScopeKt.coroutineScope(new C11061(this.$inTransaction, this.$db, flowCollector, this.$tableNames, this.$callable, null), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i != 1) {
