...
@DebugMetadata(m5607c = "androidx.room.RoomDatabaseKt$invalidationTrackerFlow$1$job$1", m5608f = "RoomDatabaseExt.kt", m5609i = {}, m5610l = {230}, m5611m = "invokeSuspend", m5612n = {}, m5613s = {})
        ...
        try {
            if (i == 0) {
                ...
                if (this.$emitInitialState) {
                    this.$$this$callbackFlow.mo8737trySendJP2dKIU(ArraysKt.toSet(this.$tables));
                }
