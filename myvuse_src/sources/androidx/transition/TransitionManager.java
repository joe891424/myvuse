...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo5812clone = transition.mo5812clone();
        transitionMo5812clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo5812clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo5812clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo5812clone);
    }
    ...
    public static void m1230go(Scene scene) {
        changeScene(scene, sDefaultTransition);
    }

    /* JADX INFO: renamed from: go */
    public static void m1231go(Scene scene, Transition transition) {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo5812clone = transition.mo5812clone();
        sceneChangeSetup(viewGroup, transitionMo5812clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo5812clone);
    }
