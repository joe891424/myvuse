...
public class TransitionSet extends Transition {
    ...
    public Transition mo5812clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo5812clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo5812clone());
        }
