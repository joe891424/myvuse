package androidx.autofill.inline.p030v1;
...
import androidx.autofill.C0352R;
...
public final class InlineSuggestionUi {
    ...
    public static View render(Context context, Content content, Style style) {
        ViewGroup viewGroup = (ViewGroup) LayoutInflater.from(getDefaultContextThemeWrapper(context)).inflate(C0352R.layout.autofill_inline_suggestion, (ViewGroup) null);
        ImageView imageView = (ImageView) viewGroup.findViewById(C0352R.id.autofill_inline_suggestion_start_icon);
        TextView textView = (TextView) viewGroup.findViewById(C0352R.id.autofill_inline_suggestion_title);
        TextView textView2 = (TextView) viewGroup.findViewById(C0352R.id.autofill_inline_suggestion_subtitle);
        ImageView imageView2 = (ImageView) viewGroup.findViewById(C0352R.id.autofill_inline_suggestion_end_icon);
    ...
    private static Context getDefaultContextThemeWrapper(Context context) {
        ...
        themeNewTheme.applyStyle(C0352R.style.Theme_AutofillInlineSuggestion, true);
