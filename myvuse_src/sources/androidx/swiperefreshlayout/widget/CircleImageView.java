...
import androidx.swiperefreshlayout.C1126R;
...
class CircleImageView extends ImageView {
    ...
    CircleImageView(Context context) {
        ...
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(C1126R.styleable.SwipeRefreshLayout);
        this.mBackgroundColor = typedArrayObtainStyledAttributes.getColor(C1126R.styleable.f1842xaa980688, DEFAULT_BACKGROUND_COLOR);
