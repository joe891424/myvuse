...
public class BuildCompat {
    ...
    static {
        R_EXTENSION_INT = Build.VERSION.SDK_INT >= 30 ? Extensions30Impl.f1776R : 0;
        S_EXTENSION_INT = Build.VERSION.SDK_INT >= 30 ? Extensions30Impl.f1777S : 0;
    ...
    private static final class Extensions30Impl {
        ...
        static final int f1776R = SdkExtensions.getExtensionVersion(30);

        /* JADX INFO: renamed from: S */
        static final int f1777S = SdkExtensions.getExtensionVersion(31);
