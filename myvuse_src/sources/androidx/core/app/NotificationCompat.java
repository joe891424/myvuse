...
import androidx.core.content.p031pm.ShortcutInfoCompat;
...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it3.hasNext()) {
                    addPerson(Person.fromAndroidPerson((android.app.Person) it3.next()));
                }
            }
        ...
        private Bitmap reduceLargeIconSize(Bitmap bitmap) {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C0573R.dimen.compat_notification_large_icon_max_width);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0573R.dimen.compat_notification_large_icon_max_height);
    ...
    public static abstract class Style {
        ...
        */
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0573R.drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0573R.id.notification_main_column);
            remoteViews.addView(C0573R.id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0573R.id.notification_main_column, 0);
            Api16Impl.setViewPadding(remoteViews, C0573R.id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
        }

        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0573R.id.title, 8);
            remoteViews.setViewVisibility(C0573R.id.text2, 8);
            remoteViews.setViewVisibility(C0573R.id.text, 8);
        }

        private int calculateTopPadding() {
            Resources resources = this.mBuilder.mContext.getResources();
            int dimensionPixelSize = resources.getDimensionPixelSize(C0573R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C0573R.dimen.notification_top_pad_large_text);
    ...
    public static class CallStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            Iterator<Action> it2 = actionsListWithSystemActions.iterator();
            while (it2.hasNext()) {
                Api20Impl.addAction(builder, getActionFromActionCompat(it2.next()));
            }
        ...
        private String getDefaultText() {
            int i = this.mCallType;
            if (i == 1) {
                return this.mBuilder.mContext.getResources().getString(C0573R.string.call_notification_incoming_text);
            }
            if (i == 2) {
                return this.mBuilder.mContext.getResources().getString(C0573R.string.call_notification_ongoing_text);
            }
            if (i != 3) {
                return null;
            }
            return this.mBuilder.mContext.getResources().getString(C0573R.string.call_notification_screening_text);
        }

        private Action makeNegativeAction() {
            int i = C0573R.drawable.ic_call_decline_low;
            int i2 = C0573R.drawable.ic_call_decline;
            if (this.mDeclineIntent == null) {
                return makeAction(i2, C0573R.string.call_notification_hang_up_action, this.mDeclineButtonColor, C0573R.color.call_notification_decline_color, this.mHangUpIntent);
            }
            return makeAction(i2, C0573R.string.call_notification_decline_action, this.mDeclineButtonColor, C0573R.color.call_notification_decline_color, this.mDeclineIntent);
        }

        private Action makeAnswerAction() {
            int i;
            int i2 = C0573R.drawable.ic_call_answer_video_low;
            int i3 = C0573R.drawable.ic_call_answer_low;
            int i4 = C0573R.drawable.ic_call_answer_video;
            int i5 = C0573R.drawable.ic_call_answer;
            ...
            int i6 = z ? i4 : i5;
            if (z) {
                i = C0573R.string.call_notification_answer_video_action;
            } else {
                i = C0573R.string.call_notification_answer_action;
            }
            return makeAction(i6, i, this.mAnswerButtonColor, C0573R.color.call_notification_answer_color, this.mAnswerIntent);
        }
    ...
    public static class InboxStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            while (it2.hasNext()) {
                Api16Impl.addLine(bigContentTitle, it2.next());
            }
        }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            int iMin;
            int i = 0;
            RemoteViews remoteViewsApplyStandardTemplate = applyStandardTemplate(true, C0573R.layout.notification_template_custom_big, false);
            remoteViewsApplyStandardTemplate.removeAllViews(C0573R.id.actions);
            ...
            if (!z || nonContextualActions == null || (iMin = Math.min(nonContextualActions.size(), 3)) <= 0) {
                ...
                for (int i2 = 0; i2 < iMin; i2++) {
                    remoteViewsApplyStandardTemplate.addView(C0573R.id.actions, generateActionButton(nonContextualActions.get(i2)));
                }
            }
            remoteViewsApplyStandardTemplate.setViewVisibility(C0573R.id.actions, i);
            remoteViewsApplyStandardTemplate.setViewVisibility(C0573R.id.action_divider, i);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            if (z) {
                i = C0573R.layout.notification_action_tombstone;
            } else {
                i = C0573R.layout.notification_action;
            }
            RemoteViews remoteViews = new RemoteViews(packageName, i);
            IconCompat iconCompat = action.getIconCompat();
            if (iconCompat != null) {
                remoteViews.setImageViewBitmap(C0573R.id.action_image, createColoredBitmap(iconCompat, C0573R.color.notification_action_color_filter));
            }
            remoteViews.setTextViewText(C0573R.id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0573R.id.action_container, action.actionIntent);
            }
            Api15Impl.setContentDescription(remoteViews, C0573R.id.action_container, action.title);
            return remoteViews;
        }
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m5765clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* JADX INFO: renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m5766clone() {
            WearableExtender wearableExtender = new WearableExtender();
