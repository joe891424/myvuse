...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public NestedScrollView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0573R.attr.nestedScrollViewStyle);
    }
    ...
    public boolean executeKeyEvent(KeyEvent keyEvent) {
        ...
        int i = ISO7816Kt.INS_EXTERNAL_AUTHENTICATE;
        if (!zCanScroll) {
            ...
            View viewFindNextFocus = FocusFinder.getInstance().findNextFocus(this, viewFindFocus, ISO7816Kt.INS_EXTERNAL_AUTHENTICATE);
            return (viewFindNextFocus == null || viewFindNextFocus == this || !viewFindNextFocus.requestFocus(ISO7816Kt.INS_EXTERNAL_AUTHENTICATE)) ? false : true;
        }
        ...
        if (keyCode == 20) {
            if (!keyEvent.isAltPressed()) {
                return arrowScroll(ISO7816Kt.INS_EXTERNAL_AUTHENTICATE);
            }
            return fullScroll(ISO7816Kt.INS_EXTERNAL_AUTHENTICATE);
        }
        if (keyCode != 62) {
            return false;
        }
    ...
    */
    ...
    protected boolean onRequestFocusInDescendants(int i, Rect rect) {
        ...
        if (i == 2) {
            i = ISO7816Kt.INS_EXTERNAL_AUTHENTICATE;
        } else if (i == 1) {
            i = 33;
        }
        if (rect == null) {
