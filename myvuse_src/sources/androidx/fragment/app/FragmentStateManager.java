...
class FragmentStateManager {
    ...
    int computeExpectedState() {
        ...
        int i = C08552.$SwitchMap$androidx$lifecycle$Lifecycle$State[this.mFragment.mMaxState.ordinal()];
        if (i != 1) {
            if (i == 2) {
    ...
    void ensureInflatedView() {
        if (this.mFragment.mFromLayout && this.mFragment.mInLayout && !this.mFragment.mPerformedCreateView) {
            ...
            if (this.mFragment.mView != null) {
                ...
                this.mFragment.mView.setTag(C0816R.id.fragment_container_view_tag, this.mFragment);
                if (this.mFragment.mHidden) {
    ...
    Bundle saveState() {
        ...
        if (this.mFragment.mState > -1) {
            ...
            Bundle bundleM5784lambda$attachController$4$androidxfragmentappFragmentManager = this.mFragment.mChildFragmentManager.m5784lambda$attachController$4$androidxfragmentappFragmentManager();
            if (!bundleM5784lambda$attachController$4$androidxfragmentappFragmentManager.isEmpty()) {
                bundle.putBundle(CHILD_FRAGMENT_MANAGER_KEY, bundleM5784lambda$attachController$4$androidxfragmentappFragmentManager);
            }
            if (this.mFragment.mView != null) {
                saveViewState();
            }
