...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManager.OpGenerator {
    ...
    public void dump(String str, PrintWriter printWriter, boolean z) {
        ...
        for (int i = 0; i < size; i++) {
            FragmentTransaction.C0857Op c0857Op = this.mOps.get(i);
            switch (c0857Op.mCmd) {
                case 0:
                    str2 = "NULL";
                    break;
            ...
            printWriter.print(" ");
            printWriter.println(c0857Op.mFragment);
            if (z) {
                if (c0857Op.mEnterAnim != 0 || c0857Op.mExitAnim != 0) {
                    printWriter.print(str);
                    printWriter.print("enterAnim=#");
                    printWriter.print(Integer.toHexString(c0857Op.mEnterAnim));
                    printWriter.print(" exitAnim=#");
                    printWriter.println(Integer.toHexString(c0857Op.mExitAnim));
                }
                if (c0857Op.mPopEnterAnim != 0 || c0857Op.mPopExitAnim != 0) {
                    printWriter.print(str);
                    printWriter.print("popEnterAnim=#");
                    printWriter.print(Integer.toHexString(c0857Op.mPopEnterAnim));
                    printWriter.print(" popExitAnim=#");
                    printWriter.println(Integer.toHexString(c0857Op.mPopExitAnim));
                }
            }
        }
    }
    ...
    void bumpBackStackNesting(int i) {
        if (this.mAddToBackStack) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                FragmentTransaction.C0857Op c0857Op = this.mOps.get(i2);
                if (c0857Op.mFragment != null) {
                    c0857Op.mFragment.mBackStackNesting += i;
                    if (FragmentManager.isLoggingEnabled(2)) {
                        Log.v("FragmentManager", "Bump nesting of " + c0857Op.mFragment + " to " + c0857Op.mFragment.mBackStackNesting);
                    }
                }
            }
        }
    ...
    void executeOps() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            switch (c0857Op.mCmd) {
                case 1:
                    fragment.setAnimations(c0857Op.mEnterAnim, c0857Op.mExitAnim, c0857Op.mPopEnterAnim, c0857Op.mPopExitAnim);
                    this.mManager.setExitAnimationOrder(fragment, false);
                    this.mManager.addFragment(fragment);
                    break;
                case 2:
                default:
                    throw new IllegalArgumentException("Unknown cmd: " + c0857Op.mCmd);
                case 3:
                    fragment.setAnimations(c0857Op.mEnterAnim, c0857Op.mExitAnim, c0857Op.mPopEnterAnim, c0857Op.mPopExitAnim);
                ...
                case 9:
                    ...
                    break;
                case 10:
                    this.mManager.setMaxLifecycle(fragment, c0857Op.mCurrentMaxState);
                    break;
            }
        }
    }
    ...
    void executePopOps() {
        for (int size = this.mOps.size() - 1; size >= 0; size--) {
            FragmentTransaction.C0857Op c0857Op = this.mOps.get(size);
            Fragment fragment = c0857Op.mFragment;
            if (fragment != null) {
                fragment.mBeingSaved = this.mBeingSaved;
            ...
            switch (c0857Op.mCmd) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    this.mManager.setMaxLifecycle(fragment, c0857Op.mOldMaxState);
                    break;
            }
        }
    }
    ...
    */
    androidx.fragment.app.Fragment expandOps(java.util.ArrayList<androidx.fragment.app.Fragment> r17, androidx.fragment.app.Fragment r18) {
        ...
        L7:
            ...
            androidx.fragment.app.FragmentTransaction$Op r5 = (androidx.fragment.app.FragmentTransaction.C0857Op) r5
            int r6 = r5.mCmd
            r7 = 1
            if (r6 == r7) goto Lb8
            r8 = 2
    ...
    */
    androidx.fragment.app.Fragment trackAddedFragmentsInPop(java.util.ArrayList<androidx.fragment.app.Fragment> r6, androidx.fragment.app.Fragment r7) {
        ...
        L8:
            ...
            androidx.fragment.app.FragmentTransaction$Op r2 = (androidx.fragment.app.FragmentTransaction.C0857Op) r2
            int r3 = r2.mCmd
            if (r3 == r1) goto L2d
            r4 = 3
            if (r3 == r4) goto L27
    ...
    void collapseOps() {
        ...
        while (size >= 0) {
            FragmentTransaction.C0857Op c0857Op = this.mOps.get(size);
            if (c0857Op.mFromExpandedOp) {
                if (c0857Op.mCmd == 8) {
                    c0857Op.mFromExpandedOp = false;
                    this.mOps.remove(size - 1);
                    size--;
                } else {
                    int i = c0857Op.mFragment.mContainerId;
                    c0857Op.mCmd = 2;
                    c0857Op.mFromExpandedOp = false;
                    for (int i2 = size - 1; i2 >= 0; i2--) {
                        FragmentTransaction.C0857Op c0857Op2 = this.mOps.get(i2);
                        if (c0857Op2.mFromExpandedOp && c0857Op2.mFragment.mContainerId == i) {
                            this.mOps.remove(i2);
                            size--;
                        }
                    }
