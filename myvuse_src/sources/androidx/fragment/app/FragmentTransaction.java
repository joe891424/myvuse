...
public abstract class FragmentTransaction {
    ...
    static final class C0857Op {
        ...
        C0857Op(int i, Fragment fragment) {
            this.mCmd = i;
        ...
        C0857Op(int i, Fragment fragment, boolean z) {
            this.mCmd = i;
            this.mFragment = fragment;
        ...
        C0857Op(int i, Fragment fragment, Lifecycle.State state) {
            this.mCmd = i;
            this.mFragment = fragment;
            this.mFromExpandedOp = false;
        ...
        C0857Op(C0857Op c0857Op) {
            this.mCmd = c0857Op.mCmd;
            this.mFragment = c0857Op.mFragment;
            this.mFromExpandedOp = c0857Op.mFromExpandedOp;
            this.mEnterAnim = c0857Op.mEnterAnim;
            this.mExitAnim = c0857Op.mExitAnim;
            this.mPopEnterAnim = c0857Op.mPopEnterAnim;
            this.mPopExitAnim = c0857Op.mPopExitAnim;
            this.mOldMaxState = c0857Op.mOldMaxState;
            this.mCurrentMaxState = c0857Op.mCurrentMaxState;
        }
    }
    ...
    FragmentTransaction(FragmentFactory fragmentFactory, ClassLoader classLoader, FragmentTransaction fragmentTransaction) {
        ...
        Iterator<C0857Op> it2 = fragmentTransaction.mOps.iterator();
        while (it2.hasNext()) {
            this.mOps.add(new C0857Op(it2.next()));
        }
    ...
    void addOp(C0857Op c0857Op) {
        this.mOps.add(c0857Op);
        c0857Op.mEnterAnim = this.mEnterAnim;
        c0857Op.mExitAnim = this.mExitAnim;
        c0857Op.mPopEnterAnim = this.mPopEnterAnim;
        c0857Op.mPopExitAnim = this.mPopExitAnim;
    }
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C0857Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C0857Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C0857Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C0857Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C0857Op(7, fragment));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
        addOp(new C0857Op(8, fragment));
        return this;
    }

    public FragmentTransaction setMaxLifecycle(Fragment fragment, Lifecycle.State state) {
        addOp(new C0857Op(10, fragment, state));
        return this;
    }
