...
class BrowserActionsFallbackMenuAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(this.mContext).inflate(C0366R.layout.browser_actions_context_menu_row, (ViewGroup) null);
            ImageView imageView = (ImageView) view.findViewById(C0366R.id.browser_actions_menu_item_icon);
            TextView textView = (TextView) view.findViewById(C0366R.id.browser_actions_menu_item_text);
