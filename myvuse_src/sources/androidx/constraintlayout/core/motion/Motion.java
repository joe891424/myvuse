...
public class Motion implements TypedValues {
    ...
    public float getStartX() {
        return this.mStartMotionPath.f1720x;
    }

    public float getStartY() {
        return this.mStartMotionPath.f1721y;
    }

    public float getFinalX() {
        return this.mEndMotionPath.f1720x;
    }

    public float getFinalY() {
        return this.mEndMotionPath.f1721y;
    }
    ...
    MotionKeyPosition getPositionKeyframe(int i, int i2, float f, float f2) {
        ...
        floatRect.left = this.mStartMotionPath.f1720x;
        floatRect.top = this.mStartMotionPath.f1721y;
        ...
        floatRect2.left = this.mEndMotionPath.f1720x;
        floatRect2.top = this.mEndMotionPath.f1721y;
    ...
    float getKeyFrameParameter(int i, float f, float f2) {
        float f3 = this.mEndMotionPath.f1720x - this.mStartMotionPath.f1720x;
        float f4 = this.mEndMotionPath.f1721y - this.mStartMotionPath.f1721y;
        float f5 = this.mStartMotionPath.f1720x + (this.mStartMotionPath.width / 2.0f);
        float f6 = this.mStartMotionPath.f1721y + (this.mStartMotionPath.height / 2.0f);
    ...
    public void setup(int i, int i2, float f, long j) {
        ...
        if (motionPathsArr[0].mPathMotionArc != -1) {
            ...
            for (int i19 = 0; i19 < i4; i19++) {
                ...
                dArr6[i19][0] = motionPathsArr[i19].f1720x;
                dArr6[i19][1] = motionPathsArr[i19].f1721y;
            }
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f1720x + " y: " + this.mStartMotionPath.f1721y + " end: x: " + this.mEndMotionPath.f1720x + " y: " + this.mEndMotionPath.f1721y;
    }
    ...
    private static DifferentialInterpolator getInterpolator(int i, String str, int i2) {
        ...
        return new DifferentialInterpolator() { // from class: androidx.constraintlayout.core.motion.Motion.1
            ...
            public float getVelocity() {
                return (float) interpolator.getDiff(this.f1717mX);
            }
        };
    }
    ...
    public boolean interpolate(MotionWidget motionWidget, float f, long j, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            float f5 = this.mStartMotionPath.f1720x + ((this.mEndMotionPath.f1720x - this.mStartMotionPath.f1720x) * f4) + 0.5f;
            float f6 = this.mStartMotionPath.f1721y + ((this.mEndMotionPath.f1721y - this.mStartMotionPath.f1721y) * f4) + 0.5f;
    ...
    void getDpDt(float f, float f2, float f3, float[] fArr) {
        ...
        float f5 = this.mEndMotionPath.f1720x - this.mStartMotionPath.f1720x;
        float f6 = this.mEndMotionPath.f1721y - this.mStartMotionPath.f1721y;
