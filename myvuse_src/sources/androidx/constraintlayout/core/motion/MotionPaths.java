...
public class MotionPaths implements Comparable<MotionPaths> {
    ...
    static String[] names = {ViewProps.POSITION, EllipticCurveJsonWebKey.X_MEMBER_NAME, EllipticCurveJsonWebKey.Y_MEMBER_NAME, "width", "height", "pathRotate"};
    ...
    void initCartesian(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths.f1720x;
        float f9 = motionPaths.f1721y;
        float f10 = (motionPaths2.f1720x + (f4 / 2.0f)) - ((f5 / 2.0f) + f8);
        float f11 = (motionPaths2.f1721y + (f6 / 2.0f)) - (f9 + (f7 / 2.0f));
        float f12 = ((f4 - f5) * f2) / 2.0f;
        this.f1720x = (int) ((f8 + (f10 * f)) - f12);
        float f13 = ((f6 - f7) * f3) / 2.0f;
        this.f1721y = (int) ((f9 + (f11 * f)) - f13);
        ...
        this.mMode = 0;
        this.f1720x = (int) (((motionPaths.f1720x + (f14 * f10)) + (f16 * f11)) - f12);
        this.f1721y = (int) (((motionPaths.f1721y + (f10 * f15)) + (f11 * f)) - f13);
    ...
    void initPolar(int i, int i2, MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        if (i3 == 1) {
            ...
            float f10 = motionPaths2.f1720x;
            float f11 = motionPaths.f1720x;
            this.f1720x = (f9 * (f10 - f11)) + f11;
            if (!Float.isNaN(motionKeyPosition.mPercentY)) {
                f2 = motionKeyPosition.mPercentY;
            }
            float f12 = motionPaths2.f1721y;
            float f13 = motionPaths.f1721y;
            this.f1721y = (f2 * (f12 - f13)) + f13;
        } else if (i3 == 2) {
            if (Float.isNaN(motionKeyPosition.mPercentX)) {
                float f14 = motionPaths2.f1720x;
                float f15 = motionPaths.f1720x;
                fMin = ((f14 - f15) * f2) + f15;
            } else {
            ...
            this.f1720x = fMin;
            if (Float.isNaN(motionKeyPosition.mPercentY)) {
                float f16 = motionPaths2.f1721y;
                float f17 = motionPaths.f1721y;
                f = (f2 * (f16 - f17)) + f17;
            } else {
                f = motionKeyPosition.mPercentY;
            }
            ...
            float f19 = motionPaths2.f1720x;
            float f20 = motionPaths.f1720x;
            this.f1720x = (f18 * (f19 - f20)) + f20;
            if (!Float.isNaN(motionKeyPosition.mPercentY)) {
                f2 = motionKeyPosition.mPercentY;
            }
            float f21 = motionPaths2.f1721y;
            float f22 = motionPaths.f1721y;
            this.f1721y = (f2 * (f21 - f22)) + f22;
        }
    ...
    public void setupRelative(Motion motion, MotionPaths motionPaths) {
        double d = ((this.f1720x + (this.width / 2.0f)) - motionPaths.f1720x) - (motionPaths.width / 2.0f);
        double d2 = ((this.f1721y + (this.height / 2.0f)) - motionPaths.f1721y) - (motionPaths.height / 2.0f);
        this.mRelativeToController = motion;
        this.f1720x = (float) Math.hypot(d2, d);
        if (Float.isNaN(this.mRelativeAngle)) {
            this.f1721y = (float) (Math.atan2(d2, d) + 1.5707963267948966d);
        } else {
            this.f1721y = (float) Math.toRadians(this.mRelativeAngle);
        }
    }
    ...
    void initScreen(int i, int i2, MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths.f1720x;
        float f9 = motionPaths.f1721y;
        float f10 = motionPaths2.f1720x + (f4 / 2.0f);
        float f11 = motionPaths2.f1721y + (f6 / 2.0f);
        float f12 = (f4 - f5) * f2;
        this.f1720x = (int) ((f8 + ((f10 - ((f5 / 2.0f) + f8)) * f)) - (f12 / 2.0f));
        float f13 = (f6 - f7) * f3;
        this.f1721y = (int) ((f9 + ((f11 - (f9 + (f7 / 2.0f))) * f)) - (f13 / 2.0f));
        this.width = (int) (f5 + f12);
        this.height = (int) (f7 + f13);
        this.mMode = 2;
        if (!Float.isNaN(motionKeyPosition.mPercentX)) {
            this.f1720x = (int) (motionKeyPosition.mPercentX * ((int) (i - this.width)));
        }
        if (!Float.isNaN(motionKeyPosition.mPercentY)) {
            this.f1721y = (int) (motionKeyPosition.mPercentY * ((int) (i2 - this.height)));
        }
    ...
    void initPath(MotionKeyPosition motionKeyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f6 = motionPaths.f1720x;
        float f7 = motionPaths.width;
        float f8 = motionPaths.f1721y;
        float f9 = motionPaths.height;
        float f10 = (motionPaths2.f1720x + (motionPaths2.width / 2.0f)) - ((f7 / 2.0f) + f6);
        float f11 = (motionPaths2.f1721y + (motionPaths2.height / 2.0f)) - ((f9 / 2.0f) + f8);
        float f12 = f10 * f;
        float f13 = (f4 * f2) / 2.0f;
        this.f1720x = (int) ((f6 + f12) - f13);
        float f14 = f * f11;
        float f15 = (f5 * f3) / 2.0f;
        this.f1721y = (int) ((f8 + f14) - f15);
        ...
        this.mMode = 1;
        float f17 = (int) ((motionPaths.f1720x + f12) - f13);
        this.f1720x = f17;
        float f18 = (int) ((motionPaths.f1721y + f14) - f15);
        this.f1720x = f17 + ((-f11) * f16);
        this.f1721y = f18 + (f10 * f16);
        this.mAnimateRelativeTo = this.mAnimateRelativeTo;
        this.mKeyFrameEasing = Easing.getInterpolator(motionKeyPosition.mTransitionEasing);
        this.mPathMotionArc = motionKeyPosition.mPathMotionArc;
    }
    ...
    void different(MotionPaths motionPaths, boolean[] zArr, String[] strArr, boolean z) {
        boolean zDiff = diff(this.f1720x, motionPaths.f1720x);
        boolean zDiff2 = diff(this.f1721y, motionPaths.f1721y);
    ...
    void getCenter(double d, int[] iArr, double[] dArr, float[] fArr, int i) {
        float fSin = this.f1720x;
        float fCos = this.f1721y;
        float f = this.width;
    ...
    void getCenter(double d, int[] iArr, double[] dArr, float[] fArr, double[] dArr2, float[] fArr2) {
        float f;
        float f2 = this.f1720x;
        float f3 = this.f1721y;
        float f4 = this.width;
    ...
    void setView(float f, MotionWidget motionWidget, int[] iArr, double[] dArr, double[] dArr2, double[] dArr3) {
        float f2;
        float f3;
        float f4 = this.f1720x;
        float f5 = this.f1721y;
        float f6 = this.width;
    ...
    void fillStandard(double[] dArr, int[] iArr) {
        float[] fArr = {this.position, this.f1720x, this.f1721y, this.width, this.height, this.mPathRotate};
        int i = 0;
        for (int i2 : iArr) {
            if (i2 < 6) {
                dArr[i] = fArr[r1];
