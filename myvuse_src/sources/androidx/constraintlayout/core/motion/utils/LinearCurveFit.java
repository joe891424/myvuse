...
public class LinearCurveFit extends CurveFit {
    ...
    private double[] f1730mT;
    private double mTotalLength;

    /* JADX INFO: renamed from: mY */
    private double[][] f1731mY;
    ...
    private double getLength2D(double d) {
        ...
        int i2 = 0;
        while (i2 < i) {
            double[] dArr2 = this.f1731mY[i2];
            double d4 = dArr2[0];
            double d5 = dArr2[1];
            if (i2 > 0) {
                dHypot += Math.hypot(d4 - d2, d5 - d3);
            }
            double[] dArr3 = this.f1730mT;
            double d6 = dArr3[i2];
            if (d == d6) {
                return dHypot;
            }
    ...
    public void getPos(double d, double[] dArr) {
        double[] dArr2 = this.f1730mT;
        int length = dArr2.length;
        int i = 0;
        int length2 = this.f1731mY[0].length;
        if (this.mExtrapolate) {
            double d2 = dArr2[0];
            if (d <= d2) {
                getSlope(d2, this.mSlopeTemp);
                for (int i2 = 0; i2 < length2; i2++) {
                    dArr[i2] = this.f1731mY[0][i2] + ((d - this.f1730mT[0]) * this.mSlopeTemp[i2]);
                }
                return;
            }
            int i3 = length - 1;
            ...
            if (d >= d3) {
                ...
                while (i < length2) {
                    dArr[i] = this.f1731mY[i3][i] + ((d - this.f1730mT[i3]) * this.mSlopeTemp[i]);
                    i++;
                }
                return;
            }
        ...
        int i6 = 0;
        while (i6 < length - 1) {
            if (d == this.f1730mT[i6]) {
                for (int i7 = 0; i7 < length2; i7++) {
                    dArr[i7] = this.f1731mY[i6][i7];
                }
            }
            double[] dArr3 = this.f1730mT;
            int i8 = i6 + 1;
    ...
    public void getPos(double d, float[] fArr) {
        ...
        if (this.mExtrapolate) {
            ...
            if (d <= d2) {
                getSlope(d2, this.mSlopeTemp);
                for (int i2 = 0; i2 < length2; i2++) {
                    fArr[i2] = (float) (this.f1731mY[0][i2] + ((d - this.f1730mT[0]) * this.mSlopeTemp[i2]));
                }
                return;
            }
            int i3 = length - 1;
            ...
            if (d >= d3) {
                getSlope(d3, this.mSlopeTemp);
                while (i < length2) {
                    fArr[i] = (float) (this.f1731mY[i3][i] + ((d - this.f1730mT[i3]) * this.mSlopeTemp[i]));
                    i++;
                }
                return;
            }
            ...
            if (d <= dArr[0]) {
                for (int i4 = 0; i4 < length2; i4++) {
                    fArr[i4] = (float) this.f1731mY[0][i4];
                }
                return;
            }
            int i5 = length - 1;
            if (d >= dArr[i5]) {
                while (i < length2) {
                    fArr[i] = (float) this.f1731mY[i5][i];
                    i++;
                }
                return;
            }
        ...
        while (i6 < length - 1) {
            if (d == this.f1730mT[i6]) {
                for (int i7 = 0; i7 < length2; i7++) {
                    fArr[i7] = (float) this.f1731mY[i6][i7];
                }
            }
            double[] dArr2 = this.f1730mT;
            int i8 = i6 + 1;
    ...
    public double getPos(double d, int i) {
        ...
        if (d <= dArr[0]) {
            return this.f1731mY[0][i];
        }
        int i4 = length - 1;
        if (d >= dArr[i4]) {
            return this.f1731mY[i4][i];
        }
        while (i2 < length - 1) {
            double[] dArr2 = this.f1730mT;
            double d6 = dArr2[i2];
            if (d == d6) {
                return this.f1731mY[i2][i];
            }
            int i5 = i2 + 1;
            double d7 = dArr2[i5];
            if (d < d7) {
    ...
    */
    public void getSlope(double r13, double[] r15) {
        /*
            r12 = this;
            double[] r0 = r12.f1730mT
            int r1 = r0.length
            double[][] r2 = r12.f1731mY
            r3 = 0
            r2 = r2[r3]
            int r2 = r2.length
            r4 = r0[r3]
