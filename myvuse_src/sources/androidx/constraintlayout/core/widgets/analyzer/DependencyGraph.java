...
public class DependencyGraph {
    ...
    private String generateDisplayNode(DependencyNode dependencyNode, boolean z, String str) {
        ...
        while (it2.hasNext()) {
            String str2 = (ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE + dependencyNode.name()) + " -> " + it2.next().name();
    ...
    private String generateChainDisplayGraph(ChainRun chainRun, String str) {
        ...
        if (i == 0) {
            sb.append(NotificationMessage.NOTIF_KEY_MESSAGE_HASH);
        } else {
            sb.append("_v");
        }
        sb.append(" {\n");
