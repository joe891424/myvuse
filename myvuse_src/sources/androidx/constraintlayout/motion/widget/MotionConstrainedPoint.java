...
class MotionConstrainedPoint implements Comparable<MotionConstrainedPoint> {
    ...
    private float f1752x;

    /* JADX INFO: renamed from: y */
    private float f1753y;
    ...
    void different(MotionConstrainedPoint points, boolean[] mask, String[] custom) {
        ...
        mask[1] = mask[1] | diff(this.f1752x, points.f1752x);
        mask[2] = mask[2] | diff(this.f1753y, points.f1753y);
    ...
    void fillStandard(double[] data, int[] toUse) {
        int i = 0;
        float[] fArr = {this.position, this.f1752x, this.f1753y, this.width, this.height, this.alpha, this.elevation, this.rotation, this.rotationX, this.rotationY, this.scaleX, this.scaleY, this.mPivotX, this.mPivotY, this.translationX, this.translationY, this.translationZ, this.mPathRotate};
        for (int i2 : toUse) {
            if (i2 < 18) {
                data[i] = fArr[r4];
                i++;
