...
public class ViewTransition {
    ...
    */
    ...
    private void parseViewTransitionTags(Context context, XmlPullParser parser) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(Xml.asAttributeSet(parser), C0569R.styleable.ViewTransition);
        int indexCount = typedArrayObtainStyledAttributes.getIndexCount();
        for (int i = 0; i < indexCount; i++) {
            int index = typedArrayObtainStyledAttributes.getIndex(i);
            if (index == C0569R.styleable.ViewTransition_android_id) {
                this.mId = typedArrayObtainStyledAttributes.getResourceId(index, this.mId);
            } else if (index == C0569R.styleable.ViewTransition_motionTarget) {
    ...
    void applyTransition(ViewTransitionController controller, MotionLayout layout, int fromId, ConstraintSet current, final View... views) {
        ...
        layout.updateState(C0569R.id.view_transition, current);
        layout.setState(C0569R.id.view_transition, -1, -1);
        MotionScene.Transition transition = new MotionScene.Transition(-1, layout.mScene, C0569R.id.view_transition, fromId);
    ...
    private void updateTransition(MotionScene.Transition transition, View view) {
        ...
        if (keyFrames != null) {
            ...
            while (it2.hasNext()) {
                keyFrames2.addKey(it2.next().mo5763clone().setViewId(id));
            }
