...
public class MotionController {
    ...
    public float getStartX() {
        return this.mStartMotionPath.f1756x;
    }

    public float getStartY() {
        return this.mStartMotionPath.f1757y;
    }

    public float getFinalX() {
        return this.mEndMotionPath.f1756x;
    }

    public float getFinalY() {
        return this.mEndMotionPath.f1757y;
    }
    ...
    KeyPositionBase getPositionKeyframe(int layoutWidth, int layoutHeight, float x, float y) {
        ...
        rectF.left = this.mStartMotionPath.f1756x;
        rectF.top = this.mStartMotionPath.f1757y;
        rectF.right = rectF.left + this.mStartMotionPath.width;
        rectF.bottom = rectF.top + this.mStartMotionPath.height;
        RectF rectF2 = new RectF();
        rectF2.left = this.mEndMotionPath.f1756x;
        rectF2.top = this.mEndMotionPath.f1757y;
    ...
    float getKeyFrameParameter(int type, float x, float y) {
        float f = this.mEndMotionPath.f1756x - this.mStartMotionPath.f1756x;
        float f2 = this.mEndMotionPath.f1757y - this.mStartMotionPath.f1757y;
        float f3 = this.mStartMotionPath.f1756x + (this.mStartMotionPath.width / 2.0f);
        float f4 = this.mStartMotionPath.f1757y + (this.mStartMotionPath.height / 2.0f);
    ...
    public void setup(int parentWidth, int parentHeight, float transitionDuration, long currentTime) {
        ...
        if (motionPathsArr[0].mPathMotionArc != Key.UNSET) {
            ...
            for (int i17 = 0; i17 < i; i17++) {
                ...
                dArr7[i17][0] = motionPathsArr[i17].f1756x;
                dArr7[i17][1] = motionPathsArr[i17].f1757y;
            }
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f1756x + " y: " + this.mStartMotionPath.f1757y + " end: x: " + this.mEndMotionPath.f1756x + " y: " + this.mEndMotionPath.f1757y;
    }
    ...
    boolean interpolate(View child, float global_position, long time, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            i = 1;
            float f4 = this.mStartMotionPath.f1756x + ((this.mEndMotionPath.f1756x - this.mStartMotionPath.f1756x) * f3);
            float f5 = f4 + 0.5f;
            int i4 = (int) f5;
            float f6 = this.mStartMotionPath.f1757y + ((this.mEndMotionPath.f1757y - this.mStartMotionPath.f1757y) * f3) + 0.5f;
            int i5 = (int) f6;
    ...
    void getDpDt(float position, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        float f2 = this.mEndMotionPath.f1756x - this.mStartMotionPath.f1756x;
        float f3 = this.mEndMotionPath.f1757y - this.mStartMotionPath.f1757y;
