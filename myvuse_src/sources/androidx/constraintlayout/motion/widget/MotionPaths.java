...
class MotionPaths implements Comparable<MotionPaths> {
    ...
    void initCartesian(KeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float f8 = startTimePoint.f1756x;
        float f9 = startTimePoint.f1757y;
        float f10 = (endTimePoint.f1756x + (f4 / 2.0f)) - ((f5 / 2.0f) + f8);
        float f11 = (endTimePoint.f1757y + (f6 / 2.0f)) - (f9 + (f7 / 2.0f));
        float f12 = ((f4 - f5) * f2) / 2.0f;
        this.f1756x = (int) ((f8 + (f10 * f)) - f12);
        float f13 = ((f6 - f7) * f3) / 2.0f;
        this.f1757y = (int) ((f9 + (f11 * f)) - f13);
        ...
        this.mMode = 0;
        this.f1756x = (int) (((startTimePoint.f1756x + (f14 * f10)) + (f16 * f11)) - f12);
        this.f1757y = (int) (((startTimePoint.f1757y + (f10 * f15)) + (f11 * f)) - f13);
    ...
    void initPolar(int parentWidth, int parentHeight, KeyPosition c, MotionPaths s, MotionPaths e) {
        ...
        if (i == 1) {
            ...
            float f10 = e.f1756x;
            float f11 = s.f1756x;
            this.f1756x = (f9 * (f10 - f11)) + f11;
            if (!Float.isNaN(c.mPercentY)) {
                f2 = c.mPercentY;
            }
            float f12 = e.f1757y;
            float f13 = s.f1757y;
            this.f1757y = (f2 * (f12 - f13)) + f13;
        } else if (i == 2) {
            ...
            float f19 = e.f1756x;
            float f20 = s.f1756x;
            this.f1756x = (f18 * (f19 - f20)) + f20;
            if (!Float.isNaN(c.mPercentY)) {
                f2 = c.mPercentY;
            }
            float f21 = e.f1757y;
            float f22 = s.f1757y;
            this.f1757y = (f2 * (f21 - f22)) + f22;
        }
    ...
    public void setupRelative(MotionController mc, MotionPaths relative) {
        double d = ((this.f1756x + (this.width / 2.0f)) - relative.f1756x) - (relative.width / 2.0f);
        double d2 = ((this.f1757y + (this.height / 2.0f)) - relative.f1757y) - (relative.height / 2.0f);
        this.mRelativeToController = mc;
        this.f1756x = (float) Math.hypot(d2, d);
        if (Float.isNaN(this.mRelativeAngle)) {
            this.f1757y = (float) (Math.atan2(d2, d) + 1.5707963267948966d);
        } else {
            this.f1757y = (float) Math.toRadians(this.mRelativeAngle);
        }
    }
    ...
    void initScreen(int parentWidth, int parentHeight, KeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float f8 = startTimePoint.f1756x;
        float f9 = startTimePoint.f1757y;
        float f10 = endTimePoint.f1756x + (f4 / 2.0f);
        float f11 = endTimePoint.f1757y + (f6 / 2.0f);
        float f12 = (f4 - f5) * f2;
        this.f1756x = (int) ((f8 + ((f10 - ((f5 / 2.0f) + f8)) * f)) - (f12 / 2.0f));
        float f13 = (f6 - f7) * f3;
        this.f1757y = (int) ((f9 + ((f11 - (f9 + (f7 / 2.0f))) * f)) - (f13 / 2.0f));
        this.width = (int) (f5 + f12);
        this.height = (int) (f7 + f13);
        this.mMode = 2;
        if (!Float.isNaN(c.mPercentX)) {
            this.f1756x = (int) (c.mPercentX * ((int) (parentWidth - this.width)));
        }
        if (!Float.isNaN(c.mPercentY)) {
            this.f1757y = (int) (c.mPercentY * ((int) (parentHeight - this.height)));
        }
    ...
    void initPath(KeyPosition c, MotionPaths startTimePoint, MotionPaths endTimePoint) {
        ...
        float f6 = startTimePoint.f1756x;
        float f7 = startTimePoint.width;
        float f8 = startTimePoint.f1757y;
        float f9 = startTimePoint.height;
        float f10 = (endTimePoint.f1756x + (endTimePoint.width / 2.0f)) - ((f7 / 2.0f) + f6);
        float f11 = (endTimePoint.f1757y + (endTimePoint.height / 2.0f)) - ((f9 / 2.0f) + f8);
        float f12 = f10 * f;
        float f13 = (f4 * f2) / 2.0f;
        this.f1756x = (int) ((f6 + f12) - f13);
        float f14 = f * f11;
        float f15 = (f5 * f3) / 2.0f;
        this.f1757y = (int) ((f8 + f14) - f15);
        this.width = (int) (f7 + r7);
        this.height = (int) (f9 + r8);
        float f16 = Float.isNaN(c.mPercentY) ? 0.0f : c.mPercentY;
        this.mMode = 1;
        float f17 = (int) ((startTimePoint.f1756x + f12) - f13);
        this.f1756x = f17;
        float f18 = (int) ((startTimePoint.f1757y + f14) - f15);
        this.f1756x = f17 + ((-f11) * f16);
        this.f1757y = f18 + (f10 * f16);
        this.mAnimateRelativeTo = this.mAnimateRelativeTo;
        this.mKeyFrameEasing = Easing.getInterpolator(c.mTransitionEasing);
        this.mPathMotionArc = c.mPathMotionArc;
    }
    ...
    void different(MotionPaths points, boolean[] mask, String[] custom, boolean arcMode) {
        boolean zDiff = diff(this.f1756x, points.f1756x);
        boolean zDiff2 = diff(this.f1757y, points.f1757y);
    ...
    void getCenter(double p, int[] toUse, double[] data, float[] point, int offset) {
        float fSin = this.f1756x;
        float fCos = this.f1757y;
        float f = this.width;
    ...
    void fillStandard(double[] data, int[] toUse) {
        float[] fArr = {this.position, this.f1756x, this.f1757y, this.width, this.height, this.mPathRotate};
        int i = 0;
        for (int i2 : toUse) {
            if (i2 < 6) {
                data[i] = fArr[r1];
