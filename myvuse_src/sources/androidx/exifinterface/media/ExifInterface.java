...
public class ExifInterface {
    ...
    private static final byte[] PNG_SIGNATURE = {-119, 80, 78, 71, Ascii.f3747CR, 10, Ascii.SUB, 10};
    ...
    static {
        ...
        Charset charsetForName = Charset.forName(StringUtil.US_ASCII);
    ...
    public void saveAttributes() throws Throwable {
        ...
        try {
            if (this.mFilename != null) {
                fileCreateTempFile = new File(this.mFilename + DefaultDiskStorage.FileType.TEMP);
    ...
    */
    ...
    public long getGpsDateTime() {
        ...
        if (attribute != null && attribute2 != null) {
            ...
            if (pattern.matcher(attribute).matches() || pattern.matcher(attribute2).matches()) {
                try {
                    Date date = sFormatter.parse(attribute + SafeJsonPrimitive.NULL_CHAR + attribute2, new ParsePosition(0));
                    if (date == null) {
                        return -1L;
                    }
                    return date.getTime();
    ...
    /* JADX WARN: Removed duplicated region for block: B:34:0x00b9 A[FALL_THROUGH] */
    ...
    */
    ...
    private void getHeifAttributes(final ByteOrderedDataInputStream byteOrderedDataInputStream) throws IOException {
        ...
        try {
            ...
            if (DEBUG) {
                Log.d(TAG, "Heif meta: " + strExtractMetadata + EllipticCurveJsonWebKey.X_MEMBER_NAME + strExtractMetadata2 + ", rotation " + strExtractMetadata3);
            }
        } finally {
    ...
    /* JADX WARN: Removed duplicated region for block: B:159:0x0350 A[SYNTHETIC] */
