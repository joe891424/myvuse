...
public class FragmentNavigator extends Navigator<Destination> {
    ...
    public static class Destination extends NavDestination {
        ...
        public void onInflate(Context context, AttributeSet attributeSet) {
            ...
            TypedArray typedArrayObtainAttributes = context.getResources().obtainAttributes(attributeSet, C0994R.styleable.FragmentNavigator);
            String string = typedArrayObtainAttributes.getString(C0994R.styleable.FragmentNavigator_android_name);
            if (string != null) {
                setClassName(string);
            }
