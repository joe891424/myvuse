...
public class WebResourceErrorImpl extends WebResourceErrorCompat {
    ...
    public int getErrorCode() {
        ApiFeature.C1225M c1225m = WebViewFeatureInternal.WEB_RESOURCE_ERROR_GET_CODE;
    ...
    public CharSequence getDescription() {
        ApiFeature.C1225M c1225m = WebViewFeatureInternal.WEB_RESOURCE_ERROR_GET_DESCRIPTION;
        if (c1225m.isSupportedByFramework()) {
