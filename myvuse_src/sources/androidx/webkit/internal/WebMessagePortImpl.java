...
public class WebMessagePortImpl extends WebMessagePortCompat {
    ...
    public void postMessage(WebMessageCompat webMessageCompat) {
        ApiFeature.C1225M c1225m = WebViewFeatureInternal.WEB_MESSAGE_PORT_POST_MESSAGE;
    ...
    @Override // androidx.webkit.WebMessagePortCompat
    public void close() {
        ApiFeature.C1225M c1225m = WebViewFeatureInternal.WEB_MESSAGE_PORT_CLOSE;
    ...
    public void setWebMessageCallback(WebMessagePortCompat.WebMessageCallbackCompat webMessageCallbackCompat) {
        ApiFeature.C1225M c1225m = WebViewFeatureInternal.WEB_MESSAGE_PORT_SET_MESSAGE_CALLBACK;
        if (c1225m.isSupportedByWebView()) {
