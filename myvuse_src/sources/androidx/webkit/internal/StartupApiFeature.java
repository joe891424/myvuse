...
public abstract class StartupApiFeature {
    ...
    private static Bundle getMetaDataFromWebViewManifestOrNull(Context context) {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            try {
                return ApiHelperForTiramisu.getServiceInfo(context.getPackageManager(), componentName, ApiHelperForTiramisu.m1232of(640L)).metaData;
    ...
    public static class C1235P extends StartupApiFeature {
        C1235P(String str, String str2) {
            super(str, str2);
        }
