...
public class ServiceWorkerWebSettingsImpl extends ServiceWorkerWebSettingsCompat {
    ...
    public void setCacheMode(int i) {
        ApiFeature.C1226N c1226n = WebViewFeatureInternal.SERVICE_WORKER_CACHE_MODE;
    ...
    public void setAllowContentAccess(boolean z) {
        ApiFeature.C1226N c1226n = WebViewFeatureInternal.SERVICE_WORKER_CONTENT_ACCESS;
        if (c1226n.isSupportedByFramework()) {
    ...
    public void setAllowFileAccess(boolean z) {
        ApiFeature.C1226N c1226n = WebViewFeatureInternal.SERVICE_WORKER_FILE_ACCESS;
        if (c1226n.isSupportedByFramework()) {
    ...
    public void setBlockNetworkLoads(boolean z) {
        ApiFeature.C1226N c1226n = WebViewFeatureInternal.SERVICE_WORKER_BLOCK_NETWORK_LOADS;
        if (c1226n.isSupportedByFramework()) {
