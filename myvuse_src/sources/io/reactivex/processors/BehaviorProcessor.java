...
public final class BehaviorProcessor<T> extends FlowableProcessor<T> {
    ...
    public void onError(Throwable th) {
        ...
        if (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m1161m(this.terminalEvent, null, th)) {
    ...
    public void onComplete() {
        if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m1161m(this.terminalEvent, null, ExceptionHelper.TERMINATED)) {
    ...
    boolean add(BehaviorSubscription<T> behaviorSubscription) {
        ...
        } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m1161m(this.subscribers, behaviorSubscriptionArr, behaviorSubscriptionArr2));
        return true;
    }
