    ...
    static final class SwitchMapMaybeMainObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        public void onNext(T t) {
            ...
            try {
                ...
                } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m1161m(this.inner, switchMapMaybeObserver, switchMapMaybeObserver3));
        ...
        void innerError(SwitchMapMaybeObserver<R> switchMapMaybeObserver, Throwable th) {
            if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m1161m(this.inner, switchMapMaybeObserver, null) && this.errors.addThrowable(th)) {
                if (!this.delayErrors) {
                    this.upstream.dispose();
                    disposeInner();
                }
        ...
        void innerComplete(SwitchMapMaybeObserver<R> switchMapMaybeObserver) {
            if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m1161m(this.inner, switchMapMaybeObserver, null)) {
                drain();
            }
        }
        ...
        void drain() {
            ...
            while (!this.cancelled) {
                ...
                if (!z2 && switchMapMaybeObserver.item != null) {
                    PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m1161m(atomicReference, switchMapMaybeObserver, null);
