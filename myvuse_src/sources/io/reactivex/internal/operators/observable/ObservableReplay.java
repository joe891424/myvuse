...
public final class ObservableReplay<T> extends ConnectableObservable<T> implements HasUpstreamObservableSource<T>, ResettableConnectable {
    ...
    public void resetIf(Disposable disposable) {
        PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m1161m(this.current, (ReplayObserver) disposable, null);
    }
    ...
    public void connect(Consumer<? super Disposable> consumer) {
        ...
        while (true) {
            ...
            if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m1161m(this.current, replayObserver, replayObserver2)) {
    ...
    static final class ReplayObserver<T> extends AtomicReference<Disposable> implements Observer<T>, Disposable {
        ...
        boolean add(InnerDisposable<T> innerDisposable) {
            ...
            } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m1161m(this.observers, innerDisposableArr, innerDisposableArr2));
            return true;
        }
    ...
    static final class ReplaySource<T> implements ObservableSource<T> {
        ...
        public void subscribe(Observer<? super T> observer) {
            ...
            while (true) {
                ...
                ReplayObserver<T> replayObserver2 = new ReplayObserver<>(this.bufferFactory.call());
                if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m1161m(this.curr, null, replayObserver2)) {
                    replayObserver = replayObserver2;
                    break;
                }
            }
    ...
    static final class Replay<T> extends ConnectableObservable<T> {
        ...
        private final ConnectableObservable<T> f8273co;
        private final Observable<T> observable;

        Replay(ConnectableObservable<T> connectableObservable, Observable<T> observable) {
            this.f8273co = connectableObservable;
            this.observable = observable;
        }

        @Override // io.reactivex.observables.ConnectableObservable
        public void connect(Consumer<? super Disposable> consumer) {
            this.f8273co.connect(consumer);
        }
