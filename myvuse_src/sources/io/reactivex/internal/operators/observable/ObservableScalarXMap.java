...
public final class ObservableScalarXMap {
    ...
    public static <T, R> boolean tryScalarXMapSubscribe(ObservableSource<T> observableSource, Observer<? super R> observer, Function<? super T, ? extends ObservableSource<? extends R>> function) {
        ...
        try {
            C0004a c0004a = (Object) ((Callable) observableSource).call();
            if (c0004a == null) {
                EmptyDisposable.complete(observer);
                return true;
            }
            try {
                ObservableSource observableSource2 = (ObservableSource) ObjectHelper.requireNonNull(function.apply(c0004a), "The mapper returned a null ObservableSource");
