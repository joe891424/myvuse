...
public final class ObservableFromIterable<T> extends Observable<T> {
    ...
    static final class FromIterableDisposable<T> extends BasicQueueDisposable<T> {
        ...
        final Iterator<? extends T> f8269it;
        ...
        void run() {
            while (!isDisposed()) {
                try {
                    this.downstream.onNext(ObjectHelper.requireNonNull(this.f8269it.next(), "The iterator returned a null value"));
                    if (isDisposed()) {
                        return;
                    }
                    try {
                        if (!this.f8269it.hasNext()) {
                            if (isDisposed()) {
                                return;
                            }
        ...
        public T poll() {
            ...
            return (T) ObjectHelper.requireNonNull(this.f8269it.next(), "The iterator returned a null value");
        }
