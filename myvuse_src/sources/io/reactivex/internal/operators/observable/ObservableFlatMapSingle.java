    ...
    static final class FlatMapSingleObserver<T, R> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        */
        ...
        SpscLinkedArrayQueue<R> getOrCreateQueue() {
            ...
            } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m1161m(this.queue, null, spscLinkedArrayQueue));
        ...
        void drainLoop() {
            ...
            while (!this.cancelled) {
                ...
                C0005a0 c0005a0Poll = spscLinkedArrayQueue != null ? spscLinkedArrayQueue.poll() : null;
                boolean z2 = c0005a0Poll == null;
                if (z && z2) {
