...
public final class CompletableConcatIterable extends Completable {
    ...
    public void subscribeActual(CompletableObserver completableObserver) {
        try {
            ...
            completableObserver.onSubscribe(concatInnerObserver.f8225sd);
    ...
    static final class ConcatInnerObserver extends AtomicInteger implements CompletableObserver {
        ...
        final SequentialDisposable f8225sd = new SequentialDisposable();
        ...
        public void onSubscribe(Disposable disposable) {
            this.f8225sd.replace(disposable);
        }
        ...
        void next() {
            if (!this.f8225sd.isDisposed() && getAndIncrement() == 0) {
                Iterator<? extends CompletableSource> it2 = this.sources;
                while (!this.f8225sd.isDisposed()) {
                    try {
                        if (!it2.hasNext()) {
