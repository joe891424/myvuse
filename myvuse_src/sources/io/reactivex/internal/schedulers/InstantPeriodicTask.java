...
final class InstantPeriodicTask implements Callable<Void>, Disposable {
    ...
    void setFirst(Future<?> future) {
        ...
        } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m1161m(this.first, future2, future));
    }
    ...
    void setRest(Future<?> future) {
        ...
        } while (!PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m1161m(this.rest, future2, future));
    }
}
