...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    public final <R> R m5589as(ObservableConverter<T, ? extends R> observableConverter) {
    ...
    public final <R> R m5590to(Function<? super Observable<T>, R> function) {
        try {
    ...
    public final Flowable<T> toFlowable(BackpressureStrategy backpressureStrategy) {
        ...
        int i = C53571.$SwitchMap$io$reactivex$BackpressureStrategy[backpressureStrategy.ordinal()];
        if (i == 1) {
