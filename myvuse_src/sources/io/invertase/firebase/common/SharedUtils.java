...
public class SharedUtils {
    ...
    public static void sendEvent(ReactContext reactContext, String str, Object obj) {
        if (reactContext != null) {
            ...
            LogInstrumentation.m2726d(TAG, "Missing context - cannot send event!");
        }
    }
    ...
    public static int getResId(Context context, String str) {
        ...
        if (identifier == 0) {
            LogInstrumentation.m2728e(TAG, "resource " + str + " could not be found");
        }
        return identifier;
    }
            ...
            default:
                if (List.class.isAssignableFrom(obj.getClass())) {
                    ...
                    if (Map.class.isAssignableFrom(obj.getClass())) {
                        ...
                        LogInstrumentation.m2726d(TAG, "utils:arrayPushValue:unknownType:" + name);
                        writableArray.pushNull();
                    }
                    break;
                }
            ...
            default:
                if (List.class.isAssignableFrom(obj.getClass())) {
                    ...
                    if (Map.class.isAssignableFrom(obj.getClass())) {
                        ...
                        LogInstrumentation.m2726d(TAG, "utils:mapPutValue:unknownType:" + name);
                        writableMap.putNull(str);
                    }
                    break;
                }
