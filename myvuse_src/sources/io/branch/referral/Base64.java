...
class Base64 {
    ...
    public static byte[] decode(byte[] bArr, int i, int i2, int i3) {
        ...
        if (decoder.f8199op == decoder.output.length) {
            return decoder.output;
        }
        byte[] bArr2 = new byte[decoder.f8199op];
        System.arraycopy(decoder.output, 0, bArr2, 0, decoder.f8199op);
        return bArr2;
    }
    ...
    public static String encodeToString(byte[] bArr, int i) {
        try {
            return new String(encode(bArr, i), StringUtil.US_ASCII);
    ...
    public static String encodeToString(byte[] bArr, int i, int i2, int i3) {
        try {
            return new String(encode(bArr, i, i2, i3), StringUtil.US_ASCII);
        } catch (UnsupportedEncodingException e) {
            throw new AssertionError(e);
        }
    }
