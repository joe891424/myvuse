...
public class BlurView extends FrameLayout {
    ...
    private void init(AttributeSet attributeSet, int i) {
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C5156R.styleable.BlurView, i, 0);
        this.overlayColor = typedArrayObtainStyledAttributes.getColor(C5156R.styleable.BlurView_blurOverlayColor, 0);
    ...
    protected void onAttachedToWindow() {
        ...
        if (!isHardwareAccelerated()) {
            LogInstrumentation.m2728e(TAG, "BlurView can't be used in not hardware-accelerated window!");
        } else {
